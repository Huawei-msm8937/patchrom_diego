...
.field public static final LOAD_MODE_MMS_COMMON:I = 0x0

.field public static final LOAD_MODE_MMS_FAVORITES:I = 0x1
...
.field mHwCustPduPersister:Lcom/android/mms/pdu/HwCustPduPersister;
...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    .line 313
    const-class v0, Lcom/android/mms/pdu/HwCustPduPersister;
    ...
    check-cast v0, Lcom/android/mms/pdu/HwCustPduPersister;

    iput-object v0, p0, Lcom/google/android/mms/pdu/PduPersister;->mHwCustPduPersister:Lcom/android/mms/pdu/HwCustPduPersister;
...
.method public static getPduPersister(Landroid/content/Context;)Lcom/google/android/mms/pdu/PduPersister;
    ...
    .line 323
    .local v1, "priorContext":Landroid/content/Context;
    :goto_0
    if-nez v1, :cond_0
    ...
    .line 327
    :cond_0
    sget-object v2, Lcom/google/android/mms/pdu/PduPersister;->sPersister:Lcom/google/android/mms/pdu/PduPersister;

    if-nez v2, :cond_3

    .line 328
    new-instance v2, Lcom/google/android/mms/pdu/PduPersister;

    invoke-direct {v2, v1}, Lcom/google/android/mms/pdu/PduPersister;-><init>(Landroid/content/Context;)V

    sput-object v2, Lcom/google/android/mms/pdu/PduPersister;->sPersister:Lcom/google/android/mms/pdu/PduPersister;
    ...
    .line 321
    .end local v1    # "priorContext":Landroid/content/Context;
    :cond_2
    const/4 v1, 0x0
    ...
    .line 330
    .restart local v1    # "priorContext":Landroid/content/Context;
    :cond_3
    sget-object v2, Lcom/google/android/mms/pdu/PduPersister;->sPersister:Lcom/google/android/mms/pdu/PduPersister;

    iget-object v2, v2, Lcom/google/android/mms/pdu/PduPersister;->mContext:Landroid/content/Context;
    ...
    const-string v3, "PduPersister create a new one. may cause memory leak"
    ...
    invoke-virtual {v2}, Lcom/google/android/mms/pdu/PduPersister;->release()V
...
.method private loadAddress(JLcom/google/android/mms/pdu/PduHeaders;I)V
    .locals 11
    .param p1, "msgId"    # J
    ...
    const-string v3, "content://fav-mms/"
...
.method private loadParts(JI)[Lcom/google/android/mms/pdu/PduPart;
    ...
    const-string v5, "content://fav-mms/"
    ...
    const-string v3, "content://fav-mms/part/"
    ...
    .line 507
    :try_start_2
    new-instance v33, Lcom/google/android/mms/pdu/EncodedStringValue;
    ...
    invoke-direct {v0, v2, v1}, Lcom/google/android/mms/pdu/EncodedStringValue;-><init>(ILjava/lang/String;)V
    ...
    const-string v3, "Failed to EncodedStringValue: "
...
.method private persistAddress(JI[Lcom/google/android/mms/pdu/EncodedStringValue;)V
    ...
    .line 794
    .local v1, "allValues":[Landroid/content/ContentValues;
    ...
    invoke-virtual {v9, v7, v1}, Landroid/content/ContentResolver;->bulkInsert(Landroid/net/Uri;[Landroid/content/ContentValues;)I
...
.method private persistData(Lcom/google/android/mms/pdu/PduPart;Landroid/net/Uri;Ljava/lang/String;Ljava/util/HashMap;)V
    ...
    invoke-direct {v2, v9, v12}, Lcom/google/android/mms/pdu/EncodedStringValue;-><init>(I[B)V
    ...
    invoke-direct {v2, v12}, Lcom/google/android/mms/pdu/EncodedStringValue;-><init>([B)V
...
.method public load(Landroid/net/Uri;)Lcom/google/android/mms/pdu/GenericPdu;
    ...
    .line 627
    .local v29, "pdu":Lcom/google/android/mms/pdu/GenericPdu;
    const/4 v15, 0x0
    ...
    const-string v7, "content://fav-mms"
    ...
    .line 673
    .local v31, "set":Ljava/util/Set;, "Ljava/util/Set<Ljava/util/Map$Entry<Ljava/lang/Integer;Ljava/lang/Integer;>;>;"
    ...
    invoke-direct {v0, v1, v2, v3, v4}, Lcom/google/android/mms/pdu/PduPersister;->loadAddress(JLcom/google/android/mms/pdu/PduHeaders;I)V
    ...
    .line 719
    .local v27, "parts":[Lcom/google/android/mms/pdu/PduPart;
    if-eqz v27, :cond_e
    ...
    .line 727
    .end local v20    # "i":I
    .end local v27    # "parts":[Lcom/google/android/mms/pdu/PduPart;
    ...
    .end local v29    # "pdu":Lcom/google/android/mms/pdu/GenericPdu;
    .local v30, "pdu":Lcom/google/android/mms/pdu/GenericPdu;
    move-object/from16 v29, v30

    .line 776
    .end local v30    # "pdu":Lcom/google/android/mms/pdu/GenericPdu;
    .restart local v29    # "pdu":Lcom/google/android/mms/pdu/GenericPdu;
    :goto_b
    sget-object v7, Lcom/google/android/mms/pdu/PduPersister;->PDU_CACHE_INSTANCE:Lcom/google/android/mms/util/PduCache;
    ...
    .end local v31    # "set":Ljava/util/Set;, "Ljava/util/Set<Ljava/util/Map$Entry<Ljava/lang/Integer;Ljava/lang/Integer;>;>;"
    .restart local v16    # "cacheEntry":Lcom/google/android/mms/util/PduCacheEntry;
    :cond_10
    :try_start_17
    new-instance v15, Lcom/google/android/mms/util/PduCacheEntry;
    ...
    .restart local v31    # "set":Ljava/util/Set;, "Ljava/util/Set<Ljava/util/Map$Entry<Ljava/lang/Integer;Ljava/lang/Integer;>;>;"
    :catchall_8
    move-exception v6
...
.method public persist(Lcom/google/android/mms/pdu/GenericPdu;Landroid/net/Uri;ZZLjava/util/HashMap;I)Landroid/net/Uri;
    ...
    .line 1523
    .restart local v45    # "str":Ljava/lang/String;
    ...
    invoke-direct {v7, v10}, Lcom/google/android/mms/pdu/EncodedStringValue;-><init>(Ljava/lang/String;)V
    ...
    iget-object v6, v0, Lcom/google/android/mms/pdu/PduPersister;->mHwCustPduPersister:Lcom/android/mms/pdu/HwCustPduPersister;
    ...
    invoke-virtual {v6}, Lcom/android/mms/pdu/HwCustPduPersister;->isShortCodeFeatureEnabled()Z
    ...
    iget-object v10, v0, Lcom/google/android/mms/pdu/PduPersister;->mHwCustPduPersister:Lcom/android/mms/pdu/HwCustPduPersister;
    ...
    invoke-virtual {v10, v6, v7}, Lcom/android/mms/pdu/HwCustPduPersister;->hasShortCode([Lcom/google/android/mms/pdu/EncodedStringValue;[Lcom/google/android/mms/pdu/EncodedStringValue;)Z
...
.method public persistPart(Lcom/google/android/mms/pdu/PduPart;JLjava/util/HashMap;)Landroid/net/Uri;
    ...
    .line 835
    :cond_0
    invoke-static {v1}, Lcom/google/android/mms/ContentType;->isSupportedType(Ljava/lang/String;)Z
    ...
    invoke-static {v7, v8, v4, v6}, Lcom/google/android/mms/util/SqliteWrapper;->insert(Landroid/content/Context;Landroid/content/ContentResolver;Landroid/net/Uri;Landroid/content/ContentValues;)Landroid/net/Uri;
    ...
    const-string v8, "Failed to persist part, return null."
    ...
    const-string v8, "MIME type of the part must be set."
    ...
    :cond_d
    invoke-direct {p0, p1, v3, v1, p4}, Lcom/google/android/mms/pdu/PduPersister;->persistData(Lcom/google/android/mms/pdu/PduPart;Landroid/net/Uri;Ljava/lang/String;Ljava/util/HashMap;)V

    .line 905
    invoke-virtual {p1, v3}, Lcom/google/android/mms/pdu/PduPart;->setDataUri(Landroid/net/Uri;)V
