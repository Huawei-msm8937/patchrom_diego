...
.super Lcom/android/internal/telephony/gsm/AbstractGsmCallTracker;
...
.method constructor <init>(Lcom/android/internal/telephony/gsm/GSMPhone;)V
    ...
    .line 119
    invoke-direct {p0}, Lcom/android/internal/telephony/gsm/AbstractGsmCallTracker;-><init>()V
...
.method private updatePhoneState()V
    ...
    .line 459
    invoke-virtual {p0}, Lcom/android/internal/telephony/gsm/GsmCallTracker;->notifyRegistrantsDelayed()Z
...
.method public dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    .line 1141
    invoke-super {p0, p1, p2, p3}, Lcom/android/internal/telephony/gsm/AbstractGsmCallTracker;->dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    .end local v0    # "ar":Landroid/os/AsyncResult;
    :sswitch_2
    iput-boolean v12, p0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->callSwitchPending:Z
    ...
    .line 1122
    :sswitch_9
    sget-boolean v9, Lcom/android/internal/telephony/CallTracker;->IS_SUPPORT_RIL_RECOVERY:Z

    if-eqz v9, :cond_2

    .line 1123
    const-string v9, "restartRild for hungup call."
    ...
    invoke-interface {v9, v10}, Lcom/android/internal/telephony/CommandsInterface;->restartRild(Landroid/os/Message;)V
...
.method protected declared-synchronized handlePollCalls(Landroid/os/AsyncResult;)V
    ...
    :try_start_0
    invoke-static/range {v21 .. v21}, Landroid/hdm/HwDeviceManager;->disallowOp(I)Z
    ...
    const-string v22, "HwDeviceManager disallow open call."
    ...
    const-string v21, "no DriverCall"
    ...
    .line 497
    const-string v21, "pollCallsAfterDelay"
    ...
    invoke-virtual {v13}, Lcom/android/internal/telephony/Connection;->getOrigDialString()Ljava/lang/String;

    move-result-object v22

    invoke-virtual/range {v21 .. v22}, Lcom/android/internal/telephony/gsm/GsmConnection;->setPostDialString(Ljava/lang/String;)V
    ...
    .line 569
    iget-object v0, v13, Lcom/android/internal/telephony/Connection;->mPreHandoverState:Lcom/android/internal/telephony/Call$State;
    ...
    sget-object v22, Lcom/android/internal/telephony/DriverCall$State;->ACTIVE:Lcom/android/internal/telephony/DriverCall$State;
    ...
    .line 699
    .local v15, "it":Ljava/util/Iterator;, "Ljava/util/Iterator<Lcom/android/internal/telephony/Connection;>;"
    :goto_a
    ...
    .line 703
    check-cast v13, Lcom/android/internal/telephony/imsphone/ImsPhoneConnection;
    ...
    invoke-virtual {v13, v0}, Lcom/android/internal/telephony/imsphone/ImsPhoneConnection;->onDisconnect(I)Z
...
.method hangup(Lcom/android/internal/telephony/gsm/GsmCall;)V
    ...
    .line 860
    sget-boolean v1, Lcom/android/internal/telephony/gsm/GsmCallTracker;->IS_SUPPORT_RIL_RECOVERY:Z
    ...
    .line 868
    :goto_0
    invoke-virtual {p1}, Lcom/android/internal/telephony/gsm/GsmCall;->getState()Lcom/android/internal/telephony/Call$State;

    move-result-object v1

    invoke-virtual {p0, v1}, Lcom/android/internal/telephony/gsm/GsmCallTracker;->delaySendRilRecoveryMsg(Lcom/android/internal/telephony/Call$State;)V
    ...
    .line 912
    :cond_1
    invoke-virtual {p0}, Lcom/android/internal/telephony/gsm/GsmCallTracker;->cleanRilRecovery()V
