...
.super Lcom/android/internal/telephony/dataconnection/AbsDctController;
...
.field private static final EVENT_EMERGENCY_CALL_TOGGLED:I = 0x320

.field private static final EVENT_EXECUTE_ALL_REQUESTS:I = 0x66

.field private static final EVENT_EXECUTE_REQUEST:I = 0x65

.field private static final EVENT_PHONE_RADIO_OFF_OR_NOT_AVAILABLE:I = 0x2ee

.field private static final EVENT_PHONE_RADIO_ON:I = 0x2bc
...
# instance fields
.field private isDSDSManualPsAttach:Z

.field private isDsds:Z
...
.field private mDefault4GSlot:[I
...
.field private mRadioOn:[Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/internal/telephony/dataconnection/DctController;->IS_HISI_CDMA_SUPPORTED:Z
...
.method private constructor <init>([Lcom/android/internal/telephony/PhoneProxy;Landroid/os/Looper;)V
    ...
    .line 326
    invoke-direct {p0, p2}, Lcom/android/internal/telephony/dataconnection/AbsDctController;-><init>(Landroid/os/Looper;)V
    ...
    invoke-static {v4}, Lcom/android/internal/telephony/HwModemCapability;->isCapabilitySupport(I)Z

    move-result v4

    if-eqz v4, :cond_1

    invoke-static {v6}, Lcom/android/internal/telephony/HwModemCapability;->isCapabilitySupport(I)Z
    ...
    :goto_0
    iput-boolean v4, p0, Lcom/android/internal/telephony/dataconnection/DctController;->isDSDSManualPsAttach:Z
    ...
    :goto_1
    iput-boolean v5, p0, Lcom/android/internal/telephony/dataconnection/DctController;->isDsds:Z
    ...
    iput-object v4, p0, Lcom/android/internal/telephony/dataconnection/DctController;->mDefault4GSlot:[I
    ...
    iput-object v4, p0, Lcom/android/internal/telephony/dataconnection/DctController;->mRadioOn:[Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-direct {v5, v7, v8, v2}, Lcom/android/internal/telephony/dataconnection/DcSwitchStateMachine;-><init>(Lcom/android/internal/telephony/Phone;Ljava/lang/String;I)V
    ...
    invoke-direct {v5, v7, v2}, Lcom/android/internal/telephony/dataconnection/DcSwitchAsyncChannel;-><init>(Lcom/android/internal/telephony/dataconnection/DcSwitchStateMachine;I)V
    ...
    invoke-virtual {v4, v5, v7, v8}, Lcom/android/internal/telephony/dataconnection/DcSwitchAsyncChannel;->fullyConnectSync(Landroid/content/Context;Landroid/os/Handler;Landroid/os/Handler;)I
    ...
    .line 374
    iget-object v4, p0, Lcom/android/internal/telephony/dataconnection/DctController;->mDefault4GSlot:[I
    ...
    .line 377
    iget-object v4, p0, Lcom/android/internal/telephony/dataconnection/DctController;->mRadioOn:[Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    .line 392
    invoke-virtual {p0, p1, p2}, Lcom/android/internal/telephony/dataconnection/DctController;->initHw([Lcom/android/internal/telephony/PhoneProxy;Landroid/os/Looper;)V
...
.method static synthetic access$1000(Lcom/android/internal/telephony/dataconnection/DctController;Landroid/net/NetworkRequest;ILandroid/util/LocalLog;I)I
    .locals 1
    .param p0, "x0"    # Lcom/android/internal/telephony/dataconnection/DctController;
...
.method static synthetic access$300(Lcom/android/internal/telephony/dataconnection/DctController;)[Ljava/util/concurrent/atomic/AtomicBoolean;
    .locals 1
    .param p0, "x0"    # Lcom/android/internal/telephony/dataconnection/DctController;

    .prologue
    .line 72
    iget-object v0, p0, Lcom/android/internal/telephony/dataconnection/DctController;->mRadioOn:[Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method static synthetic access$400()Z
    ...
    .prologue
    .line 72
    sget-boolean v0, Lcom/android/internal/telephony/dataconnection/DctController;->IS_HISI_CDMA_SUPPORTED:Z
...
.method static synthetic access$500(Lcom/android/internal/telephony/dataconnection/DctController;)Z
    ...
    .prologue
    .line 72
    iget-boolean v0, p0, Lcom/android/internal/telephony/dataconnection/DctController;->isDSDSManualPsAttach:Z

    return v0
.end method

.method static synthetic access$600(Lcom/android/internal/telephony/dataconnection/DctController;)[I
    .locals 1
    .param p0, "x0"    # Lcom/android/internal/telephony/dataconnection/DctController;

    .prologue
    .line 72
    iget-object v0, p0, Lcom/android/internal/telephony/dataconnection/DctController;->mDefault4GSlot:[I

    return-object v0
.end method

.method static synthetic access$700(Lcom/android/internal/telephony/dataconnection/DctController;)[Lcom/android/internal/telephony/PhoneProxy;
    .locals 1
    .param p0, "x0"    # Lcom/android/internal/telephony/dataconnection/DctController;
...
.method static synthetic access$900(Lcom/android/internal/telephony/dataconnection/DctController;Landroid/net/NetworkRequest;)Ljava/lang/String;
    .locals 1
    .param p0, "x0"    # Lcom/android/internal/telephony/dataconnection/DctController;
    .param p1, "x1"    # Landroid/net/NetworkRequest;
...
.method private apnForNetworkRequest(Landroid/net/NetworkRequest;)Ljava/lang/String;
    ...
    .line 813
    const-string v5, "XCAP APN type is supported"
...
.method public static getInstanceHw()Lcom/android/internal/telephony/dataconnection/DctController;
    .locals 1
...
.method public static makeDctController([Lcom/android/internal/telephony/PhoneProxy;Landroid/os/Looper;)Lcom/android/internal/telephony/dataconnection/DctController;
    ...
    invoke-interface {v0, p0, p1}, Lcom/android/internal/telephony/HwDataConnectionManager;->makeStaticDctControllerHw([Lcom/android/internal/telephony/PhoneProxy;Landroid/os/Looper;)V
...
.method private onProcessRequest()V
    ...
    .line 532
    :cond_0
    invoke-virtual {p0}, Lcom/android/internal/telephony/dataconnection/DctController;->supportHwDualDataSwitch()Z

    move-result v6

    if-eqz v6, :cond_1

    iget-boolean v6, p0, Lcom/android/internal/telephony/dataconnection/DctController;->isDsds:Z
    ...
    invoke-virtual {p0, v4, v6, v0}, Lcom/android/internal/telephony/dataconnection/DctController;->getTopPriorityRequestPhoneIdHw(ILjava/util/HashMap;I)I
    ...
    .line 546
    .local v5, "requestInfo":Lcom/android/internal/telephony/dataconnection/DcSwitchAsyncChannel$RequestInfo;
    iget v6, v5, Lcom/android/internal/telephony/dataconnection/DcSwitchAsyncChannel$RequestInfo;->phoneId:I
    ...
    invoke-virtual {v6, v5}, Lcom/android/internal/telephony/dataconnection/DcSwitchAsyncChannel;->connect(Lcom/android/internal/telephony/dataconnection/DcSwitchAsyncChannel$RequestInfo;)I
...
.method private onSettingsChanged()V
    ...
    .line 678
    const-string v10, "DctController.onSettingsChange releasing request"

    invoke-virtual {v7, v10}, Lcom/android/internal/telephony/dataconnection/DcSwitchAsyncChannel$RequestInfo;->log(Ljava/lang/String;)V
    ...
    invoke-virtual {v3, v1, v10}, Lcom/android/internal/telephony/dataconnection/DcTrackerBase;->decApnRefCount(Ljava/lang/String;Landroid/util/LocalLog;)V
...
# virtual methods
.method public apnForNetworkRequestHw(Landroid/net/NetworkRequest;)Ljava/lang/String;
    .locals 1
    .param p1, "nr"    # Landroid/net/NetworkRequest;
...
.method public dispose()V
    ...
    :cond_0
    invoke-super {p0}, Lcom/android/internal/telephony/dataconnection/AbsDctController;->dispose()V
...
.method public getNetworkFactory()[Landroid/net/NetworkFactory;
    .locals 1
    ...
    invoke-virtual {v0}, [Landroid/net/NetworkFactory;->clone()Ljava/lang/Object;
...
.method public getRequestPhoneIdHw(Landroid/net/NetworkRequest;)I
    .locals 1
    .param p1, "networkRequest"    # Landroid/net/NetworkRequest;
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    .prologue
    .line 418
    invoke-virtual {p0, p1}, Lcom/android/internal/telephony/dataconnection/DctController;->beforeHandleMessage(Landroid/os/Message;)Z
...
.method protected releaseAllNetworkRequests()V
    .locals 2
...
.method public releaseNetworkHw(Landroid/net/NetworkRequest;)I
    .locals 1
    .param p1, "request"    # Landroid/net/NetworkRequest;
...
.method public requestNetworkHw(Landroid/net/NetworkRequest;ILandroid/util/LocalLog;I)I
    .locals 1
    .param p1, "request"    # Landroid/net/NetworkRequest;
    .param p2, "priority"    # I
    .param p3, "l"    # Landroid/util/LocalLog;
...
.method protected updateSubIdAndCapability()V
    .locals 2
