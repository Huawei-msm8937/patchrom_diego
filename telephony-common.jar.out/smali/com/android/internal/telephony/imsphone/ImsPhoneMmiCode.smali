...
.method private getImsExceptionMessage(Lcom/android/ims/ImsException;)Ljava/lang/CharSequence;
    .locals 2
    .param p1, "error"    # Lcom/android/ims/ImsException;
    ...
    .line 1124
    invoke-direct {p0, v1}, Lcom/android/internal/telephony/imsphone/ImsPhoneMmiCode;->getErrorMessage(Landroid/os/AsyncResult;)Ljava/lang/CharSequence;
...
.method private onQueryCfComplete(Landroid/os/AsyncResult;)V
    ...
    invoke-virtual {p0, v8}, Lcom/android/internal/telephony/imsphone/ImsPhoneMmiCode;->isUtNoConnectionException(Ljava/lang/Exception;)Z
    ...
    sget-object v8, Lcom/android/internal/telephony/CommandException$Error;->UT_NO_CONNECTION:Lcom/android/internal/telephony/CommandException$Error;
    ...
    invoke-virtual {v8, p0, v0}, Lcom/android/internal/telephony/imsphone/ImsPhone;->onMMIDone(Lcom/android/internal/telephony/imsphone/ImsPhoneMmiCode;Ljava/lang/Exception;)V
    ...
    iput-object v8, p0, Lcom/android/internal/telephony/imsphone/ImsPhoneMmiCode;->mState:Lcom/android/internal/telephony/MmiCode$State;
    ...
    invoke-direct {p0, v1}, Lcom/android/internal/telephony/imsphone/ImsPhoneMmiCode;->getImsExceptionMessage(Lcom/android/ims/ImsException;)Ljava/lang/CharSequence;
    ...
    :goto_1
    iput-object v5, p0, Lcom/android/internal/telephony/imsphone/ImsPhoneMmiCode;->mMessage:Ljava/lang/CharSequence;

    .line 1379
    iget-object v8, p0, Lcom/android/internal/telephony/imsphone/ImsPhoneMmiCode;->mPhone:Lcom/android/internal/telephony/imsphone/ImsPhone;

    invoke-virtual {v8, p0}, Lcom/android/internal/telephony/imsphone/ImsPhone;->onMMIDone(Lcom/android/internal/telephony/imsphone/ImsPhoneMmiCode;)V
    ...
    .line 1344
    iget-object v8, p0, Lcom/android/internal/telephony/imsphone/ImsPhoneMmiCode;->mContext:Landroid/content/Context;
    ...
    .line 1347
    iget-object v8, p0, Lcom/android/internal/telephony/imsphone/ImsPhoneMmiCode;->mIccRecords:Lcom/android/internal/telephony/uicc/IccRecords;
    ...
    invoke-virtual {v8, v11, v9, v10}, Lcom/android/internal/telephony/uicc/IccRecords;->setVoiceCallForwardingFlag(IZLjava/lang/String;)V
    ...
    invoke-direct {p0, v8, v6}, Lcom/android/internal/telephony/imsphone/ImsPhoneMmiCode;->makeCFQueryResultMessage(Lcom/android/internal/telephony/CallForwardInfo;I)Ljava/lang/CharSequence;
...
.method private onQueryClirComplete(Landroid/os/AsyncResult;)V
    ...
    invoke-virtual {p0, v5}, Lcom/android/internal/telephony/imsphone/ImsPhoneMmiCode;->isUtNoConnectionException(Ljava/lang/Exception;)Z
    ...
    sget-object v6, Lcom/android/internal/telephony/CommandException$Error;->UT_NO_CONNECTION:Lcom/android/internal/telephony/CommandException$Error;
    ...
    invoke-virtual {v6, p0, v1}, Lcom/android/internal/telephony/imsphone/ImsPhone;->onMMIDone(Lcom/android/internal/telephony/imsphone/ImsPhoneMmiCode;Ljava/lang/Exception;)V
    ...
    .line 1472
    .local v2, "error":Lcom/android/ims/ImsException;
    invoke-direct {p0, v2}, Lcom/android/internal/telephony/imsphone/ImsPhoneMmiCode;->getImsExceptionMessage(Lcom/android/ims/ImsException;)Ljava/lang/CharSequence;
    ...
    .line 1557
    .end local v2    # "error":Lcom/android/ims/ImsException;
    :cond_1
    :goto_1
    ...
    .line 1480
    .local v4, "ssInfo":Landroid/os/Bundle;
    ...
    .line 1487
    .end local v4    # "ssInfo":Landroid/os/Bundle;
    :goto_2
...
.method private onQueryComplete(Landroid/os/AsyncResult;)V
    ...
    invoke-virtual {p0, v4}, Lcom/android/internal/telephony/imsphone/ImsPhoneMmiCode;->isUtNoConnectionException(Ljava/lang/Exception;)Z
    ...
    sget-object v5, Lcom/android/internal/telephony/CommandException$Error;->UT_NO_CONNECTION:Lcom/android/internal/telephony/CommandException$Error;
    ...
    invoke-virtual {v5, p0, v0}, Lcom/android/internal/telephony/imsphone/ImsPhone;->onMMIDone(Lcom/android/internal/telephony/imsphone/ImsPhoneMmiCode;Ljava/lang/Exception;)V
    ...
    invoke-direct {p0, v5}, Lcom/android/internal/telephony/imsphone/ImsPhoneMmiCode;->createQueryCallWaitingResultMessage(I)Ljava/lang/CharSequence;
...
.method private onSetComplete(Landroid/os/Message;Landroid/os/AsyncResult;)V
    ...
    .line 1194
    iget-boolean v5, p0, Lcom/android/internal/telephony/imsphone/ImsPhoneMmiCode;->mIsCallFwdReg:Z
...
.method private onSuppSvcQueryComplete(Landroid/os/AsyncResult;)V
    ...
    invoke-virtual {p0, v6}, Lcom/android/internal/telephony/imsphone/ImsPhoneMmiCode;->isUtNoConnectionException(Ljava/lang/Exception;)Z
    ...
    .line 1408
    .local v4, "ssInfo":Lcom/android/ims/ImsSsInfo;
    iget-object v6, p1, Landroid/os/AsyncResult;->result:Ljava/lang/Object;
    ...
    const-string v7, "Received CLIP/COLP/COLR Response."
    ...
    .line 1412
    .local v5, "ssInfoResp":Landroid/os/Bundle;
    ...
    .end local v4    # "ssInfo":Lcom/android/ims/ImsSsInfo;
    check-cast v4, Lcom/android/ims/ImsSsInfo;

    .line 1413
    .restart local v4    # "ssInfo":Lcom/android/ims/ImsSsInfo;
    if-eqz v4, :cond_5
    ...
    const-string v8, "ImsSsInfo mStatus = "

    invoke-virtual {v7, v8}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v7

    iget v8, v4, Lcom/android/ims/ImsSsInfo;->mStatus:I
    ...
    .line 1415
    iget v6, v4, Lcom/android/ims/ImsSsInfo;->mStatus:I
    ...
    .line 1429
    .end local v5    # "ssInfoResp":Landroid/os/Bundle;
    :cond_6
    const-string v6, "ImsPhoneMmiCode"

    const-string v7, "Received Call Barring Response."
...
.method isSupportedOverImsPhone()Z
    ...
    :cond_9
    :try_start_0
    iget-object v5, p0, Lcom/android/internal/telephony/imsphone/ImsPhoneMmiCode;->mSib:Ljava/lang/String;

    invoke-static {v5}, Lcom/android/internal/telephony/imsphone/ImsPhoneMmiCode;->siToServiceClass(Ljava/lang/String;)I
    :try_end_0
    ...
    .line 701
    :cond_c
    iget-object v5, p0, Lcom/android/internal/telephony/imsphone/ImsPhoneMmiCode;->mPoundString:Ljava/lang/String;
...
.method isUtNoConnectionException(Ljava/lang/Exception;)Z
    .locals 5
    ...
    .line 709
    instance-of v3, p1, Lcom/android/ims/ImsException;
    ...
    .line 716
    .local v0, "commandException":Lcom/android/internal/telephony/CommandException;
    invoke-virtual {v0}, Lcom/android/internal/telephony/CommandException;->getCommandError()Lcom/android/internal/telephony/CommandException$Error;

    move-result-object v3

    sget-object v4, Lcom/android/internal/telephony/CommandException$Error;->UT_NO_CONNECTION:Lcom/android/internal/telephony/CommandException$Error;

    if-eq v3, v4, :cond_0

    .line 720
    .end local v0    # "commandException":Lcom/android/internal/telephony/CommandException;
    :cond_2
    const/4 v2, 0x0
...
.method processCode()V
    ...
    invoke-static {v0}, Lcom/android/internal/telephony/imsphone/HwImsPhoneMmiCode;->isUnSupportMMICode(Ljava/lang/String;)V
