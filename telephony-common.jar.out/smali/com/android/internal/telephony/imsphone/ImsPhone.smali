...
.field private mCust:Lcom/android/internal/telephony/imsphone/HwCustImsPhone;
...
.field public mHwImsPhone:Lcom/android/internal/telephony/imsphone/HwImsPhone;
...
.method constructor <init>(Landroid/content/Context;Lcom/android/internal/telephony/PhoneNotifier;Lcom/android/internal/telephony/Phone;)V
    ...
    .line 213
    new-instance v1, Lcom/android/internal/telephony/imsphone/HwImsPhone;
    ...
    invoke-direct {v1, v2}, Lcom/android/internal/telephony/imsphone/HwImsPhone;-><init>(Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;)V

    iput-object v1, p0, Lcom/android/internal/telephony/imsphone/ImsPhone;->mHwImsPhone:Lcom/android/internal/telephony/imsphone/HwImsPhone;

    .line 216
    const-class v1, Lcom/android/internal/telephony/imsphone/HwCustImsPhone;
    ...
    check-cast v1, Lcom/android/internal/telephony/imsphone/HwCustImsPhone;

    iput-object v1, p0, Lcom/android/internal/telephony/imsphone/ImsPhone;->mCust:Lcom/android/internal/telephony/imsphone/HwCustImsPhone;

    .line 217
    iget-object v1, p0, Lcom/android/internal/telephony/imsphone/ImsPhone;->mCust:Lcom/android/internal/telephony/imsphone/HwCustImsPhone;
    ...
    invoke-virtual {v1}, Lcom/android/internal/telephony/imsphone/HwCustImsPhone;->registerContentObservers()V
...
.method static synthetic access$200(Lcom/android/internal/telephony/imsphone/ImsPhone;)Lcom/android/internal/telephony/imsphone/HwCustImsPhone;
    .locals 1
    .param p0, "x0"    # Lcom/android/internal/telephony/imsphone/ImsPhone;

    .prologue
    .line 106
    iget-object v0, p0, Lcom/android/internal/telephony/imsphone/ImsPhone;->mCust:Lcom/android/internal/telephony/imsphone/HwCustImsPhone;
...
.method private handleCallWaitingIncallSupplementaryService(Ljava/lang/String;)Z
    ...
    .line 443
    iget-object v6, p0, Lcom/android/internal/telephony/imsphone/ImsPhone;->mCT:Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;

    invoke-virtual {v6, v0, v1}, Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;->hangupConnectionByIndex(Lcom/android/internal/telephony/imsphone/ImsPhoneCall;I)V
    :try_end_0
    .catch Lcom/android/internal/telephony/CallStateException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-virtual {p0, v6}, Lcom/android/internal/telephony/imsphone/ImsPhone;->notifySuppServiceFailed(Lcom/android/internal/telephony/Phone$SuppService;)V
    ...
    invoke-virtual {v6, v0}, Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;->hangup(Lcom/android/internal/telephony/imsphone/ImsPhoneCall;)V
    ...
    invoke-virtual {v6}, Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;->switchWaitingOrHoldingAndActive()V
    :try_end_1
    .catch Lcom/android/internal/telephony/CallStateException; {:try_start_1 .. :try_end_1} :catch_0
...
.method public dispose()V
    ...
    invoke-virtual {v0}, Lcom/android/internal/telephony/imsphone/HwCustImsPhone;->unRegisterContentObservers()V
...
.method public getCallForwardingIndicator()Z
    ...
    invoke-virtual {p0}, Lcom/android/internal/telephony/imsphone/ImsPhone;->getSubscriberId()Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lcom/android/internal/telephony/imsphone/ImsPhone;->getVmSimImsi()Ljava/lang/String;
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    .line 1284
    iget-object v8, p0, Lcom/android/internal/telephony/imsphone/ImsPhone;->mHwImsPhone:Lcom/android/internal/telephony/imsphone/HwImsPhone;

    invoke-virtual {v8, p1}, Lcom/android/internal/telephony/imsphone/HwImsPhone;->beforeHandleMessage(Landroid/os/Message;)Z
    ...
    invoke-virtual {v5, v9, v8, v10}, Lcom/android/internal/telephony/uicc/IccRecords;->setVoiceCallForwardingFlag(IZLjava/lang/String;)V
    ...
    invoke-direct {p0, v8, v12, v9}, Lcom/android/internal/telephony/imsphone/ImsPhone;->sendResponse(Landroid/os/Message;Ljava/lang/Object;Ljava/lang/Throwable;)V
    ...
    instance-of v8, v8, [Lcom/android/ims/ImsCallForwardInfo;
    ...
    invoke-direct {p0, v8, v9, v10}, Lcom/android/internal/telephony/imsphone/ImsPhone;->sendResponse(Landroid/os/Message;Ljava/lang/Object;Ljava/lang/Throwable;)V
    ...
    .line 1316
    .local v7, "tempMsg":Landroid/os/Message;
    ...
    .line 1320
    .end local v7    # "tempMsg":Landroid/os/Message;
    ...
    instance-of v8, v8, [Lcom/android/ims/ImsSsInfo;
    ...
    invoke-direct {p0, v8, v6, v4}, Lcom/android/internal/telephony/imsphone/ImsPhone;->sendResponse(Landroid/os/Message;Ljava/lang/Object;Ljava/lang/Throwable;)V
    ...
    invoke-direct {p0, v8, v9, v4}, Lcom/android/internal/telephony/imsphone/ImsPhone;->sendResponse(Landroid/os/Message;Ljava/lang/Object;Ljava/lang/Throwable;)V
    ...
    const-string v10, "Callforwarding is "
...
.method notifyUnKnowConnection(Lcom/android/internal/telephony/Connection;)V
    .locals 1
    .param p1, "c"    # Lcom/android/internal/telephony/Connection;
...
.method onMMIDone(Lcom/android/internal/telephony/imsphone/ImsPhoneMmiCode;Ljava/lang/Exception;)V
    .locals 3
    .param p1, "mmi"    # Lcom/android/internal/telephony/imsphone/ImsPhoneMmiCode;
...
.method public processDisconnectReason(Lcom/android/ims/ImsReasonInfo;)V
    ...
    iget-object v1, v0, Lcom/android/internal/telephony/imsphone/ImsPhone;->mCust:Lcom/android/internal/telephony/imsphone/HwCustImsPhone;
    ...
    iget-object v3, v0, Lcom/android/internal/telephony/imsphone/ImsPhone;->mResultReceiver:Landroid/content/BroadcastReceiver;

    move-object/from16 v0, p1

    invoke-virtual {v1, v0, v3}, Lcom/android/internal/telephony/imsphone/HwCustImsPhone;->setOperatorErrorCodes(Lcom/android/ims/ImsReasonInfo;Landroid/content/BroadcastReceiver;)Z
...
.method public setCallBarring(Ljava/lang/String;ZLjava/lang/String;Landroid/os/Message;)V
    ...
    const-string v3, "setCallBarring facility="
    ...
    invoke-virtual {p0, v1, p4}, Lcom/android/internal/telephony/imsphone/ImsPhone;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
    ...
    invoke-interface/range {v0 .. v5}, Lcom/android/ims/ImsUtInterface;->updateCallBarringOption(Ljava/lang/String;IZLandroid/os/Message;[Ljava/lang/String;)V
    :try_end_0
    .catch Lcom/android/ims/ImsException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setImsRegistered(Z)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/internal/telephony/imsphone/HwCustImsPhone;->removeNotification(Z)V
