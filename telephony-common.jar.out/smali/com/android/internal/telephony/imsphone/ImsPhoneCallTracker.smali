...
.super Lcom/android/internal/telephony/imsphone/AbstractImsPhoneCallTracker;
...
.field private mCallExpectedToResume:Ljava/util/ArrayList;
...
.field private mCust:Lcom/android/internal/telephony/imsphone/HwCustImsPhoneCallTracker;
...
.method constructor <init>(Lcom/android/internal/telephony/imsphone/ImsPhone;)V
    ...
    .line 230
    invoke-direct {p0}, Lcom/android/internal/telephony/imsphone/AbstractImsPhoneCallTracker;-><init>()V
    ...
    .line 200
    iput-object v7, p0, Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;->mUssdSession:Lcom/android/ims/ImsCall;

    .line 201
    iput-object v7, p0, Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;->mPendingUssd:Landroid/os/Message;
    ...
    iput-object v2, p0, Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;->mCallExpectedToResume:Ljava/util/ArrayList;
    ...
    .line 238
    const-class v2, Lcom/android/internal/telephony/imsphone/HwCustImsPhoneCallTracker;
    ...
    check-cast v2, Lcom/android/internal/telephony/imsphone/HwCustImsPhoneCallTracker;

    iput-object v2, p0, Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;->mCust:Lcom/android/internal/telephony/imsphone/HwCustImsPhoneCallTracker;
...
.method static synthetic access$1800(Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;)Ljava/util/ArrayList;
    .locals 1
    .param p0, "x0"    # Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;

    .prologue
    .line 77
    iget-object v0, p0, Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;->mCallExpectedToResume:Ljava/util/ArrayList;
...
.method static synthetic access$700(Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;I)Lcom/android/internal/telephony/Call$State;
    .locals 1
    .param p0, "x0"    # Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;
    .param p1, "x1"    # I
...
.method private hangupImsCall(Lcom/android/internal/telephony/imsphone/ImsPhoneCall;)V
    .locals 3
    ...
    .prologue
    .line 924
    const-string v2, "hangupImsCall ImsPhoneCall"
    ...
    .line 927
    .local v1, "ipc":Lcom/android/internal/telephony/imsphone/ImsPhoneConnection;
    invoke-direct {p0, v1}, Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;->hangupImsConnection(Lcom/android/internal/telephony/imsphone/ImsPhoneConnection;)V
    ...
    .line 929
    .end local v1    # "ipc":Lcom/android/internal/telephony/imsphone/ImsPhoneConnection;
    :cond_0
    return-void
.end method

.method private hangupImsConnection(Lcom/android/internal/telephony/imsphone/ImsPhoneConnection;)V
    .locals 7
    .param p1, "conn"    # Lcom/android/internal/telephony/imsphone/ImsPhoneConnection;
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    .prologue
    .line 932
    const-string v4, "hangupImsConnection ImsPhoneConnection"
    ...
    const-string v5, "no connections"
    ...
    .line 943
    .local v3, "rejectCall":Z
    iget-object v4, p0, Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;->mRingingCall:Lcom/android/internal/telephony/imsphone/ImsPhoneCall;

    if-ne v0, v4, :cond_2

    .line 944
    const-string v4, "(ringing) hangup incoming"
    ...
    const-string v5, "hangupImsConnection imsCall  :: "
    ...
    :try_start_0
    invoke-virtual {v2, v4}, Lcom/android/ims/ImsCall;->reject(I)V
    :try_end_0
    .catch Lcom/android/ims/ImsException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 947
    invoke-virtual {v0}, Lcom/android/internal/telephony/imsphone/ImsPhoneCall;->isDialingOrAlerting()Z
    ...
    .line 953
    :cond_3
    const-string v4, "(foregnd) hangup foreground"
    ...
    .line 959
    const-string v4, "(backgnd) hangup waiting or background"
    ...
    const-string v6, "does not belong to ImsPhoneCallTracker "
    ...
    :try_start_1
    invoke-virtual {v2, v4}, Lcom/android/ims/ImsCall;->terminate(I)V
    :try_end_1
    ...
    invoke-virtual {v4, v5, v6}, Lcom/android/internal/telephony/imsphone/ImsPhoneConnection;->update(Lcom/android/ims/ImsCall;Lcom/android/internal/telephony/Call$State;)Z

    .line 975
    iget-object v4, p0, Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;->mPendingMO:Lcom/android/internal/telephony/imsphone/ImsPhoneConnection;

    invoke-virtual {v4}, Lcom/android/internal/telephony/imsphone/ImsPhoneConnection;->onDisconnect()Z

    .line 976
    iget-object v4, p0, Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;->mPendingMO:Lcom/android/internal/telephony/imsphone/ImsPhoneConnection;

    invoke-direct {p0, v4}, Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;->removeConnection(Lcom/android/internal/telephony/imsphone/ImsPhoneConnection;)V
    ...
    invoke-virtual {p0, v4}, Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;->removeMessages(I)V
    :try_end_2
...
.method private processCallStateChange(Lcom/android/ims/ImsCall;Lcom/android/internal/telephony/Call$State;IZ)V
    ...
    invoke-static {}, Lcom/android/internal/telephony/imsphone/ImsPhoneFactory;->isimsAsNormalCon()Z
...
.method private transferHandoverConnections(Lcom/android/internal/telephony/imsphone/ImsPhoneCall;)V
    ...
    .line 1817
    const-string v2, "srvcc mPendingMO == conn"
...
.method acceptCall(I)V
    ...
    .line 508
    :cond_0
    invoke-virtual {p0}, Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;->sendAnswerResultCheckMessage()V
...
.method canDial()Z
    ...
    .line 684
    .local v1, "disableCall":Ljava/lang/String;
    iget-object v4, p0, Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;->mForegroundCall:Lcom/android/internal/telephony/imsphone/ImsPhoneCall;
...
.method declared-synchronized dial(Ljava/lang/String;IILandroid/os/Bundle;)Lcom/android/internal/telephony/Connection;
    ...
    invoke-virtual {v6, p3}, Lcom/android/internal/telephony/imsphone/ImsPhoneConnection;->setVideoState(I)V
...
.method public dispose()V
    ...
    const-string v2, "ImsManager.close : exception "
...
.method public dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    .line 1927
    invoke-super {p0, p1, p2, p3}, Lcom/android/internal/telephony/imsphone/AbstractImsPhoneCallTracker;->dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
...
.method public getUtInterfaceEx()Lcom/android/ims/ImsUtInterface;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/android/ims/ImsException;
...
.method hangup(Lcom/android/internal/telephony/imsphone/ImsPhoneCall;)V
    ...
    .line 900
    invoke-direct {p0, p1}, Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;->hangupImsCall(Lcom/android/internal/telephony/imsphone/ImsPhoneCall;)V
    :try_end_0
    .catch Lcom/android/ims/ImsException; {:try_start_0 .. :try_end_0} :catch_0
...
.method hangup(Lcom/android/internal/telephony/imsphone/ImsPhoneConnection;)V
    ...
    .line 852
    invoke-direct {p0, p1}, Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;->hangupImsConnection(Lcom/android/internal/telephony/imsphone/ImsPhoneConnection;)V
...
.method hangupConnectionByIndex(Lcom/android/internal/telephony/imsphone/ImsPhoneCall;I)V
    .locals 5
    .param p1, "call"    # Lcom/android/internal/telephony/imsphone/ImsPhoneCall;
    .param p2, "index"    # I
    .annotation system Ldalvik/annotation/Throws;
    ...
    invoke-virtual {v0}, Lcom/android/internal/telephony/imsphone/ImsPhoneConnection;->getImsIndex()I
    ...
    .line 996
    invoke-direct {p0, v0}, Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;->hangupImsConnection(Lcom/android/internal/telephony/imsphone/ImsPhoneConnection;)V
...
.method public isUtEnabledForQcom()Z
    .locals 2
    ...
    :cond_0
    iget-object v0, p0, Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;->mCust:Lcom/android/internal/telephony/imsphone/HwCustImsPhoneCallTracker;

    if-eqz v0, :cond_1

    iget-object v0, p0, Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;->mCust:Lcom/android/internal/telephony/imsphone/HwCustImsPhoneCallTracker;

    invoke-virtual {v0}, Lcom/android/internal/telephony/imsphone/HwCustImsPhoneCallTracker;->checkImsRegistered()Z
...
.method resumeWaitingOrHolding()V
    ...
    const-string v3, "ImsException e = "
...
.method switchWaitingOrHoldingAndActive()V
    ...
    invoke-virtual {v4}, Lcom/android/internal/telephony/imsphone/ImsPhoneCall;->getConnections()Ljava/util/List;
    ...
    .line 584
    iget-object v4, p0, Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;->mCallExpectedToResume:Ljava/util/ArrayList;
