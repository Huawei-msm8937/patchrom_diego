...
.super Lcom/android/internal/telephony/AbstractWapPushOverSms;
...
.field protected mOriginalAddr:Ljava/lang/String;

.field protected mSmsTracker:Lcom/android/internal/telephony/InboundSmsTracker;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .prologue
    .line 105
    invoke-direct {p0}, Lcom/android/internal/telephony/AbstractWapPushOverSms;-><init>()V
...
.method public dispatchWapPdu([BLandroid/content/BroadcastReceiver;Lcom/android/internal/telephony/InboundSmsHandler;)I
    ...
    invoke-interface {v4, v0}, Lcom/android/internal/telephony/HwInnerSmsManager;->createHwWspTypeDecoder([B)Lcom/android/internal/telephony/WspTypeDecoder;
    ...
    invoke-virtual {v6, v0}, Lcom/android/internal/telephony/WspTypeDecoder;->decodeUintvarInteger(I)Z
    ...
    invoke-virtual {v6, v0}, Lcom/android/internal/telephony/WspTypeDecoder;->decodeContentType(I)Z
    ...
    .line 228
    invoke-static/range {v36 .. v36}, Landroid/telephony/SubscriptionManager;->getSubId(I)[I
    ...
    invoke-virtual {v6, v0, v4}, Lcom/android/internal/telephony/WspTypeDecoder;->seekXWapApplicationId(II)Z
    ...
    invoke-virtual {v6, v0}, Lcom/android/internal/telephony/WspTypeDecoder;->decodeXWapApplicationId(I)Z
    ...
    .end local v38    # "processFurther":Z
    ...
    .line 368
    .end local v6    # "pduDecoder":Lcom/android/internal/telephony/WspTypeDecoder;
    .end local v8    # "pduType":I
    .end local v9    # "headerStartIndex":I
    .end local v10    # "headerLength":I
    .end local v22    # "binaryContentType":J
    .end local v26    # "dataIndex":I
    .end local v30    # "header":[B
    .end local v33    # "intentData":[B
    ...
    const-string v11, "ignoring dispatchWapPdu() array index exception: "
    ...
    .end local v40    # "subIds":[I
    .restart local v41    # "wapAppId":Ljava/lang/String;
    :cond_9
    ...
    .restart local v38    # "processFurther":Z
    ...
    const-string v12, "mms-mgr"

    invoke-interface {v4, v5, v11, v12}, Landroid/os/IDeviceIdleController;->addPowerSaveTempWhitelistAppForMms(Ljava/lang/String;ILjava/lang/String;)J
    ...
    invoke-virtual {v13, v4, v7}, Landroid/content/Intent;->putExtra(Ljava/lang/String;I)Landroid/content/Intent;
    ...
    invoke-virtual {v13, v4, v0}, Landroid/content/Intent;->putExtra(Ljava/lang/String;[B)Landroid/content/Intent;
    ...
    invoke-virtual {v13, v4, v5}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Ljava/io/Serializable;)Landroid/content/Intent;
    ...
    invoke-interface {v0, v1, v2, v13}, Lcom/android/internal/telephony/IWapPushManager;->processMessage(Ljava/lang/String;Ljava/lang/String;Landroid/content/Intent;)I
    :try_end_7
    ...
    invoke-interface {v4, v0}, Lcom/android/internal/telephony/HwInnerSmsManager;->handleWapPushExtraMimeType(Ljava/lang/String;)Z
    ...
    .line 297
    invoke-virtual/range {v4 .. v12}, Lcom/android/internal/telephony/WapPushOverSms;->dispatchWapPduForWbxml([BLcom/android/internal/telephony/WspTypeDecoder;IIIILcom/android/internal/telephony/InboundSmsHandler;Landroid/content/BroadcastReceiver;)Z
    ...
    .line 309
    .local v20, "appOp":I
    const-string v4, "ro.hwpp.wcdma_voice_preference"
    ...
    iget-object v0, v4, Lcom/android/internal/telephony/PhoneBase;->mDcTracker:Lcom/android/internal/telephony/dataconnection/DcTrackerBase;

    move-object/from16 v27, v0

    .line 312
    .local v27, "dcTracker":Lcom/android/internal/telephony/dataconnection/DcTrackerBase;
    const/4 v4, 0x1

    move-object/from16 v0, v27

    iget v5, v0, Lcom/android/internal/telephony/dataconnection/DcTrackerBase;->mVpStatus:I

    if-ne v4, v5, :cond_e

    .line 315
    invoke-virtual/range {v27 .. v27}, Lcom/android/internal/telephony/dataconnection/DcTrackerBase;->onVPEnded()V
    ...
    iput v4, v0, Lcom/android/internal/telephony/dataconnection/DcTrackerBase;->mVpStatus:I

    .line 325
    .end local v27    # "dcTracker":Lcom/android/internal/telephony/dataconnection/DcTrackerBase;
    :cond_e
    :goto_6
    new-instance v13, Landroid/content/Intent;
    ...
    iget-object v5, v0, Lcom/android/internal/telephony/WapPushOverSms;->mOriginalAddr:Ljava/lang/String;
    ...
    iget-object v4, v0, Lcom/android/internal/telephony/WapPushOverSms;->mSmsTracker:Lcom/android/internal/telephony/InboundSmsTracker;
    ...
    iget-object v12, v0, Lcom/android/internal/telephony/WapPushOverSms;->mContext:Landroid/content/Context;

    move-object/from16 v0, p0

    iget-object v4, v0, Lcom/android/internal/telephony/WapPushOverSms;->mSmsTracker:Lcom/android/internal/telephony/InboundSmsTracker;

    invoke-virtual {v4}, Lcom/android/internal/telephony/InboundSmsTracker;->getDeleteWhere()Ljava/lang/String;
    ...
    invoke-interface/range {v11 .. v17}, Lcom/android/internal/telephony/HwInnerSmsManager;->newSmsShouldBeIntercepted(Landroid/content/Context;Landroid/content/Intent;Lcom/android/internal/telephony/InboundSmsHandler;Ljava/lang/String;[Ljava/lang/String;Z)Z
    ...
    .line 357
    .local v21, "bopts":Landroid/app/BroadcastOptions;
    ...
    .line 363
    .end local v21    # "bopts":Landroid/app/BroadcastOptions;
    ...
    invoke-virtual/range {v12 .. v18}, Lcom/android/internal/telephony/InboundSmsHandler;->dispatchIntent(Landroid/content/Intent;Ljava/lang/String;ILandroid/os/Bundle;Landroid/content/BroadcastReceiver;Landroid/os/UserHandle;)V
    ...
    const-string v5, "JL_WAP_DISPATCH_PDU"
