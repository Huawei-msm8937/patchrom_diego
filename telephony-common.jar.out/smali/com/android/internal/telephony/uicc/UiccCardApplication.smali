...
.field private mFdnStatusChangeRegistrants:Landroid/os/RegistrantList;

.field private mGetAdDoneRegistrants:Landroid/os/RegistrantList;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/internal/telephony/uicc/UiccCardApplication;->sIsPlatformSupportVSim:Z
...
.method constructor <init>(Lcom/android/internal/telephony/uicc/UiccCard;Lcom/android/internal/telephony/uicc/IccCardApplicationStatus;Landroid/content/Context;Lcom/android/internal/telephony/CommandsInterface;)V
    ...
    iput-object v1, p0, Lcom/android/internal/telephony/uicc/UiccCardApplication;->mGetAdDoneRegistrants:Landroid/os/RegistrantList;
    ...
    iput-object v1, p0, Lcom/android/internal/telephony/uicc/UiccCardApplication;->mFdnStatusChangeRegistrants:Landroid/os/RegistrantList;
...
.method static synthetic access$100()Z
    ...
    .prologue
    .line 57
    sget-boolean v0, Lcom/android/internal/telephony/uicc/UiccCardApplication;->sIsPlatformSupportVSim:Z

    return v0
.end method

.method static synthetic access$200(Lcom/android/internal/telephony/uicc/UiccCardApplication;Ljava/lang/String;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/internal/telephony/uicc/UiccCardApplication;
...
.method private createIccRecords(Lcom/android/internal/telephony/uicc/IccCardApplicationStatus$AppType;Landroid/content/Context;Lcom/android/internal/telephony/CommandsInterface;)Lcom/android/internal/telephony/uicc/IccRecords;
    ...
    invoke-interface {v0, p0, p2, p3}, Lcom/android/internal/telephony/HwUiccManager;->createHwSIMRecords(Lcom/android/internal/telephony/uicc/UiccCardApplication;Landroid/content/Context;Lcom/android/internal/telephony/CommandsInterface;)Lcom/android/internal/telephony/uicc/SIMRecords;
    ...
    invoke-interface {v0, p0, p2, p3}, Lcom/android/internal/telephony/HwUiccManager;->createHwRuimRecords(Lcom/android/internal/telephony/uicc/UiccCardApplication;Landroid/content/Context;Lcom/android/internal/telephony/CommandsInterface;)Lcom/android/internal/telephony/uicc/RuimRecords;
...
.method private onChangeFdnDone(Landroid/os/AsyncResult;)V
    ...
    .line 318
    invoke-virtual {p0}, Lcom/android/internal/telephony/uicc/UiccCardApplication;->notifyFdnStatusChange()V
...
.method public getUiccCardHw()Lcom/android/internal/telephony/uicc/UiccCard;
    ...
    .prologue
    .line 1053
    invoke-virtual {p0}, Lcom/android/internal/telephony/uicc/UiccCardApplication;->getUiccCard()Lcom/android/internal/telephony/uicc/UiccCard;
...
.method public notifyFdnStatusChange()V
    ...
    .prologue
    .line 585
    invoke-static {}, Lcom/android/internal/telephony/HuaweiTelephonyConfigs;->isPsRestrictedByFdn()Z
    ...
    .line 587
    :try_start_0
    iget-object v0, p0, Lcom/android/internal/telephony/uicc/UiccCardApplication;->mFdnStatusChangeRegistrants:Landroid/os/RegistrantList;
...
.method public notifyGetAdDone(Landroid/os/Registrant;)V
    .locals 2
    .param p1, "r"    # Landroid/os/Registrant;
    ...
    .line 523
    :cond_0
    const-string v0, "Notifying registrants: notifyGetAdDone"
    ...
    .line 526
    iget-object v0, p0, Lcom/android/internal/telephony/uicc/UiccCardApplication;->mGetAdDoneRegistrants:Landroid/os/RegistrantList;
    ...
    .line 528
    :cond_1
    const-string v0, "Notifying 1 registrant: notifyGetAdDone"
...
.method public registerForFdnStatusChange(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    iget-object v1, p0, Lcom/android/internal/telephony/uicc/UiccCardApplication;->mFdnStatusChangeRegistrants:Landroid/os/RegistrantList;
...
.method public registerForGetAdDone(Landroid/os/Handler;ILjava/lang/Object;)V
    .locals 3
    .param p1, "h"    # Landroid/os/Handler;
    .param p2, "what"    # I
    .param p3, "obj"    # Ljava/lang/Object;
    ...
    .line 510
    .local v0, "r":Landroid/os/Registrant;
    iget-object v1, p0, Lcom/android/internal/telephony/uicc/UiccCardApplication;->mGetAdDoneRegistrants:Landroid/os/RegistrantList;
...
.method public supplyPin(Ljava/lang/String;Landroid/os/Message;)V
    ...
    sget-boolean v1, Lcom/android/internal/telephony/uicc/UiccCardApplication;->sIsPlatformSupportVSim:Z

    if-eqz v1, :cond_1

    .line 774
    const-string v1, "supplyPin:ICC card is Destroyed."
    ...
    const-string v1, "ICC card is Destroyed."
    ...
    invoke-interface {v1, p1, v3, v4}, Lcom/android/internal/telephony/CommandsInterface;->supplyIccPinForApp(Ljava/lang/String;Ljava/lang/String;Landroid/os/Message;)V
...
.method public unregisterForGetAdDone(Landroid/os/Handler;)V
    .locals 2
    .param p1, "h"    # Landroid/os/Handler;
...
.method update(Lcom/android/internal/telephony/uicc/IccCardApplicationStatus;Landroid/content/Context;Lcom/android/internal/telephony/CommandsInterface;)V
    ...
    invoke-virtual {v3}, Lcom/android/internal/telephony/uicc/IccRecords;->disableRequestIccRecords()V
