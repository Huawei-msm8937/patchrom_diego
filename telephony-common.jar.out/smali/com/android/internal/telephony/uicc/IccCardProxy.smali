...
.super Lcom/android/internal/telephony/uicc/AbstractIccCardProxy;
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/internal/telephony/CommandsInterface;I)V
    ...
    .line 131
    invoke-direct {p0}, Lcom/android/internal/telephony/uicc/AbstractIccCardProxy;-><init>()V
...
.method private broadcastIccStateChangedIntent(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v0, v1, p1}, Lcom/android/internal/telephony/vsim/VSimUtilsInner;->putVSimExtraForIccStateChanged(Landroid/content/Intent;ILjava/lang/String;)V
...
.method public static getEventAppReadyHw()I
    .locals 1
...
.method public static getEventRadioOffOrUnavailableHw()I
    .locals 1
...
.method private registerUiccCardEvents()V
    ...
    .line 570
    invoke-virtual {p0, p0}, Lcom/android/internal/telephony/uicc/IccCardProxy;->registerForFdnStatusChange(Landroid/os/Handler;)V
    ...
    .line 580
    :cond_2
    invoke-virtual {p0}, Lcom/android/internal/telephony/uicc/IccCardProxy;->registerUiccCardEventsExtend()V
...
.method private setExternalState(Lcom/android/internal/telephony/IccCardConstants$State;Z)V
    ...
    .line 657
    :cond_3
    invoke-virtual {p0, p1}, Lcom/android/internal/telephony/uicc/IccCardProxy;->custResetExternalState(Lcom/android/internal/telephony/IccCardConstants$State;)V

    .line 661
    :cond_4
    invoke-virtual {p0, p1}, Lcom/android/internal/telephony/uicc/IccCardProxy;->blockPinStateForDualCards(Lcom/android/internal/telephony/IccCardConstants$State;)Z
    ...
    .line 671
    invoke-virtual {p0}, Lcom/android/internal/telephony/uicc/IccCardProxy;->processSimLockStateForCT()V
...
.method private unregisterUiccCardEvents()V
    ...
    .line 590
    :cond_3
    invoke-virtual {p0, p0}, Lcom/android/internal/telephony/uicc/IccCardProxy;->unregisterForFdnStatusChange(Landroid/os/Handler;)V
    ...
    .line 597
    :cond_6
    invoke-virtual {p0}, Lcom/android/internal/telephony/uicc/IccCardProxy;->unregisterUiccCardEventsExtend()V
...
.method private updateExternalState()V
    ...
    invoke-interface {v0}, Lcom/android/internal/telephony/CommandsInterface;->isRadioAvailable()Z
    ...
    .line 481
    const-string v0, "[2Cards] update the state to absent"
    ...
    invoke-virtual {p0, v0, v1, v2}, Lcom/android/internal/telephony/uicc/IccCardProxy;->isSimAbsent(Landroid/content/Context;Lcom/android/internal/telephony/uicc/UiccCard;Z)Z
    ...
    .line 498
    const-string v0, "updateExternalState ABSENT"
    ...
    invoke-virtual {p0, v0}, Lcom/android/internal/telephony/uicc/IccCardProxy;->custUpdateExternalState(Lcom/android/internal/telephony/IccCardConstants$State;)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/internal/telephony/uicc/IccCardProxy;->custSetExternalState(Lcom/android/internal/telephony/uicc/IccCardApplicationStatus$PersoSubState;)V
    ...
    const-string v1, "updateExternalState: set mPhoneId="
...
.method private updateIccAvailability()V
    ...
    invoke-virtual {p0, v1, v4, v6}, Lcom/android/internal/telephony/uicc/IccCardProxy;->processCurrentAppType(Lcom/android/internal/telephony/uicc/UiccCard;II)I
    ...
    const-string v6, "mIccRecords[old, new] = ["
    ...
    const-string v6, "mUiccApplication[old, new] = ["
    ...
    const-string v6, "mUiccCard[old, new] = ["
    ...
    .line 445
    invoke-virtual {p0, v0}, Lcom/android/internal/telephony/uicc/IccCardProxy;->setUiccApplication(Lcom/android/internal/telephony/uicc/UiccCardApplication;)V

    .line 447
    invoke-virtual {p0}, Lcom/android/internal/telephony/uicc/IccCardProxy;->queryFdn()V
...
.method private updateQuietMode()V
    ...
    invoke-virtual {p0, v4, v6}, Lcom/android/internal/telephony/uicc/IccCardProxy;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
...
# virtual methods
.method public blockPinStateForDualCards(Lcom/android/internal/telephony/IccCardConstants$State;)Z
    .locals 7
    ...
    const-string v6, "blockPinStateForDualCards s = "
    ...
    invoke-interface {v5}, Lcom/android/internal/telephony/HwUiccManager;->isFullNetworkSupported()Z
    ...
    invoke-interface {v5}, Lcom/android/internal/telephony/HwUiccManager;->getCommrilMode()Z
    ...
    invoke-interface {v5}, Lcom/android/internal/telephony/HwUiccManager;->isRestartingRild()Z
    ...
    .line 697
    .local v2, "mNeedSwitchCommrilMode":Z
    :goto_0
    const/4 v1, 0x0

    .line 698
    .local v1, "mBlockPinForeignUsim":Z
    iget-boolean v5, p0, Lcom/android/internal/telephony/uicc/IccCardProxy;->IS_CHINA_TELECOM:Z

    if-eqz v5, :cond_3

    const-string v5, "persist.radio.supp_oversea_usim"
    ...
    .line 699
    .local v0, "IS_OVERSEA_USIM_SUPPORT":Z
    :goto_1
    if-eqz v0, :cond_1
    ...
    invoke-interface {v5}, Lcom/android/internal/telephony/HwUiccManager;->getSwitchTag()Z
    ...
    invoke-static {}, Lcom/android/internal/telephony/vsim/VSimUtilsInner;->needBlockPinInBoot()Z
    ...
    invoke-interface {v5}, Landroid/telephony/HwInnerTelephonyManager;->getDefault4GSlotId()I
    ...
    const-string v5, "blockPinStateForDualCards s = "
    ...
    const-string v5, "vsim block pin in boot for phone id "
    ...
    .line 727
    .end local v0    # "IS_OVERSEA_USIM_SUPPORT":Z
    .end local v1    # "mBlockPinForeignUsim":Z
    .end local v2    # "mNeedSwitchCommrilMode":Z
    :goto_2
    return v3
    ...
    .restart local v1    # "mBlockPinForeignUsim":Z
    .restart local v2    # "mNeedSwitchCommrilMode":Z
    :cond_3
    move v0, v4
    ...
    .line 711
    .restart local v0    # "IS_OVERSEA_USIM_SUPPORT":Z
    :cond_4
    ...
    invoke-static {v5}, Lcom/android/internal/telephony/vsim/VSimUtilsInner;->needBlockPin(I)Z
    ...
    const-string v5, "vsim block pin for phone id "
    ...
    const-string v5, "vsim no need block pin for phone id "
    ...
    .restart local v2    # "mNeedSwitchCommrilMode":Z
    :cond_7
    const-string v5, "persist.sys.dualcards"
    ...
    const-string v5, "ro.config.full_network_support"
    ...
    invoke-interface {v5}, Lcom/android/internal/telephony/HwUiccManager;->getSwitchingSlot()Z
    ...
    .line 723
    :cond_9
    const-string v4, "setExternalState getWaitingSwitchBalongSlot is true, so return"
...
.method public broadcastIccStateChangedIntentHw(Ljava/lang/String;Ljava/lang/String;)V
    .locals 0
    .param p1, "value"    # Ljava/lang/String;
    .param p2, "reason"    # Ljava/lang/String;
...
.method public getCiHw()Lcom/android/internal/telephony/CommandsInterface;
    .locals 1
...
.method public getIccRecordsHw()Lcom/android/internal/telephony/uicc/IccRecords;
    .locals 1
...
.method public getIccStateIntentStringHw(Lcom/android/internal/telephony/IccCardConstants$State;)Ljava/lang/String;
    .locals 1
    .param p1, "state"    # Lcom/android/internal/telephony/IccCardConstants$State;

    .prologue
    .line 1222
    invoke-direct {p0, p1}, Lcom/android/internal/telephony/uicc/IccCardProxy;->getIccStateIntentString(Lcom/android/internal/telephony/IccCardConstants$State;)Ljava/lang/String;
...
.method public getState()Lcom/android/internal/telephony/IccCardConstants$State;
    ...
    const-string v1, "[2Cards]pending sub"
    ...
    const-string v1, " getState return ABSENT!"
...
.method public getUiccCardHw()Lcom/android/internal/telephony/uicc/UiccCard;
    .locals 1
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    .line 387
    invoke-virtual {p0, p1}, Lcom/android/internal/telephony/uicc/IccCardProxy;->handleMessageExtend(Landroid/os/Message;)V

    .line 393
    :cond_0
    :goto_0
    invoke-virtual {p0, p1}, Lcom/android/internal/telephony/uicc/IccCardProxy;->handleCustMessage(Landroid/os/Message;)V
    ...
    .line 287
    :sswitch_2
    invoke-virtual {p0, p1}, Lcom/android/internal/telephony/uicc/IccCardProxy;->getUiccIndex(Landroid/os/Message;)Ljava/lang/Integer;
    ...
    .line 289
    const-string v6, "Ignore the changes of the different card"
    ...
    const-string v7, "countryCodeForMcc error for countryCode = "
...
.method public registerForNetworkLocked(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    .line 876
    :cond_0
    invoke-virtual {p0, p1, p2, p3}, Lcom/android/internal/telephony/uicc/IccCardProxy;->custRegisterForNetworkLocked(Landroid/os/Handler;ILjava/lang/Object;)V
...
.method public registerUiccCardEventsHw()V
    .locals 0
...
.method public setExternalStateHw(Lcom/android/internal/telephony/IccCardConstants$State;)V
    .locals 0
    .param p1, "newState"    # Lcom/android/internal/telephony/IccCardConstants$State;

    .prologue
    .line 1217
    invoke-direct {p0, p1}, Lcom/android/internal/telephony/uicc/IccCardProxy;->setExternalState(Lcom/android/internal/telephony/IccCardConstants$State;)V
...
.method public setRadioOnHw(Z)V
    .locals 0
    .param p1, "value"    # Z

    .prologue
    .line 1197
    iput-boolean p1, p0, Lcom/android/internal/telephony/uicc/IccCardProxy;->mRadioOn:Z
...
.method public supplyPin(Ljava/lang/String;Landroid/os/Message;)V
    ...
    invoke-static {}, Lcom/android/internal/telephony/vsim/VSimUtilsInner;->mainSlotPinBusy()Z
    ...
    const-string v3, "supplyPin() mPhoneId:"
    ...
    const-string v3, "supplyPin() getDefault4GSlotId:"
    ...
    const-string v3, "supplyPin() mainSlotPinBusy:"
    ...
    const-string v1, "mainSlotPinBusy"
...
.method public unregisterForNetworkLocked(Landroid/os/Handler;)V
    ...
    .line 886
    invoke-virtual {p0, p1}, Lcom/android/internal/telephony/uicc/IccCardProxy;->custUnregisterForNetworkLocked(Landroid/os/Handler;)V
...
.method public unregisterUiccCardEventsHw()V
    .locals 0
