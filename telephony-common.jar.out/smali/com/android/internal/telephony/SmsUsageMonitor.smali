...
.field private static final ENABLE_CUSTOM_SHORTCODES:Z
...
# instance fields
.field private CUSTOM_SHORT_CODES:Ljava/lang/String;

.field private CUSTOM_SHORT_CODES_LIST:Ljava/util/List;
...
.method static constructor <clinit>()V
    ...
    .prologue
    .line 194
    const-string v0, "ro.config.custom_short_codes"
    ...
    sput-boolean v0, Lcom/android/internal/telephony/SmsUsageMonitor;->ENABLE_CUSTOM_SHORTCODES:Z
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v2, p0, Lcom/android/internal/telephony/SmsUsageMonitor;->CUSTOM_SHORT_CODES:Ljava/lang/String;
    ...
    iput-object v2, p0, Lcom/android/internal/telephony/SmsUsageMonitor;->CUSTOM_SHORT_CODES_LIST:Ljava/util/List;
    ...
    .line 284
    sget-boolean v2, Lcom/android/internal/telephony/SmsUsageMonitor;->ENABLE_CUSTOM_SHORTCODES:Z
    ...
    const-string v3, "custom_sms_shortcodes"
    ...
    .line 287
    iget-object v2, p0, Lcom/android/internal/telephony/SmsUsageMonitor;->CUSTOM_SHORT_CODES:Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/android/internal/telephony/SmsUsageMonitor;->CUSTOM_SHORT_CODES_LIST:Ljava/util/List;
    ...
    .line 289
    .local v0, "CUSTOM_SHORT_CODES_ARRAY":[Ljava/lang/String;
    ...
    .line 293
    .end local v0    # "CUSTOM_SHORT_CODES_ARRAY":[Ljava/lang/String;
    :cond_0
    new-instance v2, Lcom/android/internal/telephony/SmsUsageMonitor$SettingsObserverHandler;
    ...
    invoke-direct {v2, v3, v4}, Lcom/android/internal/telephony/SmsUsageMonitor$SettingsObserverHandler;-><init>(Landroid/content/Context;Ljava/util/concurrent/atomic/AtomicBoolean;)V

    iput-object v2, p0, Lcom/android/internal/telephony/SmsUsageMonitor;->mSettingsObserverHandler:Lcom/android/internal/telephony/SmsUsageMonitor$SettingsObserverHandler;
...
.method private isSpecialPattern(Ljava/lang/String;)Z
    .locals 2
    .param p1, "destAdd"    # Ljava/lang/String;

    .prologue
    const/4 v0, 0x0

    .line 471
    iget-object v1, p0, Lcom/android/internal/telephony/SmsUsageMonitor;->CUSTOM_SHORT_CODES_LIST:Ljava/util/List;
...
.method public checkDestination(Ljava/lang/String;Ljava/lang/String;)I
    ...
    .line 443
    :cond_3
    sget-boolean v3, Lcom/android/internal/telephony/SmsUsageMonitor;->ENABLE_CUSTOM_SHORTCODES:Z

    if-eqz v3, :cond_5

    .line 444
    invoke-direct {p0, p1}, Lcom/android/internal/telephony/SmsUsageMonitor;->isSpecialPattern(Ljava/lang/String;)Z

    move-result v0

    .line 445
    .local v0, "custom_free_shortcode":Z
    if-eqz v0, :cond_5
    ...
    .line 437
    .end local v0    # "custom_free_shortcode":Z
    :cond_4
