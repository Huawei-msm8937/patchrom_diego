...
.super Lcom/android/internal/telephony/AbstractPhoneBase;
...
.field protected static final FAST_PREF_NET_REG:Z
...
.field private static final LOG_TAG_STATIC:Ljava/lang/String; = "PhoneBase"
...
.field protected final mMccChangedRegistrants:Landroid/os/RegistrantList;
...
.method static constructor <clinit>()V
    ...
    .prologue
    .line 239
    const-string v0, "ro.hwpp_fast_pref_net_reg"
    ...
    sput-boolean v0, Lcom/android/internal/telephony/PhoneBase;->FAST_PREF_NET_REG:Z
    ...
    sput-object v0, Lcom/android/internal/telephony/PhoneBase;->mPasswordUtil:Landroid/encrypt/PasswordUtil;
...
.method protected constructor <init>(Ljava/lang/String;Lcom/android/internal/telephony/PhoneNotifier;Landroid/content/Context;Lcom/android/internal/telephony/CommandsInterface;ZI)V
    ...
    .prologue
    .line 455
    invoke-direct {p0, p4}, Lcom/android/internal/telephony/AbstractPhoneBase;-><init>(Lcom/android/internal/telephony/CommandsInterface;)V
    ...
    iput-object v5, p0, Lcom/android/internal/telephony/PhoneBase;->mMccChangedRegistrants:Landroid/os/RegistrantList;
    ...
    invoke-interface {v5, v6}, Lcom/android/internal/telephony/HwVolteChrManager;->init(Landroid/content/Context;)V
    ...
    invoke-interface {v5, v6}, Lcom/android/internal/telephony/HwPhoneManager;->setDefaultTimezone(Landroid/content/Context;)V
    ...
    invoke-interface {v5, v6}, Lcom/android/internal/telephony/HwDataServiceChrManager;->init(Landroid/content/Context;)V
    ...
    invoke-interface {v5, p0, v6, v7}, Lcom/android/internal/telephony/CommandsInterface;->setOnECCNum(Landroid/os/Handler;ILjava/lang/Object;)V

    .line 495
    iget-object v5, p0, Lcom/android/internal/telephony/PhoneBase;->mCi:Lcom/android/internal/telephony/CommandsInterface;

    invoke-interface {v5}, Lcom/android/internal/telephony/CommandsInterface;->queryEmergencyNumbers()V
...
.method private needSetEccNumbers()Z
    .locals 8
    ...
    const-string v5, "ro.config.hw_ecc_with_sim_card"
    ...
    const-string v7, "needSetEccNumbers  slotId = "
    ...
    const-string v7, " hasPresentCard = "
...
.method private onCheckForNetworkSelectionModeAutomatic(Landroid/os/Message;)V
    ...
    .line 1160
    invoke-static {v6, v8, v8}, Landroid/os/AsyncResult;->forMessage(Landroid/os/Message;Ljava/lang/Object;Ljava/lang/Throwable;)Landroid/os/AsyncResult;
    ...
    const-string v8, "setNetworkSelectionModeAutomatic - already auto, ignoring.send empty response to apk"
...
.method private setEccNumbers(Ljava/lang/String;)V
    .locals 4
    ...
    .line 2985
    :try_start_0
    invoke-direct {p0}, Lcom/android/internal/telephony/PhoneBase;->needSetEccNumbers()Z
    ...
    const-string v3, "setEccNumbers RuntimeException: "
    ...
    const-string v3, "setEccNumbers Exception: "
...
.method public encodeSp(Ljava/lang/String;)V
    .locals 7
    ...
    const-string v4, "encodeSp Exception"
...
.method public getCdmaGsmImsi()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lcom/android/internal/telephony/uicc/IccRecords;->getCdmaGsmImsi()Ljava/lang/String;
...
.method public getUiccCardType()I
    .locals 5
    ...
    .line 2952
    .local v1, "result":I
    invoke-virtual {p0}, Lcom/android/internal/telephony/PhoneBase;->getCurrentUiccAppType()Lcom/android/internal/telephony/uicc/IccCardApplicationStatus$AppType;

    move-result-object v0

    .line 2953
    .local v0, "at":Lcom/android/internal/telephony/uicc/IccCardApplicationStatus$AppType;
    iget-object v2, p0, Lcom/android/internal/telephony/PhoneBase;->LOG_TAG:Ljava/lang/String;
    ...
    .line 2954
    sget-object v2, Lcom/android/internal/telephony/PhoneBase$2;->$SwitchMap$com$android$internal$telephony$uicc$IccCardApplicationStatus$AppType:[I
...
.method public getVmSimImsi()Ljava/lang/String;
    .locals 11
    ...
    const-string v9, "vm_sim_imsi_key"
    ...
    sget-object v8, Lcom/android/internal/telephony/PhoneBase;->mPasswordUtil:Landroid/encrypt/PasswordUtil;
    ...
    invoke-interface {v8, v2}, Landroid/encrypt/PasswordUtil;->pswd2PlainText(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v4

    .line 1653
    .local v4, "oldDecodeVmSimImsi":Ljava/lang/String;
    :try_start_0
    ...
    .line 1662
    iget-object v8, p0, Lcom/android/internal/telephony/PhoneBase;->LOG_TAG:Ljava/lang/String;

    const-string v9, "getVmSimImsi: Old IMSI encryption is not supported, now setVmSimImsi again."

    invoke-static {v8, v9}, Landroid/telephony/Rlog;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 1663
    invoke-virtual {p0, v2}, Lcom/android/internal/telephony/PhoneBase;->setVmSimImsi(Ljava/lang/String;)V
    ...
    .end local v1    # "editor":Landroid/content/SharedPreferences$Editor;
    .end local v2    # "imsi":Ljava/lang/String;
    .end local v4    # "oldDecodeVmSimImsi":Ljava/lang/String;
    :cond_0
    :goto_1
    new-instance v8, Ljava/lang/StringBuilder;
    ...
    .restart local v5    # "simimsi":Ljava/lang/String;
    :cond_1
    :goto_2
    return-object v5
    ...
    .end local v5    # "simimsi":Ljava/lang/String;
    .restart local v2    # "imsi":Ljava/lang/String;
    .restart local v4    # "oldDecodeVmSimImsi":Ljava/lang/String;
    :catch_0
    move-exception v0
    ...
    const-string v9, "getVmSimImsi UnsupportedEncodingException"
    ...
    const-string v8, "vm_sim_imsi_key"
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    .line 662
    invoke-virtual {p0, v10}, Lcom/android/internal/telephony/PhoneBase;->setOOSFlagOnSelectNetworkManually(Z)V

    .line 664
    invoke-virtual {p0}, Lcom/android/internal/telephony/PhoneBase;->restoreNetworkSelectionAuto()V
    ...
    .line 671
    .local v7, "tracker":Lcom/android/internal/telephony/ServiceStateTracker;
    if-eqz v7, :cond_3

    .line 672
    invoke-virtual {v7}, Lcom/android/internal/telephony/ServiceStateTracker;->pollState()V

    .line 678
    .end local v7    # "tracker":Lcom/android/internal/telephony/ServiceStateTracker;
    :cond_2
    :goto_1
    ...
    .line 674
    .restart local v7    # "tracker":Lcom/android/internal/telephony/ServiceStateTracker;
    :cond_3
    iget-object v8, p0, Lcom/android/internal/telephony/PhoneBase;->LOG_TAG:Ljava/lang/String;

    const-string v9, "tracker is null"
    ...
    invoke-direct {p0, v8}, Lcom/android/internal/telephony/PhoneBase;->setEccNumbers(Ljava/lang/String;)V

    .line 777
    iget-object v9, p0, Lcom/android/internal/telephony/PhoneBase;->LOG_TAG:Ljava/lang/String;

    new-instance v8, Ljava/lang/StringBuilder;

    invoke-direct {v8}, Ljava/lang/StringBuilder;-><init>()V

    const-string v10, "Handle EVENT_ECC_NUM:"
    ...
    const-string v9, "Event EVENT_IMS_SERVICE_STATE_CHANGED Received"
...
.method public isImsUseEnabled()Z
    ...
    invoke-static {v1, v2}, Lcom/android/ims/ImsManager;->isVolteEnabledByPlatform(Landroid/content/Context;I)Z
...
.method public notifyMccChanged(Ljava/lang/String;)V
    .locals 5
    ...
    const-string v3, "notifyMccChanged new mcc is "
    ...
    .line 2299
    .local v0, "ar":Landroid/os/AsyncResult;
    iget-object v1, p0, Lcom/android/internal/telephony/PhoneBase;->mMccChangedRegistrants:Landroid/os/RegistrantList;
...
.method public notifyServiceStateChangedP(Landroid/telephony/ServiceState;)V
    .locals 2
...
.method public radioCapabilityUpdated(Lcom/android/internal/telephony/RadioCapability;)V
    ...
    const-string v1, "skip restoreNetworkSelection in sendSubscriptionSettings"
...
.method public registerForMccChanged(Landroid/os/Handler;ILjava/lang/Object;)V
    .locals 3
    .param p1, "h"    # Landroid/os/Handler;
    .param p2, "what"    # I
    .param p3, "obj"    # Ljava/lang/Object;
...
.method public selectNetworkManually(Lcom/android/internal/telephony/OperatorInfo;Landroid/os/Message;)V
    ...
    invoke-virtual {p0, v2}, Lcom/android/internal/telephony/PhoneBase;->setOOSFlagOnSelectNetworkManually(Z)V

    .line 1187
    invoke-virtual {p0}, Lcom/android/internal/telephony/PhoneBase;->hasNetworkSelectionAuto()V
...
.method public sendSubscriptionSettings(Z)V
    ...
    const-string v1, "skip setPreferredNetworkType in sendSubscriptionSettings"
...
.method public setPreferredNetworkType(ILandroid/os/Message;)V
    ...
    .line 1776
    .local v0, "sSt":Lcom/android/internal/telephony/ServiceStateTracker;
    sget-boolean v1, Lcom/android/internal/telephony/PhoneBase;->FAST_PREF_NET_REG:Z
    ...
    const-string v2, "FAST_PREF_NET_REG is ture, setPreferredNetworkTypeSafely."
    ...
    invoke-interface {v1, p0, v0, p1, p2}, Lcom/android/internal/telephony/HwNetworkManager;->setPreferredNetworkTypeSafely(Lcom/android/internal/telephony/PhoneBase;Lcom/android/internal/telephony/ServiceStateTracker;ILandroid/os/Message;)V
    ...
    invoke-interface {v1, p1, v2, p2}, Lcom/android/internal/telephony/HwUiccManager;->setPreferredNetworkType(IILandroid/os/Message;)V
...
.method protected setPreferredNetworkTypeIfSimLoaded()V
    ...
    const-string v2, "skip setPreferredNetworkType in setPreferredNetworkTypeIfSimLoaded"
...
.method public setVmSimImsi(Ljava/lang/String;)V
    .locals 7
    .param p1, "imsi"    # Ljava/lang/String;
...
.method public shutdownRadio()V
    ...
    .line 2723
    .local v0, "phoneBase":Lcom/android/internal/telephony/PhoneBase;
    if-eqz v0, :cond_0

    invoke-static {v0}, Lcom/android/internal/telephony/vsim/VSimUtilsInner;->isVSimPhone(Lcom/android/internal/telephony/PhoneBase;)Z
    ...
    invoke-virtual {v1}, Lcom/android/internal/telephony/ServiceStateTracker;->requestShutdown()V

    .line 2727
    iget-object v1, p0, Lcom/android/internal/telephony/PhoneBase;->LOG_TAG:Ljava/lang/String;

    const-string v2, "Vsim is enable, send shut down radio to VSIM sub!"

    invoke-static {v1, v2}, Landroid/telephony/Rlog;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 2731
    .end local v0    # "phoneBase":Lcom/android/internal/telephony/PhoneBase;
    :cond_0
    invoke-virtual {p0}, Lcom/android/internal/telephony/PhoneBase;->getServiceStateTracker()Lcom/android/internal/telephony/ServiceStateTracker;
...
.method public startMonitoringImsService()V
    ...
    invoke-interface {v4}, Lcom/android/internal/telephony/HwUiccManager;->getUserSwitchSlots()I
...
.method public unregisterForMccChanged(Landroid/os/Handler;)V
    .locals 2
    .param p1, "h"    # Landroid/os/Handler;
    ...
    .line 2292
    :try_start_0
    iget-object v0, p0, Lcom/android/internal/telephony/PhoneBase;->mMccChangedRegistrants:Landroid/os/RegistrantList;
