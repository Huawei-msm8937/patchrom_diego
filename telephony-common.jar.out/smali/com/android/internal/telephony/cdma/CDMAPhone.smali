...
.super Lcom/android/internal/telephony/cdma/AbstractCDMAPhone;
...
.field private static final LOG_TAG_STATIC:Ljava/lang/String; = "CDMAPhone"
...
.field private newAppType:Lcom/android/internal/telephony/uicc/IccCardApplicationStatus$AppType;

.field private oldAppType:Lcom/android/internal/telephony/uicc/IccCardApplicationStatus$AppType;
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/internal/telephony/CommandsInterface;Lcom/android/internal/telephony/PhoneNotifier;I)V
    ...
    invoke-direct/range {v0 .. v6}, Lcom/android/internal/telephony/cdma/AbstractCDMAPhone;-><init>(Ljava/lang/String;Lcom/android/internal/telephony/PhoneNotifier;Landroid/content/Context;Lcom/android/internal/telephony/CommandsInterface;ZI)V
    ...
    iput-object v0, p0, Lcom/android/internal/telephony/cdma/CDMAPhone;->oldAppType:Lcom/android/internal/telephony/uicc/IccCardApplicationStatus$AppType;

    .line 162
    sget-object v0, Lcom/android/internal/telephony/uicc/IccCardApplicationStatus$AppType;->APPTYPE_UNKNOWN:Lcom/android/internal/telephony/uicc/IccCardApplicationStatus$AppType;

    iput-object v0, p0, Lcom/android/internal/telephony/cdma/CDMAPhone;->newAppType:Lcom/android/internal/telephony/uicc/IccCardApplicationStatus$AppType;
...
.method public cleanDeviceId()V
    ...
    .line 2083
    iput-object v2, p0, Lcom/android/internal/telephony/cdma/CDMAPhone;->mMeid:Ljava/lang/String;
...
.method public dial(Ljava/lang/String;Lcom/android/internal/telephony/UUSInfo;ILandroid/os/Bundle;)Lcom/android/internal/telephony/Connection;
    ...
    iget-object v8, p0, Lcom/android/internal/telephony/cdma/CDMAPhone;->mCT:Lcom/android/internal/telephony/cdma/CdmaCallTracker;

    iget-object v8, v8, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->mForegroundCall:Lcom/android/internal/telephony/cdma/CdmaCall;
    ...
    const-string v9, ", mCT.mForegroundCall.getState="

    invoke-virtual {v7, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v7

    iget-object v9, p0, Lcom/android/internal/telephony/cdma/CDMAPhone;->mCT:Lcom/android/internal/telephony/cdma/CdmaCallTracker;

    iget-object v9, v9, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->mForegroundCall:Lcom/android/internal/telephony/cdma/CdmaCall;
...
.method public dispose()V
    ...
    .line 264
    :try_start_0
    invoke-super {p0}, Lcom/android/internal/telephony/cdma/AbstractCDMAPhone;->dispose()V
...
.method public dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    .line 2019
    invoke-super {p0, p1, p2, p3}, Lcom/android/internal/telephony/cdma/AbstractCDMAPhone;->dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
...
.method public getCdmaMlplVersion()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->getMlplVersion()Ljava/lang/String;
...
.method public getCdmaMsplVersion()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->getMsplVersion()Ljava/lang/String;
...
.method public getEsn()Ljava/lang/String;
    ...
    invoke-static {v2}, Lcom/android/internal/telephony/vsim/VSimUtilsInner;->isRadioAvailable(I)Z
    ...
    const-string v4, "getEsn, the phone is pending, mPhoneId is: "
    ...
    .line 666
    const-string v2, "esn_pending_for_vsim"

    invoke-static {v2}, Lcom/android/internal/telephony/vsim/VSimUtilsInner;->getPendingDeviceInfoFromSP(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-interface {v2}, Lcom/android/internal/telephony/CommandsInterface;->getHwUimid()Ljava/lang/String;

    move-result-object v2

    iput-object v2, p0, Lcom/android/internal/telephony/cdma/CDMAPhone;->mEsn:Ljava/lang/String;
...
.method public getMeid()Ljava/lang/String;
    ...
    const-string v2, "getMeid, the phone is pending, mPhoneId is: "
    ...
    .line 689
    const-string v0, "meid_pending_for_vsim"
...
.method public getMeidHw()Ljava/lang/String;
    .locals 3
...
.method public getSubscriberId()Ljava/lang/String;
    ...
    const-string v2, "getSubscriberId from mSST"
    ...
    const-string v2, "getSubscriberId from mIccRecords"
...
.method public getSystemProperty(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    .prologue
    .line 1623
    invoke-super {p0, p1, p2}, Lcom/android/internal/telephony/cdma/AbstractCDMAPhone;->getSystemProperty(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public getVoiceMailNumber()Ljava/lang/String;
    ...
    invoke-interface {v5, v6, v7, v8}, Lcom/android/internal/telephony/HwPhoneManager;->getCDMAVoiceMailNumberHwCust(Landroid/content/Context;Ljava/lang/String;I)Ljava/lang/String;
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    .line 1345
    invoke-virtual {p0}, Lcom/android/internal/telephony/cdma/CDMAPhone;->getServiceStateTracker()Lcom/android/internal/telephony/ServiceStateTracker;

    move-result-object v5

    .line 1346
    .local v5, "tracker":Lcom/android/internal/telephony/ServiceStateTracker;
    if-eqz v5, :cond_2

    .line 1347
    invoke-virtual {v5}, Lcom/android/internal/telephony/ServiceStateTracker;->pollState()V

    .line 1353
    .end local v5    # "tracker":Lcom/android/internal/telephony/ServiceStateTracker;
    :cond_1
    :goto_1
    invoke-super {p0, p1}, Lcom/android/internal/telephony/cdma/AbstractCDMAPhone;->handleMessage(Landroid/os/Message;)V

    goto :goto_0

    .line 1349
    .restart local v5    # "tracker":Lcom/android/internal/telephony/ServiceStateTracker;
    :cond_2
    iget-object v6, p0, Lcom/android/internal/telephony/cdma/CDMAPhone;->LOG_TAG:Ljava/lang/String;

    const-string v7, "tracker is null"
    ...
    .end local v5    # "tracker":Lcom/android/internal/telephony/ServiceStateTracker;
    :cond_3
    invoke-virtual {p0, p1}, Lcom/android/internal/telephony/cdma/CDMAPhone;->beforeHandleMessage(Landroid/os/Message;)Z
    ...
    :cond_4
    :goto_2
    invoke-virtual {p0, p1}, Lcom/android/internal/telephony/cdma/CDMAPhone;->afterHandleMessage(Landroid/os/Message;)V
    ...
    invoke-virtual {v7, v8, v6}, Landroid/telephony/TelephonyManager;->setBasebandVersionForPhone(ILjava/lang/String;)V
    ...
    .line 1408
    const-string v6, "persist.radio.hwuimid"
    ...
    .line 1429
    const-string v6, "notifyMessageWaitingChanged"

    invoke-virtual {p0, v6}, Lcom/android/internal/telephony/cdma/CDMAPhone;->log(Ljava/lang/String;)V

    .line 1430
    iget-object v6, p0, Lcom/android/internal/telephony/cdma/CDMAPhone;->mNotifier:Lcom/android/internal/telephony/PhoneNotifier;

    invoke-interface {v6, p0}, Lcom/android/internal/telephony/PhoneNotifier;->notifyMessageWaitingChanged(Lcom/android/internal/telephony/Phone;)V
    ...
    .line 1480
    .local v4, "subInfoRecordUpdater":Lcom/android/internal/telephony/SubscriptionInfoUpdater;
    if-eqz v4, :cond_4

    .line 1481
    iget v6, p0, Lcom/android/internal/telephony/cdma/CDMAPhone;->mPhoneId:I

    invoke-virtual {v4, v6}, Lcom/android/internal/telephony/SubscriptionInfoUpdater;->updateSubIdForNV(I)V

    goto/16 :goto_2

    .line 1488
    .end local v4    # "subInfoRecordUpdater":Lcom/android/internal/telephony/SubscriptionInfoUpdater;
    :pswitch_e
    iget-object v0, p1, Landroid/os/Message;->obj:Ljava/lang/Object;
...
.method protected init(Landroid/content/Context;Lcom/android/internal/telephony/PhoneNotifier;)V
    ...
    invoke-interface {v5, p0}, Lcom/android/internal/telephony/HwUiccManager;->createHwRuimPhoneBookInterfaceManager(Lcom/android/internal/telephony/cdma/CDMAPhone;)Lcom/android/internal/telephony/cdma/RuimPhoneBookInterfaceManager;
...
.method public notifyNewRingingConnection(Lcom/android/internal/telephony/Connection;)V
    ...
    .prologue
    .line 1196
    invoke-super {p0, p1}, Lcom/android/internal/telephony/cdma/AbstractCDMAPhone;->notifyNewRingingConnectionP(Lcom/android/internal/telephony/Connection;)V
...
.method notifyPreciseCallStateChanged()V
    ...
    .prologue
    .line 1184
    invoke-super {p0}, Lcom/android/internal/telephony/cdma/AbstractCDMAPhone;->notifyPreciseCallStateChangedP()V
...
.method notifyServiceStateChanged(Landroid/telephony/ServiceState;)V
    ...
    .prologue
    .line 1188
    invoke-super {p0, p1}, Lcom/android/internal/telephony/cdma/AbstractCDMAPhone;->notifyServiceStateChangedP(Landroid/telephony/ServiceState;)V
...
.method protected onUpdateIccAvailability()V
    ...
    iput-object v2, p0, Lcom/android/internal/telephony/cdma/CDMAPhone;->newAppType:Lcom/android/internal/telephony/uicc/IccCardApplicationStatus$AppType;
    ...
    const-string v3, "newAppType = "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    iget-object v3, p0, Lcom/android/internal/telephony/cdma/CDMAPhone;->newAppType:Lcom/android/internal/telephony/uicc/IccCardApplicationStatus$AppType;

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/Object;)Ljava/lang/StringBuilder;

    move-result-object v2

    const-string v3, ", oldAppType = "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    iget-object v3, p0, Lcom/android/internal/telephony/cdma/CDMAPhone;->oldAppType:Lcom/android/internal/telephony/uicc/IccCardApplicationStatus$AppType;
    ...
    iget-object v2, p0, Lcom/android/internal/telephony/cdma/CDMAPhone;->newAppType:Lcom/android/internal/telephony/uicc/IccCardApplicationStatus$AppType;

    sget-object v3, Lcom/android/internal/telephony/uicc/IccCardApplicationStatus$AppType;->APPTYPE_UNKNOWN:Lcom/android/internal/telephony/uicc/IccCardApplicationStatus$AppType;

    if-eq v2, v3, :cond_0

    iget-object v2, p0, Lcom/android/internal/telephony/cdma/CDMAPhone;->oldAppType:Lcom/android/internal/telephony/uicc/IccCardApplicationStatus$AppType;
    ...
    iput-object v2, p0, Lcom/android/internal/telephony/cdma/CDMAPhone;->oldAppType:Lcom/android/internal/telephony/uicc/IccCardApplicationStatus$AppType;
...
.method public removeReferences()V
    ...
    .line 309
    invoke-super {p0}, Lcom/android/internal/telephony/cdma/AbstractCDMAPhone;->removeReferences()V
...
.method public setImei(Ljava/lang/String;)V
    ...
    .line 2110
    const-string v0, "setImei mImei=xxxx"
...
.method public setMeidHw(Ljava/lang/String;)V
    .locals 0
...
.method public setRadioPower(ZLandroid/os/Message;)V
    ...
    invoke-virtual {v0, p1, p2}, Lcom/android/internal/telephony/cdma/CdmaServiceStateTracker;->setRadioPower(ZLandroid/os/Message;)V
...
.method public setSystemProperty(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .prologue
    .line 1614
    invoke-super {p0, p1, p2}, Lcom/android/internal/telephony/cdma/AbstractCDMAPhone;->setSystemProperty(Ljava/lang/String;Ljava/lang/String;)V
...
.method public testVoiceLoopBack(I)V
    ...
    invoke-interface {v0, p1}, Lcom/android/internal/telephony/CommandsInterface;->testVoiceLoopBack(I)V
