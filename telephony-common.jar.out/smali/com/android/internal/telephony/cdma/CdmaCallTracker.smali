...
.super Lcom/android/internal/telephony/cdma/AbstractCdmaCallTracker;
...
.method constructor <init>(Lcom/android/internal/telephony/cdma/CDMAPhone;)V
    ...
    .line 114
    invoke-direct {p0}, Lcom/android/internal/telephony/cdma/AbstractCdmaCallTracker;-><init>()V
...
.method private handleCallWaitingInfo(Lcom/android/internal/telephony/cdma/CdmaCallWaitingNotification;)V
    ...
    iget-object v8, v8, Lcom/android/internal/telephony/cdma/CdmaCall;->mConnections:Ljava/util/ArrayList;
    ...
    iget-object v8, p1, Lcom/android/internal/telephony/cdma/CdmaCallWaitingNotification;->number:Ljava/lang/String;
    ...
    invoke-virtual {v1}, Lcom/android/internal/telephony/cdma/CdmaConnection;->getCreateTime()J

    move-result-wide v4

    .line 1097
    .local v4, "lastConnTime":J
    sub-long v6, v2, v4

    .line 1098
    .local v6, "passedTime":J
    ...
    const-string v9, "Ignoring callingwaiting events received for same number within 30s"
    ...
    .end local v4    # "lastConnTime":J
    .end local v6    # "passedTime":J
    :goto_0
    return-void
    ...
    const-string v10, "the ringingcall connection size = "
    ...
    iget-object v10, v10, Lcom/android/internal/telephony/cdma/CdmaCall;->mConnections:Ljava/util/ArrayList;
    ...
    const-string v9, "Update the ringing connection if the call is from another number."
    ...
    invoke-direct {v8, v9, p1, p0, v10}, Lcom/android/internal/telephony/cdma/CdmaConnection;-><init>(Landroid/content/Context;Lcom/android/internal/telephony/cdma/CdmaCallWaitingNotification;Lcom/android/internal/telephony/cdma/CdmaCallTracker;Lcom/android/internal/telephony/cdma/CdmaCall;)V
    ...
    invoke-virtual {v8, v9}, Lcom/android/internal/telephony/cdma/CdmaCall;->isTooFrequency(Ljava/lang/String;)Z
    ...
    invoke-virtual {v8, v9}, Lcom/android/internal/telephony/cdma/CdmaCall;->setLastRingNumberAndChangeTime(Ljava/lang/String;)V

    .line 1118
    const-string v8, "CdmaCallTracker"

    const-string v9, "ringing too frequency, ignore this callwaiting message."
    ...
    const-string v9, "new callwaiting message, create a connection"
...
.method private updatePhoneState()V
    ...
    .line 525
    invoke-virtual {p0}, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->notifyRegistrantsDelayed()Z
...
.method acceptCall()V
    ...
    .line 342
    .local v1, "mLastNumber":Ljava/lang/String;
    iget-object v2, p0, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->mRingingCall:Lcom/android/internal/telephony/cdma/CdmaCall;

    invoke-virtual {v2, v1}, Lcom/android/internal/telephony/cdma/CdmaCall;->setLastRingNumberAndChangeTime(Ljava/lang/String;)V
    ...
    .line 348
    .end local v1    # "mLastNumber":Ljava/lang/String;
    :cond_1
    invoke-direct {p0}, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->updatePhoneState()V
...
.method dial(Ljava/lang/String;I)Lcom/android/internal/telephony/Connection;
    ...
    invoke-virtual {v9}, Lcom/android/internal/telephony/cdma/CdmaConnection;->getDialAddress()Ljava/lang/String;
...
.method public dispose()V
    ...
    .line 135
    invoke-super {p0}, Lcom/android/internal/telephony/cdma/AbstractCdmaCallTracker;->dispose()V
...
.method public dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    .line 1375
    invoke-super {p0, p1, p2, p3}, Lcom/android/internal/telephony/cdma/AbstractCdmaCallTracker;->dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-virtual {v8}, Lcom/android/internal/telephony/cdma/CdmaConnection;->getDialAddress()Ljava/lang/String;
    ...
    invoke-interface {v7, v9}, Lcom/android/internal/telephony/CommandsInterface;->restartRild(Landroid/os/Message;)V
...
.method protected handlePollCalls(Landroid/os/AsyncResult;)V
    ...
    invoke-static/range {v25 .. v25}, Landroid/hdm/HwDeviceManager;->disallowOp(I)Z
    ...
    const-string v26, "HwDeviceManager disallow open call."
    ...
    new-instance v26, Lcom/android/internal/telephony/cdma/CdmaConnection;
    ...
    invoke-virtual/range {v25 .. v25}, Lcom/android/internal/telephony/cdma/CdmaConnection;->onConnectedInOrOut()V
    ...
    invoke-virtual/range {v25 .. v26}, Lcom/android/internal/telephony/cdma/CDMAPhone;->notifyHandoverStateChanged(Lcom/android/internal/telephony/Connection;)V
    ...
    .line 663
    const-string v25, "conn != null, dc == null. Still have connections in the call list"
    ...
    .line 809
    .end local v7    # "conn":Lcom/android/internal/telephony/cdma/CdmaConnection;
    .end local v24    # "wasDisconnected":Z
    :cond_21
    move-object/from16 v0, p0
...
.method hangup(Lcom/android/internal/telephony/cdma/CdmaCall;)V
    ...
    invoke-virtual {p0, v1}, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->delaySendRilRecoveryMsg(Lcom/android/internal/telephony/Call$State;)V
    ...
    .line 989
    :cond_1
    invoke-virtual {p0}, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->cleanRilRecovery()V
    ...
    .line 957
    .end local v0    # "state":Lcom/android/internal/telephony/Call$State;
    :cond_3
...
.method hangup(Lcom/android/internal/telephony/cdma/CdmaConnection;)V
    ...
    .prologue
    .line 852
    iget-object v3, p1, Lcom/android/internal/telephony/cdma/CdmaConnection;->mOwner:Lcom/android/internal/telephony/cdma/CdmaCallTracker;
    ...
    const-string v5, "CdmaConnection "
    ...
    .line 861
    const-string v3, "hangup: set hangupPendingMO to true"
    ...
    .line 898
    invoke-virtual {p1}, Lcom/android/internal/telephony/cdma/CdmaConnection;->getState()Lcom/android/internal/telephony/Call$State;
    ...
    invoke-virtual {v3}, Lcom/android/internal/telephony/cdma/CdmaCall;->isMultiparty()Z
    ...
    .line 901
    invoke-virtual {p0, v2}, Lcom/android/internal/telephony/cdma/CdmaCallTracker;->delaySendRilRecoveryMsg(Lcom/android/internal/telephony/Call$State;)V
    ...
    invoke-virtual {v3, v1}, Lcom/android/internal/telephony/cdma/CdmaCall;->setLastRingNumberAndChangeTime(Ljava/lang/String;)V
    ...
    const-string v5, "CdmaCallTracker WARN: hangup() on absent connection "
