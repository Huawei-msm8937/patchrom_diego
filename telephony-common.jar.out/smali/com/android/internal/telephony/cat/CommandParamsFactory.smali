...
.super Lcom/android/internal/telephony/cat/AbstractCommandParamsFactory;
...
.field private stkSupportIcon:Z
...
.method private constructor <init>(Lcom/android/internal/telephony/cat/RilMessageDecoder;Lcom/android/internal/telephony/uicc/IccFileHandler;)V
    ...
    .line 121
    invoke-direct {p0}, Lcom/android/internal/telephony/cat/AbstractCommandParamsFactory;-><init>()V
    ...
    .line 73
    const-string v0, "ro.config.hw_stk_icon"

    invoke-static {v0, v1}, Landroid/os/SystemProperties;->getBoolean(Ljava/lang/String;Z)Z

    move-result v0

    iput-boolean v0, p0, Lcom/android/internal/telephony/cat/CommandParamsFactory;->stkSupportIcon:Z
...
.method private processCloseChannel(Lcom/android/internal/telephony/cat/CommandDetails;Ljava/util/List;)Z
    ...
    .line 1377
    .local v1, "alertMsg":Lcom/android/internal/telephony/cat/TextMessage;
    const/4 v0, 0x0

    .line 1378
    .local v0, "alertIconId":Lcom/android/internal/telephony/cat/IconId;
    const/4 v2, 0x0
    ...
    .line 1387
    invoke-static {v3}, Lcom/android/internal/telephony/cat/ValueParser;->retrieveDeviceIdentities(Lcom/android/internal/telephony/cat/ComprehensionTlv;)Lcom/android/internal/telephony/cat/DeviceIdentities;

    move-result-object v4

    iget v2, v4, Lcom/android/internal/telephony/cat/DeviceIdentities;->destinationId:I
    ...
    .line 1400
    invoke-static {v3}, Lcom/android/internal/telephony/cat/ValueParser;->retrieveBIPAlphaId(Lcom/android/internal/telephony/cat/ComprehensionTlv;)Ljava/lang/String;
    ...
    .line 1406
    iget-boolean v4, v0, Lcom/android/internal/telephony/cat/IconId;->selfExplanatory:Z

    iput-boolean v4, v1, Lcom/android/internal/telephony/cat/TextMessage;->iconSelfExplanatory:Z

    .line 1409
    :cond_3
    new-instance v4, Lcom/android/internal/telephony/cat/CloseChannelParams;

    invoke-direct {v4, p1, v1, v2}, Lcom/android/internal/telephony/cat/CloseChannelParams;-><init>(Lcom/android/internal/telephony/cat/CommandDetails;Lcom/android/internal/telephony/cat/TextMessage;I)V
...
.method private processDisplayText(Lcom/android/internal/telephony/cat/CommandDetails;Ljava/util/List;)Z
    ...
    .line 418
    iget-boolean v3, p0, Lcom/android/internal/telephony/cat/CommandParamsFactory;->stkSupportIcon:Z

    if-nez v3, :cond_8

    .line 419
    const-string v3, "Close load icon feature."
    ...
    iput-boolean v4, v3, Lcom/android/internal/telephony/cat/CommandParams;->loadIconFailed:Z
...
.method private processEventNotify(Lcom/android/internal/telephony/cat/CommandDetails;Ljava/util/List;)Z
    ...
    .line 826
    iget-boolean v5, p0, Lcom/android/internal/telephony/cat/CommandParamsFactory;->stkSupportIcon:Z

    if-nez v5, :cond_2

    .line 827
    const-string v5, "Close load icon feature."
    ...
    iput-boolean v3, v5, Lcom/android/internal/telephony/cat/CommandParams;->loadIconFailed:Z
...
.method private processGetInput(Lcom/android/internal/telephony/cat/CommandDetails;Ljava/util/List;)Z
    ...
    iput-object v6, v3, Lcom/android/internal/telephony/cat/Input;->duration:Lcom/android/internal/telephony/cat/Duration;
    ...
    .line 638
    iget-boolean v6, p0, Lcom/android/internal/telephony/cat/CommandParamsFactory;->stkSupportIcon:Z

    if-nez v6, :cond_d

    .line 639
    const-string v6, "Close load icon feature."
...
.method private processLaunchBrowser(Lcom/android/internal/telephony/cat/CommandDetails;Ljava/util/List;)Z
    ...
    invoke-interface {v10, v5, v7, v8, v11}, Lcom/android/internal/telephony/HwTelephonyBaseManager;->gsm8BitUnpackedToString([BIIZ)Ljava/lang/String;
    :try_end_0
    .catch Ljava/lang/IndexOutOfBoundsException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 965
    iget-boolean v10, p0, Lcom/android/internal/telephony/cat/CommandParamsFactory;->stkSupportIcon:Z

    if-nez v10, :cond_4

    .line 966
    const-string v10, "Close load icon feature."
    ...
    iput-boolean v9, v10, Lcom/android/internal/telephony/cat/CommandParams;->loadIconFailed:Z
...
.method private processOpenChannel(Lcom/android/internal/telephony/cat/CommandDetails;Ljava/util/List;)Z
    ...
    .line 1226
    .local v13, "confirmIconId":Lcom/android/internal/telephony/cat/IconId;
    const/4 v5, 0x0
    ...
    .line 1239
    invoke-static {v14}, Lcom/android/internal/telephony/cat/ValueParser;->retrieveBIPAlphaId(Lcom/android/internal/telephony/cat/ComprehensionTlv;)Ljava/lang/String;
    ...
    iput-boolean v2, v4, Lcom/android/internal/telephony/cat/TextMessage;->iconSelfExplanatory:Z
    ...
    .line 1261
    .local v15, "iter":Ljava/util/Iterator;, "Ljava/util/Iterator<Lcom/android/internal/telephony/cat/ComprehensionTlv;>;"
    ...
    invoke-direct {v0, v2, v15}, Lcom/android/internal/telephony/cat/CommandParamsFactory;->searchForNextTag(Lcom/android/internal/telephony/cat/ComprehensionTlvTag;Ljava/util/Iterator;)Lcom/android/internal/telephony/cat/ComprehensionTlv;
    ...
    .line 1263
    invoke-static {v14}, Lcom/android/internal/telephony/cat/ValueParser;->retrieveInterfaceTransportLevel(Lcom/android/internal/telephony/cat/ComprehensionTlv;)Lcom/android/internal/telephony/cat/InterfaceTransportLevel;
    ...
    .line 1267
    invoke-static {v14}, Lcom/android/internal/telephony/cat/ValueParser;->retrieveOtherAddress(Lcom/android/internal/telephony/cat/ComprehensionTlv;)[B
    ...
    .line 1278
    invoke-static {v14}, Lcom/android/internal/telephony/cat/ValueParser;->retrieveBearerDescription(Lcom/android/internal/telephony/cat/ComprehensionTlv;)Lcom/android/internal/telephony/cat/BearerDescription;
    ...
    iget-object v3, v6, Lcom/android/internal/telephony/cat/InterfaceTransportLevel;->protocol:Lcom/android/internal/telephony/cat/InterfaceTransportLevel$TransportProtocol;
    ...
    iget v3, v6, Lcom/android/internal/telephony/cat/InterfaceTransportLevel;->port:I
    ...
    .end local v15    # "iter":Ljava/util/Iterator;, "Ljava/util/Iterator<Lcom/android/internal/telephony/cat/ComprehensionTlv;>;"
    ...
    .line 1310
    .restart local v15    # "iter":Ljava/util/Iterator;, "Ljava/util/Iterator<Lcom/android/internal/telephony/cat/ComprehensionTlv;>;"
    :cond_9
    iget-object v2, v6, Lcom/android/internal/telephony/cat/InterfaceTransportLevel;->protocol:Lcom/android/internal/telephony/cat/InterfaceTransportLevel$TransportProtocol;
    ...
    sget-object v3, Lcom/android/internal/telephony/cat/BearerDescription$BearerType;->E_UTRAN:Lcom/android/internal/telephony/cat/BearerDescription$BearerType;
    ...
    .line 1354
    .local v17, "uhe":Ljava/net/UnknownHostException;
    ...
    .line 1357
    .end local v17    # "uhe":Ljava/net/UnknownHostException;
    :cond_10
...
.method private processPlayTone(Lcom/android/internal/telephony/cat/CommandDetails;Ljava/util/List;)Z
    ...
    .line 1039
    iget-boolean v0, p0, Lcom/android/internal/telephony/cat/CommandParamsFactory;->stkSupportIcon:Z

    if-nez v0, :cond_6

    .line 1040
    const-string v0, "Close load icon feature."
...
.method private processReceiveData(Lcom/android/internal/telephony/cat/CommandDetails;Ljava/util/List;)Z
    ...
    iget v0, v4, Lcom/android/internal/telephony/cat/DeviceIdentities;->destinationId:I
    ...
    const-string v5, "Invalid Channel number given: "
    ...
    .end local v3    # "textMsg":Lcom/android/internal/telephony/cat/TextMessage;
    invoke-direct {v3}, Lcom/android/internal/telephony/cat/TextMessage;-><init>()V

    .line 1444
    .restart local v3    # "textMsg":Lcom/android/internal/telephony/cat/TextMessage;
    invoke-static {v1}, Lcom/android/internal/telephony/cat/ValueParser;->retrieveBIPAlphaId(Lcom/android/internal/telephony/cat/ComprehensionTlv;)Ljava/lang/String;
    ...
    .line 1451
    :cond_2
    sget-object v4, Lcom/android/internal/telephony/cat/ComprehensionTlvTag;->CHANNEL_DATA_LENGTH:Lcom/android/internal/telephony/cat/ComprehensionTlvTag;
    ...
    .line 1459
    new-instance v4, Lcom/android/internal/telephony/cat/ReceiveDataParams;

    invoke-direct {v4, p1, v0, v2, v3}, Lcom/android/internal/telephony/cat/ReceiveDataParams;-><init>(Lcom/android/internal/telephony/cat/CommandDetails;IILcom/android/internal/telephony/cat/TextMessage;)V
...
.method private processSelectItem(Lcom/android/internal/telephony/cat/CommandDetails;Ljava/util/List;)Z
    ...
    .line 759
    :pswitch_1
    iget-boolean v7, p0, Lcom/android/internal/telephony/cat/CommandParamsFactory;->stkSupportIcon:Z

    if-nez v7, :cond_c

    .line 760
    const-string v7, "Close load icon feature."
...
.method private processSendData(Lcom/android/internal/telephony/cat/CommandDetails;Ljava/util/List;)Z
    ...
    .line 1499
    :cond_2
    sget-object v4, Lcom/android/internal/telephony/cat/ComprehensionTlvTag;->CHANNEL_DATA:Lcom/android/internal/telephony/cat/ComprehensionTlvTag;
    ...
    .line 1508
    new-instance v4, Lcom/android/internal/telephony/cat/SendDataParams;

    invoke-direct {v4, p1, v0, v2, v3}, Lcom/android/internal/telephony/cat/SendDataParams;-><init>(Lcom/android/internal/telephony/cat/CommandDetails;I[BLcom/android/internal/telephony/cat/TextMessage;)V
...
.method private processSetUpIdleModeText(Lcom/android/internal/telephony/cat/CommandDetails;Ljava/util/List;)Z
    ...
    .line 478
    iget-boolean v4, p0, Lcom/android/internal/telephony/cat/CommandParamsFactory;->stkSupportIcon:Z

    if-nez v4, :cond_4

    .line 479
    const-string v4, "Close load icon feature."
    ...
    iput-boolean v3, v4, Lcom/android/internal/telephony/cat/CommandParams;->loadIconFailed:Z
...
.method private processSetupCall(Lcom/android/internal/telephony/cat/CommandDetails;Ljava/util/List;)Z
    ...
    .line 1096
    const-string v9, "ADDRESS_ID parse entered"
    ...
    const-string v10, "confirmMsg.text"
    ...
    .line 1131
    :cond_5
    iget-boolean v9, p0, Lcom/android/internal/telephony/cat/CommandParamsFactory;->stkSupportIcon:Z

    if-nez v9, :cond_8

    .line 1132
    const-string v9, "Close load icon feature."

    invoke-static {p0, v9}, Lcom/android/internal/telephony/cat/CatLog;->d(Ljava/lang/Object;Ljava/lang/String;)V

    .line 1133
    iget-object v9, p0, Lcom/android/internal/telephony/cat/CommandParamsFactory;->mCmdParams:Lcom/android/internal/telephony/cat/CommandParams;

    const/4 v10, 0x1

    iput-boolean v10, v9, Lcom/android/internal/telephony/cat/CommandParams;->loadIconFailed:Z
...
.method make(Lcom/android/internal/telephony/cat/BerTlv;)V
    ...
    .line 248
    :cond_8
    sget-object v5, Lcom/android/internal/telephony/cat/AppInterface$CommandType;->CLOSE_CHANNEL:Lcom/android/internal/telephony/cat/AppInterface$CommandType;
    ...
    .line 251
    :cond_9
    sget-object v5, Lcom/android/internal/telephony/cat/AppInterface$CommandType;->RECEIVE_DATA:Lcom/android/internal/telephony/cat/AppInterface$CommandType;
    ...
    .line 254
    :cond_a
    sget-object v5, Lcom/android/internal/telephony/cat/AppInterface$CommandType;->SEND_DATA:Lcom/android/internal/telephony/cat/AppInterface$CommandType;
    ...
    .line 265
    :pswitch_f
    invoke-virtual {p0, v0, v3}, Lcom/android/internal/telephony/cat/CommandParamsFactory;->processLanguageNotification(Lcom/android/internal/telephony/cat/CommandDetails;Ljava/util/List;)Z
    :try_end_2
