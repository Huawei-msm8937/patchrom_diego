...
.super Lcom/android/internal/telephony/cat/AbstractCatService;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/internal/telephony/cat/CatService$DefaultBearerStateReceiver;
    }
.end annotation
...
.field private static final DEFAULT_SEND_RETRY_DELAY:I = 0x4e20
...
.field private static final EVENT_LENGTH:I = 0xa

.field private static final EVENT_SEND_ENVELOPE_RESULT:I = 0x64

.field private static final EVENT_SEND_ENVELOPE_RETRY:I = 0x63

.field private static final EVENT_SEND_RESPONSE_WAIT:I = 0x28

.field private static final EVENT_SEND_RESPONSE_WAIT_TIME:I = 0x3c

.field private static final ID_BROWSER_TERMINATION_EVENT:I = 0x5

.field private static final ID_BROWSING_STATUS_EVENT:I = 0x6

.field private static final ID_CHANNEL_STATUS_EVENT:I = 0x0

.field private static final ID_DATA_AVAILABLE_EVENT:I = 0x1

.field private static final ID_IDLE_SCREEN_AVAILABLE_EVENT:I = 0x3

.field private static final ID_LANGUAGE_SELECTION_EVENT:I = 0x4

.field private static final ID_USER_ACTIVITY_EVENT:I = 0x2

.field private static final MAX_SEND_RETRIES:I = 0x5
...
.field private static final isHideStkpop:Z
...
.field private mDefaultBearerStateReceiver:Lcom/android/internal/telephony/cat/CatService$DefaultBearerStateReceiver;
...
.field private mRetryHexString:Ljava/lang/String;
...
.method static constructor <clinit>()V
    ...
    .line 185
    const-string v0, "ro.hwpp.hidestk"
    ...
    sput-boolean v0, Lcom/android/internal/telephony/cat/CatService;->isHideStkpop:Z
...
.method private constructor <init>(Lcom/android/internal/telephony/CommandsInterface;Lcom/android/internal/telephony/uicc/UiccCardApplication;Lcom/android/internal/telephony/uicc/IccRecords;Landroid/content/Context;Lcom/android/internal/telephony/uicc/IccFileHandler;Lcom/android/internal/telephony/uicc/UiccCard;I)V
    ...
    .line 205
    invoke-direct {p0}, Lcom/android/internal/telephony/cat/AbstractCatService;-><init>()V
    ...
    .line 131
    iput-boolean v1, p0, Lcom/android/internal/telephony/cat/CatService;->mIsWifiConnected:Z

    .line 132
    iput-object v3, p0, Lcom/android/internal/telephony/cat/CatService;->mDefaultBearerStateReceiver:Lcom/android/internal/telephony/cat/CatService$DefaultBearerStateReceiver;

    .line 168
    iput v4, p0, Lcom/android/internal/telephony/cat/CatService;->mRetryCount:I

    .line 170
    iput-object v3, p0, Lcom/android/internal/telephony/cat/CatService;->mRetryHexString:Ljava/lang/String;
    ...
    iput-object v0, p0, Lcom/android/internal/telephony/cat/CatService;->mEvents:[I
    ...
    invoke-interface {v0, p0, v4, v3}, Lcom/android/internal/telephony/CommandsInterface;->setOnCatSessionEnd(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    .line 250
    new-instance v0, Lcom/android/internal/telephony/cat/CatService$DefaultBearerStateReceiver;

    invoke-direct {v0, p0, p4}, Lcom/android/internal/telephony/cat/CatService$DefaultBearerStateReceiver;-><init>(Lcom/android/internal/telephony/cat/CatService;Landroid/content/Context;)V

    iput-object v0, p0, Lcom/android/internal/telephony/cat/CatService;->mDefaultBearerStateReceiver:Lcom/android/internal/telephony/cat/CatService$DefaultBearerStateReceiver;

    .line 251
    iget-object v0, p0, Lcom/android/internal/telephony/cat/CatService;->mDefaultBearerStateReceiver:Lcom/android/internal/telephony/cat/CatService$DefaultBearerStateReceiver;

    invoke-virtual {v0}, Lcom/android/internal/telephony/cat/CatService$DefaultBearerStateReceiver;->startListening()V
...
.method static synthetic access$000(Lcom/android/internal/telephony/cat/CatService;)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/internal/telephony/cat/CatService;

    .prologue
    .line 103
    iget-boolean v0, p0, Lcom/android/internal/telephony/cat/CatService;->mIsWifiConnected:Z

    return v0
.end method

.method static synthetic access$002(Lcom/android/internal/telephony/cat/CatService;Z)Z
    .locals 0
    .param p0, "x0"    # Lcom/android/internal/telephony/cat/CatService;
    .param p1, "x1"    # Z
    ...
    .prologue
    .line 103
    iput-boolean p1, p0, Lcom/android/internal/telephony/cat/CatService;->mIsWifiConnected:Z
...
.method private checkSetupEventCommand(Lcom/android/internal/telephony/cat/CatCmdMessage;)V
    .locals 7
    .param p1, "cmdMsg"    # Lcom/android/internal/telephony/cat/CatCmdMessage;
    ...
    .line 454
    iget-object v3, p0, Lcom/android/internal/telephony/cat/CatService;->mEvents:[I
    ...
    .line 461
    :pswitch_1
    const-string v3, "DATA_AVAILABLE_EVENT is true"
    ...
    .line 465
    :pswitch_2
    const-string v3, "CHANNEL_STATUS_EVENT is true"
    ...
    .line 469
    :pswitch_3
    const-string v3, "USER_ACTIVITY_EVENT is true"
    ...
    .line 473
    :pswitch_4
    const-string v3, "IDLE_SCREEN_AVAILABLE_EVENT is true"
    ...
    .line 477
    :pswitch_5
    const-string v3, "LANGUAGE_SELECTION_EVENT is true"
    ...
    .line 481
    :pswitch_6
    const-string v3, "BROWSER_TERMINATION_EVENT is true"
    ...
    .line 485
    :pswitch_7
    const-string v3, "BROWSING_STATUS_EVENT is true"
...
.method private eventDownload(III[BZ)V
    ...
    .line 993
    sget-object v10, Lcom/android/internal/telephony/cat/ComprehensionTlvTag;->EVENT_LIST:Lcom/android/internal/telephony/cat/ComprehensionTlvTag;
    ...
    .line 999
    sget-object v10, Lcom/android/internal/telephony/cat/ComprehensionTlvTag;->DEVICE_IDENTITIES:Lcom/android/internal/telephony/cat/ComprehensionTlvTag;
    ...
    const-string v11, " Sending Idle Screen Available event download to ICC"

    invoke-static {v10, v11}, Lcom/android/internal/telephony/cat/CatLog;->d(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    const-string v11, " Sending Language Selection event download to ICC"
    ...
    const-string v11, "DATA_AVAILABLE_EVENT isRetry "
    ...
    const-string v11, "ENVELOPE COMMAND: "
    ...
    const-string v11, "ENVELOPE COMMAND mRetryHexString: "

    invoke-virtual {v10, v11}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v10

    iget-object v11, p0, Lcom/android/internal/telephony/cat/CatService;->mRetryHexString:Ljava/lang/String;
    ...
    .line 1066
    iget-object v10, p0, Lcom/android/internal/telephony/cat/CatService;->mCmdIf:Lcom/android/internal/telephony/CommandsInterface;

    const/16 v11, 0x64

    invoke-virtual {p0, v11}, Lcom/android/internal/telephony/cat/CatService;->obtainMessage(I)Landroid/os/Message;

    move-result-object v11

    invoke-interface {v10, v3, v11}, Lcom/android/internal/telephony/CommandsInterface;->sendEnvelope(Ljava/lang/String;Landroid/os/Message;)V
...
.method private handleCmdResponse(Lcom/android/internal/telephony/cat/CatResponseMessage;)V
    ...
    .line 1319
    :cond_2
    iget-object v2, p1, Lcom/android/internal/telephony/cat/CatResponseMessage;->envelopeCmd:Ljava/lang/String;
    ...
    invoke-interface {v0, v2, v11}, Lcom/android/internal/telephony/CommandsInterface;->sendEnvelope(Ljava/lang/String;Landroid/os/Message;)V
    ...
    .line 1329
    .local v10, "type":Lcom/android/internal/telephony/cat/AppInterface$CommandType;
    ...
    iget-boolean v2, p0, Lcom/android/internal/telephony/cat/CatService;->mIsWifiConnected:Z
    ...
    const-string v2, "handleCmdResponse() bad Cmd details="
    ...
    invoke-interface {v0, v5, v11}, Lcom/android/internal/telephony/CommandsInterface;->handleCallSetupRequestFromSim(ZLandroid/os/Message;)V
...
.method private handleCommand(Lcom/android/internal/telephony/cat/CommandParams;Z)V
    ...
    :pswitch_0
    const-string v2, "handleProactiveCommand()  SET_UP_MENU "
    ...
    .line 540
    :pswitch_2
    sget-boolean v2, Lcom/android/internal/telephony/cat/CatService;->isHideStkpop:Z

    if-eqz v2, :cond_5

    .line 541
    const-string v2, "gsm.stk.hide"
    ...
    .line 542
    .local v21, "modemReboot":I
    new-instance v2, Ljava/lang/StringBuilder;

    invoke-direct {v2}, Ljava/lang/StringBuilder;-><init>()V

    const-string v3, "Receive DisplayTetxt modem reboot="
    ...
    .line 544
    const-string v2, "Modem reboot, avoid DisplayText"
    ...
    .line 559
    .local v24, "sendTerminalResponseWait":Landroid/os/Message;
    move-object/from16 v0, p1
    ...
    invoke-virtual {v0, v1, v2, v3}, Lcom/android/internal/telephony/cat/CatService;->sendMessageDelayed(Landroid/os/Message;J)Z

    goto/16 :goto_3

    .line 554
    .end local v4    # "resultCode":Lcom/android/internal/telephony/cat/ResultCode;
    .end local v24    # "sendTerminalResponseWait":Landroid/os/Message;
    :cond_6
    sget-object v4, Lcom/android/internal/telephony/cat/ResultCode;->OK:Lcom/android/internal/telephony/cat/ResultCode;
    ...
    invoke-virtual/range {v18 .. v18}, Lcom/android/internal/telephony/cat/CatCmdMessage;->getLanguageNotification()Ljava/lang/String;
    ...
    invoke-direct {v0, v1}, Lcom/android/internal/telephony/cat/CatService;->checkSetupEventCommand(Lcom/android/internal/telephony/cat/CatCmdMessage;)V
    ...
    .line 669
    .local v22, "newChannel":Lcom/android/internal/telephony/cat/CatCmdMessage$ChannelSettings;
    if-nez v22, :cond_c
    ...
    .line 684
    const-string v2, "open channel text not null"
    ...
    .line 689
    .end local v22    # "newChannel":Lcom/android/internal/telephony/cat/CatCmdMessage$ChannelSettings;
    :cond_e
    move-object/from16 v0, p0

    iget-boolean v2, v0, Lcom/android/internal/telephony/cat/CatService;->mIsWifiConnected:Z
...
.method public dispose()V
    ...
    invoke-virtual {v0}, Lcom/android/internal/telephony/cat/CatService$DefaultBearerStateReceiver;->stopListening()V
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    const-string v3, "ril message arrived,slotid:"
    ...
    .line 1116
    invoke-virtual {p0, v9}, Lcom/android/internal/telephony/cat/CatService;->setLanguageNotificationCode(Ljava/lang/String;)V
    :try_end_0
    .catch Ljava/lang/ClassCastException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-direct {v3, v4, v9}, Lcom/android/internal/telephony/cat/RilMessage;-><init>(ILjava/lang/String;)V
    ...
    invoke-direct {v3, v4, v7}, Lcom/android/internal/telephony/cat/RilMessage;-><init>(ILjava/lang/String;)V
    ...
    invoke-direct {p0, v2}, Lcom/android/internal/telephony/cat/CatService;->handleRilMsg(Lcom/android/internal/telephony/cat/RilMessage;)V
    ...
    invoke-direct {p0, v2}, Lcom/android/internal/telephony/cat/CatService;->handleCmdResponse(Lcom/android/internal/telephony/cat/CatResponseMessage;)V
    ...
    invoke-direct {p0, v3, v2}, Lcom/android/internal/telephony/cat/CatService;->broadcastCardStateAndIccRefreshResp(Lcom/android/internal/telephony/uicc/IccCardStatus$CardState;Lcom/android/internal/telephony/uicc/IccRefreshResponse;)V
    ...
    const-string v3, "Icc REFRESH with exception: "
    ...
    invoke-direct {p0, v2}, Lcom/android/internal/telephony/cat/CatService;->broadcastAlphaMessage(Ljava/lang/String;)V
    ...
    .line 1173
    :cond_5
    const-string v2, "Wait Message is null"
    ...
    .line 1181
    iget v2, p0, Lcom/android/internal/telephony/cat/CatService;->mRetryCount:I
    ...
    invoke-virtual {p0, v11, v2, v3}, Lcom/android/internal/telephony/cat/CatService;->sendMessageDelayed(Landroid/os/Message;J)Z

    goto/16 :goto_0

    .line 1185
    .end local v11    # "retryMsg":Landroid/os/Message;
    :cond_6
    const-string v2, "SEND ENVELOPE COMMAND exceed MAX RETRIES"
    ...
    .line 1187
    iput-object v7, p0, Lcom/android/internal/telephony/cat/CatService;->mRetryHexString:Ljava/lang/String;

    goto/16 :goto_0

    .line 1190
    :cond_7
    const-string v2, "SEND ENVELOPE SUCCESS"
    ...
    const-string v3, "SEND ENVELOPE retry times "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    iget v3, p0, Lcom/android/internal/telephony/cat/CatService;->mRetryCount:I

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    move-result-object v2

    const-string v3, " RETRY ENVELOPE COMMAND "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    iget-object v3, p0, Lcom/android/internal/telephony/cat/CatService;->mRetryHexString:Ljava/lang/String;
    ...
    iput v2, p0, Lcom/android/internal/telephony/cat/CatService;->mRetryCount:I
...
.method public onEventDownload(Lcom/android/internal/telephony/cat/CatEventMessage;)V
    .locals 6
    .param p1, "eventMsg"    # Lcom/android/internal/telephony/cat/CatEventMessage;
    ...
    iget-object v0, p0, Lcom/android/internal/telephony/cat/CatService;->mEvents:[I
    ...
    .line 968
    const-string v0, "channel_status == 0 and don\'t send envelope to card"
...
.method public sendTerminalResponse(Lcom/android/internal/telephony/cat/CommandDetails;Lcom/android/internal/telephony/cat/ResultCode;ZILcom/android/internal/telephony/cat/ResponseData;)V
    .locals 8
    .param p1, "cmdDet"    # Lcom/android/internal/telephony/cat/CommandDetails;
    .param p2, "resultCode"    # Lcom/android/internal/telephony/cat/ResultCode;
