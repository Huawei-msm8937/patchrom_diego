...
.method public enter()V
    ...
    invoke-static {v2, v3}, Lcom/android/server/wifi/WifiStateMachine;->access$802(Lcom/android/server/wifi/WifiStateMachine;Z)Z
    ...
    invoke-virtual {v2}, Lcom/android/server/wifi/WifiStateMachine;->enterDriverStartedStateByMode()Z
    ...
    const-string v5, "DriverStartedState enter transitionTo mDisconnectedState"
    ...
    # getter for: Lcom/android/server/wifi/WifiStateMachine;->mWifiSettingStore:Lcom/android/server/wifi/WifiSettingsStore;
    invoke-static {v2}, Lcom/android/server/wifi/WifiStateMachine;->access$11300(Lcom/android/server/wifi/WifiStateMachine;)Lcom/android/server/wifi/WifiSettingsStore;
    ...
    const-string v5, "isWifiToggleEnabled = true,donot setwifistate to disable"
    ...
    invoke-static {v2, v3, v9}, Lcom/android/server/wifi/WifiStateMachine;->access$11600(Lcom/android/server/wifi/WifiStateMachine;ILjava/lang/String;)Z
    ...
    invoke-static {v5}, Lcom/android/server/wifi/WifiStateMachine;->access$11700(Lcom/android/server/wifi/WifiStateMachine;)Lcom/android/internal/util/State;
...
.method public exit()V
    ...
    # getter for: Lcom/android/server/wifi/WifiStateMachine;->mWifiLogger:Lcom/android/server/wifi/WifiLogger;
    invoke-static {v1}, Lcom/android/server/wifi/WifiStateMachine;->access$2600(Lcom/android/server/wifi/WifiStateMachine;)Lcom/android/server/wifi/WifiLogger;
    ...
    # setter for: Lcom/android/server/wifi/WifiStateMachine;->mIsRunning:Z
    invoke-static {v1, v3}, Lcom/android/server/wifi/WifiStateMachine;->access$802(Lcom/android/server/wifi/WifiStateMachine;Z)Z
    ...
    invoke-virtual {v1, v2}, Lcom/android/server/wifi/WifiStateMachine;->setWiFiProScanResultList(Ljava/util/List;)V
    ...
    invoke-static {v1}, Lcom/android/server/wifi/WifiStateMachine;->access$10800(Lcom/android/server/wifi/WifiStateMachine;)Z
    ...
    const-string v2, "DriverStartedState exit,Delayed stop ignored due to exit"
    ...
    # setter for: Lcom/android/server/wifi/WifiStateMachine;->mInDelayedStop:Z
    invoke-static {v1, v3}, Lcom/android/server/wifi/WifiStateMachine;->access$10802(Lcom/android/server/wifi/WifiStateMachine;Z)Z

    .line 7147
    iget-object v1, p0, Lcom/android/server/wifi/WifiStateMachine$DriverStartedState;->this$0:Lcom/android/server/wifi/WifiStateMachine;

    # operator++ for: Lcom/android/server/wifi/WifiStateMachine;->mDelayedStopCounter:I
    invoke-static {v1}, Lcom/android/server/wifi/WifiStateMachine;->access$10908(Lcom/android/server/wifi/WifiStateMachine;)I

    .line 7148
    iget-object v1, p0, Lcom/android/server/wifi/WifiStateMachine$DriverStartedState;->this$0:Lcom/android/server/wifi/WifiStateMachine;

    # getter for: Lcom/android/server/wifi/WifiStateMachine;->mAlarmManager:Landroid/app/AlarmManager;
    invoke-static {v1}, Lcom/android/server/wifi/WifiStateMachine;->access$12700(Lcom/android/server/wifi/WifiStateMachine;)Landroid/app/AlarmManager;
    ...
    invoke-static {v2}, Lcom/android/server/wifi/WifiStateMachine;->access$12600(Lcom/android/server/wifi/WifiStateMachine;)Landroid/app/PendingIntent;
...
.method public processMessage(Landroid/os/Message;)Z
    ...
    invoke-static {v7, p1, v10}, Lcom/android/server/wifi/WifiStateMachine;->access$1300(Lcom/android/server/wifi/WifiStateMachine;Landroid/os/Message;Ljava/lang/String;)V
    ...
    invoke-static {v7, v10, v11}, Lcom/android/server/wifi/WifiStateMachine;->access$12502(Lcom/android/server/wifi/WifiStateMachine;J)J
    ...
    iget-object v7, v7, Lcom/android/server/wifi/WifiStateMachine;->mWifiStateMachineHisiExt:Lcom/android/server/wifi/WifiStateMachineHisiExt;

    invoke-virtual {v7}, Lcom/android/server/wifi/WifiStateMachineHisiExt;->isP2pEnable()Z
    ...
    const-string v11, "mDriverStopP2pDelayMs:"
    ...
    iget-object v11, v11, Lcom/android/server/wifi/WifiStateMachine;->mWifiStateMachineHisiExt:Lcom/android/server/wifi/WifiStateMachineHisiExt;

    invoke-virtual {v11}, Lcom/android/server/wifi/WifiStateMachineHisiExt;->getDriverStopP2pDelayMs()I
    ...
    iget-object v12, v12, Lcom/android/server/wifi/WifiStateMachine;->mWifiStateMachineHisiExt:Lcom/android/server/wifi/WifiStateMachineHisiExt;

    invoke-virtual {v12}, Lcom/android/server/wifi/WifiStateMachineHisiExt;->getDriverStopP2pDelayMs()I
    ...
    invoke-static {v12}, Lcom/android/server/wifi/WifiStateMachine;->access$12800(Lcom/android/server/wifi/WifiStateMachine;)I
    ...
    # getter for: Lcom/android/server/wifi/WifiStateMachine;->mDisconnectedState:Lcom/android/internal/util/State;
    invoke-static {v9}, Lcom/android/server/wifi/WifiStateMachine;->access$11700(Lcom/android/server/wifi/WifiStateMachine;)Lcom/android/internal/util/State;
    ...
    # invokes: Lcom/android/server/wifi/WifiStateMachine;->setSuspendOptimizationsNative(IZ)V
    invoke-static {v7, v11, v9}, Lcom/android/server/wifi/WifiStateMachine;->access$13300(Lcom/android/server/wifi/WifiStateMachine;IZ)V
    ...
    # invokes: Lcom/android/server/wifi/WifiStateMachine;->setSuspendOptimizationsNative(IZ)V
    invoke-static {v7, v11, v8}, Lcom/android/server/wifi/WifiStateMachine;->access$13300(Lcom/android/server/wifi/WifiStateMachine;IZ)V
    ...
    invoke-static {v7}, Lcom/android/server/wifi/WifiStateMachine;->access$3500(Lcom/android/server/wifi/WifiStateMachine;)Lcom/android/server/wifi/WifiStateMachine$WifiNetworkAgent;
