...
.method static synthetic access$1600(Lcom/android/server/wifi/WifiServiceImpl$LockList;Ljava/io/PrintWriter;)V
    .locals 0
...
.method static synthetic access$2200(Lcom/android/server/wifi/WifiServiceImpl$LockList;Lcom/android/server/wifi/WifiServiceImpl$WifiLock;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/wifi/WifiServiceImpl$LockList;
...
.method static synthetic access$2300(Lcom/android/server/wifi/WifiServiceImpl$LockList;Landroid/os/IBinder;)I
    .locals 1
    .param p0, "x0"    # Lcom/android/server/wifi/WifiServiceImpl$LockList;
...
.method static synthetic access$2400(Lcom/android/server/wifi/WifiServiceImpl$LockList;)Ljava/util/List;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/wifi/WifiServiceImpl$LockList;
...
.method static synthetic access$2500(Lcom/android/server/wifi/WifiServiceImpl$LockList;Landroid/os/IBinder;)Lcom/android/server/wifi/WifiServiceImpl$WifiLock;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/wifi/WifiServiceImpl$LockList;
    .param p1, "x1"    # Landroid/os/IBinder;
...
# virtual methods
.method declared-synchronized clearLocks()Z
    .locals 7
    ...
    :try_start_0
    const-string v0, "WiFiDirectFT"

    .line 2168
    .local v0, "EXCEPT":Ljava/lang/String;
    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    .line 2169
    .local v1, "copyList":Ljava/util/List;, "Ljava/util/List<Lcom/android/server/wifi/WifiServiceImpl$WifiLock;>;"
    iget-object v4, p0, Lcom/android/server/wifi/WifiServiceImpl$LockList;->mList:Ljava/util/List;
    ...
    check-cast v3, Lcom/android/server/wifi/WifiServiceImpl$WifiLock;

    .line 2173
    .local v3, "l":Lcom/android/server/wifi/WifiServiceImpl$WifiLock;
    iget-object v4, v3, Lcom/android/server/wifi/WifiServiceImpl$WifiLock;->mTag:Ljava/lang/String;
    ...
    const-string v6, "don\'t release module: "
    ...
    .line 2167
    .end local v0    # "EXCEPT":Ljava/lang/String;
    .end local v1    # "copyList":Ljava/util/List;, "Ljava/util/List<Lcom/android/server/wifi/WifiServiceImpl$WifiLock;>;"
    .end local v2    # "i$":Ljava/util/Iterator;
    .end local v3    # "l":Lcom/android/server/wifi/WifiServiceImpl$WifiLock;
    :catchall_0
    move-exception v4
    ...
    .line 2177
    .restart local v0    # "EXCEPT":Ljava/lang/String;
    .restart local v1    # "copyList":Ljava/util/List;, "Ljava/util/List<Lcom/android/server/wifi/WifiServiceImpl$WifiLock;>;"
    .restart local v2    # "i$":Ljava/util/Iterator;
    .restart local v3    # "l":Lcom/android/server/wifi/WifiServiceImpl$WifiLock;
    :cond_1
    :try_start_1
    iget-object v4, p0, Lcom/android/server/wifi/WifiServiceImpl$LockList;->this$0:Lcom/android/server/wifi/WifiServiceImpl;

    iget-object v5, v3, Lcom/android/server/wifi/WifiServiceImpl$WifiLock;->mBinder:Landroid/os/IBinder;

    invoke-virtual {v4, v5}, Lcom/android/server/wifi/WifiServiceImpl;->releaseWifiLock(Landroid/os/IBinder;)Z
    ...
    const-string v5, "releaseWifiLock failed , don\'t send CMD_LACKS_CHANGED"
...
.method declared-synchronized getStrongestLockMode()I
    ...
    invoke-static {v1}, Lcom/android/server/wifi/WifiServiceImpl;->access$1800(Lcom/android/server/wifi/WifiServiceImpl;)I
    ...
    invoke-static {v2}, Lcom/android/server/wifi/WifiServiceImpl;->access$1900(Lcom/android/server/wifi/WifiServiceImpl;)I
    ...
    invoke-static {v1}, Lcom/android/server/wifi/WifiServiceImpl;->access$2000(Lcom/android/server/wifi/WifiServiceImpl;)I
    ...
    invoke-static {v2}, Lcom/android/server/wifi/WifiServiceImpl;->access$2100(Lcom/android/server/wifi/WifiServiceImpl;)I
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
