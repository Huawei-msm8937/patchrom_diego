...
.method public onWriteCalled(Ljava/io/DataOutputStream;)V
    ...
    invoke-static {}, Lcom/android/server/wifi/WifiConfigStore;->access$100()Z
    ...
    const-string v16, "WIFI_PRO_TEMP_CREATE:  "

    invoke-virtual/range {v15 .. v16}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v15

    iget-boolean v0, v4, Landroid/net/wifi/WifiConfiguration;->isTempCreated:Z
    ...
    const-string v16, "LAST_HAS_INTERNET_TS:  "

    invoke-virtual/range {v15 .. v16}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v15

    iget-wide v0, v4, Landroid/net/wifi/WifiConfiguration;->lastHasInternetTimestamp:J
    ...
    invoke-static {v4, v0, v15, v1}, Landroid/net/wifi/wifipro/NetworkHistoryUtils;->writeNetworkHistory(Landroid/net/wifi/WifiConfiguration;Ljava/io/DataOutputStream;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v16, "CLOUD_SECURITY_CHECK:  "

    invoke-virtual/range {v15 .. v16}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v15

    iget v0, v4, Landroid/net/wifi/WifiConfiguration;->cloudSecurityCheck:I
    ...
    invoke-virtual {v15, v4}, Lcom/android/server/wifi/WifiConfigStore;->getScanDetailCache(Landroid/net/wifi/WifiConfiguration;)Lcom/android/server/wifi/ScanDetailCache;
    ...
    invoke-virtual {v15}, Lcom/android/server/wifi/ScanDetailCache;->values()Ljava/util/Collection;
