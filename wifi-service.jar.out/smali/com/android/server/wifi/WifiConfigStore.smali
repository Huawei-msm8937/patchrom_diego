...
.super Lcom/android/server/wifi/AbsWifiConfigStore;
...
.field private static final CLOUD_SECURITY_CHECK_KEY:Ljava/lang/String; = "CLOUD_SECURITY_CHECK"
...
.field private static final LAST_HAS_INTERNET_TS_KEY:Ljava/lang/String; = "LAST_HAS_INTERNET_TS"
...
.field private static final WIFI_PRO_TEMP_CREATE:Ljava/lang/String; = "WIFI_PRO_TEMP_CREATE"
...
# instance fields
.field private SUPPLICANT_CONFIG_FILE:Ljava/lang/String;

.field private SUPPLICANT_CONFIG_FILE_BACKUP:Ljava/lang/String;
...
.method static constructor <clinit>()V
    ...
    :goto_0
    sput-boolean v0, Lcom/android/server/wifi/WifiConfigStore;->HWFLOW:Z

    .line 179
    sget-boolean v0, Lcom/android/server/wifi/WifiConfigStore;->HWFLOW:Z
    ...
    .line 181
    sput-boolean v2, Lcom/android/server/wifi/WifiConfigStore;->HWLOGW_E:Z
    ...
    const-string v3, "/misc/wifi/ipconfig.txt"
    ...
    const-string v3, "/misc/wifi/networkHistory.txt"
    ...
    const-string v3, "/misc/wifi/autojoinconfig.txt"
...
.method constructor <init>(Landroid/content/Context;Lcom/android/server/wifi/WifiStateMachine;Lcom/android/server/wifi/WifiNative;)V
    ...
    .line 558
    invoke-direct {p0}, Lcom/android/server/wifi/AbsWifiConfigStore;-><init>()V

    .line 184
    const-string v1, "/data/misc/wifi/wpa_supplicant.conf"

    iput-object v1, p0, Lcom/android/server/wifi/WifiConfigStore;->SUPPLICANT_CONFIG_FILE:Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/android/server/wifi/WifiConfigStore;->SUPPLICANT_CONFIG_FILE:Ljava/lang/String;
    ...
    iput-object v1, p0, Lcom/android/server/wifi/WifiConfigStore;->SUPPLICANT_CONFIG_FILE_BACKUP:Ljava/lang/String;
    ...
    iput-object v1, p0, Lcom/android/server/wifi/WifiConfigStore;->mWiFiCHRManager:Lcom/android/server/wifi/HwWifiCHRStateManager;
    ...
    iput-object v1, p0, Lcom/android/server/wifi/WifiConfigStore;->mScanDetailCaches:Ljava/util/concurrent/ConcurrentHashMap;
...
.method static synthetic access$000(Lcom/android/server/wifi/WifiConfigStore;)Ljava/lang/String;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/wifi/WifiConfigStore;

    .prologue
    .line 172
    iget-object v0, p0, Lcom/android/server/wifi/WifiConfigStore;->SUPPLICANT_CONFIG_FILE:Ljava/lang/String;
...
.method static synthetic access$200(Lcom/android/server/wifi/WifiConfigStore;Ljava/lang/String;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/wifi/WifiConfigStore;
...
.method private addOrUpdateNetworkNative(Landroid/net/wifi/WifiConfiguration;I)Lcom/android/server/wifi/NetworkUpdateResult;
    ...
    .line 2802
    new-instance v38, Lcom/android/server/wifi/NetworkUpdateResult;
    ...
    .line 2810
    invoke-virtual/range {p1 .. p1}, Landroid/net/wifi/WifiConfiguration;->defendSsid()V
    ...
    iget-object v5, v0, Landroid/net/wifi/WifiConfiguration;->oriSsid:Ljava/lang/String;
    ...
    invoke-static {v5}, Lcom/android/server/wifi/WifiConfigStore;->encodeSSID(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget v5, v0, Landroid/net/wifi/WifiConfiguration;->cloudSecurityCheck:I

    move-object/from16 v0, v40

    iput v5, v0, Landroid/net/wifi/WifiConfiguration;->cloudSecurityCheck:I
    ...
    const-string v6, "cloudSecurityCheck"

    move-object/from16 v0, p1

    iget v8, v0, Landroid/net/wifi/WifiConfiguration;->cloudSecurityCheck:I
    ...
    const-string v6, "failed to set cloudSecurityCheck: "
    ...
    iget v6, v0, Landroid/net/wifi/WifiConfiguration;->cloudSecurityCheck:I
    ...
    invoke-virtual {v0, v1, v2}, Lcom/android/server/wifi/WifiConfigStore;->isVariablesWapi(Landroid/net/wifi/WifiConfiguration;I)Z
    ...
    invoke-static/range {v26 .. v26}, Lcom/android/server/wifi/WifiConfigStore;->needsKeyStore(Landroid/net/wifi/WifiEnterpriseConfig;)Z
    ...
    .line 3115
    .local v23, "currentConfig":Landroid/net/wifi/WifiConfiguration;
    move-object/from16 v0, p1
    ...
    .line 3117
    .local v34, "keyId":Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    .line 3121
    .end local v23    # "currentConfig":Landroid/net/wifi/WifiConfiguration;
    .end local v34    # "keyId":Ljava/lang/String;
    :catch_0
    move-exception v24
    ...
    .line 3131
    .local v21, "currConfig":Landroid/net/wifi/WifiConfiguration;
    if-eqz v21, :cond_2c
    ...
    const-string v6, "current Eap Method:"
    ...
    .line 3135
    invoke-virtual/range {v26 .. v26}, Landroid/net/wifi/WifiEnterpriseConfig;->getFields()Ljava/util/HashMap;

    move-result-object v27

    .line 3137
    .local v27, "enterpriseFields":Ljava/util/HashMap;, "Ljava/util/HashMap<Ljava/lang/String;Ljava/lang/String;>;"
    const/16 v41, 0x0

    .line 3138
    .local v41, "savedEnterpriseFields":Ljava/util/HashMap;, "Ljava/util/HashMap<Ljava/lang/String;Ljava/lang/String;>;"
    const/16 v42, 0x0

    .line 3139
    .local v42, "savedValue":Ljava/lang/String;
    if-eqz v40, :cond_2d
    ...
    .end local v42    # "savedValue":Ljava/lang/String;
    check-cast v42, Ljava/lang/String;

    .line 3147
    .restart local v42    # "savedValue":Ljava/lang/String;
    :cond_2f
    ...
    const-string v6, " with eapMethod:"
    ...
    .line 3177
    .end local v21    # "currConfig":Landroid/net/wifi/WifiConfiguration;
    .end local v22    # "currEapMethod":I
    .end local v25    # "eapMethod":I
    .end local v26    # "enterpriseConfig":Landroid/net/wifi/WifiEnterpriseConfig;
    .end local v27    # "enterpriseFields":Ljava/util/HashMap;, "Ljava/util/HashMap<Ljava/lang/String;Ljava/lang/String;>;"
    .end local v31    # "i$":Ljava/util/Iterator;
    .end local v33    # "key":Ljava/lang/String;
    .end local v41    # "savedEnterpriseFields":Ljava/util/HashMap;, "Ljava/util/HashMap<Ljava/lang/String;Ljava/lang/String;>;"
    .end local v42    # "savedValue":Ljava/lang/String;
    ...
    .line 3196
    .restart local v23    # "currentConfig":Landroid/net/wifi/WifiConfiguration;
    if-nez v23, :cond_38

    .line 3197
    new-instance v23, Landroid/net/wifi/WifiConfiguration;

    .end local v23    # "currentConfig":Landroid/net/wifi/WifiConfiguration;
    invoke-direct/range {v23 .. v23}, Landroid/net/wifi/WifiConfiguration;-><init>()V
    ...
    iget-boolean v5, v0, Landroid/net/wifi/WifiConfiguration;->isTempCreated:Z

    move-object/from16 v0, v23

    iput-boolean v5, v0, Landroid/net/wifi/WifiConfiguration;->isTempCreated:Z
    ...
    .line 3238
    .local v29, "homeSP":Lcom/android/server/wifi/hotspot2/pps/HomeSP;
    invoke-virtual/range {p1 .. p1}, Landroid/net/wifi/WifiConfiguration;->isPasspoint()Z
    ...
    .line 3244
    .local v39, "roamingConsortiumId":Ljava/lang/Long;
    ...
    .end local v31    # "i$":I
    .end local v35    # "len$":I
    .end local v39    # "roamingConsortiumId":Ljava/lang/Long;
    :cond_39
    const/4 v5, 0x0
    ...
    .line 3252
    .end local v29    # "homeSP":Lcom/android/server/wifi/hotspot2/pps/HomeSP;
    ...
    .line 3326
    .local v38, "result":Lcom/android/server/wifi/NetworkUpdateResult;
    move-object/from16 v0, v38
    ...
    .end local v38    # "result":Lcom/android/server/wifi/NetworkUpdateResult;
    .end local v43    # "sb":Ljava/lang/StringBuilder;
    .restart local v29    # "homeSP":Lcom/android/server/wifi/hotspot2/pps/HomeSP;
    :catch_1
    move-exception v32
...
.method private isLastSelectedConfigNetwork(Landroid/net/wifi/WifiConfiguration;)Z
    .locals 2
    .param p1, "config"    # Landroid/net/wifi/WifiConfiguration;
    ...
    iget-object v1, p0, Lcom/android/server/wifi/WifiConfigStore;->lastSelectedConfiguration:Ljava/lang/String;
...
.method private readIpAndProxyConfigurations()V
    ...
    invoke-super {p0, v4}, Lcom/android/server/wifi/AbsWifiConfigStore;->readIpAndProxyConfigurations(Ljava/lang/String;)Landroid/util/SparseArray;
...
.method private readNetworkHistory()V
    ...
    :sswitch_2
    const-string v9, "CLOUD_SECURITY_CHECK"
    ...
    :sswitch_a
    const-string v9, "WIFI_PRO_TEMP_CREATE"
    ...
    :sswitch_b
    const-string v9, "INTERNET_HISTORY"
    ...
    :sswitch_c
    const-string v9, "PORTAL_NETWORK"
    ...
    :sswitch_d
    const-string v9, "LAST_HAS_INTERNET_TS"
    ...
    :goto_5
    iput v8, v14, Landroid/net/wifi/WifiConfiguration;->cloudSecurityCheck:I
    ...
    iput-boolean v8, v14, Landroid/net/wifi/WifiConfiguration;->isTempCreated:Z

    goto/16 :goto_0

    .line 2549
    :pswitch_c
    const-string v8, "INTERNET_HISTORY"
    ...
    iput-object v0, v14, Landroid/net/wifi/WifiConfiguration;->internetHistory:Ljava/lang/String;

    .line 2552
    :cond_c
    const-string v8, "PORTAL_NETWORK"
    ...
    iput-boolean v8, v14, Landroid/net/wifi/WifiConfiguration;->portalNetwork:Z

    .line 2555
    :cond_d
    const-string v8, "LAST_HAS_INTERNET_TS"
    ...
    iput-wide v8, v14, Landroid/net/wifi/WifiConfiguration;->lastHasInternetTimestamp:J

    .line 2558
    :cond_e
    iget-boolean v8, v14, Landroid/net/wifi/WifiConfiguration;->portalNetwork:Z
    ...
    :sswitch_data_0
    .sparse-switch
        -0x77e81a92 -> :sswitch_14
        -0x7719684c -> :sswitch_22
        -0x740b4755 -> :sswitch_2a
        -0x6fcb8415 -> :sswitch_a
        -0x6f46bcc5 -> :sswitch_1a
        -0x6f2cb82f -> :sswitch_9
        -0x622b2dfc -> :sswitch_8
        -0x4e1d22c5 -> :sswitch_c
        -0x488f99b1 -> :sswitch_d
        -0x41c84b47 -> :sswitch_1d
        -0x38535683 -> :sswitch_10
        -0x2f732002 -> :sswitch_13
        -0x2d6010b3 -> :sswitch_26
        -0x20eb6f12 -> :sswitch_7
        -0x18796e15 -> :sswitch_12
        -0x15f84296 -> :sswitch_1c
        0x1fe7ae -> :sswitch_24
        0x210a95 -> :sswitch_1
        0x210e78 -> :sswitch_23
        0x23a7fa -> :sswitch_1f
        ...
        0x26fb7b -> :sswitch_0
        0x1134293 -> :sswitch_2
        0x3c90abd -> :sswitch_20
        0x551d90b -> :sswitch_16
        0x94828e0 -> :sswitch_15
        0xb5a17ba -> :sswitch_1b
        0x141ecd1c -> :sswitch_19
        0x18e77cb7 -> :sswitch_27
        0x1ddf6a2d -> :sswitch_6
        0x1f1b4de6 -> :sswitch_5
        0x2c26c6de -> :sswitch_28
        0x2eae182d -> :sswitch_e
        0x3cbace17 -> :sswitch_4
        0x455dcbce -> :sswitch_3
        0x53fccfee -> :sswitch_25
        0x580b1670 -> :sswitch_17
        0x5af9fd76 -> :sswitch_b
        0x5fe59441 -> :sswitch_29
        0x5fe86c83 -> :sswitch_f
        0x72f01508 -> :sswitch_18
        0x7400e87d -> :sswitch_11
        0x767051a1 -> :sswitch_1e
    .end sparse-switch
...
.method private readNetworkVariableFromSupplicantFile(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 2098
    .local v2, "end":J
    sget-boolean v1, Lcom/android/server/wifi/WifiConfigStore;->HWLOGW_E:Z
...
.method private readNetworkVariables(Landroid/net/wifi/WifiConfiguration;)V
    ...
    .line 3965
    iput-object v7, p1, Landroid/net/wifi/WifiConfiguration;->oriSsid:Ljava/lang/String;
    ...
    .end local v4    # "key":Ljava/lang/String;
    :cond_e
    invoke-virtual {p0, p1, v6}, Lcom/android/server/wifi/WifiConfigStore;->setWifiConfigurationWapi(Landroid/net/wifi/WifiConfiguration;I)V
...
.method private readNetworkVariablesFromSupplicantFile(Ljava/lang/String;)Ljava/util/Map;
    ...
    .line 2041
    .local v4, "reader":Ljava/io/BufferedReader;
    sget-boolean v9, Lcom/android/server/wifi/WifiConfigStore;->HWLOGW_E:Z
    ...
    iget-object v10, p0, Lcom/android/server/wifi/WifiConfigStore;->SUPPLICANT_CONFIG_FILE:Ljava/lang/String;
    ...
    const-string v10, "Could not open "
...
.method private removeConfigAndSendBroadcastIfNeeded(I)Z
    ...
    .line 1517
    sget-boolean v2, Lcom/android/server/wifi/WifiConfigStore;->HWLOGW_E:Z
    ...
    .line 1556
    iget-object v2, p0, Lcom/android/server/wifi/WifiConfigStore;->mScanDetailCaches:Ljava/util/concurrent/ConcurrentHashMap;
...
.method private writeIpAndProxyConfigurations()V
    ...
    invoke-super {p0, v3, v2}, Lcom/android/server/wifi/AbsWifiConfigStore;->writeIpAndProxyConfigurations(Ljava/lang/String;Landroid/util/SparseArray;)V
...
.method addOrUpdateNetwork(Landroid/net/wifi/WifiConfiguration;I)I
    ...
    const-string v4, "set mLastPriority: old=="
    ...
    const-string v4, "to new network priority:"
...
.method disableNetwork(II)Z
    ...
    .line 1701
    .local v0, "config":Landroid/net/wifi/WifiConfiguration;
    iget-object v3, p0, Lcom/android/server/wifi/WifiConfigStore;->mWiFiCHRManager:Lcom/android/server/wifi/HwWifiCHRStateManager;
    ...
    invoke-virtual {v3, p2, p1}, Lcom/android/server/wifi/HwWifiCHRStateManager;->uploadFailureIfFailed(II)V
...
.method enableAllNetworks()V
    ...
    .line 965
    .local v0, "config":Landroid/net/wifi/WifiConfiguration;
    invoke-virtual {p0, v0}, Lcom/android/server/wifi/WifiConfigStore;->isAttWifi(Landroid/net/wifi/WifiConfiguration;)Z

    move-result v3

    if-eqz v3, :cond_1

    invoke-virtual {p0}, Lcom/android/server/wifi/WifiConfigStore;->isAutoConnect()Z
    ...
    const-string v6, "is attwifi and not auto-connect ,do nothing"
    ...
    invoke-static {v3, v0, v6}, Lcom/android/server/wifi/WifiConfigStoreUtils;->ignoreEnableNetwork(Landroid/content/Context;Landroid/net/wifi/WifiConfiguration;Lcom/android/server/wifi/WifiNative;)Z
...
.method public getLastPriorityWifiConfiguration()Landroid/net/wifi/WifiConfiguration;
    .locals 4
...
.method getMatchingConfig(Landroid/net/wifi/ScanResult;)Landroid/net/wifi/WifiConfiguration;
    ...
    .prologue
    .line 823
    iget-object v5, p0, Lcom/android/server/wifi/WifiConfigStore;->mScanDetailCaches:Ljava/util/concurrent/ConcurrentHashMap;
...
.method getRecentConfiguredNetworks(IZ)Ljava/util/List;
    ...
    .line 863
    .local v1, "config":Landroid/net/wifi/WifiConfiguration;
    invoke-direct {p0, v1}, Lcom/android/server/wifi/WifiConfigStore;->isLastSelectedConfigNetwork(Landroid/net/wifi/WifiConfiguration;)Z
    ...
    const-string v6, "autoJoinStatus is AUTO_JOIN_DELETED or ephemeral is true. "
    ...
    invoke-virtual {v1, v5}, Landroid/net/wifi/WifiConfiguration;->setVisibility(Landroid/net/wifi/WifiConfiguration$Visibility;)V

    .line 884
    iget-object v5, v1, Landroid/net/wifi/WifiConfiguration;->visibility:Landroid/net/wifi/WifiConfiguration$Visibility;
    ...
    const-string v6, "visibility is null. "
    ...
    const-string v6, "rssi5&rssi24 is invaild. "
    ...
    invoke-direct {v5, v1}, Landroid/net/wifi/WifiConfiguration;-><init>(Landroid/net/wifi/WifiConfiguration;)V
...
.method public getScanDetailCache(Landroid/net/wifi/WifiConfiguration;)Lcom/android/server/wifi/ScanDetailCache;
    ...
    check-cast v1, Lcom/android/server/wifi/ScanDetailCache;

    .line 3358
    .local v1, "sdc":Lcom/android/server/wifi/ScanDetailCache;
    if-eqz v1, :cond_0
...
.method public linkConfiguration(Landroid/net/wifi/WifiConfiguration;)V
    ...
    .line 3381
    .local v14, "link":Landroid/net/wifi/WifiConfiguration;
    const/4 v10, 0x0
    ...
    .line 3387
    iget v2, v14, Landroid/net/wifi/WifiConfiguration;->autoJoinStatus:I

    const/16 v3, 0xc8

    if-eq v2, v3, :cond_2

    iget-boolean v2, v14, Landroid/net/wifi/WifiConfiguration;->ephemeral:Z
    ...
    .line 3398
    .local v15, "linkedScanDetailCache":Lcom/android/server/wifi/ScanDetailCache;
    if-eqz v15, :cond_3
    ...
    iget-object v2, v14, Landroid/net/wifi/WifiConfiguration;->defaultGwMacAddress:Ljava/lang/String;
    ...
    iget-object v3, v14, Landroid/net/wifi/WifiConfiguration;->defaultGwMacAddress:Ljava/lang/String;
    ...
    iget-object v3, v14, Landroid/net/wifi/WifiConfiguration;->SSID:Ljava/lang/String;
    ...
    .line 3440
    invoke-direct/range {p0 .. p0}, Lcom/android/server/wifi/WifiConfigStore;->getCredentialsBySsidMap()Ljava/util/Map;
    ...
    .line 3459
    :cond_8
    iget-object v2, v14, Landroid/net/wifi/WifiConfiguration;->linkedConfigurations:Ljava/util/HashMap;
    ...
    iput-object v2, v14, Landroid/net/wifi/WifiConfiguration;->linkedConfigurations:Ljava/util/HashMap;
    ...
    iput-boolean v2, v14, Landroid/net/wifi/WifiConfiguration;->dirty:Z
    ...
    invoke-virtual {v15}, Lcom/android/server/wifi/ScanDetailCache;->keySet()Ljava/util/Collection;
...
.method loadConfiguredNetworks()V
    ...
    iget-object v0, v0, Lcom/android/server/wifi/WifiConfigStore;->mScanDetailCaches:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-virtual/range {v20 .. v20}, Ljava/util/concurrent/ConcurrentHashMap;->clear()V
    ...
    iget-object v0, v0, Lcom/android/server/wifi/WifiConfigStore;->SUPPLICANT_CONFIG_FILE:Ljava/lang/String;
    ...
    iget-object v0, v0, Lcom/android/server/wifi/WifiConfigStore;->SUPPLICANT_CONFIG_FILE_BACKUP:Ljava/lang/String;
...
.method saveNetwork(Landroid/net/wifi/WifiConfiguration;I)Lcom/android/server/wifi/NetworkUpdateResult;
    ...
    .line 1146
    sget-boolean v6, Lcom/android/server/wifi/WifiConfigStore;->HWLOGW_E:Z
...
.method selectNetwork(Landroid/net/wifi/WifiConfiguration;ZI)Z
    ...
    .line 1069
    :cond_2
    sget-boolean v5, Lcom/android/server/wifi/WifiConfigStore;->HWLOGW_E:Z
...
.method public updateSavedNetworkHistory(Lcom/android/server/wifi/ScanDetail;)Z
    ...
    invoke-virtual {v1}, Landroid/net/wifi/WifiConfiguration;->configKeyNotIncludeSSID()Ljava/lang/String;
