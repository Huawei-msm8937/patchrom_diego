...
.method public enter()V
    ...
    invoke-static {v0}, Lcom/android/server/wifi/WifiStateMachine;->access$2800(Lcom/android/server/wifi/WifiStateMachine;)Z
    ...
    invoke-virtual {v0}, Lcom/android/server/wifi/WifiStateMachine;->handleDisconnectedInWifiPro()V
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/wifi/WifiStateMachine;->handleStopWifiRepeater(Lcom/android/internal/util/AsyncChannel;)V
    ...
    invoke-static {v0}, Lcom/android/server/wifi/WifiStateMachine;->access$26600(Lcom/android/server/wifi/WifiStateMachine;)I
    ...
    invoke-static {v0}, Lcom/android/server/wifi/WifiStateMachine;->access$2700(Lcom/android/server/wifi/WifiStateMachine;)Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-static {v0, v2, v3}, Lcom/android/server/wifi/WifiStateMachine;->access$26802(Lcom/android/server/wifi/WifiStateMachine;J)J

    .line 10334
    iget-object v0, p0, Lcom/android/server/wifi/WifiStateMachine$DisconnectedState;->this$0:Lcom/android/server/wifi/WifiStateMachine;

    invoke-virtual {v0}, Lcom/android/server/wifi/WifiStateMachine;->startScreenOffScan()V

    .line 10336
    iget-object v0, p0, Lcom/android/server/wifi/WifiStateMachine$DisconnectedState;->this$0:Lcom/android/server/wifi/WifiStateMachine;

    # setter for: Lcom/android/server/wifi/WifiStateMachine;->mDisconnectedPnoAlarmCount:I
    invoke-static {v0, v4}, Lcom/android/server/wifi/WifiStateMachine;->access$26902(Lcom/android/server/wifi/WifiStateMachine;I)I
    ...
    invoke-static {v0, v1}, Lcom/android/server/wifi/WifiStateMachine;->access$26500(Lcom/android/server/wifi/WifiStateMachine;I)V
    ...
    invoke-static {v0, v5}, Lcom/android/server/wifi/WifiStateMachine;->access$23400(Lcom/android/server/wifi/WifiStateMachine;Z)V
...
.method public exit()V
    ...
    iget-boolean v0, v0, Lcom/android/server/wifi/WifiStateMachine;->mScanUpdate:Z
    ...
    iput v2, v0, Lcom/android/server/wifi/WifiStateMachine;->mFrameworkShortScanCount:I
    ...
    const-string v1, "wifi smartscan: reset by DisconnectedState exit"
    ...
    # setter for: Lcom/android/server/wifi/WifiStateMachine;->mDisconnectedPnoAlarmCount:I
    invoke-static {v0, v2}, Lcom/android/server/wifi/WifiStateMachine;->access$26902(Lcom/android/server/wifi/WifiStateMachine;I)I

    .line 10627
    iget-object v0, p0, Lcom/android/server/wifi/WifiStateMachine$DisconnectedState;->this$0:Lcom/android/server/wifi/WifiStateMachine;

    invoke-virtual {v0, v2}, Lcom/android/server/wifi/WifiStateMachine;->enableBackgroundScan(Z)Z

    .line 10628
    iget-object v0, p0, Lcom/android/server/wifi/WifiStateMachine$DisconnectedState;->this$0:Lcom/android/server/wifi/WifiStateMachine;

    # invokes: Lcom/android/server/wifi/WifiStateMachine;->setScanAlarm(Z)V
    invoke-static {v0, v2}, Lcom/android/server/wifi/WifiStateMachine;->access$23400(Lcom/android/server/wifi/WifiStateMachine;Z)V
    ...
    invoke-static {v1}, Lcom/android/server/wifi/WifiStateMachine;->access$16800(Lcom/android/server/wifi/WifiStateMachine;)Landroid/app/PendingIntent;
...
.method public processMessage(Landroid/os/Message;)Z
    ...
    invoke-virtual {v2, v0}, Lcom/android/server/wifi/WifiStateMachine;->processScreenOffScan(Landroid/os/Message;)Z
    ...
    invoke-static {v6}, Lcom/android/server/wifi/WifiStateMachine;->access$27004(Lcom/android/server/wifi/WifiStateMachine;)I
    ...
    invoke-static {v4}, Lcom/android/server/wifi/WifiStateMachine;->access$27100(Lcom/android/server/wifi/WifiStateMachine;)I
    ...
    # getter for: Lcom/android/server/wifi/WifiStateMachine;->mNoNetworksPeriodicScan:I
    invoke-static {v4}, Lcom/android/server/wifi/WifiStateMachine;->access$26600(Lcom/android/server/wifi/WifiStateMachine;)I
    ...
    invoke-virtual {v2, v0}, Lcom/android/server/wifi/WifiStateMachine;->processDisconnectedSetMode(Landroid/os/Message;)Z
    ...
    const-string v3, "DisconnectedState process CMD_SET_OPERATIONAL_MODE"
    ...
    const-string v3, "Can not enter ScanModeState when screen on"
    ...
    invoke-static {v2, v0}, Lcom/android/server/wifi/WifiStateMachine;->access$27300(Lcom/android/server/wifi/WifiStateMachine;Landroid/os/Message;)Z
    ...
    invoke-static {v2}, Lcom/android/server/wifi/WifiStateMachine;->access$26908(Lcom/android/server/wifi/WifiStateMachine;)I
    ...
    # getter for: Lcom/android/server/wifi/WifiStateMachine;->mPnoIntent:Landroid/app/PendingIntent;
    invoke-static {v4}, Lcom/android/server/wifi/WifiStateMachine;->access$16800(Lcom/android/server/wifi/WifiStateMachine;)Landroid/app/PendingIntent;
    ...
    invoke-static {v2, v3, v4, v6}, Lcom/android/server/wifi/WifiStateMachine;->access$24500(Lcom/android/server/wifi/WifiStateMachine;ILandroid/net/wifi/ScanSettings;Landroid/os/WorkSource;)V
    ...
    invoke-direct {v8, v2}, Landroid/net/wifi/WifiConfiguration;-><init>(Landroid/net/wifi/WifiConfiguration;)V
    ...
    invoke-virtual {v8, v3}, Landroid/net/wifi/WifiConfiguration;->configKey(Z)Ljava/lang/String;

    move-result-object v3

    # setter for: Lcom/android/server/wifi/WifiStateMachine;->mTls12ConfKey:Ljava/lang/String;
    invoke-static {v2, v3}, Lcom/android/server/wifi/WifiStateMachine;->access$27502(Lcom/android/server/wifi/WifiStateMachine;Ljava/lang/String;)Ljava/lang/String;
