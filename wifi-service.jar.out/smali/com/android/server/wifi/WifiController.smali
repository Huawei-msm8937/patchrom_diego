...
.super Lcom/android/server/wifi/AbsWifiController;
...
# static fields
.field public static final ACTION_DELAY_DEVICE_IDLE:Ljava/lang/String; = "com.android.server.WifiManager.action.DELAY_DEVICE_IDLE"

.field private static final ACTION_DEVICE_IDLE:Ljava/lang/String; = "com.android.server.WifiManager.action.DEVICE_IDLE"

.field public static final ACTION_START_WIFI_FAILED:Ljava/lang/String; = "com.android.server.wifi.action.START_WIFI_FAILED"

.field private static final BASE:I = 0x26000

.field static final CMD_AIRPLANE_TOGGLED:I = 0x26009

.field static final CMD_AP_START_FAILURE:I = 0x2600e

.field static final CMD_BATTERY_CHANGED:I = 0x26004

.field static final CMD_DEFERRED_TOGGLE:I = 0x2600b

.field static final CMD_DELAY_DEVICE_IDLE:I = 0x2600d
...
.field private mDelayIdleIntent:Landroid/app/PendingIntent;
...
.method static constructor <clinit>()V
    ...
    :goto_0
    sput-boolean v0, Lcom/android/server/wifi/WifiController;->HWFLOW:Z

    .line 66
    sget-boolean v0, Lcom/android/server/wifi/WifiController;->HWFLOW:Z
...
.method constructor <init>(Landroid/content/Context;Lcom/android/server/wifi/WifiServiceImpl;Landroid/os/Looper;)V
    ...
    invoke-direct {p0, v6, p3}, Lcom/android/server/wifi/AbsWifiController;-><init>(Ljava/lang/String;Landroid/os/Looper;)V
    ...
    const-string v6, "com.android.server.WifiManager.action.DELAY_DEVICE_IDLE"

    invoke-direct {v0, v6, v11}, Landroid/content/Intent;-><init>(Ljava/lang/String;Landroid/net/Uri;)V

    .line 183
    .local v0, "delayIdleIntent":Landroid/content/Intent;
    iget-object v6, p0, Lcom/android/server/wifi/WifiController;->mContext:Landroid/content/Context;
    ...
    iput-object v6, p0, Lcom/android/server/wifi/WifiController;->mDelayIdleIntent:Landroid/app/PendingIntent;
    ...
    .line 221
    const-string v6, "com.android.server.wifi.action.START_WIFI_FAILED"
...
.method static synthetic access$1400(Lcom/android/server/wifi/WifiController;)I
    .locals 1
    .param p0, "x0"    # Lcom/android/server/wifi/WifiController;
...
.method static synthetic access$1402(Lcom/android/server/wifi/WifiController;I)I
    .locals 0
    .param p0, "x0"    # Lcom/android/server/wifi/WifiController;
    .param p1, "x1"    # I
...
.method static synthetic access$1500(Lcom/android/server/wifi/WifiController;I)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/server/wifi/WifiController;
    .param p1, "x1"    # I
...
.method static synthetic access$1600(Lcom/android/server/wifi/WifiController;)J
    .locals 2
    .param p0, "x0"    # Lcom/android/server/wifi/WifiController;
...
.method static synthetic access$1700(Lcom/android/server/wifi/WifiController;)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/server/wifi/WifiController;
...
.method static synthetic access$1702(Lcom/android/server/wifi/WifiController;Z)Z
    .locals 0
    .param p0, "x0"    # Lcom/android/server/wifi/WifiController;
    .param p1, "x1"    # Z
...
.method static synthetic access$3700(Lcom/android/server/wifi/WifiController;)Lcom/android/server/wifi/WifiController$ApStaDisabledState;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/wifi/WifiController;
...
.method static synthetic access$400(Lcom/android/server/wifi/WifiController;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/wifi/WifiController;
...
.method static synthetic access$6100(Lcom/android/server/wifi/WifiController;Landroid/os/Message;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/wifi/WifiController;
    .param p1, "x1"    # Landroid/os/Message;
...
.method static synthetic access$6500(Lcom/android/server/wifi/WifiController;Landroid/os/Message;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/wifi/WifiController;
    .param p1, "x1"    # Landroid/os/Message;
...
.method static synthetic access$800(Lcom/android/server/wifi/WifiController;)Landroid/app/PendingIntent;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/wifi/WifiController;

    .prologue
    .line 61
    iget-object v0, p0, Lcom/android/server/wifi/WifiController;->mDelayIdleIntent:Landroid/app/PendingIntent;
...
.method static synthetic access$900(Lcom/android/server/wifi/WifiController;)Landroid/app/AlarmManager;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/wifi/WifiController;
...
.method private shouldWifiStayAwake(I)Z
    ...
    .line 360
    invoke-static {v4}, Landroid/net/wifi/HiSiWifiComm;->writeSleepOption(I)V
    ...
    .line 369
    invoke-static {v0}, Landroid/net/wifi/HiSiWifiComm;->writeSleepOption(I)V
    ...
    invoke-static {v1}, Landroid/net/wifi/HiSiWifiComm;->writeSleepOption(I)V

    .line 381
    :cond_4
    invoke-virtual {p0}, Lcom/android/server/wifi/WifiController;->isWifiRepeaterStarted()Z
...
.method public dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    .prologue
    .line 1050
    invoke-super {p0, p1, p2, p3}, Lcom/android/server/wifi/AbsWifiController;->dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
