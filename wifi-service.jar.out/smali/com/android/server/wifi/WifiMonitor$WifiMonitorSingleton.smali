...
# static fields
.field private static final SLEEP_TIME_RETRY:[I
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/server/wifi/WifiMonitor$WifiMonitorSingleton;->SLEEP_TIME_RETRY:[I
...
.method static synthetic access$1200(Lcom/android/server/wifi/WifiMonitor$WifiMonitorSingleton;)Z
    .locals 1
...
.method static synthetic access$1300(Lcom/android/server/wifi/WifiMonitor$WifiMonitorSingleton;Ljava/lang/String;)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/server/wifi/WifiMonitor$WifiMonitorSingleton;
...
.method private declared-synchronized dispatchEvent(Ljava/lang/String;)Z
    ...
    const-string v11, "Dispatching event to interface: "
    ...
    invoke-static {v6, p1, v3}, Lcom/android/server/wifi/WifiMonitor;->access$700(Lcom/android/server/wifi/WifiMonitor;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    const-string v11, "Not finish, Interface Name:"
    ...
    invoke-static {v7}, Lcom/android/server/wifi/WifiMonitor;->access$800(Lcom/android/server/wifi/WifiMonitor;)Ljava/lang/String;
    ...
    .line 828
    .restart local v7    # "monitor":Lcom/android/server/wifi/WifiMonitor;
    # getter for: Lcom/android/server/wifi/WifiMonitor;->mMonitoring:Z
    invoke-static {v7}, Lcom/android/server/wifi/WifiMonitor;->access$100(Lcom/android/server/wifi/WifiMonitor;)Z
    ...
    .line 830
    # invokes: Lcom/android/server/wifi/WifiMonitor;->dispatchEvent(Ljava/lang/String;Ljava/lang/String;)Z
    invoke-static {v7, p1, v3}, Lcom/android/server/wifi/WifiMonitor;->access$700(Lcom/android/server/wifi/WifiMonitor;Ljava/lang/String;Ljava/lang/String;)Z
...
.method public declared-synchronized startMonitoring(Ljava/lang/String;)Z
    ...
    const-string v5, ") failed!, wlan0 interface restarted"
    ...
    .line 693
    .restart local v1    # "m":Lcom/android/server/wifi/WifiMonitor;
    :cond_2
    :try_start_2
    # getter for: Lcom/android/server/wifi/WifiMonitor;->DBG:Z
    invoke-static {}, Lcom/android/server/wifi/WifiMonitor;->access$300()Z
    ...
    .line 701
    new-instance v2, Lcom/android/server/wifi/WifiMonitor$MonitorThread;

    iget-object v4, p0, Lcom/android/server/wifi/WifiMonitor$WifiMonitorSingleton;->mWifiNative:Lcom/android/server/wifi/WifiNative;

    invoke-direct {v2, v4, p0}, Lcom/android/server/wifi/WifiMonitor$MonitorThread;-><init>(Lcom/android/server/wifi/WifiNative;Lcom/android/server/wifi/WifiMonitor$WifiMonitorSingleton;)V

    # setter for: Lcom/android/server/wifi/WifiMonitor;->mMonitorThread:Lcom/android/server/wifi/WifiMonitor$MonitorThread;
    invoke-static {v2}, Lcom/android/server/wifi/WifiMonitor;->access$402(Lcom/android/server/wifi/WifiMonitor$MonitorThread;)Lcom/android/server/wifi/WifiMonitor$MonitorThread;
    ...
    invoke-virtual {v2}, Lcom/android/server/wifi/WifiMonitor$MonitorThread;->start()V

    .line 703
    new-instance v2, Lcom/android/server/wifi/WifiMonitor$WatchdogThread;

    invoke-direct {v2}, Lcom/android/server/wifi/WifiMonitor$WatchdogThread;-><init>()V

    invoke-virtual {v2}, Lcom/android/server/wifi/WifiMonitor$WatchdogThread;->start()V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
    ...
    const-string v6, "startMonitoring connectTries sleep:"

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    sget-object v6, Lcom/android/server/wifi/WifiMonitor$WifiMonitorSingleton;->SLEEP_TIME_RETRY:[I
    ...
    .line 711
    sget-object v4, Lcom/android/server/wifi/WifiMonitor$WifiMonitorSingleton;->SLEEP_TIME_RETRY:[I
