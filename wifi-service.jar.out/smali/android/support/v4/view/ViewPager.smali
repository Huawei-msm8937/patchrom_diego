...
.field private mHwViewPager:Landroid/support/v4/interfaces/HwControlFactory$HwViewPager;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 268
    iput-boolean v1, p0, Landroid/support/v4/view/ViewPager;->isLayoutRtl:Z
...
.method private determineTargetPage(IFII)I
    ...
    .prologue
    .line 2349
    iget-boolean v4, p0, Landroid/support/v4/view/ViewPager;->isLayoutRtl:Z
...
.method private infoForCurrentScrollPosition()Landroid/support/v4/view/ViewPager$ItemInfo;
    ...
    .line 2309
    .local v0, "first":Z
    iget-boolean v13, p0, Landroid/support/v4/view/ViewPager;->isLayoutRtl:Z
...
.method private pageScrolled(I)Z
    ...
    iget-boolean v7, p0, Landroid/support/v4/view/ViewPager;->isLayoutRtl:Z
...
.method private performDrag(F)Z
    ...
    iget v15, v0, Landroid/support/v4/view/ViewPager;->mLastMotionX:F
    ...
    iget v15, v3, Landroid/support/v4/view/ViewPager$ItemInfo;->position:I
    ...
    iget-boolean v15, v0, Landroid/support/v4/view/ViewPager;->isLayoutRtl:Z
    ...
    .line 2246
    :goto_0
    iget v15, v3, Landroid/support/v4/view/ViewPager$ItemInfo;->offset:F
    ...
    iget-object v15, v0, Landroid/support/v4/view/ViewPager;->mHwViewPager:Landroid/support/v4/interfaces/HwControlFactory$HwViewPager;
    ...
    invoke-interface {v15, v0, v8, v2, v6}, Landroid/support/v4/interfaces/HwControlFactory$HwViewPager;->scrollEdgeBound(ZFFF)F
    ...
    iput v15, v0, Landroid/support/v4/view/ViewPager;->mLastMotionX:F
    ...
    invoke-virtual {v0, v15, v1}, Landroid/support/v4/view/ViewPager;->scrollTo(II)V
    ...
    invoke-direct {v0, v15}, Landroid/support/v4/view/ViewPager;->pageScrolled(I)Z
    ...
    iget-object v15, v0, Landroid/support/v4/view/ViewPager;->mLeftEdge:Landroid/support/v4/widget/EdgeEffectCompat;
    ...
    invoke-interface {v15, v0, v8, v2, v11}, Landroid/support/v4/interfaces/HwControlFactory$HwViewPager;->scrollEdgeBound(ZFFF)F
    ...
    iget-object v15, v0, Landroid/support/v4/view/ViewPager;->mRightEdge:Landroid/support/v4/widget/EdgeEffectCompat;
...
.method private scrollToItem(IZIZ)V
    ...
    :cond_0
    iget-boolean v3, p0, Landroid/support/v4/view/ViewPager;->isLayoutRtl:Z
...
.method public endFakeDrag()V
    ...
    iget v11, p0, Landroid/support/v4/view/ViewPager;->mMaximumVelocity:I
    ...
    .line 2518
    .local v0, "currentPage":I
    iget-boolean v9, p0, Landroid/support/v4/view/ViewPager;->isLayoutRtl:Z
    ...
    iget v11, p0, Landroid/support/v4/view/ViewPager;->mInitialMotionX:F
    ...
    .line 2523
    .local v3, "nextPage":I
    invoke-virtual {p0, v3, v10, v10, v2}, Landroid/support/v4/view/ViewPager;->setCurrentItemInternal(IZZI)V
...
.method initViewPager()V
    ...
    .line 380
    invoke-static {v1}, Landroid/support/v4/interfaces/HwControlFactory;->getHwViewPager(Landroid/content/Context;)Landroid/support/v4/interfaces/HwControlFactory$HwViewPager;

    move-result-object v4

    iput-object v4, p0, Landroid/support/v4/view/ViewPager;->mHwViewPager:Landroid/support/v4/interfaces/HwControlFactory$HwViewPager;

    .line 381
    iget-object v4, p0, Landroid/support/v4/view/ViewPager;->mHwViewPager:Landroid/support/v4/interfaces/HwControlFactory$HwViewPager;
    ...
    invoke-interface {v4, v1}, Landroid/support/v4/interfaces/HwControlFactory$HwViewPager;->createScroller(Landroid/content/Context;)Landroid/widget/Scroller;
    ...
    .line 386
    .local v2, "curentLang":Ljava/lang/String;
    const-string v4, "ar"
    ...
    .line 387
    :cond_1
    iput-boolean v6, p0, Landroid/support/v4/view/ViewPager;->isLayoutRtl:Z
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    const-string v1, "pointerIndex out of range, pointerIndex = -1"
...
.method protected onLayout(ZIIII)V
    ...
    iget-boolean v0, v0, Landroid/support/v4/view/ViewPager;->isLayoutRtl:Z
...
.method protected onPageScrolled(IFI)V
    ...
    .line 1753
    .local v8, "lp":Landroid/support/v4/view/ViewPager$LayoutParams;
    iget-boolean v14, v8, Landroid/support/v4/view/ViewPager$LayoutParams;->isDecor:Z
    ...
    .line 1755
    :cond_1
    iget v14, v8, Landroid/support/v4/view/ViewPager$LayoutParams;->gravity:I
    ...
    .end local v7    # "i":I
    .end local v8    # "lp":Landroid/support/v4/view/ViewPager$LayoutParams;
    ...
    iget-object v14, v0, Landroid/support/v4/view/ViewPager;->mPageTransformer:Landroid/support/v4/view/ViewPager$PageTransformer;
    ...
    .line 1792
    .restart local v8    # "lp":Landroid/support/v4/view/ViewPager$LayoutParams;
    iget-boolean v14, v8, Landroid/support/v4/view/ViewPager$LayoutParams;->isDecor:Z
    ...
    .line 1795
    .local v12, "transformPos":F
    move-object/from16 v0, p0

    iget-object v14, v0, Landroid/support/v4/view/ViewPager;->mPageTransformer:Landroid/support/v4/view/ViewPager$PageTransformer;

    invoke-interface {v14, v2, v12}, Landroid/support/v4/view/ViewPager$PageTransformer;->transformPage(Landroid/view/View;F)V
    ...
    iget-object v14, v0, Landroid/support/v4/view/ViewPager;->mHwViewPager:Landroid/support/v4/interfaces/HwControlFactory$HwViewPager;
    ...
    invoke-interface {v14, v0, v1}, Landroid/support/v4/interfaces/HwControlFactory$HwViewPager;->tabScrollerFollowed(IF)V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    const-string v25, "pointerIndex out of range, pointerIndex = -1"
    ...
    const-string v25, "activePointerIndex out of range, activePointerIndex = -1"
    ...
    const-string v25, "index out of range, index = -1"
