...
.field private static final H_ABNORMAL_SD_BROADCAST:I = 0x8
...
.field private mCustMountService:Lcom/android/server/HwCustMountService;
...
.field private final mToVoldBroadcastReceiver:Landroid/content/BroadcastReceiver;
...
.field private mUserStartedFinish:Z
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 164
    const-class v2, Lcom/android/server/HwCustMountService;
    ...
    check-cast v2, Lcom/android/server/HwCustMountService;

    move-object/from16 v0, p0

    iput-object v2, v0, Lcom/android/server/MountService;->mCustMountService:Lcom/android/server/HwCustMountService;
    ...
    iput-boolean v2, v0, Lcom/android/server/MountService;->mUserStartedFinish:Z
    ...
    iput v2, v0, Lcom/android/server/MountService;->mCurrentUserId:I
    ...
    iput-object v2, v0, Lcom/android/server/MountService;->mToVoldBroadcastReceiver:Landroid/content/BroadcastReceiver;
    ...
    iget-object v3, v0, Lcom/android/server/MountService;->mToVoldBroadcastReceiver:Landroid/content/BroadcastReceiver;
    ...
    .line 1509
    .end local v9    # "bootFilter":Landroid/content/IntentFilter;
...
.method static synthetic access$1400(Lcom/android/server/MountService;)Z
    ...
    .prologue
    .line 158
    iget-boolean v0, p0, Lcom/android/server/MountService;->mUserStartedFinish:Z
...
.method static synthetic access$2000(Lcom/android/server/MountService;)V
    ...
    .prologue
    .line 158
    invoke-direct {p0}, Lcom/android/server/MountService;->bootCompleteToVold()V
...
.method private bootCompleteToVold()V
    .locals 7
    ...
    :try_start_0
    const-string v2, "begin send BootCompleteToVold"
    ...
    const-string v1, "vold not realizate bootcom"

    invoke-static {v6, v1}, Landroid/util/Flog;->e(ILjava/lang/String;)I
...
.method private handleDaemonConnected()V
    ...
    .line 958
    :cond_1
    iget-object v0, p0, Lcom/android/server/MountService;->mCustMountService:Lcom/android/server/HwCustMountService;
    ...
    const-string v1, "physicalWarnOnNotMounted , start "
    ...
    invoke-virtual {v0, v1, v2}, Lcom/android/server/HwCustMountService;->physicalWarnOnNotMounted(Landroid/util/ArrayMap;Lcom/android/server/NativeDaemonConnector;)V
...
.method private onEventLocked(ILjava/lang/String;[Ljava/lang/String;)Z
    ...
    .line 1017
    .local v8, "cookedBuilder":Ljava/lang/StringBuilder;
    const-string v38, "onEvent::"
    ...
    invoke-static/range {v38 .. v39}, Landroid/util/Flog;->i(ILjava/lang/String;)I

    .line 1028
    sparse-switch p1, :sswitch_data_0

    .line 1237
    const-string v38, "MountService"

    new-instance v39, Ljava/lang/StringBuilder;

    invoke-direct/range {v39 .. v39}, Ljava/lang/StringBuilder;-><init>()V

    const-string v40, "Unhandled vold event "
    ...
    .line 1034
    .local v18, "flags":I
    const-string v38, "persist.fw.force_adoptable"
    ...
    new-instance v39, Landroid/os/storage/DiskInfo;
    ...
    invoke-virtual/range {v38 .. v39}, Landroid/util/ArrayMap;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iput-wide v0, v9, Landroid/os/storage/DiskInfo;->size:J
    ...
    .line 1052
    .restart local v9    # "disk":Landroid/os/storage/DiskInfo;
    if-eqz v9, :cond_1
    ...
    iput-object v0, v9, Landroid/os/storage/DiskInfo;->label:Ljava/lang/String;
    ...
    invoke-direct {v0, v9}, Lcom/android/server/MountService;->onDiskScannedLocked(Landroid/os/storage/DiskInfo;)V
    ...
    iput-object v0, v9, Landroid/os/storage/DiskInfo;->sysPath:Ljava/lang/String;
    ...
    invoke-virtual/range {v38 .. v39}, Landroid/util/ArrayMap;->remove(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {v0, v9}, Lcom/android/server/MountService$Callbacks;->access$1700(Lcom/android/server/MountService$Callbacks;Landroid/os/storage/DiskInfo;)V
    ...
    invoke-static/range {v38 .. v38}, Landroid/text/TextUtils;->nullIfEmpty(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v14

    .line 1090
    .local v14, "diskId":Ljava/lang/String;
    const/16 v38, 0x4
    ...
    .line 1092
    .local v27, "partGuid":Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    .line 1093
    .restart local v9    # "disk":Landroid/os/storage/DiskInfo;
    new-instance v37, Landroid/os/storage/VolumeInfo;
    ...
    invoke-direct {v0, v1, v2, v9, v3}, Landroid/os/storage/VolumeInfo;-><init>(Ljava/lang/String;ILandroid/os/storage/DiskInfo;Ljava/lang/String;)V

    .line 1094
    .local v37, "vol":Landroid/os/storage/VolumeInfo;
    move-object/from16 v0, p0
    ...
    .line 1099
    .end local v9    # "disk":Landroid/os/storage/DiskInfo;
    .end local v14    # "diskId":Ljava/lang/String;
    .end local v21    # "id":Ljava/lang/String;
    .end local v27    # "partGuid":Ljava/lang/String;
    .end local v36    # "type":I
    .end local v37    # "vol":Landroid/os/storage/VolumeInfo;
    :sswitch_7
    move-object/from16 v0, p3
    ...
    check-cast v37, Landroid/os/storage/VolumeInfo;

    .line 1101
    .restart local v37    # "vol":Landroid/os/storage/VolumeInfo;
    if-eqz v37, :cond_1
    ...
    .line 1110
    .end local v25    # "newState":I
    .end local v26    # "oldState":I
    .end local v37    # "vol":Landroid/os/storage/VolumeInfo;
    :sswitch_8
    move-object/from16 v0, p3
    ...
    aget-object v28, p3, v38

    .line 1167
    .local v28, "path":Ljava/lang/String;
    const/16 v38, 0x2

    aget-object v22, p3, v38

    .line 1168
    .local v22, "ident":Ljava/lang/String;
    const/16 v38, 0x3
    ...
    const-class v39, Landroid/os/DropBoxManager;

    invoke-virtual/range {v38 .. v39}, Landroid/content/Context;->getSystemService(Ljava/lang/Class;)Ljava/lang/Object;
    ...
    .line 1175
    .local v15, "dropBox":Landroid/os/DropBoxManager;
    if-eqz v15, :cond_6

    .line 1176
    const-string v38, "storage_benchmark"
    ...
    invoke-virtual {v15, v0, v1}, Landroid/os/DropBoxManager;->addText(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 1182
    .local v29, "rec":Landroid/os/storage/VolumeRecord;
    if-eqz v29, :cond_1
    ...
    .line 1190
    .end local v10    # "create":J
    .end local v12    # "destroy":J
    .end local v15    # "dropBox":Landroid/os/DropBoxManager;
    .end local v16    # "drop":J
    .end local v22    # "ident":Ljava/lang/String;
    .end local v28    # "path":Ljava/lang/String;
    .end local v29    # "rec":Landroid/os/storage/VolumeRecord;
    .end local v30    # "run":J
    :sswitch_10
    move-object/from16 v0, p3
    ...
    .line 1197
    .restart local v15    # "dropBox":Landroid/os/DropBoxManager;
    if-eqz v15, :cond_7

    .line 1198
    const-string v38, "storage_trim"
    ...
    .line 1204
    .restart local v29    # "rec":Landroid/os/storage/VolumeRecord;
    if-eqz v29, :cond_1
    ...
    .line 1224
    .restart local v25    # "newState":I
    new-instance v23, Landroid/content/Intent;

    const-string v38, "android.intent.action.MEDIA_ABNORMAL_SD"
    ...
    const-string v38, "storage_volume"
    ...
    .line 1226
    const-string v38, "android.os.storage.extra.VOLUME_OLD_STATE"
    ...
    .line 1227
    const-string v38, "android.os.storage.extra.VOLUME_NEW_STATE"
    ...
    const-string v40, "AbNormal SD card volumeInfo = "

    invoke-virtual/range {v39 .. v40}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v39

    invoke-virtual/range {v37 .. v37}, Landroid/os/storage/VolumeInfo;->toString()Ljava/lang/String;
...
.method private onStartUser(I)V
    ...
    const-string v6, "hava send user_started to vold , userId = "
    ...
    .line 879
    iput-boolean v9, p0, Lcom/android/server/MountService;->mUserStartedFinish:Z
...
.method private onVolumeStateChangedLocked(Landroid/os/storage/VolumeInfo;II)V
    ...
    const-string v15, "onVolumeStateChangedLocked volumeInfo = "
    ...
    invoke-static {v13, v14}, Landroid/util/Flog;->i(ILjava/lang/String;)I
...
.method public mkdirs(Ljava/lang/String;Ljava/lang/String;)I
    ...
    invoke-static {v7, v0}, Landroid/os/FileUtils;->contains([Ljava/io/File;Ljava/io/File;)Z
...
.method public mount(Ljava/lang/String;)V
    ...
    invoke-static {v2}, Landroid/hdm/HwDeviceManager;->disallowOp(I)Z
    ...
    const-string v3, "Usb mass device is disabled by dpm"
    ...
    const-string v4, " failed because of USB otg is disabled by dpm"
...
.method public unmount(Ljava/lang/String;)V
    ...
    iget-object v4, p0, Lcom/android/server/MountService;->mCustMountService:Lcom/android/server/HwCustMountService;

    if-eqz v4, :cond_1

    iget-object v4, p0, Lcom/android/server/MountService;->mCustMountService:Lcom/android/server/HwCustMountService;

    invoke-virtual {v4, v1}, Lcom/android/server/HwCustMountService;->isSdVol(Landroid/os/storage/VolumeInfo;)Z
...
.method public unmountSecureContainer(Ljava/lang/String;Z)I
    ...
    invoke-virtual {v4}, Lcom/android/server/HwCustMountService;->isSdInstallEnabled()Z
