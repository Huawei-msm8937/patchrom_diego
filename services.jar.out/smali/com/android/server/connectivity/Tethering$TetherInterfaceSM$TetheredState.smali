...
.method private cleanupUpstream()V
    ...
    const-string v3, "cleanupUpstream disableNat("
    ...
    # getter for: Lcom/android/server/connectivity/Tethering;->HWLOGW_E:Z
...
.method public enter()V
    ...
    const-string v3, "TetheredState enter"
    ...
    invoke-virtual {v2, v3}, Lcom/android/server/connectivity/Tethering;->isWifi(Ljava/lang/String;)Z
    ...
    invoke-static {v2, v3}, Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->access$800(Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;Z)V

    .line 1101
    iget-object v2, p0, Lcom/android/server/connectivity/Tethering$TetherInterfaceSM$TetheredState;->this$1:Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;

    # invokes: Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->setTethered(Z)V
    invoke-static {v2, v6}, Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->access$900(Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;Z)V
    ...
    invoke-interface {v2, v3, v6, v4, v5}, Lcom/android/server/HwConnectivityManager;->setTetheringProp(Lcom/android/server/connectivity/Tethering;ZZLjava/lang/String;)V
    ...
    invoke-static {v2}, Lcom/android/server/connectivity/Tethering;->access$1000(Lcom/android/server/connectivity/Tethering;)V
    ...
    const-string v3, "Failed to enable IPv6:RemoteException"
    ...
    const-string v3, "Failed to enable IPv6:IllegalStateException"
    ...
    invoke-static {v2, v3}, Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->access$1100(Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;I)V
    ...
    invoke-static {v3}, Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->access$1600(Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;)Lcom/android/internal/util/State;

    move-result-object v3

    # invokes: Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->transitionTo(Lcom/android/internal/util/IState;)V
    invoke-static {v2, v3}, Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->access$2300(Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;Lcom/android/internal/util/IState;)V
...
.method public processMessage(Landroid/os/Message;)Z
    ...
    invoke-static {v5, v8}, Lcom/android/server/connectivity/Tethering;->access$700(Lcom/android/server/connectivity/Tethering;Z)Z
    ...
    # invokes: Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->setLastError(I)V
    invoke-static {v5, v10}, Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->access$1100(Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;I)V
    ...
    const-string v7, "TetheredState CMD_TETHER_CONNECTION_CHANGED mMyUpstreamIfaceName: "
    ...
    const-string v7, ", newUpstreamIfaceName: "
    ...
    .line 1193
    # getter for: Lcom/android/server/connectivity/Tethering;->HWDBG:Z
    ...
    const-string v7, "tether connection changed, mIfaceName="
    ...
    # invokes: Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->setLastError(I)V
    invoke-static {v5, v6}, Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;->access$1100(Lcom/android/server/connectivity/Tethering$TetherInterfaceSM;I)V
    ...
    const-string v7, "TetheredState untetherInterface failed, exception: "
