...
.field private mHwNotificationTethering:Lcom/android/server/connectivity/HwNotificationTethering;
...
.method static constructor <clinit>()V
    ...
    :goto_0
    sput-boolean v0, Lcom/android/server/connectivity/Tethering;->HWFLOW:Z

    .line 116
    sget-boolean v0, Lcom/android/server/connectivity/Tethering;->HWFLOW:Z

    sput-boolean v0, Lcom/android/server/connectivity/Tethering;->VDBG:Z

    .line 117
    sput-boolean v2, Lcom/android/server/connectivity/Tethering;->HWLOGW_E:Z
    ...
    :goto_1
    sput-boolean v0, Lcom/android/server/connectivity/Tethering;->HWDBG:Z
...
.method public constructor <init>(Landroid/content/Context;Landroid/os/INetworkManagementService;Landroid/net/INetworkStatsService;Landroid/os/Looper;)V
    ...
    .line 188
    const-class v2, Lcom/android/server/connectivity/HwCustTethering;
    ...
    check-cast v1, Lcom/android/server/connectivity/HwCustTethering;

    .line 190
    .local v1, "mCust":Lcom/android/server/connectivity/HwCustTethering;
    ...
    invoke-virtual {v1, v2, p0, v3}, Lcom/android/server/connectivity/HwCustTethering;->registerBroadcast(Ljava/lang/Object;Lcom/android/server/connectivity/Tethering;Ljava/util/HashMap;)V
    ...
    invoke-static {v2}, Lcom/android/server/HwServiceFactory;->getHwNotificationTethering(Landroid/content/Context;)Lcom/android/server/connectivity/HwNotificationTethering;

    move-result-object v2

    iput-object v2, p0, Lcom/android/server/connectivity/Tethering;->mHwNotificationTethering:Lcom/android/server/connectivity/HwNotificationTethering;
...
.method static synthetic access$2500()Z
    ...
    .prologue
    .line 108
    sget-boolean v0, Lcom/android/server/connectivity/Tethering;->HWLOGW_E:Z
...
.method static synthetic access$2800()Z
    ...
    .prologue
    .line 108
    sget-boolean v0, Lcom/android/server/connectivity/Tethering;->HWDBG:Z
...
.method static synthetic access$3300(Lcom/android/server/connectivity/Tethering;)Landroid/net/ConnectivityManager;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/connectivity/Tethering;
...
.method static synthetic access$5000(Lcom/android/server/connectivity/Tethering;)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/server/connectivity/Tethering;

    .prologue
    .line 108
    invoke-direct {p0}, Lcom/android/server/connectivity/Tethering;->isTetherOpenUpstream()Z
...
.method static synthetic access$5600(Lcom/android/server/connectivity/Tethering;)Landroid/content/Context;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/connectivity/Tethering;
...
.method static synthetic access$5800(Lcom/android/server/connectivity/Tethering;)Ljava/util/HashMap;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/connectivity/Tethering;
...
.method static synthetic access$5900(Lcom/android/server/connectivity/Tethering;Ljava/lang/String;)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/server/connectivity/Tethering;
...
.method private clearTetheredNotification()V
    ...
    .line 583
    iget-object v1, p0, Lcom/android/server/connectivity/Tethering;->mHwNotificationTethering:Lcom/android/server/connectivity/HwNotificationTethering;

    invoke-interface {v1}, Lcom/android/server/connectivity/HwNotificationTethering;->clearTetheredNotification()V
...
.method private configureUsbIface(Z)Z
    ...
    .line 646
    sget-boolean v9, Lcom/android/server/connectivity/Tethering;->VDBG:Z
...
.method private isTetherOpenUpstream()Z
    .locals 3
    ...
    .line 2119
    const-string v1, "gsm.check_is_single_pdp_sub1"
    ...
    const-string v1, "gsm.check_is_single_pdp_sub2"
    ...
    .line 2121
    :cond_3
    const-string v1, "gsm.check_is_single_pdp"
...
.method private sendTetherStateChangedBroadcast()V
    ...
    invoke-interface {v15, v13}, Lcom/android/server/HwConnectivityManager;->isP2pTether(Ljava/lang/String;)Z
    ...
    invoke-virtual {v4, v13, v5}, Landroid/content/Intent;->putStringArrayListExtra(Ljava/lang/String;Ljava/util/ArrayList;)Landroid/content/Intent;
    ...
    iget-object v13, v0, Lcom/android/server/connectivity/Tethering;->mHwNotificationTethering:Lcom/android/server/connectivity/HwNotificationTethering;

    invoke-interface {v13, v12, v11, v3}, Lcom/android/server/connectivity/HwNotificationTethering;->setTetheringNumber(ZZZ)V
...
.method private showTetheredNotification(II)V
    ...
    const-string v3, "showTetheredNotification icon:"
    ...
    .line 522
    iget-object v0, p0, Lcom/android/server/connectivity/Tethering;->mHwNotificationTethering:Lcom/android/server/connectivity/HwNotificationTethering;

    invoke-interface {v0}, Lcom/android/server/connectivity/HwNotificationTethering;->sendTetherNotification()V
    ...
    invoke-static {v11, p2}, Landroid/graphics/BitmapFactory;->decodeResource(Landroid/content/res/Resources;I)Landroid/graphics/Bitmap;
    ...
    invoke-static {v0, v1, v3, v4}, Landroid/hwnotification/HwNotificationResource;->getNotificationThemeData(IIII)Landroid/os/Bundle;
    ...
    invoke-interface {v0, v8, v12, v7, v10}, Lcom/android/server/connectivity/HwNotificationTethering;->sendTetherNotification(Landroid/app/Notification;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Landroid/app/PendingIntent;)Z
...
.method private tetherUsb(Z)V
    ...
    .prologue
    .line 624
    sget-boolean v7, Lcom/android/server/connectivity/Tethering;->VDBG:Z
...
.method public checkDunRequired()V
    ...
    invoke-interface {v5, v6}, Lcom/android/server/HwConnectivityManager;->checkDunExisted(Landroid/content/Context;)Z
...
.method public interfaceAdded(Ljava/lang/String;)V
    ...
    invoke-interface {v3, p1}, Lcom/android/server/HwConnectivityManager;->isP2pTether(Ljava/lang/String;)Z
...
.method public interfaceRemoved(Ljava/lang/String;)V
    ...
    .line 381
    sget-boolean v1, Lcom/android/server/connectivity/Tethering;->HWLOGW_E:Z
...
.method public setUsbTethering(Z)I
    ...
    invoke-interface {v1, v0}, Lcom/android/server/HwConnectivityManager;->setUsbFunctionForTethering(Landroid/hardware/usb/UsbManager;)Z
