...
.method static synthetic access$4600(Lcom/android/server/connectivity/Tethering$TetherMasterSM$TetherMasterUtilState;Landroid/net/LinkProperties;)Z
    .locals 1
...
.method private getNetworkRequest(I)Landroid/net/NetworkRequest;
    ...
    .prologue
    .line 1511
    # getter for: Lcom/android/server/connectivity/Tethering;->VDBG:Z
    invoke-static {}, Lcom/android/server/connectivity/Tethering;->access$500()Z
...
.method protected chooseUpstreamType(Z)V
    ...
    invoke-static/range {v19 .. v19}, Lcom/android/server/connectivity/Tethering;->access$3300(Lcom/android/server/connectivity/Tethering;)Landroid/net/ConnectivityManager;
    ...
    invoke-static/range {v19 .. v19}, Lcom/android/server/connectivity/Tethering$TetherMasterSM;->access$3200(Lcom/android/server/connectivity/Tethering$TetherMasterSM;)I
    ...
    const-string v21, "hipri connected, ignore default mobile upstream"
    ...
    # invokes: Lcom/android/server/connectivity/Tethering;->isTetherOpenUpstream()Z
    invoke-static/range {v19 .. v19}, Lcom/android/server/connectivity/Tethering;->access$5000(Lcom/android/server/connectivity/Tethering;)Z
    ...
    invoke-static {}, Lcom/android/internal/telephony/HuaweiTelephonyConfigs;->isQcomPlatform()Z
    ...
    .line 1713
    invoke-static {v14}, Lcom/android/server/NetPluginDelegate;->setUpstream(Landroid/net/Network;)V
    ...
    invoke-static/range {v19 .. v19}, Lcom/android/server/connectivity/Tethering;->access$5100(Lcom/android/server/connectivity/Tethering;)[Ljava/lang/String;
    ...
    invoke-static/range {v19 .. v19}, Lcom/android/server/connectivity/Tethering$TetherMasterSM;->access$4700(Lcom/android/server/connectivity/Tethering$TetherMasterSM;)Landroid/net/ConnectivityManager$NetworkCallback;
    ...
    invoke-static/range {v19 .. v20}, Lcom/android/server/connectivity/Tethering$TetherMasterSM;->access$4702(Lcom/android/server/connectivity/Tethering$TetherMasterSM;Landroid/net/ConnectivityManager$NetworkCallback;)Landroid/net/ConnectivityManager$NetworkCallback;
    ...
    # getter for: Lcom/android/server/connectivity/Tethering$TetherMasterSM;->mNetworkCallback:Landroid/net/ConnectivityManager$NetworkCallback;
    invoke-static/range {v20 .. v20}, Lcom/android/server/connectivity/Tethering$TetherMasterSM;->access$4700(Lcom/android/server/connectivity/Tethering$TetherMasterSM;)Landroid/net/ConnectivityManager$NetworkCallback;
    ...
    invoke-static/range {v19 .. v20}, Lcom/android/server/connectivity/Tethering$TetherMasterSM;->access$5300(Lcom/android/server/connectivity/Tethering$TetherMasterSM;Lcom/android/internal/util/IState;)V
...
.method protected turnOffUpstreamMobileConnection()Z
    ...
    invoke-static {v0}, Lcom/android/server/connectivity/Tethering$TetherMasterSM;->access$3404(Lcom/android/server/connectivity/Tethering$TetherMasterSM;)I

    .line 1414
    iget-object v0, p0, Lcom/android/server/connectivity/Tethering$TetherMasterSM$TetherMasterUtilState;->this$1:Lcom/android/server/connectivity/Tethering$TetherMasterSM;

    # getter for: Lcom/android/server/connectivity/Tethering$TetherMasterSM;->mMobileApnReserved:I
    invoke-static {v0}, Lcom/android/server/connectivity/Tethering$TetherMasterSM;->access$3200(Lcom/android/server/connectivity/Tethering$TetherMasterSM;)I
    ...
    # invokes: Lcom/android/server/connectivity/Tethering;->getConnectivityManager()Landroid/net/ConnectivityManager;
    invoke-static {v0}, Lcom/android/server/connectivity/Tethering;->access$3300(Lcom/android/server/connectivity/Tethering;)Landroid/net/ConnectivityManager;
    ...
    invoke-static {v0, v3}, Lcom/android/server/connectivity/Tethering$TetherMasterSM;->access$3202(Lcom/android/server/connectivity/Tethering$TetherMasterSM;I)I
...
.method protected turnOnMasterTetherSettings()Z
    ...
    const-string v5, "sleep 100ms to wait for dnsmaq start up completely."
...
.method protected turnOnUpstreamMobileConnection(I)Z
    ...
    # invokes: Lcom/android/server/connectivity/Tethering;->getConnectivityManager()Landroid/net/ConnectivityManager;
    invoke-static {v5}, Lcom/android/server/connectivity/Tethering;->access$3300(Lcom/android/server/connectivity/Tethering;)Landroid/net/ConnectivityManager;
