...
.method private cancelActiveSyncH(Lcom/android/server/content/SyncStorageEngine$EndPoint;Landroid/os/Bundle;)V
    ...
    invoke-static {v4}, Lcom/android/server/content/SyncManager;->access$300(Lcom/android/server/content/SyncManager;)Z
    ...
    # invokes: Lcom/android/server/content/SyncManager;->isInIdleWhiteList(Lcom/android/server/content/SyncOperation;)Z
    invoke-static {v4, v5}, Lcom/android/server/content/SyncManager;->access$3600(Lcom/android/server/content/SyncManager;Lcom/android/server/content/SyncOperation;)Z
...
.method private getSyncWakeLock(Lcom/android/server/content/SyncOperation;)Landroid/os/PowerManager$WakeLock;
    ...
    invoke-virtual {p1}, Lcom/android/server/content/SyncOperation;->wakeLockTag()Ljava/lang/String;
...
.method private installHandleTooManyDeletesNotification(Landroid/accounts/Account;Ljava/lang/String;JI)V
    ...
    invoke-virtual {v13, v2}, Landroid/content/pm/ProviderInfo;->loadLabel(Landroid/content/pm/PackageManager;)Ljava/lang/CharSequence;
    ...
    .line 3346
    .local v14, "tooManyDeletesDescFormat":Ljava/lang/CharSequence;
    move-object/from16 v0, p0
    ...
    invoke-virtual {v2, v3, v5, v11, v7}, Landroid/app/NotificationManager;->notifyAsUser(Ljava/lang/String;ILandroid/app/Notification;Landroid/os/UserHandle;)V
...
.method private isOperationValidLocked(Lcom/android/server/content/SyncOperation;)Z
    ...
    invoke-virtual {v12, v10}, Lcom/android/server/content/SyncManager;->isAllow2Sync(I)Z
...
.method private manageSyncAlarmLocked(JJ)V
    ...
    iget-object v0, v5, Lcom/android/server/content/SyncManager$ActiveSyncContext;->mSyncOperation:Lcom/android/server/content/SyncOperation;

    move-object/from16 v18, v0

    # invokes: Lcom/android/server/content/SyncManager;->isInIdleWhiteList(Lcom/android/server/content/SyncOperation;)Z
    invoke-static/range {v17 .. v18}, Lcom/android/server/content/SyncManager;->access$3600(Lcom/android/server/content/SyncManager;Lcom/android/server/content/SyncOperation;)Z
...
.method private maybeStartNextSyncH()J
    ...
    # getter for: Lcom/android/server/content/SyncManager;->mRunningAccounts:[Landroid/accounts/AccountAndUser;
    invoke-static/range {v31 .. v31}, Lcom/android/server/content/SyncManager;->access$2900(Lcom/android/server/content/SyncManager;)[Landroid/accounts/AccountAndUser;
    ...
    # getter for: Lcom/android/server/content/SyncManager;->mContext:Landroid/content/Context;
    invoke-static/range {v31 .. v31}, Lcom/android/server/content/SyncManager;->access$1900(Lcom/android/server/content/SyncManager;)Landroid/content/Context;
    ...
    invoke-static/range {v31 .. v31}, Lcom/android/server/content/SyncManager;->access$3300(Lcom/android/server/content/SyncManager;)Landroid/os/UserManager;
    ...
    invoke-static/range {v31 .. v31}, Lcom/android/server/content/SyncManager;->access$3400(Lcom/android/server/content/SyncManager;)Lcom/android/server/content/AppIdleMonitor;
