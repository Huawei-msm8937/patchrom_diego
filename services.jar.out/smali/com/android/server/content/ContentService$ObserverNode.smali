...
.method private collectMyObserversLocked(ZLandroid/database/IContentObserver;ZILjava/util/ArrayList;)V
    ...
    .line 1206
    .local v7, "entry":Lcom/android/server/content/ContentService$ObserverNode$ObserverEntry;
    iget-object v0, v7, Lcom/android/server/content/ContentService$ObserverNode$ObserverEntry;->observer:Landroid/database/IContentObserver;
    ...
    .end local v7    # "entry":Lcom/android/server/content/ContentService$ObserverNode$ObserverEntry;
    .end local v8    # "i":I
    .end local v9    # "observerBinder":Landroid/os/IBinder;
    :cond_1
    ...
    .line 1206
    .restart local v7    # "entry":Lcom/android/server/content/ContentService$ObserverNode$ObserverEntry;
    .restart local v8    # "i":I
    .restart local v9    # "observerBinder":Landroid/os/IBinder;
    :cond_2
    const/4 v3, 0x0
    ...
    iget v1, v7, Lcom/android/server/content/ContentService$ObserverNode$ObserverEntry;->pid:I

    invoke-interface {v0, v1}, Lcom/android/server/HwNLPManager;->shouldSkipGoogleNlp(I)Z
    ...
    invoke-static {v7}, Lcom/android/server/content/ContentService$ObserverNode$ObserverEntry;->access$100(Lcom/android/server/content/ContentService$ObserverNode$ObserverEntry;)I
    ...
    iget-boolean v0, v7, Lcom/android/server/content/ContentService$ObserverNode$ObserverEntry;->notifyForDescendants:Z

    if-eqz v0, :cond_0

    .line 1224
    :cond_5
    new-instance v0, Lcom/android/server/content/ContentService$ObserverCall;

    iget-object v2, v7, Lcom/android/server/content/ContentService$ObserverNode$ObserverEntry;->observer:Landroid/database/IContentObserver;

    iget v4, v7, Lcom/android/server/content/ContentService$ObserverNode$ObserverEntry;->pid:I

    iget v5, v7, Lcom/android/server/content/ContentService$ObserverNode$ObserverEntry;->uid:I
