...
.super Lcom/android/server/content/AbsSyncManager;
...
.field private mDebugIdleType:I
...
.method static constructor <clinit>()V
    ...
    const-string v5, "ro.config.hw_low_ram"
    ...
    .line 252
    new-instance v3, Lcom/android/server/content/SyncManager$1;

    invoke-direct {v3}, Lcom/android/server/content/SyncManager$1;-><init>()V

    sput-object v3, Lcom/android/server/content/SyncManager;->mWhiteList:Ljava/util/ArrayList;
...
.method public constructor <init>(Landroid/content/Context;Z)V
    ...
    .line 450
    invoke-direct {p0}, Lcom/android/server/content/AbsSyncManager;-><init>()V
    ...
    .line 250
    iput-object v4, p0, Lcom/android/server/content/SyncManager;->mIDeviceIdleController:Landroid/os/IDeviceIdleController;

    .line 251
    const-string v0, "debug.syncmanager.idle.type"

    invoke-static {v0, v6}, Landroid/os/SystemProperties;->getInt(Ljava/lang/String;I)I

    move-result v0

    iput v0, p0, Lcom/android/server/content/SyncManager;->mDebugIdleType:I
    ...
    new-instance v11, Lcom/android/server/content/SyncManager$12;

    invoke-direct {v11, p0, v4, v12}, Lcom/android/server/content/SyncManager$12;-><init>(Lcom/android/server/content/SyncManager;Landroid/os/Handler;Landroid/content/ContentResolver;)V
...
.method static synthetic access$3600(Lcom/android/server/content/SyncManager;Lcom/android/server/content/SyncOperation;)Z
    ...
    .prologue
    .line 123
    invoke-direct {p0, p1}, Lcom/android/server/content/SyncManager;->isInIdleWhiteList(Lcom/android/server/content/SyncOperation;)Z
...
.method private dumpRecentHistory(Ljava/io/PrintWriter;)V
    ...
    new-instance v49, Lcom/android/server/content/SyncManager$15;
    ...
    .line 1852
    const-string v49, "XXXXXXXXX"

    move-object/from16 v0, v49

    move-object/from16 v1, v44

    iput-object v0, v1, Lcom/android/server/content/SyncManager$AccountSyncStats;->name:Ljava/lang/String;
...
.method private isInIdleWhiteList(Lcom/android/server/content/SyncOperation;)Z
    .locals 5
    .param p1, "op"    # Lcom/android/server/content/SyncOperation;
    ...
    iget-boolean v3, p0, Lcom/android/server/content/SyncManager;->mDeviceIsIdle:Z
    ...
    .line 3591
    iget v3, p0, Lcom/android/server/content/SyncManager;->mDebugIdleType:I

    if-nez v3, :cond_2

    .line 3593
    sget-object v3, Lcom/android/server/content/SyncManager;->mWhiteList:Ljava/util/ArrayList;
    ...
    iget v4, p0, Lcom/android/server/content/SyncManager;->mDebugIdleType:I

    if-ne v3, v4, :cond_4

    .line 3597
    :try_start_0
    iget-object v3, p0, Lcom/android/server/content/SyncManager;->mIDeviceIdleController:Landroid/os/IDeviceIdleController;
    ...
    iput-object v3, p0, Lcom/android/server/content/SyncManager;->mIDeviceIdleController:Landroid/os/IDeviceIdleController;
    ...
    invoke-interface {v3, v2}, Landroid/os/IDeviceIdleController;->isPowerSaveWhitelistApp(Ljava/lang/String;)Z
    :try_end_0
    ...
    const-string v4, "can not check isPowerSaveWhitelistApp"
...
.method protected dumpSyncState(Ljava/io/PrintWriter;)V
    ...
    .line 1583
    new-instance v34, Lcom/android/server/content/SyncManager$13;
