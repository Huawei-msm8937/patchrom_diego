...
.field static final DEBUG_FLOW:Z
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/server/InputMethodManagerService;->DEBUG_FLOW:Z
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/wm/WindowManagerService;)V
    ...
    .prologue
    .line 802
    invoke-direct/range {p0 .. p0}, Lcom/android/server/AbsInputMethodManagerService;-><init>()V
    ...
    iput-boolean v2, v0, Lcom/android/server/InputMethodManagerService;->bFlag:Z
    ...
    invoke-static {v3, v4, v5, v6}, Landroid/hwnotification/HwNotificationResource;->getNotificationThemeData(IIII)Landroid/os/Bundle;
    ...
    .line 936
    invoke-virtual/range {p0 .. p0}, Lcom/android/server/InputMethodManagerService;->createFlagIfNecessary()V
    ...
    invoke-virtual {v2, v7}, Lcom/android/server/InputMethodManagerService$SettingsObserver;->registerContentObserverLocked(I)V
...
.method static synthetic access$000(Lcom/android/server/InputMethodManagerService;)Lcom/android/server/InputMethodManagerService$InputMethodFileManager;
    .locals 1
...
.method static synthetic access$200(Lcom/android/server/InputMethodManagerService;)Landroid/content/pm/IPackageManager;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/InputMethodManagerService;
...
.method static synthetic access$300(Lcom/android/server/InputMethodManagerService;Landroid/os/IBinder;II)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/InputMethodManagerService;
...
.method static synthetic access$500(Lcom/android/server/InputMethodManagerService;Ljava/lang/String;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/InputMethodManagerService;
...
.method private setSelectedInputMethodAndSubtypeLocked(Landroid/view/inputmethod/InputMethodInfo;IZ)V
    ...
    invoke-virtual {p0, v1}, Lcom/android/server/InputMethodManagerService;->isSecureIME(Ljava/lang/String;)Z
    ...
    const-string v2, "setSelectedInputMethodAndSubtypeLocked: Skipping SecureIME"
...
.method private showInputMethodMenu(Z)V
    ...
    const-string v30, "androidhwext:style/Theme.Emui.Dialog.Alert"
    ...
    .line 3205
    .local v25, "themeContext":Landroid/view/ContextThemeWrapper;
    ...
    .end local v25    # "themeContext":Landroid/view/ContextThemeWrapper;
    .end local v26    # "themeID":I
    ...
    .restart local v25    # "themeContext":Landroid/view/ContextThemeWrapper;
    .restart local v26    # "themeID":I
...
.method private switchUserLocked(I)V
    ...
    .line 1097
    :cond_0
    invoke-virtual {p0, p1}, Lcom/android/server/InputMethodManagerService;->switchUserExtra(I)V
...
.method attachNewInputLocked(Z)Lcom/android/internal/view/InputBindResult;
    ...
    .line 1390
    sget-boolean v0, Lcom/android/server/InputMethodManagerService;->DEBUG_FLOW:Z
...
.method buildInputMethodListLocked(Ljava/util/ArrayList;Ljava/util/HashMap;Z)V
    ...
    const-string v19, "buildInputMethodListLocked: Skipping IME "
    ...
    invoke-virtual {v0, v10, v12, v1}, Lcom/android/server/InputMethodManagerService;->ensureEnableSystemIME(Ljava/lang/String;Landroid/view/inputmethod/InputMethodInfo;Landroid/content/Context;)V
    :try_end_0
    ...
    :cond_3
    invoke-virtual/range {p0 .. p0}, Lcom/android/server/InputMethodManagerService;->updateSecureIMEStatus()V
...
.method hideCurrentInputLocked(ILandroid/os/ResultReceiver;)Z
    ...
    .line 2249
    iget-boolean v3, p0, Lcom/android/server/InputMethodManagerService;->mLastInputShown:Z

    if-eqz v3, :cond_0

    iget-boolean v3, p0, Lcom/android/server/InputMethodManagerService;->mIsDiffIME:Z
    ...
    const-string v4, "cancel hide "

    invoke-static {v3, v4}, Landroid/util/Slog;->i(Ljava/lang/String;Ljava/lang/String;)I

    .line 2252
    iput-boolean v2, p0, Lcom/android/server/InputMethodManagerService;->mLastInputShown:Z
...
.method public hideMySoftInput(Landroid/os/IBinder;I)V
    ...
    :cond_1
    :try_start_1
    sget-boolean v3, Lcom/android/server/InputMethodManagerService;->DEBUG_FLOW:Z
    ...
    const-string v6, "hideMySoftInput, pid="
...
.method public hideSoftInput(Lcom/android/internal/view/IInputMethodClient;ILandroid/os/ResultReceiver;)Z
    ...
    .line 2222
    :try_start_1
    iget-object v7, p0, Lcom/android/server/InputMethodManagerService;->mCurClient:Lcom/android/server/InputMethodManagerService$ClientState;
    ...
    invoke-interface {v7, p1}, Landroid/view/IWindowManager;->inputMethodClientHasFocus(Lcom/android/internal/view/IInputMethodClient;)Z
    :try_end_2
    ...
    :cond_2
    :try_start_5
    sget-boolean v5, Lcom/android/server/InputMethodManagerService;->DEBUG_FLOW:Z
    ...
    const-string v8, "Client requesting input be hidden, pid="
...
.method onSessionCreated(Lcom/android/internal/view/IInputMethod;Lcom/android/internal/view/IInputMethodSession;Landroid/view/InputChannel;)V
    ...
    .line 1611
    sget-boolean v1, Lcom/android/server/InputMethodManagerService;->DEBUG_FLOW:Z

    if-eqz v1, :cond_0

    const-string v1, "InputMethodManagerService"

    const-string v3, "IME session created"
...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    .line 1118
    :pswitch_0
    const-string v2, "android.input.IInputMethodManager"
    ...
    const-string v3, "Input Method Manager Crash"
...
.method setInputMethodLocked(Ljava/lang/String;I)V
    ...
    invoke-static {v8, v9}, Lhuawei/android/mw/HwMultiWindowUtils;->reevaluateFloatImeMode(Landroid/content/Context;Ljava/lang/String;)V
    ...
    .line 2064
    iput-boolean v10, p0, Lcom/android/server/InputMethodManagerService;->mIsDiffIME:Z
    ...
    .line 2085
    invoke-direct {p0, v1, p2, v11}, Lcom/android/server/InputMethodManagerService;->setSelectedInputMethodAndSubtypeLocked(Landroid/view/inputmethod/InputMethodInfo;IZ)V
    ...
    :cond_6
    iput-boolean v11, p0, Lcom/android/server/InputMethodManagerService;->mIsDiffIME:Z
...
.method public showSoftInput(Lcom/android/internal/view/IInputMethodClient;ILandroid/os/ResultReceiver;)Z
    ...
    :cond_2
    :try_start_5
    sget-boolean v4, Lcom/android/server/InputMethodManagerService;->DEBUG_FLOW:Z
    ...
    const-string v7, "Client requesting input be shown, requestedUid="
...
.method public systemRunning(Lcom/android/server/statusbar/StatusBarManagerService;)V
    ...
    invoke-static {v2}, Lhuawei/android/mw/HwMultiWindowUtils;->initWhiteListFloatKeyboard(Landroid/content/Context;)V
    ...
    invoke-static {v2, v3}, Lhuawei/android/mw/HwMultiWindowUtils;->reevaluateFloatImeMode(Landroid/content/Context;Ljava/lang/String;)V
...
.method public windowGainedFocus(Lcom/android/internal/view/IInputMethodClient;Landroid/os/IBinder;IIILandroid/view/inputmethod/EditorInfo;Lcom/android/internal/view/IInputContext;)Lcom/android/internal/view/InputBindResult;
    ...
    const-string v15, "Window already focused, force refreshime kgon:"
    ...
    iget v14, v0, Lcom/android/server/InputMethodManagerService;->mImeWindowVis:I

    move-object/from16 v0, p0

    iget v15, v0, Lcom/android/server/InputMethodManagerService;->mBackDisposition:I

    move-object/from16 v0, p0

    invoke-direct {v0, v12, v14, v15}, Lcom/android/server/InputMethodManagerService;->updateSystemUi(Landroid/os/IBinder;II)V
    ...
    .line 2386
    sget-boolean v12, Lcom/android/server/InputMethodManagerService;->DEBUG_FLOW:Z
