...
.method private loadActiveStats(JZZ)V
    ...
    .line 496
    sget-boolean v6, Lcom/android/server/usage/UserUsageStatsService;->DEBUG:Z
    ...
    const-string v8, "Loading existing stats @ "
    ...
    const-string v8, "Creating new stats @ "
...
.method private queryStats(IJJLcom/android/server/usage/UsageStatsDatabase$StatCombiner;)Ljava/util/List;
    ...
    const-string v4, "Bad intervalType used "
    ...
    iget-wide v4, v9, Lcom/android/server/usage/IntervalStats;->endTime:J
    ...
    iget-wide v4, v9, Lcom/android/server/usage/IntervalStats;->beginTime:J
...
.method reportEvent(Landroid/app/usage/UsageEvents$Event;J)V
    ...
    const-string v8, "Got usage event for "
    ...
    invoke-static {v8}, Lcom/android/server/usage/UserUsageStatsService;->eventToString(I)Ljava/lang/String;
