...
.method private disableLocked(IILandroid/os/IBinder;Ljava/lang/String;I)V
    ...
    const-string v3, "disableLocked mBar is null."
...
.method public getStatusBar()Lcom/android/internal/statusbar/IStatusBar;
    .locals 1
...
.method public isNotificationsPanelExpand()Z
    ...
    invoke-interface {v1}, Lcom/android/internal/statusbar/IStatusBar;->isNotificationPanelExpanded()Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method manageDisableListLocked(IILandroid/os/IBinder;Ljava/lang/String;I)V
    ...
    .prologue
    .line 740
    sget-boolean v9, Landroid/util/Log;->HWINFO:Z
    ...
    .line 742
    .local v2, "NUM_REGEX":Ljava/lang/String;
    const-string v9, "[0-9]++"
    ...
    .line 744
    .local v5, "matcherForpkg":Ljava/util/regex/Matcher;
    ...
    .line 745
    const-string v9, "StatusBarManagerService"

    new-instance v10, Ljava/lang/StringBuilder;

    invoke-direct {v10}, Ljava/lang/StringBuilder;-><init>()V

    const-string v11, "manageDisableList userId="
    ...
    .line 750
    .end local v2    # "NUM_REGEX":Ljava/lang/String;
    .end local v5    # "matcherForpkg":Ljava/util/regex/Matcher;
    ...
    .line 753
    .local v8, "tok":Lcom/android/server/statusbar/StatusBarManagerService$DisableRecord;
    const/4 v4, 0x0
    ...
    .line 755
    .local v7, "t":Lcom/android/server/statusbar/StatusBarManagerService$DisableRecord;
    iget-object v9, v7, Lcom/android/server/statusbar/StatusBarManagerService$DisableRecord;->token:Landroid/os/IBinder;

    if-ne v9, p3, :cond_5

    iget v9, v7, Lcom/android/server/statusbar/StatusBarManagerService$DisableRecord;->userId:I
    ...
    .line 760
    .end local v7    # "t":Lcom/android/server/statusbar/StatusBarManagerService$DisableRecord;
    :cond_1
    if-eqz p2, :cond_2
    ...
    const-string v11, "Disable records remove token "
    ...
    iget-object v11, p0, Lcom/android/server/statusbar/StatusBarManagerService;->mDisableRecords:Ljava/util/ArrayList;
    ...
    .line 764
    iget-object v9, v8, Lcom/android/server/statusbar/StatusBarManagerService$DisableRecord;->token:Landroid/os/IBinder;

    const/4 v10, 0x0

    invoke-interface {v9, v8, v10}, Landroid/os/IBinder;->unlinkToDeath(Landroid/os/IBinder$DeathRecipient;I)Z
    ...
    .end local v1    # "N":I
    .end local v4    # "i":I
    .end local v8    # "tok":Lcom/android/server/statusbar/StatusBarManagerService$DisableRecord;
    .restart local v2    # "NUM_REGEX":Ljava/lang/String;
    ...
    .restart local v7    # "t":Lcom/android/server/statusbar/StatusBarManagerService$DisableRecord;
    .restart local v8    # "tok":Lcom/android/server/statusbar/StatusBarManagerService$DisableRecord;
    :cond_5
    ...
    .line 768
    new-instance v8, Lcom/android/server/statusbar/StatusBarManagerService$DisableRecord;

    .end local v8    # "tok":Lcom/android/server/statusbar/StatusBarManagerService$DisableRecord;
    const/4 v9, 0x0

    invoke-direct {v8, p0, v9}, Lcom/android/server/statusbar/StatusBarManagerService$DisableRecord;-><init>(Lcom/android/server/statusbar/StatusBarManagerService;Lcom/android/server/statusbar/StatusBarManagerService$1;)V

    .line 769
    .restart local v8    # "tok":Lcom/android/server/statusbar/StatusBarManagerService$DisableRecord;
    iput p1, v8, Lcom/android/server/statusbar/StatusBarManagerService$DisableRecord;->userId:I

    .line 771
    const/4 v9, 0x0

    :try_start_0
    invoke-interface {p3, v8, v9}, Landroid/os/IBinder;->linkToDeath(Landroid/os/IBinder$DeathRecipient;I)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 779
    iput p2, v8, Lcom/android/server/statusbar/StatusBarManagerService$DisableRecord;->what1:I

    .line 783
    :goto_3
    iput-object p3, v8, Lcom/android/server/statusbar/StatusBarManagerService$DisableRecord;->token:Landroid/os/IBinder;

    .line 784
    move-object/from16 v0, p4

    iput-object v0, v8, Lcom/android/server/statusbar/StatusBarManagerService$DisableRecord;->pkg:Ljava/lang/String;
    ...
    :cond_8
    iput p2, v8, Lcom/android/server/statusbar/StatusBarManagerService$DisableRecord;->what2:I
