...
# instance fields
.field final CUST_TYPE_CONFIG:I
...
.method constructor <init>()V
    ...
    .line 52
    iput v3, p0, Lcom/android/server/SystemConfig;->CUST_TYPE_CONFIG:I
    ...
    .line 169
    invoke-virtual {p0}, Lcom/android/server/SystemConfig;->readCustPermissions()V
...
.method getCanonicalPathOrNull(Ljava/io/File;)Ljava/lang/String;
    .locals 3
    ...
    const-string v2, "Unable to resolve canonical"
...
.method readCustPermissions()V
    ...
    invoke-virtual {p0, v9}, Lcom/android/server/SystemConfig;->getCanonicalPathOrNull(Ljava/io/File;)Ljava/lang/String;

    move-result-object v8

    .line 177
    .local v8, "sysPath":Ljava/lang/String;
    const/4 v9, 0x0

    :try_start_0
    invoke-static {v9}, Lhuawei/cust/HwCfgFilePolicy;->getCfgPolicyDir(I)[Ljava/lang/String;
    :try_end_0
    ...
    invoke-virtual {p0, v5}, Lcom/android/server/SystemConfig;->getCanonicalPathOrNull(Ljava/io/File;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v9, v13}, Lcom/android/server/SystemConfig;->readPermissions(Ljava/io/File;Z)V
    ...
    const-string v10, "HwCfgFilePolicy NoClassDefFoundError"
