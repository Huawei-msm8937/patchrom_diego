...
# direct methods
.method constructor <init>(Lcom/android/server/fingerprint/FingerprintService$FingerprintServiceWrapper;Ljava/lang/String;Landroid/os/IBinder;JILandroid/hardware/fingerprint/IFingerprintServiceReceiver;IZ)V
    .locals 0
    ...
    iput-object p3, p0, Lcom/android/server/fingerprint/FingerprintService$FingerprintServiceWrapper$3;->val$token:Landroid/os/IBinder;

    iput-wide p4, p0, Lcom/android/server/fingerprint/FingerprintService$FingerprintServiceWrapper$3;->val$opId:J

    iput p6, p0, Lcom/android/server/fingerprint/FingerprintService$FingerprintServiceWrapper$3;->val$effectiveGroupId:I
...
.method public run()V
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/fingerprint/FingerprintService;->setLivenessSwitch(Ljava/lang/String;)V
    ...
    iget-object v8, p0, Lcom/android/server/fingerprint/FingerprintService$FingerprintServiceWrapper$3;->this$1:Lcom/android/server/fingerprint/FingerprintService$FingerprintServiceWrapper;

    # getter for: Lcom/android/server/fingerprint/FingerprintService$FingerprintServiceWrapper;->isUnlock:Z
    invoke-static {v8}, Lcom/android/server/fingerprint/FingerprintService$FingerprintServiceWrapper;->access$2000(Lcom/android/server/fingerprint/FingerprintService$FingerprintServiceWrapper;)Z

    move-result v8

    invoke-virtual/range {v0 .. v8}, Lcom/android/server/fingerprint/FingerprintService;->startAuthentication(Landroid/os/IBinder;JILandroid/hardware/fingerprint/IFingerprintServiceReceiver;IZZ)V
