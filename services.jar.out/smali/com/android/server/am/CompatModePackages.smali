...
# instance fields
.field private mCust:Lcom/android/server/am/HwCustCompatModePackages;

.field private final mFile:Landroid/util/AtomicFile;

.field private final mHandler:Lcom/android/server/am/CompatModePackages$CompatHandler;

.field private mIsInitCustList:Z
...
.method static constructor <clinit>()V
    ...
    const-string v2, "com.vectorunit.red"
...
.method public constructor <init>(Lcom/android/server/am/ActivityManagerService;Ljava/io/File;Landroid/os/Handler;)V
    ...
    .line 100
    const-class v8, Lcom/android/server/am/HwCustCompatModePackages;

    const/4 v9, 0x0

    new-array v9, v9, [Ljava/lang/Object;

    invoke-static {v8, v9}, Lhuawei/cust/HwCustUtils;->createObj(Ljava/lang/Class;[Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v8

    check-cast v8, Lcom/android/server/am/HwCustCompatModePackages;

    iput-object v8, p0, Lcom/android/server/am/CompatModePackages;->mCust:Lcom/android/server/am/HwCustCompatModePackages;

    .line 108
    const/4 v8, 0x0

    iput-boolean v8, p0, Lcom/android/server/am/CompatModePackages;->mIsInitCustList:Z
    ...
    :goto_3
    :try_start_4
    iget-object v8, p0, Lcom/android/server/am/CompatModePackages;->mCust:Lcom/android/server/am/HwCustCompatModePackages;

    if-eqz v8, :cond_8

    iget-object v8, p0, Lcom/android/server/am/CompatModePackages;->mCust:Lcom/android/server/am/HwCustCompatModePackages;

    invoke-virtual {v8}, Lcom/android/server/am/HwCustCompatModePackages;->isLowPowerDisplayMode()Z
...
.method private addCompatForCheck(Ljava/lang/String;Z)V
    ...
    .line 249
    iget-object v9, p0, Lcom/android/server/am/CompatModePackages;->mCust:Lcom/android/server/am/HwCustCompatModePackages;

    if-eqz v9, :cond_1

    iget-object v9, p0, Lcom/android/server/am/CompatModePackages;->mCust:Lcom/android/server/am/HwCustCompatModePackages;

    invoke-virtual {v9}, Lcom/android/server/am/HwCustCompatModePackages;->isLowPowerDisplayMode()Z
...
.method private addCompatList()V
    ...
    .line 230
    iget-object v5, p0, Lcom/android/server/am/CompatModePackages;->mCust:Lcom/android/server/am/HwCustCompatModePackages;

    if-eqz v5, :cond_1

    iget-object v5, p0, Lcom/android/server/am/CompatModePackages;->mCust:Lcom/android/server/am/HwCustCompatModePackages;

    invoke-virtual {v5}, Lcom/android/server/am/HwCustCompatModePackages;->isLowPowerDisplayMode()Z
...
.method private getCustAppList(I)V
    .locals 9
    .param p1, "type"    # I
    ...
    .line 145
    .local v0, "COMPAT_MODE":I
    invoke-static {}, Landroid/common/HwFrameworkFactory;->getHwNsdImpl()Landroid/view/IHwNsdImpl;

    move-result-object v6

    invoke-interface {v6, p1}, Landroid/view/IHwNsdImpl;->getCustAppList(I)[Ljava/lang/String;

    move-result-object v2

    .line 146
    .local v2, "custPkgList":[Ljava/lang/String;
    if-eqz v2, :cond_1
    ...
    const-string v8, "APS: SDR: CompatModePackages.getCustAppList. mPackages size = "
...
.method public loadCompatModeAppList()V
    .locals 2

    .prologue
    .line 135
    iget-boolean v0, p0, Lcom/android/server/am/CompatModePackages;->mIsInitCustList:Z
    ...
    const-string v1, "APS: SDR: CompatModePackages.loadCompatModeAppList."
    ...
    invoke-direct {p0, v0}, Lcom/android/server/am/CompatModePackages;->getCustAppList(I)V

    .line 138
    const/4 v0, 0x1

    iput-boolean v0, p0, Lcom/android/server/am/CompatModePackages;->mIsInitCustList:Z
