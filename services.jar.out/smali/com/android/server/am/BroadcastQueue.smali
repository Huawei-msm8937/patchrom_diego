...
.super Lcom/android/server/am/AbsBroadcastQueue;
...
# static fields
.field static final BROADCAST_CHECKTIMEOUT_MSG:I = 0xcb
...
.field static final MAYBE_BROADCAST_BG_TIMEOUT:I = 0x1388

.field static final MAYBE_BROADCAST_FG_TIMEOUT:I = 0x7d0
...
.method constructor <init>(Lcom/android/server/am/ActivityManagerService;Landroid/os/Handler;Ljava/lang/String;JZ)V
    ...
    .line 281
    invoke-direct {p0}, Lcom/android/server/am/AbsBroadcastQueue;-><init>()V
...
.method static synthetic access$000(Lcom/android/server/am/BroadcastQueue;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/am/BroadcastQueue;

    .prologue
    .line 73
    invoke-direct {p0}, Lcom/android/server/am/BroadcastQueue;->handleMaybeTimeoutBC()V
...
.method private handleMaybeTimeoutBC()V
    .locals 9
    ...
    const-string v8, "handleMaybeTimeoutBC, but mOrderedBroadcasts is null"
    ...
    iget v7, v6, Lcom/android/server/am/BroadcastRecord;->nextReceiver:I
    ...
    const-string v8, "handleMaybeTimeoutBC Timeout on receiver with nextReceiver <= 0"
    ...
    iget-object v7, v6, Lcom/android/server/am/BroadcastRecord;->receivers:Ljava/util/List;

    iget v8, v6, Lcom/android/server/am/BroadcastRecord;->nextReceiver:I
    ...
    instance-of v7, v1, Lcom/android/server/am/BroadcastFilter;
    ...
    iget v2, v7, Lcom/android/server/am/ReceiverList;->pid:I
    ...
    iget v2, v7, Lcom/android/server/am/ProcessRecord;->pid:I
    ...
    invoke-static {v7, v5, v4}, Lcom/huawei/pgmng/common/Utils;->handleTimeOut(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    goto :goto_0

    .line 254
    :cond_4
    instance-of v7, v1, Landroid/content/pm/ResolveInfo;
...
.method private final processCurBroadcastLocked(Lcom/android/server/am/BroadcastRecord;Lcom/android/server/am/ProcessRecord;)V
    ...
    const-string v2, ", callerApp euid: "
...
.method dumpLocked(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;IZLjava/lang/String;Z)Z
    .locals 17
...
.method final processNextBroadcast(Z)V
    ...
    :try_start_2
    const-string v6, "mParallelBroadcasts.get(0) is null"

    invoke-static {v4, v6}, Landroid/util/Flog;->e(ILjava/lang/String;)I
    ...
    invoke-virtual {v0, v4, v1, v2}, Lcom/android/server/am/BroadcastQueue;->enqueueProxyBroadcast(ZLcom/android/server/am/BroadcastRecord;Ljava/lang/Object;)Z
    ...
    const-string v7, ") should be proxyed, target:("
    ...
    .line 783
    .restart local v45    # "target":Ljava/lang/Object;
    :cond_6
    invoke-virtual/range {p0 .. p0}, Lcom/android/server/am/BroadcastQueue;->getMtmBRManagerEnabled()Z
    ...
    .line 784
    invoke-virtual/range {p0 .. p0}, Lcom/android/server/am/BroadcastQueue;->getMtmBRManager()Lcom/android/server/am/AbsHwMtmBroadcastResourceManager;
    ...
    invoke-interface {v6, v0, v4}, Lcom/android/server/am/AbsHwMtmBroadcastResourceManager;->isBroadcastResourceManaged(Lcom/android/server/am/BroadcastRecord;Lcom/android/server/am/BroadcastFilter;)Z

    move-result v27

    .line 785
    .local v27, "isManaged":Z
    if-eqz v27, :cond_7

    .line 786
    const-string v4, "BroadcastQueue"

    const-string v6, "mHwMtmBroadcastResourceManager isBroadcastResourceManaged"
    ...
    invoke-static {v4, v6}, Landroid/util/Flog;->i(ILjava/lang/String;)I
    ...
    const-string v7, "dispatch ordered broadcast ["
    ...
    invoke-interface {v4, v6, v7}, Lcom/android/server/HwNLPManager;->shouldSkipGoogleNlp(Landroid/content/Intent;Ljava/lang/String;)Z
    ...
    .line 1215
    .local v44, "sourceDir":Ljava/lang/String;
    move-object/from16 v0, v24
    ...
    .line 1216
    .local v38, "publicSourceDir":Ljava/lang/String;
    invoke-static {}, Landroid/app/AppGlobals;->getPackageManager()Landroid/content/pm/IPackageManager;
    ...
    invoke-interface {v4, v0, v6, v7}, Landroid/content/pm/IPackageManager;->getApplicationInfo(Ljava/lang/String;II)Landroid/content/pm/ApplicationInfo;
    :try_end_15
    ...
    .end local v38    # "publicSourceDir":Ljava/lang/String;
    .end local v44    # "sourceDir":Ljava/lang/String;
    :catch_6
    move-exception v20
    ...
    .restart local v38    # "publicSourceDir":Ljava/lang/String;
    .restart local v44    # "sourceDir":Ljava/lang/String;
    :cond_3a
    :try_start_17
    ...
    const-string v7, " is replaced, sourceDir is changed from "
    ...
    const-string v7, ", publicSourceDir is changed from "
    ...
    iget-object v7, v0, Landroid/content/pm/ApplicationInfo;->publicSourceDir:Ljava/lang/String;
...
.method public final replaceParallelBroadcastLocked(Lcom/android/server/am/BroadcastRecord;)Z
    ...
    const-string v4, "***** DROPPING PARALLEL ["
...
.method final setBroadcastTimeoutLocked(J)V
    ...
    invoke-virtual {v1, v0, v2, v3}, Lcom/android/server/am/BroadcastQueue$BroadcastHandler;->sendMessageDelayed(Landroid/os/Message;J)Z
