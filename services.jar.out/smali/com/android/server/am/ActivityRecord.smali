.class public Lcom/android/server/am/ActivityRecord;
.super Lcom/android/server/am/AbsActivityRecord;
...
.field protected static final TAG_STATES:Ljava/lang/String; = "ActivityManager"
...
.field public final realActivity:Landroid/content/ComponentName;
...
# direct methods
.method public constructor <init>(Lcom/android/server/am/ActivityManagerService;Lcom/android/server/am/ProcessRecord;ILjava/lang/String;Landroid/content/Intent;Ljava/lang/String;Landroid/content/pm/ActivityInfo;Landroid/content/res/Configuration;Lcom/android/server/am/ActivityRecord;Ljava/lang/String;IZZLcom/android/server/am/ActivityStackSupervisor;Lcom/android/server/am/ActivityStackSupervisor$ActivityContainer;Landroid/os/Bundle;)V
    .locals 10
    ...
    .prologue
    .line 493
    invoke-direct {p0}, Lcom/android/server/am/AbsActivityRecord;-><init>()V
    ...
    invoke-direct {v5, p0, v6}, Lcom/android/server/am/ActivityRecord$Token;-><init>(Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ActivityManagerService;)V
    ...
    .line 501
    invoke-virtual {p5}, Landroid/content/Intent;->getHwFlags()I
    ...
    iget v5, v5, Landroid/content/pm/ApplicationInfo;->euid:I
    ...
    :goto_0
    iput v5, p0, Lcom/android/server/am/ActivityRecord;->multiLaunchId:I
    ...
    iget-object v5, v5, Lcom/android/server/am/ActivityStack;->mOverrideConfig:Landroid/content/res/Configuration;

    :goto_1
    iput-object v5, p0, Lcom/android/server/am/ActivityRecord;->stackConfigOverride:Landroid/content/res/Configuration;
    ...
    invoke-virtual {v5}, Landroid/app/ActivityOptions;->getUsageTimeReport()Landroid/app/PendingIntent;

    move-result-object v4

    .line 533
    .local v4, "usageReport":Landroid/app/PendingIntent;
    if-eqz v4, :cond_1

    .line 534
    new-instance v5, Lcom/android/server/am/AppTimeTracker;

    invoke-direct {v5, v4}, Lcom/android/server/am/AppTimeTracker;-><init>(Landroid/app/PendingIntent;)V

    iput-object v5, p0, Lcom/android/server/am/ActivityRecord;->appTimeTracker:Lcom/android/server/am/AppTimeTracker;

    .line 541
    .end local v4    # "usageReport":Landroid/app/PendingIntent;
    :cond_1
    const/4 v5, 0x1
    ...
    :goto_6
    iput-boolean v5, p0, Lcom/android/server/am/ActivityRecord;->translucent:Z
    ...
    iget-boolean v5, p0, Lcom/android/server/am/ActivityRecord;->translucent:Z
...
.method static forTokenLocked(Landroid/os/IBinder;)Lcom/android/server/am/ActivityRecord;
    ...
    invoke-static {v2}, Lcom/android/server/am/ActivityRecord$Token;->access$100(Lcom/android/server/am/ActivityRecord$Token;)Lcom/android/server/am/ActivityRecord;
    :try_end_0
...
.method public static forToken_MW(Landroid/os/IBinder;)Lcom/android/server/am/ActivityRecord;
    .locals 6
    .param p0, "token"    # Landroid/os/IBinder;
    ...
    # getter for: Lcom/android/server/am/ActivityRecord$Token;->weakActivity:Ljava/lang/ref/WeakReference;
    invoke-static {v2}, Lcom/android/server/am/ActivityRecord$Token;->access$000(Lcom/android/server/am/ActivityRecord$Token;)Ljava/lang/ref/WeakReference;
...
.method private reportLaunchTimeLocked(J)V
    ...
    .line 1052
    iget-object v1, v8, Lcom/android/server/am/ActivityStack;->mshortComponentName:Ljava/lang/String;
    ...
    invoke-static {v1, v2, v3, v9}, Landroid/util/Jlog;->d(ILjava/lang/String;ILjava/lang/String;)I
...
.method static restoreFromXml(Lorg/xmlpull/v1/XmlPullParser;Lcom/android/server/am/ActivityStackSupervisor;)Lcom/android/server/am/ActivityRecord;
    ...
    .line 1317
    .local v10, "service":Lcom/android/server/am/ActivityManagerService;
    const/4 v7, 0x0
    ...
    invoke-virtual {v10}, Lcom/android/server/am/ActivityManagerService;->getConfiguration()Landroid/content/res/Configuration;
    ...
    invoke-static/range {v10 .. v25}, Lcom/android/server/HwServiceFactory;->createActivityRecord(Lcom/android/server/am/ActivityManagerService;Lcom/android/server/am/ProcessRecord;ILjava/lang/String;Landroid/content/Intent;Ljava/lang/String;Landroid/content/pm/ActivityInfo;Landroid/content/res/Configuration;Lcom/android/server/am/ActivityRecord;Ljava/lang/String;IZZLcom/android/server/am/ActivityStackSupervisor;Lcom/android/server/am/ActivityStackSupervisor$ActivityContainer;Landroid/os/Bundle;)Lcom/android/server/am/ActivityRecord;
    ...
    iput-object v0, v1, Lcom/android/server/am/ActivityRecord;->persistentState:Landroid/os/PersistableBundle;
    ...
    iput-object v0, v1, Lcom/android/server/am/ActivityRecord;->taskDescription:Landroid/app/ActivityManager$TaskDescription;
...
.method dump(Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    .line 224
    const-string v11, " multiLaunchId="
    ...
    iget v11, v0, Lcom/android/server/am/ActivityRecord;->multiLaunchId:I
