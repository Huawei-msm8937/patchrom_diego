...
.field static final IS_FPGA:Z

.field static final LAST_ANR_LIFETIME_DURATION_MSECS:I = 0x6ddd00

.field private static final LOG_SERVICE_START_STOP:Z = true
...
.field static final SERVICE_WAIT_TIMEOUT:I = 0xbb8
...
.field static boardname:Ljava/lang/String;

.field private static final enableANRWarning:Z
...
.field mTmpCollectionResults:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/ArrayList",
            "<",
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/server/am/ActiveServices;->boardname:Ljava/lang/String;

    .line 94
    sget-object v0, Lcom/android/server/am/ActiveServices;->boardname:Ljava/lang/String;
    ...
    sput-boolean v0, Lcom/android/server/am/ActiveServices;->IS_FPGA:Z

    .line 97
    sget-boolean v0, Lcom/android/server/am/ActiveServices;->IS_FPGA:Z
    ...
    .line 104
    sget v0, Lcom/android/server/am/ActiveServices;->SERVICE_TIMEOUT:I
    ...
    .line 186
    const-string v0, "ro.anr.warning.enable"

    invoke-static {v0, v2}, Landroid/os/SystemProperties;->getBoolean(Ljava/lang/String;Z)Z

    move-result v0

    sput-boolean v0, Lcom/android/server/am/ActiveServices;->enableANRWarning:Z
...
.method private final bringDownServiceIfNeededLocked(Lcom/android/server/am/ServiceRecord;ZZ)V
    ...
    const-string v1, "ServiceNeeded not bring down service:"
    ...
    const-string v1, "still in launching not bring down service:"
    ...
    .line 1909
    :cond_1
    invoke-virtual {p0, p1}, Lcom/android/server/am/ActiveServices;->bringDownServiceLocked(Lcom/android/server/am/ServiceRecord;)V
...
.method private final bringUpServiceLocked(Lcom/android/server/am/ServiceRecord;IZZ)Ljava/lang/String;
    ...
    const-string v5, "do nothing when waiting for a restart and Bringing up "
    ...
    .line 1610
    invoke-virtual/range {p0 .. p1}, Lcom/android/server/am/ActiveServices;->bringDownServiceLocked(Lcom/android/server/am/ServiceRecord;)V
    ...
    const-string v5, "bindServiceLocked, r: "
    ...
    const-string v5, "mAm.startProcessLocked for service: "
...
.method private final realStartServiceLocked(Lcom/android/server/am/ServiceRecord;Lcom/android/server/am/ProcessRecord;Z)V
    ...
    const-string v4, "Destroying no retry when creating service "
    ...
    const-string v5, "Destroying no retry when creating service "
...
.method private retrieveServiceLocked(Landroid/content/Intent;Ljava/lang/String;Ljava/lang/String;IIIZZ)Lcom/android/server/am/ActiveServices$ServiceLookupResult;
    ...
    const-string v12, "retrieveServiceLocked: "
    ...
    .line 1143
    .local v24, "isServiceToBeClone":Z
    if-eqz v19, :cond_1
    ...
    invoke-virtual {v5, v10, v0}, Lcom/android/server/am/ActivityManagerService;->isPackageCloned(Ljava/lang/String;I)Z
    ...
    const-string v12, "retrieveServiceLocked, callerApp: "
    ...
    invoke-interface {v5, v0, v1, v2, v3}, Landroid/content/pm/IPackageManager;->resolveService(Landroid/content/Intent;Ljava/lang/String;II)Landroid/content/pm/ResolveInfo;
    ...
    invoke-virtual {v5, v9, v0, v1}, Lcom/android/server/am/ActivityManagerService;->shouldPreventStartService(Landroid/content/pm/ServiceInfo;II)Z
    ...
    const-string v12, "prevent by hsm Will not start service "
    ...
    invoke-static {v5, v10}, Landroid/util/Flog;->w(ILjava/lang/String;)I
    ...
    const-string v10, "resolve service error"

    move-object/from16 v0, v21

    invoke-static {v5, v10, v0}, Landroid/util/Flog;->i(ILjava/lang/String;Ljava/lang/Throwable;)I
    ...
    const-string v12, "prevent by firewall Unable to start service "
    ...
    const-string v12, "retrieve service "
    ...
    invoke-static {v5, v10}, Landroid/util/Flog;->i(ILjava/lang/String;)I
...
.method private final scheduleServiceRestartLocked(Lcom/android/server/am/ServiceRecord;Z)Z
    ...
    iget v0, v0, Landroid/content/pm/ApplicationInfo;->euid:I
    ...
    invoke-virtual/range {v20 .. v22}, Lcom/android/server/am/ActivityManagerService;->isPackageCloned(Ljava/lang/String;I)Z
...
.method private final sendServiceArgsLocked(Lcom/android/server/am/ServiceRecord;ZZ)V
    ...
    const-string v1, "Transaction too large"
...
.method bindServiceLocked(Landroid/app/IApplicationThread;Landroid/os/IBinder;Landroid/content/Intent;Ljava/lang/String;Landroid/app/IServiceConnection;ILjava/lang/String;I)I
    ...
    .line 813
    :cond_4
    iget v4, v14, Lcom/android/server/am/ProcessRecord;->setSchedGroup:I
    ...
    invoke-virtual {v4, v13, v0}, Landroid/util/ArrayMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v4, v3, v5}, Lcom/android/server/am/ActivityManagerService;->smartTrimAddProcessRelation_HwSysM(Lcom/android/server/am/AppBindRecord;Lcom/android/server/am/AppBindRecord;)V
    ...
    invoke-static {v4, v5, v6, v7}, Lcom/huawei/pgmng/log/LogPower;->push(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)I
    ...
    invoke-static {v4, v5, v6, v7, v8}, Lcom/huawei/pgmng/log/LogPower;->push(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)I
...
.method bringDownDisabledPackageServicesLocked(Ljava/lang/String;Ljava/util/Set;IZZZ)Z
    ...
    invoke-virtual/range {v0 .. v6}, Lcom/android/server/am/ActiveServices;->collectPackageServicesLocked(Ljava/lang/String;Ljava/util/Set;ZZZLandroid/util/ArrayMap;)Z
    ...
    invoke-virtual {p0, v0}, Lcom/android/server/am/ActiveServices;->bringDownServiceLocked(Lcom/android/server/am/ServiceRecord;)V
...
.method final bringDownServiceLocked(Lcom/android/server/am/ServiceRecord;)V
    .locals 13
    .param p1, "r"    # Lcom/android/server/am/ServiceRecord;
...
.method cleanUpRemovedTaskLocked(Lcom/android/server/am/TaskRecord;Landroid/content/ComponentName;Landroid/content/Intent;)V
    ...
    .line 2432
    .local v11, "services":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/server/am/ServiceRecord;>;"
    new-instance v9, Ljava/util/ArrayList;

    invoke-direct {v9}, Ljava/util/ArrayList;-><init>()V

    .line 2433
    .local v9, "list":Ljava/util/List;, "Ljava/util/List<Landroid/util/ArrayMap<Landroid/content/ComponentName;Lcom/android/server/am/ServiceRecord;>;>;"
    ...
    .line 2434
    .local v10, "map":Landroid/util/ArrayMap;, "Landroid/util/ArrayMap<Landroid/content/ComponentName;Lcom/android/server/am/ServiceRecord;>;"
    ...
    .line 2456
    :cond_5
    iget-object v12, v1, Lcom/android/server/am/ServiceRecord;->pendingStarts:Ljava/util/ArrayList;
    ...
    :try_start_0
    invoke-direct {p0, v1, v0, v2}, Lcom/android/server/am/ActiveServices;->sendServiceArgsLocked(Lcom/android/server/am/ServiceRecord;ZZ)V
    :try_end_0
    .catch Landroid/os/TransactionTooLargeException; {:try_start_0 .. :try_end_0} :catch_0
...
.method collectPackageServicesLocked(Ljava/lang/String;Ljava/util/Set;ZZZLandroid/util/ArrayMap;)Z
    .locals 9
    .param p1, "packageName"    # Ljava/lang/String;
...
.method protected dumpService(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;Ljava/lang/String;[Ljava/lang/String;IZ)Z
    ...
    invoke-static {v0, v2, v1, v4, v5}, Ljava/lang/System;->arraycopy([II[III)V
    ...
    .restart local v22    # "usersFromAms":[I
    :cond_9
    :try_start_3
...
.method dumpServicesLocked(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;IZZLjava/lang/String;)V
    ...
    .restart local v31    # "usersFromAms":[I
    :catch_2
    move-exception v12
...
.method getRunningServiceInfoLocked(II)Ljava/util/List;
    ...
    .line 2731
    .local v15, "res":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/app/ActivityManager$RunningServiceInfo;>;"
    invoke-static {}, Landroid/os/Binder;->getCallingUid()I
    ...
    .local v10, "ident":J
    :try_start_0
    const-string v22, "android.permission.INTERACT_ACROSS_USERS_FULL"
    ...
    invoke-virtual/range {v22 .. v22}, Lcom/android/server/am/ActivityManagerService;->getUsersLocked()[I

    move-result-object v21

    .line 2739
    .local v21, "usersFromAms":[I
    move-object/from16 v0, v21
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/am/ActiveServices;->getServices(I)Landroid/util/ArrayMap;
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/am/ActiveServices;->makeRunningServiceInfoLocked(Lcom/android/server/am/ServiceRecord;)Landroid/app/ActivityManager$RunningServiceInfo;
    ...
    invoke-virtual {v0, v14}, Lcom/android/server/am/ActiveServices;->makeRunningServiceInfoLocked(Lcom/android/server/am/ServiceRecord;)Landroid/app/ActivityManager$RunningServiceInfo;
    ...
    iput-wide v0, v12, Landroid/app/ActivityManager$RunningServiceInfo;->restarting:J
    ...
    .line 2759
    .end local v8    # "i":I
    .end local v12    # "info":Landroid/app/ActivityManager$RunningServiceInfo;
    .end local v14    # "r":Lcom/android/server/am/ServiceRecord;
    .end local v17    # "ui":I
    .end local v20    # "users":[I
    .end local v21    # "usersFromAms":[I
    :cond_2
    ...
    .line 2771
    .restart local v16    # "sr":Lcom/android/server/am/ServiceRecord;
    move-object/from16 v0, p0
    ...
    .line 2781
    .restart local v12    # "info":Landroid/app/ActivityManager$RunningServiceInfo;
    iget-wide v0, v14, Lcom/android/server/am/ServiceRecord;->nextRestartTime:J
...
.method final killServicesLocked(Lcom/android/server/am/ProcessRecord;Z)V
    ...
    .line 2504
    .local v19, "r":Lcom/android/server/am/ConnectionRecord;
    const/16 v22, 0x0
    ...
    .line 2506
    .end local v19    # "r":Lcom/android/server/am/ConnectionRecord;
    :cond_0
    ...
    const-string v24, "killServices remove destroying "
    ...
    const-string v24, "Killing binding "
    ...
    invoke-virtual/range {v22 .. v23}, Lcom/android/server/am/ActivityManagerService;->shouldPreventRestartService(Ljava/lang/String;)Z

    move-result v17

    .line 2598
    .local v17, "preventRestart":Z
    if-eqz v17, :cond_f
    ...
    const-string v24, " prevent restart by hsm srname: "
    ...
    invoke-static/range {v22 .. v23}, Landroid/util/Flog;->i(ILjava/lang/String;)I
    ...
    .line 2605
    .end local v17    # "preventRestart":Z
    :cond_10
    :goto_9
    if-eqz p2, :cond_11
    ...
    invoke-virtual {v0, v1, v2}, Lcom/android/server/am/ActivityManagerService;->isAcquireAppServiceResourceLocked(Lcom/android/server/am/ServiceRecord;Lcom/android/server/am/ProcessRecord;)Z
    ...
    const-string v24, " prevent restart by RMS srname: "
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/am/ActiveServices;->bringDownServiceLocked(Lcom/android/server/am/ServiceRecord;)V

    goto/16 :goto_8

    .line 2600
    .restart local v17    # "preventRestart":Z
    :cond_12
    const/16 p2, 0x0
    ...
    invoke-virtual/range {v24 .. v24}, Lcom/android/server/am/ProcessStatsService;->getMemFactorLocked()I
...
.method final performServiceRestartLocked(Lcom/android/server/am/ServiceRecord;)V
    ...
    const-string v5, "no need to performServiceRestart for r:"
    ...
    invoke-static {v7, v4}, Landroid/util/Flog;->i(ILjava/lang/String;)I
    ...
    .line 1526
    .local v0, "e":Landroid/os/TransactionTooLargeException;
    const-string v4, "performServiceRestart TransactionTooLarge e:"

    invoke-static {v7, v4, v0}, Landroid/util/Flog;->w(ILjava/lang/String;Ljava/lang/Throwable;)I
    ...
    .restart local v3    # "top_rc":Lcom/android/server/am/ActivityRecord;
    :cond_3
    :try_start_1
    ...
    const-string v6, "Reschedule service restart due to app launch r.shortName "
...
.method processStartTimedOutLocked(Lcom/android/server/am/ProcessRecord;)V
    ...
    .line 2354
    invoke-virtual {p0, v1}, Lcom/android/server/am/ActiveServices;->bringDownServiceLocked(Lcom/android/server/am/ServiceRecord;)V
...
.method removeConnectionLocked(Lcom/android/server/am/ConnectionRecord;Lcom/android/server/am/ProcessRecord;Lcom/android/server/am/ActivityRecord;)V
    ...
    iget-object v9, v0, Lcom/android/server/am/ConnectionRecord;->conn:Landroid/app/IServiceConnection;
    ...
    iget-object v8, v2, Lcom/android/server/am/AppBindRecord;->service:Lcom/android/server/am/ServiceRecord;

    .line 2045
    .local v8, "s":Lcom/android/server/am/ServiceRecord;
    iget-object v9, v8, Lcom/android/server/am/ServiceRecord;->connections:Landroid/util/ArrayMap;
    ...
    .line 2052
    :cond_0
    iget-object v9, v2, Lcom/android/server/am/AppBindRecord;->connections:Landroid/util/ArraySet;
    ...
    iget-object v9, v9, Lcom/android/server/am/ActivityRecord;->connections:Ljava/util/HashSet;
    ...
    .line 2058
    :cond_1
    iget-object v9, v2, Lcom/android/server/am/AppBindRecord;->client:Lcom/android/server/am/ProcessRecord;
    ...
    iget-object v9, v9, Lcom/android/server/am/ProcessRecord;->connections:Landroid/util/ArraySet;
    ...
    .line 2062
    iget-object v7, v2, Lcom/android/server/am/AppBindRecord;->client:Lcom/android/server/am/ProcessRecord;
    ...
    iget-object v12, v8, Lcom/android/server/am/ServiceRecord;->app:Lcom/android/server/am/ProcessRecord;
    ...
    invoke-static {v9, v10, v11, v12, v13}, Lcom/huawei/pgmng/log/LogPower;->push(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)I

    .line 2076
    :cond_2
    move-object/from16 v0, p1

    iget v9, v0, Lcom/android/server/am/ConnectionRecord;->flags:I
    ...
    invoke-virtual {v9}, Lcom/android/server/am/ProcessRecord;->updateHasAboveClientLocked()V
    ...
    invoke-direct {v0, v9, v1, v10}, Lcom/android/server/am/ActiveServices;->updateServiceClientActivitiesLocked(Lcom/android/server/am/ProcessRecord;Lcom/android/server/am/ConnectionRecord;Z)Z
    ...
    iget-object v9, v0, Lcom/android/server/am/ActiveServices;->mServiceConnections:Landroid/util/ArrayMap;
    ...
    iget-object v12, v8, Lcom/android/server/am/ServiceRecord;->appInfo:Landroid/content/pm/ApplicationInfo;

    iget v12, v12, Landroid/content/pm/ApplicationInfo;->uid:I

    iget-object v13, v8, Lcom/android/server/am/ServiceRecord;->name:Landroid/content/ComponentName;

    invoke-virtual {v9, v10, v11, v12, v13}, Lcom/android/server/am/ActivityManagerService;->stopAssociationLocked(ILjava/lang/String;ILandroid/content/ComponentName;)V
    ...
    .line 2094
    iget-object v9, v2, Lcom/android/server/am/AppBindRecord;->intent:Lcom/android/server/am/IntentBindRecord;

    iget-object v9, v9, Lcom/android/server/am/IntentBindRecord;->apps:Landroid/util/ArrayMap;
    ...
    iget-boolean v9, v0, Lcom/android/server/am/ConnectionRecord;->serviceDead:Z
    ...
    const-string v11, "Disconnecting binding "
    ...
    iget-boolean v11, v11, Lcom/android/server/am/IntentBindRecord;->hasBound:Z
    ...
    invoke-direct {v0, v8, v9, v10}, Lcom/android/server/am/ActiveServices;->bumpServiceExecutingLocked(Lcom/android/server/am/ServiceRecord;ZLjava/lang/String;)V
    ...
    iget v9, v9, Lcom/android/server/am/ProcessRecord;->setProcState:I
    ...
    iput-boolean v10, v9, Lcom/android/server/am/IntentBindRecord;->hasBound:Z
    ...
    iput-boolean v10, v9, Lcom/android/server/am/IntentBindRecord;->doRebind:Z
    ...
    invoke-interface {v9, v8, v10}, Landroid/app/IApplicationThread;->scheduleUnbindService(Landroid/os/IBinder;Landroid/content/Intent;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-virtual {v9, v10, v11, v12, v13}, Lcom/android/internal/app/ProcessStats$ServiceState;->setBound(ZIJ)V
    ...
    invoke-direct {v0, v8, v9, v6}, Lcom/android/server/am/ActiveServices;->bringDownServiceIfNeededLocked(Lcom/android/server/am/ServiceRecord;ZZ)V

    .line 2138
    .end local v6    # "hasAutoCreate":Z
    :cond_b
    return-void
    ...
    iget-object v11, v8, Lcom/android/server/am/ServiceRecord;->shortName:Ljava/lang/String;
    ...
    iget-boolean v9, v9, Lcom/android/server/am/ProcessRecord;->killedByAm:Z
    ...
    invoke-direct {v0, v8}, Lcom/android/server/am/ActiveServices;->serviceProcessGoneLocked(Lcom/android/server/am/ServiceRecord;)V
...
.method scheduleServiceTimeoutLocked(Lcom/android/server/am/ProcessRecord;)V
    ...
    const-string v4, "no need to schedule service timeout"

    invoke-static {v1, v4}, Landroid/util/Flog;->i(ILjava/lang/String;)I
...
.method serviceDoneExecutingLocked(Lcom/android/server/am/ServiceRecord;III)V
    ...
    const-string v5, "Service done not stopIfKilled for r:"
    ...
    invoke-static {v8, v4}, Landroid/util/Flog;->i(ILjava/lang/String;)I
    ...
    const-string v5, "Service done with onDestroy, but not inDestroying:"
    ...
    invoke-static {v8, v4}, Landroid/util/Flog;->w(ILjava/lang/String;)I
    ...
    const-string v5, "Service done with onDestroy, but executeNesting="
...
.method serviceTimeout(Lcom/android/server/am/ProcessRecord;)V
    ...
    const-string v3, "nextTime invaild, remove the message"
    ...
    invoke-virtual {v2, v3, v0}, Lcom/android/server/am/ActivityManagerService$MainHandler;->removeMessages(ILjava/lang/Object;)V
...
.method startServiceLocked(Landroid/app/IApplicationThread;Landroid/content/Intent;Ljava/lang/String;IILjava/lang/String;I)Landroid/content/ComponentName;
    ...
    .restart local v16    # "addToStarting":Z
    .restart local v18    # "proc":Lcom/android/server/am/ProcessRecord;
    :cond_d
    ...
    invoke-static {v2, v3, v4, v5, v6}, Lcom/huawei/pgmng/log/LogPower;->push(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)I
...
.method stopServiceTokenLocked(Landroid/content/ComponentName;Landroid/os/IBinder;I)Z
    ...
    iget v2, v8, Landroid/content/pm/ApplicationInfo;->euid:I
    ...
    const-string v10, "stopServiceToken: "
    ...
    .end local v2    # "euid":I
    :cond_1
    invoke-direct {p0, p1, p2, v2}, Lcom/android/server/am/ActiveServices;->findServiceLocked(Landroid/content/ComponentName;Landroid/os/IBinder;I)Lcom/android/server/am/ServiceRecord;
    ...
    .line 605
    invoke-virtual {v3, p3, v7}, Lcom/android/server/am/ServiceRecord;->findDeliveredStart(IZ)Lcom/android/server/am/ServiceRecord$StartItem;

    move-result-object v6

    .line 606
    .local v6, "si":Lcom/android/server/am/ServiceRecord$StartItem;
    if-eqz v6, :cond_3
    ...
    .line 609
    .local v1, "cur":Lcom/android/server/am/ServiceRecord$StartItem;
    ...
    .line 616
    .end local v1    # "cur":Lcom/android/server/am/ServiceRecord$StartItem;
    :cond_3
    ...
    .line 641
    .end local v6    # "si":Lcom/android/server/am/ServiceRecord$StartItem;
    :cond_4
    :goto_1
    return v7
    ...
    .restart local v6    # "si":Lcom/android/server/am/ServiceRecord$StartItem;
    :cond_6
    iget-object v8, v3, Lcom/android/server/am/ServiceRecord;->deliveredStarts:Ljava/util/ArrayList;
    ...
    const-string v10, "stopServiceToken startId "
    ...
    const-string v10, " is last, but have "

    invoke-virtual {v9, v10}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v9

    iget-object v10, v3, Lcom/android/server/am/ServiceRecord;->deliveredStarts:Ljava/util/ArrayList;
    ...
    const-string v10, " remaining args"
    ...
    .end local v6    # "si":Lcom/android/server/am/ServiceRecord$StartItem;
    :cond_7
    iget-object v8, v3, Lcom/android/server/am/ServiceRecord;->stats:Lcom/android/internal/os/BatteryStatsImpl$Uid$Pkg$Serv;
    ...
    .line 628
    :try_start_0
    iget-object v9, v3, Lcom/android/server/am/ServiceRecord;->stats:Lcom/android/internal/os/BatteryStatsImpl$Uid$Pkg$Serv;

    invoke-virtual {v9}, Lcom/android/internal/os/BatteryStatsImpl$Uid$Pkg$Serv;->stopRunningLocked()V
    ...
    .line 631
    iget-object v8, v3, Lcom/android/server/am/ServiceRecord;->tracker:Lcom/android/internal/app/ProcessStats$ServiceState;
    ...
    invoke-virtual {v8, v7, v9, v10, v11}, Lcom/android/internal/app/ProcessStats$ServiceState;->setStarted(ZIJ)V
    ...
    .line 637
    .local v4, "origId":J
    invoke-direct {p0, v3, v7, v7}, Lcom/android/server/am/ActiveServices;->bringDownServiceIfNeededLocked(Lcom/android/server/am/ServiceRecord;ZZ)V
