...
.super Lcom/android/server/am/AbsActivityStackSupervisor;
...
.field private static final MW_EXTRA_LAUNCH_DUAL_WINDOW:Ljava/lang/String; = "multi-win-dual-window"
...
.field private static final isPerfhubEnable:Z
...
.field protected final mActivityDisplays:Landroid/util/SparseArray;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroid/util/SparseArray",
            "<",
...
.field mActivityLaunchTrack:Ljava/lang/String;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/server/am/ActivityStackSupervisor;->POWER_SAVER_PLUS:Z

    .line 213
    const-string v0, "ro.config.hw_perfhub"

    invoke-static {v0, v1}, Landroid/os/SystemProperties;->getBoolean(Ljava/lang/String;Z)Z

    move-result v0

    sput-boolean v0, Lcom/android/server/am/ActivityStackSupervisor;->isPerfhubEnable:Z
...
.method public constructor <init>(Lcom/android/server/am/ActivityManagerService;Lcom/android/server/am/RecentTasks;)V
    ...
    .line 390
    invoke-direct {p0}, Lcom/android/server/am/AbsActivityStackSupervisor;-><init>()V

    .line 202
    iput-object v2, p0, Lcom/android/server/am/ActivityStackSupervisor;->mPerf_iop:Landroid/util/BoostFramework;
    ...
    .line 339
    iput-object v2, p0, Lcom/android/server/am/ActivityStackSupervisor;->mCurActivityPkName:Ljava/lang/String;
    ...
    iput-object v0, p0, Lcom/android/server/am/ActivityStackSupervisor;->mActivityLaunchTrack:Ljava/lang/String;
    ...
    iput-object v0, p0, Lcom/android/server/am/ActivityStackSupervisor;->mCurActivityPkName:Ljava/lang/String;
...
.method static synthetic access$900(Lcom/android/server/am/ActivityStackSupervisor;)I
    .locals 1
    .param p0, "x0"    # Lcom/android/server/am/ActivityStackSupervisor;
...
.method attachApplicationLocked(Lcom/android/server/am/ProcessRecord;)Z
    ...
    iget v9, v9, Landroid/content/pm/ApplicationInfo;->euid:I
...
.method comeOutOfSleepIfNeededLocked()V
    ...
    .line 3850
    const-string v4, "outofsleep"

    iput-object v4, p0, Lcom/android/server/am/ActivityStackSupervisor;->mActivityLaunchTrack:Ljava/lang/String;
...
.method getTasksLocked(ILjava/util/List;IZ)V
    ...
    iput-wide v2, v0, Landroid/app/ActivityManager$RunningTaskInfo;->lastActiveTime:J
    ...
    .restart local v6    # "lastActiveTime":J
    :cond_4
    cmp-long v17, v6, v8
...
.method public getTopMwRunningRecordLocked()Lcom/android/server/am/ActivityRecord;
    .locals 2
    ...
    .line 5340
    .local v0, "topRecord":Lcom/android/server/am/ActivityRecord;
    if-eqz v0, :cond_0

    invoke-virtual {v0}, Lcom/android/server/am/ActivityRecord;->isMultiWin()Z
    ...
    .line 5343
    .end local v0    # "topRecord":Lcom/android/server/am/ActivityRecord;
    :goto_0
    return-object v0

    .restart local v0    # "topRecord":Lcom/android/server/am/ActivityRecord;
    :cond_0
    const/4 v0, 0x0
...
.method pauseBackStacks(ZZZ)Z
    ...
    .line 790
    invoke-virtual {p0}, Lcom/android/server/am/ActivityStackSupervisor;->pauseMwBackStacks()Z
    ...
    .local v2, "someActivityPaused":I
    :goto_0
    return v2

    .line 797
    .end local v2    # "someActivityPaused":I
    .restart local v1    # "someActivityPaused":Z
    :cond_0
    iget-object v6, p0, Lcom/android/server/am/ActivityStackSupervisor;->mActivityDisplays:Landroid/util/SparseArray;
    ...
    invoke-virtual {v3, p1, v6, p2, p3}, Lcom/android/server/am/ActivityStack;->startPausingLocked(ZZZZ)Z
    ...
    .line 809
    .restart local v2    # "someActivityPaused":I
    goto :goto_0
.end method
...
.method final realStartActivityLocked(Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ProcessRecord;ZZ)Z
    ...
    .line 1429
    invoke-static {}, Landroid/app/HwCustNonHardwareAcceleratedPackagesManager;->getDefault()Landroid/app/HwCustNonHardwareAcceleratedPackagesManager;
    ...
    invoke-virtual {v4, v5, v6}, Landroid/app/HwCustNonHardwareAcceleratedPackagesManager;->shouldForceEnabled(Landroid/content/pm/ActivityInfo;Landroid/content/ComponentName;)Z

    move-result v24

    .line 1431
    .local v24, "forceHardAccel":Z
    if-eqz v24, :cond_10
    ...
    iput-object v4, v0, Lcom/android/server/am/ActivityStackSupervisor;->mActivityLaunchTrack:Ljava/lang/String;
    ...
    const-string v6, ", r.info.applicationInfo.euid  = "
    ...
    invoke-virtual {v4, v0, v1}, Lcom/android/server/am/ActivityManagerService;->isPackageInstallerActivity(Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ProcessRecord;)Z
    ...
    invoke-virtual {v4, v5}, Lcom/android/server/wm/WindowManagerService;->sendUpdateStateSuspensionWindow(Z)V
    ...
    const-string v5, "multi-win-dual-window"
    ...
    iget-object v5, v0, Lcom/android/server/am/ActivityStackSupervisor;->mActivityLaunchTrack:Ljava/lang/String;

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    const-string v5, " minmalResume"
    ...
    .line 1407
    .end local v24    # "forceHardAccel":Z
    ...
    .end local v27    # "profileFd":Landroid/os/ParcelFileDescriptor;
    .end local v28    # "profileFile":Ljava/lang/String;
    .restart local v24    # "forceHardAccel":Z
    :cond_18
    const/16 v19, 0x0
...
.method reportActivityLaunchedLocked(ZLcom/android/server/am/ActivityRecord;JJ)V
    ...
    const-string v5, "waited activity launched, r= "
...
.method resolveActivity(Landroid/content/Intent;Ljava/lang/String;ILandroid/app/ProfilerInfo;I)Landroid/content/pm/ActivityInfo;
    ...
    invoke-interface {v3, p1, p2, v5, p5}, Landroid/content/pm/IPackageManager;->resolveIntent(Landroid/content/Intent;Ljava/lang/String;II)Landroid/content/pm/ResolveInfo;
    ...
    invoke-virtual {v3, v5, v6, v4}, Lcom/android/server/am/ActivityManagerService;->setDebugApp(Ljava/lang/String;ZZ)V
...
.method sendWaitingVisibleReportLocked(Lcom/android/server/am/ActivityRecord;)V
    ...
    const-string v5, "waited activity visible, r="
...
.method startActivityLocked(Landroid/app/IApplicationThread;Landroid/content/Intent;Ljava/lang/String;Landroid/content/pm/ActivityInfo;Landroid/service/voice/IVoiceInteractionSession;Lcom/android/internal/app/IVoiceInteractor;Landroid/os/IBinder;Ljava/lang/String;IIILjava/lang/String;IIILandroid/os/Bundle;ZZ[Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ActivityStackSupervisor$ActivityContainer;Lcom/android/server/am/TaskRecord;)I
    ...
    invoke-static {v7, v9}, Landroid/hdm/HwDeviceManager;->disallowOp(ILjava/lang/String;)Z
    ...
    const-string v10, "] is disallowed running by MDM apk"
    ...
    invoke-interface {v7}, Landroid/vrsystem/IVRSystemServiceManager;->isVRMode()Z
    ...
    invoke-interface {v7, v9, v10}, Landroid/vrsystem/IVRSystemServiceManager;->isVRApplication(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    invoke-virtual {v7, v0}, Lcom/android/server/am/ActivityManagerService;->getRecordForAppLocked(Landroid/app/IApplicationThread;)Lcom/android/server/am/ProcessRecord;
    ...
    iget-object v7, v0, Lcom/android/server/am/ActivityStackSupervisor;->mFocusedStack:Lcom/android/server/am/ActivityStack;
    ...
    invoke-static {v9, v7}, Landroid/util/Flog;->i(ILjava/lang/String;)I

    .line 1628
    invoke-virtual/range {p0 .. p2}, Lcom/android/server/am/ActivityStackSupervisor;->RecognitionMaliciousApp(Landroid/app/IApplicationThread;Landroid/content/Intent;)V
    ...
    .line 1632
    .local v28, "cmp":Landroid/content/ComponentName;
    const-string v41, ""

    .line 1633
    .local v41, "strPkg":Ljava/lang/String;
    if-eqz v28, :cond_4
    ...
    invoke-virtual {v7}, Lcom/android/server/am/ActivityManagerService;->getRecordCust()Lcom/android/server/util/AbsUserBehaviourRecord;

    move-result-object v7

    move-object/from16 v0, v41

    invoke-virtual {v7, v0}, Lcom/android/server/util/AbsUserBehaviourRecord;->appEnterRecord(Ljava/lang/String;)V
    ...
    invoke-static {v7, v9, v10}, Landroid/util/Jlog;->perfEvent(ILjava/lang/String;[I)I

    .line 1646
    move-object/from16 v0, p0

    iget-object v7, v0, Lcom/android/server/am/ActivityStackSupervisor;->mCurActivityPkName:Ljava/lang/String;
    ...
    .line 1648
    :cond_6
    sget-boolean v7, Lcom/android/server/am/ActivityStackSupervisor;->isPerfhubEnable:Z
    ...
    .line 1658
    .end local v28    # "cmp":Landroid/content/ComponentName;
    .end local v41    # "strPkg":Ljava/lang/String;
    :cond_7
    :goto_4
    const/4 v11, 0x0
    ...
    .line 1662
    sget-boolean v7, Lcom/android/server/am/ActivityManagerDebugConfig;->DEBUG_RESULTS:Z
    ...
    iget-boolean v7, v11, Lcom/android/server/am/ActivityRecord;->finishing:Z
    ...
    iget-object v7, v0, Lcom/android/server/am/ActivityStackSupervisor$ActivityContainer;->mActivityDisplay:Lcom/android/server/am/ActivityStackSupervisor$ActivityDisplay;
    ...
    iget v7, v7, Lcom/android/server/am/ActivityStackSupervisor$ActivityDisplay;->mDisplayId:I

    goto/16 :goto_3

    .line 1651
    .restart local v28    # "cmp":Landroid/content/ComponentName;
    .restart local v41    # "strPkg":Ljava/lang/String;
    :cond_e
    const/16 v7, 0x8b

    move-object/from16 v0, v41

    invoke-static {v7, v0}, Lcom/huawei/pgmng/log/LogPower;->push(ILjava/lang/String;)I
    ...
    .end local v28    # "cmp":Landroid/content/ComponentName;
    .end local v41    # "strPkg":Ljava/lang/String;
    .restart local v8    # "resultRecord":Lcom/android/server/am/ActivityRecord;
    ...
    const-string v10, "resultRecord isn\'t set, requestCode="
    ...
    const-string v10, ", sourceRecord finishing="
    ...
    invoke-virtual {v8}, Lcom/android/server/am/ActivityRecord;->isInStackLocked()Z
    ...
    const-string v10, "Forwarding result to: "
    ...
    iput-object v7, v0, Lcom/android/server/am/ActivityRecord;->resultTo:Lcom/android/server/am/ActivityRecord;
    ...
    invoke-virtual {v8, v0, v1, v2}, Lcom/android/server/am/ActivityRecord;->removeResultsLocked(Lcom/android/server/am/ActivityRecord;Ljava/lang/String;I)V

    .line 1694
    :cond_13
    move-object/from16 v0, v38

    iget v7, v0, Lcom/android/server/am/ActivityRecord;->launchedFromUid:I
    ...
    iget-object v7, v7, Lcom/android/server/am/TaskRecord;->voiceSession:Landroid/service/voice/IVoiceInteractionSession;
    ...
    iget v7, v7, Landroid/content/pm/ApplicationInfo;->euid:I
    ...
    invoke-interface {v7, v9, v0, v1}, Landroid/content/pm/IPackageManager;->activitySupportsIntent(Landroid/content/ComponentName;Landroid/content/Intent;Ljava/lang/String;)Z
    ...
    .line 1773
    .local v6, "resultStack":Lcom/android/server/am/ActivityStack;
    :goto_8
    if-eqz v31, :cond_1d
    ...
    .line 1747
    .end local v6    # "resultStack":Lcom/android/server/am/ActivityStack;
    :catch_0
    move-exception v30
    ...
    .end local v30    # "e":Landroid/os/RemoteException;
    :cond_1c
    iget-object v7, v8, Lcom/android/server/am/ActivityRecord;->task:Lcom/android/server/am/TaskRecord;

    iget-object v6, v7, Lcom/android/server/am/TaskRecord;->stack:Lcom/android/server/am/ActivityStack;

    goto :goto_8

    .line 1783
    .restart local v6    # "resultStack":Lcom/android/server/am/ActivityStack;
    :cond_1d
    const/16 v25, 0x0
    ...
    const-string v9, "android.permission.START_ANY_ACTIVITY"

    move/from16 v0, p10

    move/from16 v1, p11

    invoke-virtual {v7, v9, v0, v1}, Lcom/android/server/am/ActivityManagerService;->checkPermission(Ljava/lang/String;II)I
    ...
    .line 1789
    invoke-direct/range {v9 .. v14}, Lcom/android/server/am/ActivityStackSupervisor;->getComponentRestrictionForCallingPackage(Landroid/content/pm/ActivityInfo;Ljava/lang/String;IIZ)I
    ...
    invoke-direct {v0, v7, v1, v2, v3}, Lcom/android/server/am/ActivityStackSupervisor;->getActionRestrictionForCallingPackage(Ljava/lang/String;Ljava/lang/String;II)I
    ...
    const-string v9, " with revoked permission "

    invoke-virtual {v7, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v9

    sget-object v7, Lcom/android/server/am/ActivityStackSupervisor;->ACTION_TO_RUNTIME_PERMISSION:Landroid/util/ArrayMap;
    ...
    const-string v9, "Appop Denial: starting "
    ...
    iget-object v9, v7, Lcom/android/server/am/ActivityManagerService;->mIntentFirewall:Lcom/android/server/firewall/IntentFirewall;
    ...
    invoke-virtual/range {v9 .. v14}, Lcom/android/server/firewall/IntentFirewall;->checkStartActivity(Landroid/content/Intent;IILjava/lang/String;Landroid/content/pm/ApplicationInfo;)Z
    ...
    const-string v9, "Abort from intent firewall"
    ...
    iget-object v7, v7, Lcom/android/server/am/ActivityManagerService;->mCustomController:Landroid/app/IActivityController;
    ...
    invoke-virtual {v7, v0, v9}, Lcom/android/server/am/ActivityManagerService;->customActivityStarting(Landroid/content/Intent;Ljava/lang/String;)Z
    ...
    const-string v9, "Abort from controller"
    ...
    .end local v30    # "e":Landroid/os/RemoteException;
    :cond_2b
    sget-boolean v7, Lcom/android/server/am/ActivityManagerService;->MULTIWINDOW_FLAG:Z
    ...
    invoke-virtual {v0, v1, v2, v3, v4}, Lcom/android/server/am/ActivityStackSupervisor;->isHomeLauncheFromMultiWin(ZILandroid/content/Intent;Lcom/android/server/am/ProcessRecord;)Z
    ...
    const-string v9, "returning from multi-win launcher"
    ...
    const-string v10, "ActivityRecord info: "
    ...
    iget v10, v10, Landroid/content/pm/ApplicationInfo;->euid:I
    ...
    iget-object v0, v7, Lcom/android/server/am/ActivityManagerService;->mConfiguration:Landroid/content/res/Configuration;
    ...
    invoke-virtual {v7, v0, v1, v2}, Lcom/android/server/am/ActivityManagerService;->shouldPreventActivity(Landroid/content/Intent;Landroid/content/pm/ActivityInfo;Lcom/android/server/am/ActivityRecord;)Z
    ...
    const-string v10, "forbiden launch for activity: "
    ...
    iput-object v7, v0, Lcom/android/server/am/ActivityRecord;->appTimeTracker:Lcom/android/server/am/AppTimeTracker;
    ...
    invoke-virtual {v7, v0}, Lcom/android/server/am/ActivityManagerService;->isStartLauncher(Landroid/content/Intent;)Z
    ...
    iget-object v7, v0, Lcom/android/server/am/ActivityStack;->mLastPausedActivity:Lcom/android/server/am/ActivityRecord;
    ...
    iget-object v9, v0, Lcom/android/server/am/ActivityStack;->mLastPausedActivity:Lcom/android/server/am/ActivityRecord;
    ...
    const-string v10, "abort launch for activity: "
    ...
    const-string v14, "Activity start"
    ...
    invoke-virtual/range {v9 .. v14}, Lcom/android/server/am/ActivityManagerService;->checkAppSwitchAllowedLocked(IIIILjava/lang/String;)Z
    ...
    iget-object v7, v0, Lcom/android/server/am/ActivityStackSupervisor;->mPendingActivityLaunches:Ljava/util/ArrayList;
    ...
    iget-boolean v7, v7, Lcom/android/server/am/ActivityManagerService;->mDidAppSwitch:Z
    ...
    iput-wide v12, v7, Lcom/android/server/am/ActivityManagerService;->mAppSwitchesAllowedTime:J
    ...
    invoke-virtual {v0, v7}, Lcom/android/server/am/ActivityStackSupervisor;->doPendingActivityLaunchesLocked(Z)V
    ...
    invoke-virtual {v0, v1, v2}, Lcom/android/server/am/ActivityStackSupervisor;->getMwSourceRecord(Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ActivityRecord;)Lcom/android/server/am/ActivityRecord;

    move-result-object v35

    .line 1956
    .local v35, "mwSourceRecord":Lcom/android/server/am/ActivityRecord;
    if-eqz v35, :cond_37
    ...
    .line 1962
    .end local v35    # "mwSourceRecord":Lcom/android/server/am/ActivityRecord;
    .end local v38    # "sourceRecord":Lcom/android/server/am/ActivityRecord;
    .restart local v11    # "sourceRecord":Lcom/android/server/am/ActivityRecord;
    :goto_10
    const/4 v15, 0x1
    ...
    invoke-virtual/range {v9 .. v17}, Lcom/android/server/am/ActivityStackSupervisor;->startActivityUncheckedLocked(Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ActivityRecord;Landroid/service/voice/IVoiceInteractionSession;Lcom/android/internal/app/IVoiceInteractor;IZLandroid/os/Bundle;Lcom/android/server/am/TaskRecord;)I
    ...
    iput-boolean v9, v7, Lcom/android/server/am/ActivityManagerService;->mDidAppSwitch:Z
    ...
    invoke-static {v7, v9}, Landroid/util/Jlog;->d(ILjava/lang/String;)I
...
.method startActivityMayWait(Landroid/app/IApplicationThread;ILjava/lang/String;Landroid/content/Intent;Ljava/lang/String;Landroid/service/voice/IVoiceInteractionSession;Lcom/android/internal/app/IVoiceInteractor;Landroid/os/IBinder;Ljava/lang/String;IILandroid/app/ProfilerInfo;Landroid/app/IActivityManager$WaitResult;Landroid/content/res/Configuration;Landroid/os/Bundle;ZILandroid/app/IActivityContainer;Lcom/android/server/am/TaskRecord;)I
    ...
    .line 1047
    .local v35, "isSuperPowerSavingMode":Z
    if-eqz v35, :cond_1
    ...
    .line 1050
    .local v32, "categories":Ljava/util/Set;, "Ljava/util/Set<Ljava/lang/String;>;"
    if-eqz v32, :cond_1
    ...
    .line 1053
    sget-boolean v2, Lcom/android/server/am/ActivityStackSupervisor;->POWER_SAVER_PLUS:Z
    ...
    const-string v4, "com.huawei.android.launcher.powersavemode.PowerSaveModeLauncher"

    invoke-virtual {v3, v2, v4}, Landroid/content/Intent;->setClassName(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;

    .end local v32    # "categories":Ljava/util/Set;, "Ljava/util/Set<Ljava/lang/String;>;"
    :cond_1
    :goto_1
    move-object/from16 v2, p0
    ...
    const-string v4, "parentActivity is not resumed, cancel activity start"
    ...
    .end local v35    # "isSuperPowerSavingMode":Z
    :cond_2
    const/16 v26, 0x0
    ...
    .restart local v32    # "categories":Ljava/util/Set;, "Ljava/util/Set<Ljava/lang/String;>;"
    .restart local v35    # "isSuperPowerSavingMode":Z
    :cond_3
    const-string v2, "com.huawei.android.launcher"

    const-string v4, "com.huawei.android.launcher.limitpowermode.LimitPowerModeLauncher"
    ...
    iget v2, v2, Landroid/content/pm/ApplicationInfo;->euid:I

    move-object/from16 v0, v30

    iget-object v4, v0, Landroid/content/pm/ActivityInfo;->applicationInfo:Landroid/content/pm/ApplicationInfo;

    iget v4, v4, Landroid/content/pm/ApplicationInfo;->euid:I
    ...
    const-string v4, "launch heavy weight process"
    ...
    invoke-virtual {v2, v0, v1}, Lcom/android/server/am/ActivityManagerService;->addCallerToIntent(Landroid/content/Intent;Landroid/app/IApplicationThread;)V

    .line 1179
    invoke-static/range {p4 .. p4}, Landroid/hdm/HwDeviceManager;->disallowOp(Landroid/content/Intent;)Z
    ...
    const-string v4, "due to disallow op launching activity aborted"
    ...
    const-string v5, "launching activity aborted, reason code: "
    ...
    const-string v5, "waiting activity visible for intent: "
    ...
    const-string v5, "waiting activity: "
...
.method final startActivityUncheckedLocked(Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ActivityRecord;Landroid/service/voice/IVoiceInteractionSession;Lcom/android/internal/app/IVoiceInteractor;IZLandroid/os/Bundle;Lcom/android/server/am/TaskRecord;)I
    ...
    .line 2128
    invoke-virtual/range {p0 .. p2}, Lcom/android/server/am/ActivityStackSupervisor;->updateMwCallerActivityUncheckedLocked(Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ActivityRecord;)V
    ...
    .restart local v7    # "launchFlags":I
    :goto_5
    const/high16 v3, 0x10000000
    ...
    .line 2228
    .local v45, "notTop":Lcom/android/server/am/ActivityRecord;
    :goto_7
    ...
    .line 2230
    .local v26, "checkedCaller":Lcom/android/server/am/ActivityRecord;
    if-nez v26, :cond_8
    ...
    .line 2247
    .end local v26    # "checkedCaller":Lcom/android/server/am/ActivityRecord;
    :cond_9
    const/16 v32, 0x0

    .line 2249
    .local v32, "lMWNonFocusLaunch":Z
    const/16 v23, 0x0

    .line 2250
    .local v23, "addingToTask":Z
    const/16 v48, 0x0

    .line 2255
    .local v48, "reuseTask":Lcom/android/server/am/TaskRecord;
    if-nez p2, :cond_1f
    ...
    .line 2257
    .local v24, "baseIntent":Landroid/content/Intent;
    ...
    const-string v6, "inTask isn\'t null, root: "
    ...
    .line 2144
    .end local v7    # "launchFlags":I
    .end local v23    # "addingToTask":Z
    .end local v24    # "baseIntent":Landroid/content/Intent;
    .end local v32    # "lMWNonFocusLaunch":Z
    ...
    .end local v45    # "notTop":Lcom/android/server/am/ActivityRecord;
    .end local v48    # "reuseTask":Lcom/android/server/am/TaskRecord;
    ...
    const-string v6, ", using documentLaunchMode="
    ...
    const-string v6, ", launchTaskBehind="
    ...
    .line 2267
    .restart local v23    # "addingToTask":Z
    .restart local v24    # "baseIntent":Landroid/content/Intent;
    .restart local v32    # "lMWNonFocusLaunch":Z
    .restart local v45    # "notTop":Lcom/android/server/am/ActivityRecord;
    .restart local v48    # "reuseTask":Lcom/android/server/am/TaskRecord;
    ...
    .line 2283
    const v28, 0x18082000

    .line 2286
    .local v28, "flagsOfInterest":I
    const v3, -0x18082001
    ...
    .line 2302
    .end local v28    # "flagsOfInterest":I
    :goto_8
    ...
    invoke-virtual/range {p1 .. p1}, Lcom/android/server/am/ActivityRecord;->isMultiWin()Z
    ...
    .line 2382
    invoke-virtual/range {p0 .. p1}, Lcom/android/server/am/ActivityStackSupervisor;->isMwNonFocusLaunch(Lcom/android/server/am/ActivityRecord;)Z
    ...
    .line 2387
    .local v43, "newTaskInfo":Landroid/content/pm/ActivityInfo;
    const/16 v44, 0x0

    .line 2389
    .local v44, "newTaskIntent":Landroid/content/Intent;
    if-eqz p2, :cond_26
    ...
    .line 2415
    .local v50, "sourceStack":Lcom/android/server/am/ActivityStack;
    :goto_b
    const/16 v39, 0x0

    .line 2419
    .local v39, "movedHome":Z
    const/16 v41, 0x0

    .line 2421
    .local v41, "mwRecordRegisterNeed":Z
    const/16 v3, 0x65
    ...
    const-string v6, "Intent flags adjusted to  "
    ...
    invoke-virtual {v0, v1, v2, v5}, Lcom/android/server/am/ActivityStackSupervisor;->getMwIntentActivityRecord(Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ActivityRecord;)Lcom/android/server/am/ActivityRecord;
    ...
    .end local v9    # "isMWRoot":Z
    :goto_10
    return v3

    .line 2295
    .end local v12    # "noAnimation":Z
    .end local v39    # "movedHome":Z
    .end local v41    # "mwRecordRegisterNeed":Z
    .end local v43    # "newTaskInfo":Landroid/content/pm/ActivityInfo;
    .end local v44    # "newTaskIntent":Landroid/content/Intent;
    .end local v50    # "sourceStack":Lcom/android/server/am/ActivityStack;
    .restart local v24    # "baseIntent":Landroid/content/Intent;
    .restart local v49    # "root":Lcom/android/server/am/ActivityRecord;
    :cond_1d
    const/high16 v3, 0x10000000
    ...
    .line 2328
    .local v56, "topRecord":Lcom/android/server/am/ActivityRecord;
    invoke-virtual/range {v51 .. v51}, Lcom/android/server/am/ActivityStack;->topMWRunningActivityLockedPrevTask()Lcom/android/server/am/ActivityRecord;

    move-result-object v46

    .line 2330
    .local v46, "otherMwTopRecord":Lcom/android/server/am/ActivityRecord;
    if-eqz v56, :cond_21

    invoke-virtual/range {v56 .. v56}, Lcom/android/server/am/ActivityRecord;->isMultiWin()Z
    ...
    invoke-virtual/range {v46 .. v46}, Lcom/android/server/am/ActivityRecord;->isMultiWin()Z
    ...
    .line 2366
    .end local v46    # "otherMwTopRecord":Lcom/android/server/am/ActivityRecord;
    .end local v51    # "stack":Lcom/android/server/am/ActivityStack;
    .end local v56    # "topRecord":Lcom/android/server/am/ActivityRecord;
    :cond_22
    move-object/from16 v0, p2
    ...
    .line 2409
    .restart local v43    # "newTaskInfo":Landroid/content/pm/ActivityInfo;
    .restart local v44    # "newTaskIntent":Landroid/content/Intent;
    :cond_25
    move-object/from16 v0, p2
    ...
    .restart local v50    # "sourceStack":Lcom/android/server/am/ActivityStack;
    goto/16 :goto_b
    ...
    .line 2423
    .restart local v39    # "movedHome":Z
    .restart local v41    # "mwRecordRegisterNeed":Z
    :cond_27
    const/4 v12, 0x0
    ...
    .line 2448
    .restart local v12    # "noAnimation":Z
    :cond_28
    move-object/from16 v0, p1
    ...
    invoke-virtual {v0, v1, v3}, Lcom/android/server/am/ActivityStackSupervisor;->findActivityLocked(Landroid/content/Intent;Landroid/content/pm/ActivityInfo;)Lcom/android/server/am/ActivityRecord;
    ...
    .line 2495
    invoke-virtual/range {v3 .. v9}, Lcom/android/server/am/ActivityStackSupervisor;->startMwActivityUncheckedLocked(Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ActivityRecord;IILandroid/content/Intent;Z)Z
    ...
    .line 2500
    invoke-static {}, Lhuawei/android/mw/HwMultiWindowUtils;->getSplitWindowActiveCount()I
    ...
    iget-object v10, v3, Lcom/android/server/am/TaskRecord;->stack:Lcom/android/server/am/ActivityStack;

    .line 2519
    .local v10, "targetStack":Lcom/android/server/am/ActivityStack;
    const/4 v3, 0x0

    iput-object v3, v10, Lcom/android/server/am/ActivityStack;->mLastPausedActivity:Lcom/android/server/am/ActivityRecord;
    ...
    invoke-virtual/range {v50 .. v50}, Lcom/android/server/am/ActivityStack;->topActivity()Lcom/android/server/am/ActivityRecord;
    ...
    const-string v6, "The intentActivity is "
    ...
    const-string v6, " then set the TaskToReturnTo=HOME of this task "
    ...
    const-string v6, "lMWNonFocusLaunch: "
    ...
    invoke-virtual {v5, v3}, Lcom/android/server/am/ActivityRecord;->setTaskToAffiliateWith(Lcom/android/server/am/TaskRecord;)V
    ...
    .line 2571
    const-string v3, "bringingFoundTaskToFront"

    move-object/from16 v0, p0

    iput-object v3, v0, Lcom/android/server/am/ActivityStackSupervisor;->mActivityLaunchTrack:Ljava/lang/String;
    ...
    iget-object v14, v0, Lcom/android/server/am/ActivityRecord;->appTimeTracker:Lcom/android/server/am/AppTimeTracker;

    const-string v15, "bringingFoundTaskToFront"

    move-object/from16 v13, p7

    invoke-virtual/range {v10 .. v15}, Lcom/android/server/am/ActivityStack;->moveTaskToFrontLocked(Lcom/android/server/am/TaskRecord;ZLandroid/os/Bundle;Lcom/android/server/am/AppTimeTracker;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v3}, Lcom/android/server/am/ActivityStackSupervisor;->updateMwTaskTopOfHome(Lcom/android/server/am/TaskRecord;)V
    ...
    invoke-virtual {v10, v3}, Lcom/android/server/am/ActivityStack;->moveToFront(Ljava/lang/String;)V
    ...
    invoke-virtual {v10, v5, v0}, Lcom/android/server/am/ActivityStack;->resetTaskIfNeededLocked(Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ActivityRecord;)Lcom/android/server/am/ActivityRecord;
    ...
    .line 2615
    const-string v3, "startFlagIfNeeded"
    ...
    invoke-virtual {v0, v10, v3, v1}, Lcom/android/server/am/ActivityStackSupervisor;->resumeTopActivitiesLocked(Lcom/android/server/am/ActivityStack;Lcom/android/server/am/ActivityRecord;Landroid/os/Bundle;)Z
    ...
    .restart local v40    # "movedToFront":Z
    :cond_3c
    invoke-static/range {p7 .. p7}, Landroid/app/ActivityOptions;->abort(Landroid/os/Bundle;)V
    ...
    .line 2634
    invoke-virtual/range {v48 .. v48}, Lcom/android/server/am/TaskRecord;->performClearTaskLocked()V
    ...
    invoke-virtual {v10, v3, v0}, Lcom/android/server/am/ActivityStack;->resumeTopActivityLocked(Lcom/android/server/am/ActivityRecord;Landroid/os/Bundle;)Z
    ...
    .line 2817
    invoke-virtual/range {p0 .. p1}, Lcom/android/server/am/ActivityStackSupervisor;->releaseMultiWinRecord(Lcom/android/server/am/ActivityRecord;)V
    ...
    invoke-virtual {v3, v0, v7}, Lcom/android/server/am/TaskRecord;->performClearTaskLocked(Lcom/android/server/am/ActivityRecord;I)Lcom/android/server/am/ActivityRecord;
    ...
    .line 2687
    .local v52, "task":Lcom/android/server/am/TaskRecord;
    if-eqz v52, :cond_3e
    ...
    invoke-virtual {v10, v0, v3, v4}, Lcom/android/server/am/ActivityStack;->addTask(Lcom/android/server/am/TaskRecord;ZZ)V
    ...
    .line 2696
    .end local v52    # "task":Lcom/android/server/am/TaskRecord;
    .end local v55    # "top":Lcom/android/server/am/ActivityRecord;
    :cond_47
    move-object/from16 v0, p1
    ...
    .line 2707
    iget-boolean v3, v5, Lcom/android/server/am/ActivityRecord;->frontOfTask:Z
    ...
    invoke-virtual {v5, v0, v3, v4}, Lcom/android/server/am/ActivityRecord;->deliverNewIntentLocked(ILandroid/content/Intent;Ljava/lang/String;)V
    ...
    iget-object v4, v5, Lcom/android/server/am/ActivityRecord;->intent:Landroid/content/Intent;
    ...
    iget-object v4, v4, Lcom/android/server/am/TaskRecord;->origActivity:Landroid/content/ComponentName;
    ...
    .line 2837
    .local v13, "topStack":Lcom/android/server/am/ActivityStack;
    invoke-virtual {v13}, Lcom/android/server/am/ActivityStack;->topMWRunningActivityLockedPrevTask()Lcom/android/server/am/ActivityRecord;

    move-result-object v46

    .line 2839
    .restart local v46    # "otherMwTopRecord":Lcom/android/server/am/ActivityRecord;
    const-string v3, "mwsourceTaskToFront"
    ...
    const-string v18, "mwsourceTaskToFront"
    ...
    .line 2854
    .end local v13    # "topStack":Lcom/android/server/am/ActivityStack;
    .end local v46    # "otherMwTopRecord":Lcom/android/server/am/ActivityRecord;
    :cond_53
    move-object/from16 v0, p1
    ...
    .line 2859
    .restart local v13    # "topStack":Lcom/android/server/am/ActivityStack;
    move-object/from16 v0, v45

    invoke-virtual {v13, v0}, Lcom/android/server/am/ActivityStack;->topRunningNonDelayedActivityLocked(Lcom/android/server/am/ActivityRecord;)Lcom/android/server/am/ActivityRecord;
    ...
    iget v3, v0, Lcom/android/server/am/ActivityRecord;->multiLaunchId:I

    move-object/from16 v0, p1

    iget v4, v0, Lcom/android/server/am/ActivityRecord;->multiLaunchId:I
    ...
    iput-object v3, v13, Lcom/android/server/am/ActivityStack;->mLastPausedActivity:Lcom/android/server/am/ActivityRecord;
    ...
    iget-object v4, v0, Lcom/android/server/am/ActivityStackSupervisor;->mActivityLaunchTrack:Ljava/lang/String;
    ...
    .line 2924
    .restart local v10    # "targetStack":Lcom/android/server/am/ActivityStack;
    ...
    invoke-virtual/range {v14 .. v20}, Lcom/android/server/am/ActivityStack;->createTaskRecord(ILandroid/content/pm/ActivityInfo;Landroid/content/Intent;Landroid/service/voice/IVoiceInteractionSession;Lcom/android/internal/app/IVoiceInteractor;Z)Lcom/android/server/am/TaskRecord;
    ...
    invoke-virtual/range {v16 .. v21}, Lcom/android/server/am/ActivityManagerService;->grantUriPermissionFromIntentLocked(ILjava/lang/String;Landroid/content/Intent;Lcom/android/server/am/UriPermissionOwner;I)V
    ...
    .line 3099
    .restart local v56    # "topRecord":Lcom/android/server/am/ActivityRecord;
    move-object/from16 v0, p0
    ...
    invoke-virtual {v0, v1, v2}, Lcom/android/server/am/ActivityStackSupervisor;->registerMwActivityLocked(Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ActivityRecord;)V
    ...
    .line 3105
    invoke-virtual/range {v16 .. v21}, Lcom/android/server/am/ActivityStack;->startActivityLocked(Lcom/android/server/am/ActivityRecord;ZZZLandroid/os/Bundle;)V
    ...
    .line 2967
    .local v15, "sourceTask":Lcom/android/server/am/TaskRecord;
    move-object/from16 v0, p0

    invoke-virtual {v0, v15}, Lcom/android/server/am/ActivityStackSupervisor;->isLockTaskModeViolation(Lcom/android/server/am/TaskRecord;)Z
    ...
    const-string v19, "sourceTaskToFront"
    ...
    invoke-virtual/range {v14 .. v19}, Lcom/android/server/am/ActivityStack;->moveTaskToFrontLocked(Lcom/android/server/am/TaskRecord;ZLandroid/os/Bundle;Lcom/android/server/am/AppTimeTracker;Ljava/lang/String;)V
    ...
    invoke-virtual {v15, v0, v7}, Lcom/android/server/am/TaskRecord;->performClearTaskLocked(Lcom/android/server/am/ActivityRecord;I)Lcom/android/server/am/ActivityRecord;
    ...
    invoke-virtual {v10, v3}, Lcom/android/server/am/ActivityStack;->resumeTopActivityLocked(Lcom/android/server/am/ActivityRecord;)Z
    ...
    invoke-virtual {v15, v0}, Lcom/android/server/am/TaskRecord;->findActivityInHistoryLocked(Lcom/android/server/am/ActivityRecord;)Lcom/android/server/am/ActivityRecord;
    ...
    .line 3005
    .restart local v52    # "task":Lcom/android/server/am/TaskRecord;
    move-object/from16 v0, v52
    ...
    invoke-virtual {v0, v15, v3}, Lcom/android/server/am/ActivityRecord;->setTask(Lcom/android/server/am/TaskRecord;Lcom/android/server/am/TaskRecord;)V
    ...
    .line 3023
    .end local v10    # "targetStack":Lcom/android/server/am/ActivityStack;
    .end local v15    # "sourceTask":Lcom/android/server/am/TaskRecord;
    ...
    const-string v21, "inTaskToFront"
    ...
    invoke-virtual/range {v16 .. v21}, Lcom/android/server/am/ActivityStack;->moveTaskToFrontLocked(Lcom/android/server/am/TaskRecord;ZLandroid/os/Bundle;Lcom/android/server/am/AppTimeTracker;Ljava/lang/String;)V
    ...
    .line 3075
    .local v47, "prev":Lcom/android/server/am/ActivityRecord;
    if-eqz v47, :cond_75
    ...
    invoke-virtual/range {v16 .. v22}, Lcom/android/server/am/ActivityStack;->createTaskRecord(ILandroid/content/pm/ActivityInfo;Landroid/content/Intent;Landroid/service/voice/IVoiceInteractionSession;Lcom/android/internal/app/IVoiceInteractor;Z)Lcom/android/server/am/TaskRecord;
    ...
    .end local v13    # "topStack":Lcom/android/server/am/ActivityStack;
    .end local v23    # "addingToTask":Z
    .end local v31    # "keepCurTransition":Z
    .end local v32    # "lMWNonFocusLaunch":Z
    .end local v39    # "movedHome":Z
    .end local v41    # "mwRecordRegisterNeed":Z
    .end local v42    # "newTask":Z
    .end local v43    # "newTaskInfo":Landroid/content/pm/ActivityInfo;
    .end local v44    # "newTaskIntent":Landroid/content/Intent;
    .end local v45    # "notTop":Lcom/android/server/am/ActivityRecord;
    .end local v47    # "prev":Lcom/android/server/am/ActivityRecord;
    .end local v48    # "reuseTask":Lcom/android/server/am/TaskRecord;
    .end local v50    # "sourceStack":Lcom/android/server/am/ActivityStack;
    .end local v54    # "taskToAffiliate":Lcom/android/server/am/TaskRecord;
    .end local v55    # "top":Lcom/android/server/am/ActivityRecord;
...
.method startSpecificActivityLocked(Lcom/android/server/am/ActivityRecord;ZZ)V
    ...
    const-string v2, "mService.startProcessLocked for activity: "
