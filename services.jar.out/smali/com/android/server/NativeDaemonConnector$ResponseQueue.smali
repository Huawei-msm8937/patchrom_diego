...
.method public add(ILcom/android/server/NativeDaemonEvent;)V
    ...
    iget v5, v4, Lcom/android/server/NativeDaemonConnector$ResponseQueue$PendingCmd;->cmdNum:I
    :try_end_0
    ...
    const-string v8, "mPendingCmds.size = "
    ...
    .line 734
    .restart local v4    # "pendingCmd":Lcom/android/server/NativeDaemonConnector$ResponseQueue$PendingCmd;
    const-string v5, "NativeDaemonConnector.ResponseQueue"
    ...
    iget-object v8, v4, Lcom/android/server/NativeDaemonConnector$ResponseQueue$PendingCmd;->logCmd:Ljava/lang/String;
    ...
    iget v8, v4, Lcom/android/server/NativeDaemonConnector$ResponseQueue$PendingCmd;->cmdNum:I
    ...
    const-string v5, "NDC put"

    const-string v6, "InterruptedException happen"
...
.method public remove(IJLjava/lang/String;)Lcom/android/server/NativeDaemonEvent;
    ...
    const-string v7, "NDC poll"

    const-string v8, "InterruptedException happen"
