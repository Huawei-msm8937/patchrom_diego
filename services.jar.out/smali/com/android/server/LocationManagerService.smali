...
.super Lcom/android/server/AbsLocationManagerService;
...
.field private static final MSG_LOCATION_REMOVE:I = 0x3

.field private static final MSG_LOCATION_REQUEST:I = 0x2
...
.field private mHwGpsActionReporter:Lcom/android/server/location/IHwGpsActionReporter;

.field private mHwLocationGpsLogServices:Lcom/android/server/location/IHwGpsLogServices;
...
.field protected mLocalLocationProvider:Lcom/android/server/location/IHwLocalLocationProvider;

.field private mLocationFudger:Lcom/android/server/location/LocationFudger;

.field private mLocationHandler:Lcom/android/server/LocationManagerService$LocationWorkerHandler;

.field mLocationThread:Landroid/os/HandlerThread;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 264
    invoke-direct {p0}, Lcom/android/server/AbsLocationManagerService;-><init>()V
...
.method static synthetic access$1900(Lcom/android/server/LocationManagerService;)Lcom/android/server/location/IHwGpsActionReporter;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/LocationManagerService;

    .prologue
    .line 133
    iget-object v0, p0, Lcom/android/server/LocationManagerService;->mHwGpsActionReporter:Lcom/android/server/location/IHwGpsActionReporter;
...
.method private applyRequirementsLocked(Ljava/lang/String;)V
    ...
    .line 1570
    iget-object v9, p0, Lcom/android/server/LocationManagerService;->mHwLocationGpsLogServices:Lcom/android/server/location/IHwGpsLogServices;

    invoke-interface {v9, p1, v3}, Lcom/android/server/location/IHwGpsLogServices;->netWorkLocation(Ljava/lang/String;Lcom/android/internal/location/ProviderRequest;)V
...
.method private doesUidHavePackage(ILjava/lang/String;)Z
    ...
    .line 2368
    :cond_0
    iget-object v10, p0, Lcom/android/server/LocationManagerService;->mPackageManager:Landroid/content/pm/PackageManager;
    ...
    .line 2375
    .local v8, "pNames":[Ljava/lang/String;
    array-length v10, v8
...
.method private handleLocationChanged(Landroid/location/Location;Z)V
    ...
    .line 2679
    invoke-virtual {p0, p1, v1}, Lcom/android/server/LocationManagerService;->screenLocationLocked(Landroid/location/Location;Ljava/lang/String;)Landroid/location/Location;
...
.method private handleLocationChangedLocked(Landroid/location/Location;Z)V
    ...
    const-string v37, "incoming location: "
    ...
    .line 2472
    .local v22, "nowNanos":J
    move-object/from16 v0, p0

    iget-object v0, v0, Lcom/android/server/LocationManagerService;->mHwLocationGpsLogServices:Lcom/android/server/location/IHwGpsLogServices;
    ...
    invoke-interface {v0, v1, v2, v3, v4}, Lcom/android/server/location/IHwGpsLogServices;->updateLocation(Landroid/location/Location;JLjava/lang/String;)V
    ...
    invoke-virtual {v0, v1, v2}, Lcom/android/server/LocationManagerService;->updateLocalLocationDB(Landroid/location/Location;Ljava/lang/String;)V
...
.method private loadProvidersLocked()V
    ...
    invoke-static {v3, v0, v4}, Lcom/android/server/HwServiceFactory;->createHwGpsLocationProvider(Landroid/content/Context;Landroid/location/ILocationManager;Landroid/os/Looper;)Lcom/android/server/location/GpsLocationProvider;
    ...
    invoke-static/range {v2 .. v8}, Lcom/android/server/HwServiceFactory;->locationProviderProxyCreateAndBind(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;IIILandroid/os/Handler;)Lcom/android/server/location/LocationProviderProxy;
    ...
    invoke-static {v3, v4, v5, v6, v7}, Lcom/android/server/HwServiceFactory;->geocoderProxyCreateAndBind(Landroid/content/Context;IIILandroid/os/Handler;)Lcom/android/server/location/GeocoderProxy;
    ...
    invoke-virtual {v0, v3}, Lcom/android/server/LocationManagerService;->checkGeoFencerEnabled(Landroid/content/pm/PackageManager;)V
    ...
    invoke-static {v3, v0}, Lcom/android/server/HwServiceFactory;->getHwLocalLocationProvider(Landroid/content/Context;Landroid/location/ILocationManager;)Lcom/android/server/location/IHwLocalLocationProvider;

    move-result-object v3

    move-object/from16 v0, p0

    iput-object v3, v0, Lcom/android/server/LocationManagerService;->mLocalLocationProvider:Lcom/android/server/location/IHwLocalLocationProvider;
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/LocationManagerService;->enableLocalLocationProviders(Lcom/android/server/location/GpsLocationProvider;)V
    ...
    invoke-static {v3, v0}, Lcom/android/server/HwServiceFactory;->getHwGpsActionReporter(Landroid/content/Context;Landroid/location/ILocationManager;)Lcom/android/server/location/IHwGpsActionReporter;

    move-result-object v3

    move-object/from16 v0, p0

    iput-object v3, v0, Lcom/android/server/LocationManagerService;->mHwGpsActionReporter:Lcom/android/server/location/IHwGpsActionReporter;
...
.method private removeUpdatesLocked(Lcom/android/server/LocationManagerService$Receiver;)V
    ...
    .line 1904
    iget-object v8, p0, Lcom/android/server/LocationManagerService;->mHwGpsActionReporter:Lcom/android/server/location/IHwGpsActionReporter;
    ...
    const-string v8, "PROVIDER:all,PN:"

    invoke-virtual {v7, v8}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v8

    iget-object v9, p1, Lcom/android/server/LocationManagerService$Receiver;->mPackageName:Ljava/lang/String;
    ...
    invoke-virtual {v8, v12, v6}, Lcom/android/server/LocationManagerService$LocationWorkerHandler;->removeMessages(ILjava/lang/Object;)V

    .line 1910
    iget-object v8, p0, Lcom/android/server/LocationManagerService;->mLocationHandler:Lcom/android/server/LocationManagerService$LocationWorkerHandler;

    invoke-static {v8, v12, v6}, Landroid/os/Message;->obtain(Landroid/os/Handler;ILjava/lang/Object;)Landroid/os/Message;
    ...
    invoke-virtual {v8, v1}, Lcom/android/server/LocationManagerService$LocationWorkerHandler;->sendMessage(Landroid/os/Message;)Z
    ...
    iget-object v9, p1, Lcom/android/server/LocationManagerService$Receiver;->mKey:Ljava/lang/Object;
    ...
    invoke-interface {v8}, Landroid/location/ILocationListener;->asBinder()Landroid/os/IBinder;

    move-result-object v8

    invoke-interface {v8, p1, v11}, Landroid/os/IBinder;->unlinkToDeath(Landroid/os/IBinder$DeathRecipient;I)Z
    ...
    .line 1922
    :cond_1
    invoke-virtual {p1, v11}, Lcom/android/server/LocationManagerService$Receiver;->updateMonitoring(Z)V

    .line 1924
    iget-object v8, p1, Lcom/android/server/LocationManagerService$Receiver;->mPackageName:Ljava/lang/String;

    invoke-virtual {p0, v8}, Lcom/android/server/LocationManagerService;->hwLocationPowerTrackerRemoveRequest(Ljava/lang/String;)V
    ...
    invoke-virtual {v5, v11}, Lcom/android/server/LocationManagerService$UpdateRecord;->disposeLocked(Z)V
...
.method private requestLocationUpdatesLocked(Landroid/location/LocationRequest;Lcom/android/server/LocationManagerService$Receiver;IILjava/lang/String;)V
    ...
    iget-object v14, v0, Lcom/android/server/LocationManagerService;->mHwGpsActionReporter:Lcom/android/server/location/IHwGpsActionReporter;
    ...
    invoke-virtual {v14, v15, v12}, Lcom/android/server/LocationManagerService$LocationWorkerHandler;->removeMessages(ILjava/lang/Object;)V
    ...
    invoke-virtual {v14, v6}, Lcom/android/server/LocationManagerService$LocationWorkerHandler;->sendMessage(Landroid/os/Message;)Z
    ...
    iget-object v14, v0, Lcom/android/server/LocationManagerService;->mHwLocationGpsLogServices:Lcom/android/server/location/IHwGpsLogServices;

    move-object/from16 v0, p1

    move-object/from16 v1, p5

    invoke-interface {v14, v0, v1}, Lcom/android/server/location/IHwGpsLogServices;->updateApkName(Landroid/location/LocationRequest;Ljava/lang/String;)V
    ...
    .line 1829
    :cond_4
    new-instance v11, Lcom/android/server/LocationManagerService$UpdateRecord;
    ...
    invoke-direct {v11, v0, v7, v1, v2}, Lcom/android/server/LocationManagerService$UpdateRecord;-><init>(Lcom/android/server/LocationManagerService;Ljava/lang/String;Landroid/location/LocationRequest;Lcom/android/server/LocationManagerService$Receiver;)V
    ...
    invoke-direct {v0, v7, v1}, Lcom/android/server/LocationManagerService;->isAllowedByUserSettingsLocked(Ljava/lang/String;I)Z
    ...
    .line 1839
    instance-of v14, v10, Lcom/android/server/location/IHwLocationProviderInterface;
    ...
    .line 1840
    check-cast v3, Lcom/android/server/location/IHwLocationProviderInterface;

    .line 1841
    .local v3, "hwP":Lcom/android/server/location/IHwLocationProviderInterface;
    invoke-interface {v3}, Lcom/android/server/location/IHwLocationProviderInterface;->resetNLPFlag()V

    .line 1847
    .end local v3    # "hwP":Lcom/android/server/location/IHwLocationProviderInterface;
    :cond_6
    :goto_0
    move-object/from16 v0, p0

    invoke-direct {v0, v7}, Lcom/android/server/LocationManagerService;->applyRequirementsLocked(Ljava/lang/String;)V

    .line 1854
    :goto_1
    move-object/from16 v0, p0

    iget-object v14, v0, Lcom/android/server/LocationManagerService;->mLocalLocationProvider:Lcom/android/server/location/IHwLocalLocationProvider;
    ...
    invoke-interface {v14}, Lcom/android/server/location/IHwLocalLocationProvider;->isEnabled()Z
    ...
    const-string v14, "local_database"
    ...
    invoke-direct {v5, v0, v14, v1, v2}, Lcom/android/server/LocationManagerService$UpdateRecord;-><init>(Lcom/android/server/LocationManagerService;Ljava/lang/String;Landroid/location/LocationRequest;Lcom/android/server/LocationManagerService$Receiver;)V

    .line 1856
    .local v5, "localProviderRrecord":Lcom/android/server/LocationManagerService$UpdateRecord;
    move-object/from16 v0, p2

    iget-object v14, v0, Lcom/android/server/LocationManagerService$Receiver;->mUpdateRecords:Ljava/util/HashMap;

    const-string v15, "local_database"
    ...
    .line 1857
    .local v8, "oldLocalProviderRrecord":Lcom/android/server/LocationManagerService$UpdateRecord;
    if-eqz v8, :cond_7

    .line 1858
    const/4 v14, 0x0

    invoke-virtual {v8, v14}, Lcom/android/server/LocationManagerService$UpdateRecord;->disposeLocked(Z)V
    ...
    invoke-interface {v14}, Lcom/android/server/location/IHwLocalLocationProvider;->requestLocation()V

    .line 1865
    .end local v5    # "localProviderRrecord":Lcom/android/server/LocationManagerService$UpdateRecord;
    .end local v8    # "oldLocalProviderRrecord":Lcom/android/server/LocationManagerService$UpdateRecord;
    :cond_8
    const/4 v14, 0x1
    ...
    iget-object v14, v0, Lcom/android/server/LocationManagerService$Receiver;->mListener:Landroid/location/ILocationListener;
    ...
    invoke-virtual {v0, v1, v15, v14}, Lcom/android/server/LocationManagerService;->hwLocationPowerTrackerRecordRequest(Ljava/lang/String;IZ)V
    ...
    const-string v15, "instanceof fail"
    ...
    invoke-virtual {v0, v7, v14}, Lcom/android/server/LocationManagerService$Receiver;->callProviderEnabledLocked(Ljava/lang/String;Z)Z
...
.method public addGpsMeasurementsListener(Landroid/location/IGpsMeasurementsListener;Ljava/lang/String;)Z
    ...
    invoke-virtual {v6, p1, p2}, Lcom/android/server/location/GpsMeasurementsProvider;->addListener(Landroid/os/IInterface;Ljava/lang/String;)Z
...
.method public addGpsNavigationMessageListener(Landroid/location/IGpsNavigationMessageListener;Ljava/lang/String;)Z
    ...
    invoke-virtual {v6, p1, p2}, Lcom/android/server/location/GpsNavigationMessageProvider;->addListener(Landroid/os/IInterface;Ljava/lang/String;)Z
...
.method public addGpsStatusListener(Landroid/location/IGpsStatusListener;Ljava/lang/String;)Z
    ...
    invoke-static {v8, v9}, Landroid/hsm/HwSystemManager;->allowOp(Landroid/content/Context;I)Z
    ...
    .line 2109
    :cond_2
    iget-object v8, p0, Lcom/android/server/LocationManagerService;->mGpsStatusProvider:Landroid/location/IGpsStatusProvider;
    ...
    invoke-interface {v8, p1}, Landroid/location/IGpsStatusProvider;->addGpsStatusListener(Landroid/location/IGpsStatusListener;)V
    :try_end_1
...
.method public addTestProvider(Ljava/lang/String;Lcom/android/internal/location/ProviderProperties;Ljava/lang/String;)V
    ...
    const-string v3, "local_database"
    ...
    invoke-virtual {p0, v3}, Lcom/android/server/LocationManagerService;->setGeoFencerEnabled(Z)V
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/LocationManagerService;->hwLocationPowerTrackerDump(Ljava/io/PrintWriter;)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/LocationManagerService;->dumpGpsFreezeProxy(Ljava/io/PrintWriter;)V
...
.method public getLastLocation(Landroid/location/LocationRequest;Ljava/lang/String;)Landroid/location/Location;
    ...
    invoke-static {v9, v10}, Landroid/hsm/HwSystemManager;->allowOp(Landroid/content/Context;I)Z
    ...
    invoke-static {v9}, Landroid/hsm/HwSystemManager;->getFakeLocation(Ljava/lang/String;)Landroid/location/Location;
...
.method public getNetworkProviderPackage()Ljava/lang/String;
    ...
    .line 2289
    .local v0, "connectedPackage":Ljava/lang/String;
    if-eqz v3, :cond_0
    ...
    .line 2282
    .end local v0    # "connectedPackage":Ljava/lang/String;
    .end local v2    # "pNames":[Ljava/lang/String;
    .end local v3    # "packageName":Ljava/lang/String;
    :catchall_0
    move-exception v4
...
.method public removeGeofence(Landroid/location/Geofence;Landroid/app/PendingIntent;Ljava/lang/String;)V
    ...
    .local v0, "identity":J
    :try_start_0
    invoke-virtual {p0, p2}, Lcom/android/server/LocationManagerService;->removeQcmGeoFencer(Landroid/app/PendingIntent;)Z
...
.method public removeTestProvider(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v4}, Lcom/android/server/LocationManagerService;->setGeoFencerEnabled(Z)V
...
.method public reportLocation(Landroid/location/Location;Z)V
    ...
    const-string v6, "Dropping incomplete location: "
    ...
    invoke-static {v5, v6}, Landroid/hsm/HwSystemManager;->allowOp(Landroid/content/Context;I)Z
    ...
    instance-of v5, v2, Lcom/android/server/location/IHwLocationProviderInterface;
    ...
    .line 2414
    check-cast v0, Lcom/android/server/location/IHwLocationProviderInterface;

    .line 2415
    .local v0, "hwP":Lcom/android/server/location/IHwLocationProviderInterface;
    invoke-static {}, Landroid/os/Binder;->getCallingPid()I

    move-result v5

    invoke-interface {v0, v5}, Lcom/android/server/location/IHwLocationProviderInterface;->reportNLPLocation(I)Z
    ...
    .line 2422
    .end local v0    # "hwP":Lcom/android/server/location/IHwLocationProviderInterface;
    .end local v2    # "p":Lcom/android/server/location/LocationProviderInterface;
    :cond_2
    :goto_2
    ...
    invoke-virtual {v5, v4, p1}, Lcom/android/server/LocationManagerService$LocationWorkerHandler;->removeMessages(ILjava/lang/Object;)V
    ...
    invoke-virtual {v4, v1}, Lcom/android/server/LocationManagerService$LocationWorkerHandler;->sendMessageAtFrontOfQueue(Landroid/os/Message;)Z
    ...
    const-string v6, "instanceof fail"
...
.method public requestGeofence(Landroid/location/LocationRequest;Landroid/location/Geofence;Landroid/app/PendingIntent;Ljava/lang/String;)V
    ...
    invoke-direct {v0, v10}, Lcom/android/server/LocationManagerService;->checkResolutionLevelIsSufficientForGeofenceUse(I)V
    ...
    .line 2055
    :try_start_0
    invoke-virtual/range {v2 .. v7}, Lcom/android/server/LocationManagerService;->addQcmGeoFencer(Landroid/location/Geofence;Landroid/location/LocationRequest;ILandroid/app/PendingIntent;Ljava/lang/String;)Z
    ...
    iget-object v6, v0, Lcom/android/server/LocationManagerService;->mGeofenceManager:Lcom/android/server/location/GeofenceManager;
    ...
    invoke-virtual/range {v6 .. v12}, Lcom/android/server/location/GeofenceManager;->addFence(Landroid/location/LocationRequest;Landroid/location/Geofence;Landroid/app/PendingIntent;IILjava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public requestLocationUpdates(Landroid/location/LocationRequest;Landroid/location/ILocationListener;Landroid/app/PendingIntent;Ljava/lang/String;)V
    ...
    invoke-static {v2, v3}, Landroid/hsm/HwSystemManager;->allowOp(Landroid/content/Context;I)Z
    ...
    .line 1763
    iget-object v2, p0, Lcom/android/server/LocationManagerService;->mHwLocationGpsLogServices:Lcom/android/server/location/IHwGpsLogServices;

    invoke-interface {v2}, Lcom/android/server/location/IHwGpsLogServices;->permissionErr()V
    ...
    const-string v3, "recevier creating failed, value is null"
...
.method public sendExtraCommand(Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)Z
    ...
    invoke-static {v1, v2}, Landroid/hsm/HwSystemManager;->allowOp(Landroid/content/Context;I)Z
...
.method public systemRunning()V
    ...
    invoke-interface {v0, p0, v2}, Lcom/android/server/HwNLPManager;->setLocationManagerService(Lcom/android/server/LocationManagerService;Landroid/content/Context;)V
    ...
    invoke-interface {v0, v2}, Lcom/android/server/HwNLPManager;->setHwMultiNlpPolicy(Landroid/content/Context;)V

    .line 347
    iget-object v0, p0, Lcom/android/server/LocationManagerService;->mContext:Landroid/content/Context;

    invoke-virtual {p0, v0}, Lcom/android/server/LocationManagerService;->initHwLocationPowerTracker(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/android/server/LocationManagerService;->mHwLocationGpsLogServices:Lcom/android/server/location/IHwGpsLogServices;
    ...
    invoke-virtual {v0, v2}, Lcom/android/server/LocationManagerService$LocationWorkerHandler;->post(Ljava/lang/Runnable;)Z
    ...
    .line 389
    invoke-virtual {p0}, Lcom/android/server/LocationManagerService;->hwQuickGpsSwitch()V
