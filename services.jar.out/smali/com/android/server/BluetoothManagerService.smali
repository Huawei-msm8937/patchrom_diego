...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/server/BluetoothManagerService$BluetoothServiceStateCallback;
    }
.end annotation
...
.field private final mBluetoothServiceStateCallback:Lcom/android/server/BluetoothManagerService$BluetoothServiceStateCallback;
...
.method constructor <init>(Landroid/content/Context;)V
    ...
    .line 473
    new-instance v3, Lcom/android/server/BluetoothManagerService$BluetoothServiceStateCallback;

    invoke-direct {v3, p0, v6}, Lcom/android/server/BluetoothManagerService$BluetoothServiceStateCallback;-><init>(Lcom/android/server/BluetoothManagerService;Lcom/android/server/BluetoothManagerService$1;)V

    iput-object v3, p0, Lcom/android/server/BluetoothManagerService;->mBluetoothServiceStateCallback:Lcom/android/server/BluetoothManagerService$BluetoothServiceStateCallback;
...
.method static synthetic access$1206()I
    .locals 1
...
.method static synthetic access$1600(Lcom/android/server/BluetoothManagerService;Z)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/BluetoothManagerService;
    .param p1, "x1"    # Z
...
.method static synthetic access$2700(Lcom/android/server/BluetoothManagerService;ZZ)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/server/BluetoothManagerService;
    .param p1, "x1"    # Z
    .param p2, "x2"    # Z
...
.method static synthetic access$300(Lcom/android/server/BluetoothManagerService;)Landroid/content/Context;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/BluetoothManagerService;
...
.method static synthetic access$3600(Lcom/android/server/BluetoothManagerService;)Landroid/content/ContentResolver;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/BluetoothManagerService;
...
.method static synthetic access$3700(Lcom/android/server/BluetoothManagerService;)Landroid/bluetooth/IBluetoothCallback;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/BluetoothManagerService;
...
.method static synthetic access$400(Lcom/android/server/BluetoothManagerService;)Landroid/os/RemoteCallbackList;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/BluetoothManagerService;
...
.method static synthetic access$4502(Lcom/android/server/BluetoothManagerService;Z)Z
    .locals 0
    .param p0, "x0"    # Lcom/android/server/BluetoothManagerService;
    .param p1, "x1"    # Z
...
.method static synthetic access$4600(Lcom/android/server/BluetoothManagerService;ZZ)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/server/BluetoothManagerService;
    .param p1, "x1"    # Z
    .param p2, "x2"    # Z
...
.method static synthetic access$500(Lcom/android/server/BluetoothManagerService;)Landroid/os/RemoteCallbackList;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/BluetoothManagerService;
...
.method static synthetic access$700(Lcom/android/server/BluetoothManagerService;Ljava/lang/String;Ljava/lang/String;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/BluetoothManagerService;
...
.method static synthetic access$800(Lcom/android/server/BluetoothManagerService;)Landroid/content/BroadcastReceiver;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/BluetoothManagerService;
...
.method private bluetoothStateChangeHandler(II)V
    ...
    .line 1958
    .local v5, "isStandardBroadcast":Z
    ...
    const-string v9, "bluetoothStateChangeHandler isStandardBroadcast="
    ...
    invoke-static {v7, v8}, Lcom/android/server/HwLog;->i(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v9, "ACTION_RADIO_STATE_CHANGED, Radio State Change Intent: "
    ...
    invoke-static {v7, v8}, Lcom/android/server/HwLog;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 2044
    .end local v4    # "intermediate_off":Z
    :cond_4
    :goto_2
    const-string v7, "BluetoothManagerService"
    ...
    const-string v9, "isStandardBroadcast="
    ...
    const-string v8, "newState is ble on,so don\'t send broadcast"

    invoke-static {v7, v8}, Lcom/android/server/HwLog;->e(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 1998
    .restart local v4    # "intermediate_off":Z
    :cond_8
    if-nez v4, :cond_b
    ...
    const-string v8, "Bluetooth is in LE only mode"
    ...
    const-string v8, "Calling BluetoothGattServiceUp"
    ...
    const-string v8, "Binding Bluetooth GATT service"
    ...
    const-string v9, "send ACTION_STATE_CHANGED, newState="
    ...
    const-string v9, "send ACTION_RADIO_STATE_CHANGED, Radio State Change Intent: "
...
.method private checkIfCallerIsForegroundUser()Z
    ...
    invoke-static {v10, v11}, Lcom/android/server/HwLog;->d(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private handleDisable()V
    ...
    const-string v3, "BT-Disable-FW Sending off request."

    invoke-static {v1, v3}, Lcom/android/server/HwLog;->i(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-static {v1, v3}, Lcom/android/server/HwLog;->e(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_1
    ...
    invoke-static {v1, v3, v0}, Lcom/android/server/HwLog;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private handleEnable(Z)V
    ...
    const-string v6, "BT-Enable-FW handleEnable"

    invoke-static {v4, v6}, Lcom/android/server/HwLog;->i(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v4, v6}, Lcom/android/server/HwLog;->e(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_4
    .catch Landroid/os/RemoteException; {:try_start_4 .. :try_end_4} :catch_0
    .catchall {:try_start_4 .. :try_end_4} :catchall_0
    ...
    invoke-static {v4, v6, v0}, Lcom/android/server/HwLog;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-static {v4, v6, v2}, Lcom/android/server/HwLog;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_5
    .catchall {:try_start_5 .. :try_end_5} :catchall_0
...
.method private handleEnableRadio()V
    ...
    const-string v6, "handleEnableRadio mBluetooth = "
    ...
    invoke-static {v3, v5}, Lcom/android/server/HwLog;->i(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v5, "Illegal Argument ! Fail to open radio !"

    invoke-static {v3, v5}, Lcom/android/server/HwLog;->e(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v3, v5}, Lcom/android/server/HwLog;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v3, v5, v0}, Lcom/android/server/HwLog;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private onBluetoothGattServiceUp()V
    ...
    invoke-static {v3, v4}, Lcom/android/server/HwLog;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v3, v4, v2}, Lcom/android/server/HwLog;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private recoverBluetoothServiceFromError()V
    ...
    invoke-static {v2, v3}, Lcom/android/server/HwLog;->e(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v2, v4, v0}, Lcom/android/server/HwLog;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private sendBluetoothServiceDownCallback()V
    ...
    const-string v1, "Calling onBluetoothServiceDown callbacks"

    invoke-static {v0, v1}, Lcom/android/server/HwLog;->d(Ljava/lang/String;Ljava/lang/String;)V

    .line 1251
    iget-object v0, p0, Lcom/android/server/BluetoothManagerService;->mBluetoothServiceStateCallback:Lcom/android/server/BluetoothManagerService$BluetoothServiceStateCallback;

    invoke-virtual {v0}, Lcom/android/server/BluetoothManagerService$BluetoothServiceStateCallback;->sendBluetoothServiceDownCallback()V
...
.method private sendBluetoothServiceUpCallback()V
    ...
    const-string v1, "Calling onBluetoothServiceUp callbacks"
    ...
    invoke-virtual {v0}, Lcom/android/server/BluetoothManagerService$BluetoothServiceStateCallback;->sendBluetoothServiceUpCallback()V
...
.method private sendBluetoothStateCallback(Z)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/BluetoothManagerService$BluetoothServiceStateCallback;->sendBluetoothStateCallback(Z)V
...
.method public bindBluetoothProfileService(ILandroid/bluetooth/IBluetoothProfileServiceConnection;)Z
    ...
    invoke-static {v4, v5}, Lcom/android/server/HwLog;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v4, v5}, Lcom/android/server/HwLog;->w(Ljava/lang/String;Ljava/lang/String;)V
...
.method public disable(Z)Z
    ...
    invoke-static {v3, v4}, Lcom/android/server/HwLog;->w(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v4, "BT-Disable-FW disable(): mBluetooth = "
    ...
    invoke-static {v2, v3}, Lcom/android/server/HwLog;->i(Ljava/lang/String;Ljava/lang/String;)V
...
.method public disableRadio()Z
    ...
    invoke-static {v2, v1}, Lcom/android/server/HwLog;->d(Ljava/lang/String;Ljava/lang/String;)V
...
.method public enable()Z
    ...
    const-string v2, "bluetooth has been restricted."
    ...
    const-string v4, "BT-Enable-FW enable():  mBluetooth ="
    ...
    .line 868
    invoke-static {}, Lcom/android/server/HwServiceFactory;->getHwBluetoothBigDataService()Lcom/android/server/HwServiceFactory$IHwBluetoothBigDataService;

    move-result-object v0

    iget-object v2, p0, Lcom/android/server/BluetoothManagerService;->mContext:Landroid/content/Context;

    const-string v3, "android.bluetooth.GET_OPEN_BT_APP_NAME"

    invoke-interface {v0, v2, v3}, Lcom/android/server/HwServiceFactory$IHwBluetoothBigDataService;->sendBigDataEvent(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-static {v0, v2}, Lcom/android/server/HwLog;->d(Ljava/lang/String;Ljava/lang/String;)V
...
.method public enableRadio()Z
    ...
    invoke-static {v1, v3}, Lcom/android/server/HwLog;->w(Ljava/lang/String;Ljava/lang/String;)V
...
.method public registerAdapter(Landroid/bluetooth/IBluetoothManagerCallback;)Landroid/bluetooth/IBluetooth;
    ...
    const-string v3, "Callback is null in registerAdapter"
...
.method public unbindAndFinish()V
    ...
    invoke-static {v1, v3}, Lcom/android/server/HwLog;->d(Ljava/lang/String;Ljava/lang/String;)V
...
.method public unbindBluetoothProfileService(ILandroid/bluetooth/IBluetoothProfileServiceConnection;)V
    ...
    invoke-static {v0, p2}, Lcom/android/server/BluetoothManagerService$ProfileServiceConnections;->access$2100(Lcom/android/server/BluetoothManagerService$ProfileServiceConnections;Landroid/bluetooth/IBluetoothProfileServiceConnection;)V
