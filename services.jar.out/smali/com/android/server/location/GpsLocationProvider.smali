...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/server/location/GpsLocationProvider$NmeaData;,
        Lcom/android/server/location/GpsLocationProvider$SvData;,
...
.field private static final AGPS_APP_STARTED:I = 0x1

.field private static final AGPS_APP_STOPPED:I = 0x0
...
.field private static final GPS_DATA_MAX_SIZE:I = 0x12c

.field private static final GPS_DATA_TIMEOUT:I = 0xbb8
...
.field private static final GPS_INJECT_LOCATION_PERMISSION:Ljava/lang/String; = "com.huawei.android.permission.INJECT_LOCATION"
...
.field private static final KEY_AGPS_APP_STARTED_NAVIGATION:Ljava/lang/String; = "agps_app_started_navigation"
...
.field private static mLastAddNmeaTimestamp:J

.field private static mWcdmaVpEnabled:Z
...
.field private mAgpsConnectProvider:Lcom/android/server/location/AgpsConnectProvider;
...
.field mCust:Lcom/android/server/location/HwCustGpsLocationProvider;

.field private mDefaultApn:Ljava/lang/String;

.field private mDefaultApnObserver:Landroid/database/ContentObserver;
...
.field private mGpsDataThread:Ljava/lang/Thread;

.field private mGpsDatas:Ljava/util/concurrent/LinkedBlockingQueue;
...
.field private final mGpsLocalLocationReceiver:Landroid/content/BroadcastReceiver;
...
.field mGpsXtraReceiver:Lcom/android/server/location/IHwGpsXtraDownloadReceiver;

.field private mHandler:Landroid/os/Handler;

.field private mHwCmccGpsFeature:Lcom/android/server/location/IHwCmccGpsFeature;

.field private mHwGpsLocationCustFeature:Lcom/android/server/location/IHwGpsLocationCustFeature;

.field mHwGpsLocationManager:Lcom/android/server/location/IHwGpsLocationManager;
...
.field private mRequesetUtcTime:Z
...
.method static constructor <clinit>()V
    ...
    .line 465
    const-string v0, "ro.hwpp.wcdma_voice_preference"

    invoke-static {v0, v3}, Landroid/os/SystemProperties;->getBoolean(Ljava/lang/String;Z)Z

    move-result v0

    sput-boolean v0, Lcom/android/server/location/GpsLocationProvider;->mWcdmaVpEnabled:Z

    .line 2005
    const-wide/16 v0, 0x0

    sput-wide v0, Lcom/android/server/location/GpsLocationProvider;->mLastAddNmeaTimestamp:J
...
.method public constructor <init>(Landroid/content/Context;Landroid/location/ILocationManager;Landroid/os/Looper;)V
    ...
    .line 330
    iput-boolean v6, p0, Lcom/android/server/location/GpsLocationProvider;->mRequesetUtcTime:Z
    ...
    .line 466
    const-string v0, "ro.gnss.all.sv.enable"

    invoke-static {v0, v6}, Landroid/os/SystemProperties;->getBoolean(Ljava/lang/String;Z)Z

    move-result v0

    iput-boolean v0, p0, Lcom/android/server/location/GpsLocationProvider;->mGnssSvStatus:Z

    .line 469
    const-class v0, Lcom/android/server/location/HwCustGpsLocationProvider;
    ...
    check-cast v0, Lcom/android/server/location/HwCustGpsLocationProvider;

    iput-object v0, p0, Lcom/android/server/location/GpsLocationProvider;->mCust:Lcom/android/server/location/HwCustGpsLocationProvider;

    .line 482
    iput-boolean v6, p0, Lcom/android/server/location/GpsLocationProvider;->misBetaUser:Z
    ...
    iput-object v0, p0, Lcom/android/server/location/GpsLocationProvider;->mGpsDatas:Ljava/util/concurrent/LinkedBlockingQueue;
    ...
    iput-object v0, p0, Lcom/android/server/location/GpsLocationProvider;->mGpsLocalLocationReceiver:Landroid/content/BroadcastReceiver;
    ...
    invoke-static {v0, p0}, Lcom/android/server/HwServiceFactory;->getHwCmccGpsFeature(Landroid/content/Context;Lcom/android/server/location/GpsLocationProvider;)Lcom/android/server/location/IHwCmccGpsFeature;

    move-result-object v0

    iput-object v0, p0, Lcom/android/server/location/GpsLocationProvider;->mHwCmccGpsFeature:Lcom/android/server/location/IHwCmccGpsFeature;

    .line 841
    invoke-static {}, Lcom/android/server/HwServiceFactory;->getHwGpsLocationCustFeature()Lcom/android/server/location/IHwGpsLocationCustFeature;

    move-result-object v0

    iput-object v0, p0, Lcom/android/server/location/GpsLocationProvider;->mHwGpsLocationCustFeature:Lcom/android/server/location/IHwGpsLocationCustFeature;

    .line 844
    iget-object v0, p0, Lcom/android/server/location/GpsLocationProvider;->mContext:Landroid/content/Context;

    invoke-static {v0}, Lcom/android/server/HwServiceFactory;->getHwGpsLogServices(Landroid/content/Context;)Lcom/android/server/location/IHwGpsLogServices;

    move-result-object v0

    iput-object v0, p0, Lcom/android/server/location/GpsLocationProvider;->mHwGpsLogServices:Lcom/android/server/location/IHwGpsLogServices;

    .line 848
    invoke-static {}, Lcom/android/server/HwServiceFactory;->getHwGpsXtraDownloadReceiver()Lcom/android/server/location/IHwGpsXtraDownloadReceiver;

    move-result-object v0

    iput-object v0, p0, Lcom/android/server/location/GpsLocationProvider;->mGpsXtraReceiver:Lcom/android/server/location/IHwGpsXtraDownloadReceiver;

    .line 849
    iget-object v0, p0, Lcom/android/server/location/GpsLocationProvider;->mGpsXtraReceiver:Lcom/android/server/location/IHwGpsXtraDownloadReceiver;
    ...
    invoke-interface {v0, v1, p0}, Lcom/android/server/location/IHwGpsXtraDownloadReceiver;->init(Landroid/content/Context;Lcom/android/server/location/LocationProviderInterface;)V
    ...
    invoke-static {v0}, Lcom/android/server/HwServiceFactory;->getHwGpsLocationManager(Landroid/content/Context;)Lcom/android/server/location/IHwGpsLocationManager;

    move-result-object v0

    iput-object v0, p0, Lcom/android/server/location/GpsLocationProvider;->mHwGpsLocationManager:Lcom/android/server/location/IHwGpsLocationManager;
    ...
    iput-object v0, p0, Lcom/android/server/location/GpsLocationProvider;->mPackageManager:Landroid/content/pm/PackageManager;
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/location/GpsFreezeProc;->registerFreezeListener(Lcom/android/server/location/GpsFreezeListener;)V

    .line 874
    const-string v0, "cdma"

    const-string v1, "ro.config.gpstype"
    ...
    .line 875
    invoke-static {p1}, Lcom/android/server/location/AgpsConnectProvider;->createAgpsConnectProvider(Landroid/content/Context;)Lcom/android/server/location/AgpsConnectProvider;

    move-result-object v0

    iput-object v0, p0, Lcom/android/server/location/GpsLocationProvider;->mAgpsConnectProvider:Lcom/android/server/location/AgpsConnectProvider;
    ...
    .line 880
    iput-boolean v7, p0, Lcom/android/server/location/GpsLocationProvider;->misBetaUser:Z

    .line 882
    :cond_2
    iget-boolean v0, p0, Lcom/android/server/location/GpsLocationProvider;->misBetaUser:Z
    ...
    iput-object v0, p0, Lcom/android/server/location/GpsLocationProvider;->mHwPowerInfoService:Lcom/android/server/am/IHwPowerInfoService;
...
.method static synthetic access$000(Lcom/android/server/location/GpsLocationProvider;)Landroid/content/pm/PackageManager;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/location/GpsLocationProvider;

    .prologue
    .line 130
    iget-object v0, p0, Lcom/android/server/location/GpsLocationProvider;->mPackageManager:Landroid/content/pm/PackageManager;
...
.method static synthetic access$1700(Lcom/android/server/location/GpsLocationProvider;)Ljava/lang/Object;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/location/GpsLocationProvider;
...
.method static synthetic access$2200(Lcom/android/server/location/GpsLocationProvider;)Lcom/android/server/location/GpsLocationProvider$BackOff;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/location/GpsLocationProvider;
...
.method static synthetic access$2400(Lcom/android/server/location/GpsLocationProvider;)Landroid/os/Handler;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/location/GpsLocationProvider;
...
.method static synthetic access$2600(Lcom/android/server/location/GpsLocationProvider;)Ljava/util/Properties;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/location/GpsLocationProvider;
...
.method static synthetic access$2700(Lcom/android/server/location/GpsLocationProvider;[BI)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/location/GpsLocationProvider;
    .param p1, "x1"    # [B
    .param p2, "x2"    # I
...
.method static synthetic access$2800(Lcom/android/server/location/GpsLocationProvider;)Lcom/android/server/location/GpsLocationProvider$BackOff;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/location/GpsLocationProvider;
...
.method static synthetic access$3400()J
    ...
    .prologue
    .line 130
    sget-wide v0, Lcom/android/server/location/GpsLocationProvider;->mLastAddNmeaTimestamp:J
...
.method static synthetic access$3402(J)J
    ...
    .prologue
    .line 130
    sput-wide p0, Lcom/android/server/location/GpsLocationProvider;->mLastAddNmeaTimestamp:J

    return-wide p0
.end method

.method static synthetic access$3500(Lcom/android/server/location/GpsLocationProvider;)Ljava/util/concurrent/LinkedBlockingQueue;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/location/GpsLocationProvider;

    .prologue
    .line 130
    iget-object v0, p0, Lcom/android/server/location/GpsLocationProvider;->mGpsDatas:Ljava/util/concurrent/LinkedBlockingQueue;
...
.method static synthetic access$3900(Lcom/android/server/location/GpsLocationProvider;Lcom/android/internal/location/ProviderRequest;Landroid/os/WorkSource;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/location/GpsLocationProvider;
...
.method static synthetic access$4000(Lcom/android/server/location/GpsLocationProvider;ILandroid/net/NetworkInfo;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/location/GpsLocationProvider;
    .param p1, "x1"    # I
...
.method static synthetic access$4502(Lcom/android/server/location/GpsLocationProvider;I)I
    .locals 0
    .param p0, "x0"    # Lcom/android/server/location/GpsLocationProvider;
    .param p1, "x1"    # I
...
.method static synthetic access$4600(Lcom/android/server/location/GpsLocationProvider;Landroid/location/Location;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/location/GpsLocationProvider;
...
.method static synthetic access$4700(Lcom/android/server/location/GpsLocationProvider;Landroid/content/Context;Ljava/util/Properties;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/location/GpsLocationProvider;
...
.method static synthetic access$4800(Lcom/android/server/location/GpsLocationProvider;)Landroid/telephony/SubscriptionManager$OnSubscriptionsChangedListener;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/location/GpsLocationProvider;
...
.method static synthetic access$5000(Lcom/android/server/location/GpsLocationProvider;)Landroid/content/BroadcastReceiver;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/location/GpsLocationProvider;
...
.method static synthetic access$5100(Lcom/android/server/location/GpsLocationProvider;)Landroid/content/BroadcastReceiver;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/location/GpsLocationProvider;

    .prologue
    .line 130
    iget-object v0, p0, Lcom/android/server/location/GpsLocationProvider;->mGpsLocalLocationReceiver:Landroid/content/BroadcastReceiver;

    return-object v0
.end method

.method static synthetic access$5200(Lcom/android/server/location/GpsLocationProvider;)Landroid/database/ContentObserver;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/location/GpsLocationProvider;

    .prologue
    .line 130
    iget-object v0, p0, Lcom/android/server/location/GpsLocationProvider;->mDefaultApnObserver:Landroid/database/ContentObserver;

    return-object v0
.end method

.method static synthetic access$5400(Lcom/android/server/location/GpsLocationProvider;)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/server/location/GpsLocationProvider;
...
.method static synthetic access$700(Lcom/android/server/location/GpsLocationProvider;)Lcom/android/server/location/IHwGpsLogServices;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/location/GpsLocationProvider;

    .prologue
    .line 130
    iget-object v0, p0, Lcom/android/server/location/GpsLocationProvider;->mHwGpsLogServices:Lcom/android/server/location/IHwGpsLogServices;
...
.method private checkSmsSuplInit(Landroid/content/Intent;)V
    ...
    .prologue
    .line 595
    iget-object v4, p0, Lcom/android/server/location/GpsLocationProvider;->mHwCmccGpsFeature:Lcom/android/server/location/IHwCmccGpsFeature;

    invoke-interface {v4}, Lcom/android/server/location/IHwCmccGpsFeature;->checkSuplInit()Z
...
.method private checkWapSuplInit(Landroid/content/Intent;)V
    ...
    .prologue
    .line 616
    iget-object v1, p0, Lcom/android/server/location/GpsLocationProvider;->mHwCmccGpsFeature:Lcom/android/server/location/IHwCmccGpsFeature;

    invoke-interface {v1}, Lcom/android/server/location/IHwCmccGpsFeature;->checkSuplInit()Z
...
.method private handleDisable()V
    ...
    .line 1246
    iput-object v2, p0, Lcom/android/server/location/GpsLocationProvider;->mProviderRequest:Lcom/android/internal/location/ProviderRequest;

    .line 1247
    iput-object v2, p0, Lcom/android/server/location/GpsLocationProvider;->mWorkSource:Landroid/os/WorkSource;
...
.method private handleEnable()V
    ...
    .line 1203
    .local v0, "enabled":Z
    iget-object v1, p0, Lcom/android/server/location/GpsLocationProvider;->mHwGpsLogServices:Lcom/android/server/location/IHwGpsLogServices;

    iget v2, p0, Lcom/android/server/location/GpsLocationProvider;->mEngineCapabilities:I

    int-to-byte v2, v2

    invoke-interface {v1, v0, v2}, Lcom/android/server/location/IHwGpsLogServices;->initGps(ZB)V
...
.method private handleUpdateNetworkState(ILandroid/net/NetworkInfo;)V
    ...
    .line 923
    :cond_0
    iget-object v0, p0, Lcom/android/server/location/GpsLocationProvider;->mHwCmccGpsFeature:Lcom/android/server/location/IHwCmccGpsFeature;

    invoke-virtual {p2}, Landroid/net/NetworkInfo;->isRoaming()Z

    move-result v1

    invoke-interface {v0, v1}, Lcom/android/server/location/IHwCmccGpsFeature;->setRoaming(Z)V

    .line 927
    iget-object v0, p0, Lcom/android/server/location/GpsLocationProvider;->mCust:Lcom/android/server/location/HwCustGpsLocationProvider;
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/location/HwCustGpsLocationProvider;->setRoaming(Z)V
    ...
    iget-object v1, p0, Lcom/android/server/location/GpsLocationProvider;->mGpsXtraReceiver:Lcom/android/server/location/IHwGpsXtraDownloadReceiver;
    ...
    :goto_5
    invoke-interface {v1, p2, v0}, Lcom/android/server/location/IHwGpsXtraDownloadReceiver;->handleUpdateNetworkState(Landroid/net/NetworkInfo;Z)Z
...
.method private hibernate()V
    ...
    const-string v4, "GpsLocationProvider hibernate SET_WAKE_ALARM"
...
.method private reportAGpsStatus(II[B)V
    ...
    .line 1873
    iget-object v2, p0, Lcom/android/server/location/GpsLocationProvider;->mHwGpsLogServices:Lcom/android/server/location/IHwGpsLogServices;

    invoke-interface {v2, p1, p2}, Lcom/android/server/location/IHwGpsLogServices;->updateAgpsState(II)V
...
.method private reportLocation(IDDDFFFJ)V
    ...
    const-string v6, "reportLocation lat: XXXXXX long: XXXXXX timestamp: "
    ...
    .line 1715
    iget-object v4, p0, Lcom/android/server/location/GpsLocationProvider;->mHwGpsLocationManager:Lcom/android/server/location/IHwGpsLocationManager;
    ...
    invoke-interface {v4, v0, v1, v6, v7}, Lcom/android/server/location/IHwGpsLocationManager;->setGpsTime(JJ)V
    ...
    .line 1733
    const-string v4, "isFrameworkBroadcast"
    ...
    invoke-interface {v4, v0, v1}, Lcom/android/server/location/IHwCmccGpsFeature;->syncTime(J)V
...
.method private reportNmea(J)V
    ...
    invoke-direct {p0, p1, p2, v1}, Lcom/android/server/location/GpsLocationProvider;->updateNmeaDate(JLjava/lang/String;)V
...
.method private reportStatus(I)V
    ...
    invoke-interface {v2, p1}, Lcom/android/server/location/IHwGpsLogServices;->updateGpsRunState(I)V
    ...
    .line 1776
    :goto_0
    iget-boolean v2, p0, Lcom/android/server/location/GpsLocationProvider;->misBetaUser:Z

    if-eqz v2, :cond_0

    .line 1777
    iget-object v3, p0, Lcom/android/server/location/GpsLocationProvider;->mHwPowerInfoService:Lcom/android/server/am/IHwPowerInfoService;

    monitor-enter v3

    .line 1778
    :try_start_0
    iget-object v2, p0, Lcom/android/server/location/GpsLocationProvider;->mHwPowerInfoService:Lcom/android/server/am/IHwPowerInfoService;

    invoke-interface {v2, p1}, Lcom/android/server/am/IHwPowerInfoService;->notePowerInfoGPSStatus(I)V
    ...
    .line 1789
    const-string v2, "isFrameworkBroadcast"
...
.method private reportSvStatus()V
    ...
    invoke-interface/range {v0 .. v6}, Lcom/android/server/location/IHwGpsLogServices;->updateSvStatus(I[I[F[F[F[I)V
    ...
    invoke-direct/range {v0 .. v8}, Lcom/android/server/location/GpsLocationProvider;->updateSvDate(I[I[F[F[FIII)V
    ...
    .line 1830
    iget-boolean v0, p0, Lcom/android/server/location/GpsLocationProvider;->mGnssSvStatus:Z
    ...
    .line 1861
    const-string v0, "isFrameworkBroadcast"
...
.method private requestUtcTime()V
    ...
    .prologue
    .line 2409
    iget-boolean v0, p0, Lcom/android/server/location/GpsLocationProvider;->mRequesetUtcTime:Z
    ...
    const-string v1, "reject utc time request"
    ...
    iput-boolean v0, p0, Lcom/android/server/location/GpsLocationProvider;->mRequesetUtcTime:Z
...
.method private startCacheThread()V
    .locals 2

    .prologue
    .line 2061
    iget-object v0, p0, Lcom/android/server/location/GpsLocationProvider;->mGpsDataThread:Ljava/lang/Thread;
    ...
    const-string v1, "GpsDataThread alive"
    ...
    const-string v1, "GpsDataThread"

    invoke-direct {v0, p0, v1}, Lcom/android/server/location/GpsLocationProvider$11;-><init>(Lcom/android/server/location/GpsLocationProvider;Ljava/lang/String;)V

    iput-object v0, p0, Lcom/android/server/location/GpsLocationProvider;->mGpsDataThread:Ljava/lang/Thread;
...
.method private declared-synchronized startNavigating(Z)V
    .locals 10
    ...
    iput v1, p0, Lcom/android/server/location/GpsLocationProvider;->mTimeToFirstFix:I
    ...
    iput-boolean v1, p0, Lcom/android/server/location/GpsLocationProvider;->mRequesetUtcTime:Z
    ...
    invoke-direct {p0, v1, v6, p1}, Lcom/android/server/location/GpsLocationProvider;->getSuplMode(Ljava/util/Properties;ZZ)I
    ...
    .line 1524
    iget-object v1, p0, Lcom/android/server/location/GpsLocationProvider;->mHwGpsLocationCustFeature:Lcom/android/server/location/IHwGpsLocationCustFeature;

    iget v2, p0, Lcom/android/server/location/GpsLocationProvider;->mPositionMode:I

    invoke-interface {v1, v2, v6}, Lcom/android/server/location/IHwGpsLocationCustFeature;->setPostionMode(IZ)I
    ...
    invoke-interface {v1, v2, v6}, Lcom/android/server/location/IHwCmccGpsFeature;->setPostionModeAndAgpsServer(IZ)I
    ...
    .line 1532
    iget-object v1, p0, Lcom/android/server/location/GpsLocationProvider;->mCust:Lcom/android/server/location/HwCustGpsLocationProvider;
    ...
    invoke-virtual {v1, v2}, Lcom/android/server/location/HwCustGpsLocationProvider;->setPostionMode(I)I
    ...
    const-string v2, "ro.config.gpstype"
    ...
    invoke-static {v1, v2}, Lcom/android/server/location/AgpsConnectProvider;->setPostionMode(ILandroid/content/Context;)I
    ...
    .local v3, "interval":I
    :goto_1
    sget-boolean v1, Lcom/android/server/location/GpsLocationProvider;->mWcdmaVpEnabled:Z
    ...
    const-string v1, "agps_app_started_navigation"
    ...
    invoke-virtual {p0}, Lcom/android/server/location/GpsLocationProvider;->getPreferred_accuracy()I
    ...
    invoke-interface {v0, v1}, Lcom/android/server/location/IHwGpsLogServices;->updateSetPosMode(Z)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-interface {v0}, Lcom/android/server/location/IHwCmccGpsFeature;->setDelAidData()V
    ...
    invoke-interface {v0, v1, v2}, Lcom/android/server/location/IHwGpsLogServices;->startGps(ZI)V
    ...
    const-string v1, "GpsLocationProvider startNavigating SET_WAKE_ALARM60000"
    ...
    .line 1612
    :cond_9
    invoke-direct {p0}, Lcom/android/server/location/GpsLocationProvider;->startCacheThread()V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
...
.method private declared-synchronized stopNavigating()V
    .locals 4
    ...
    const-string v3, "stopNavigating, mStarted="
    ...
    invoke-interface {v1, v0}, Lcom/android/server/location/IHwGpsLogServices;->stopGps(Z)V
    ...
    invoke-direct {p0, v1, v2}, Lcom/android/server/location/GpsLocationProvider;->updateStatus(II)V
    ...
    const-string v2, "agps_app_started_navigation"
...
.method private subscriptionOrSimChanged(Landroid/content/Context;)V
    ...
    .line 582
    :try_start_0
    const-string v2, "ro.config.hw_agps_adpt_sim"
...
.method private updateLowPowerMode()V
    ...
    const-string v4, "updateLowPowerMode,isPowerSaveMode:"

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    iget-object v4, p0, Lcom/android/server/location/GpsLocationProvider;->mPowerManager:Landroid/os/PowerManager;
...
.method private updateNmeaDate(JLjava/lang/String;)V
    .locals 3
    .param p1, "timestamp"    # J
    ...
    .line 2054
    :try_start_0
    iget-object v1, p0, Lcom/android/server/location/GpsLocationProvider;->mGpsDatas:Ljava/util/concurrent/LinkedBlockingQueue;

    new-instance v2, Lcom/android/server/location/GpsLocationProvider$NmeaData;

    invoke-direct {v2, p0, p1, p2, p3}, Lcom/android/server/location/GpsLocationProvider$NmeaData;-><init>(Lcom/android/server/location/GpsLocationProvider;JLjava/lang/String;)V
    ...
    const-string v2, "mGpsDatas put nmea error"
...
.method private updateRequirements()V
    ...
    iget-object v1, p0, Lcom/android/server/location/GpsLocationProvider;->mWorkSource:Landroid/os/WorkSource;

    invoke-virtual {v0, v1}, Lcom/android/server/location/GpsFreezeProc;->shouldFreeze(Landroid/os/WorkSource;)Z
    ...
    .line 1344
    invoke-virtual {p0}, Lcom/android/server/location/GpsLocationProvider;->shouldReStartNavi()Z
...
.method private updateSvDate(I[I[F[F[FIII)V
    .locals 12
    .param p1, "svCount"    # I
    .param p2, "prns"    # [I
    .param p3, "snrs"    # [F
    ...
    .line 2039
    :try_start_0
    iget-object v11, p0, Lcom/android/server/location/GpsLocationProvider;->mGpsDatas:Ljava/util/concurrent/LinkedBlockingQueue;

    new-instance v0, Lcom/android/server/location/GpsLocationProvider$SvData;
    ...
    invoke-direct/range {v0 .. v9}, Lcom/android/server/location/GpsLocationProvider$SvData;-><init>(Lcom/android/server/location/GpsLocationProvider;I[I[F[F[FIII)V

    invoke-virtual {v11, v0}, Ljava/util/concurrent/LinkedBlockingQueue;->put(Ljava/lang/Object;)V
    :try_end_0
    .catch Ljava/lang/InterruptedException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v1, "mGpsDatas put sv error"
...
.method public getPreferred_accuracy()I
    .locals 1
...
.method public initDefaultApnObserver(Landroid/os/Handler;)V
    .locals 0
...
.method public isLocalDBEnabled()Z
    .locals 1
...
.method public reportContextStatus(I)V
    .locals 0
    .param p1, "status"    # I
...
.method public sendExtraCommand(Ljava/lang/String;Landroid/os/Bundle;)Z
    ...
    :cond_0
    :goto_0
    iget-object v3, p0, Lcom/android/server/location/GpsLocationProvider;->mCust:Lcom/android/server/location/HwCustGpsLocationProvider;
    ...
    invoke-virtual {v3, v2, p1}, Lcom/android/server/location/HwCustGpsLocationProvider;->sendPostionModeCommand(ZLjava/lang/String;)Z
    ...
    invoke-virtual {v3, v4}, Lcom/android/server/location/HwCustGpsLocationProvider;->setPostionMode(I)I
...
.method public shouldReStartNavi()Z
    .locals 1
