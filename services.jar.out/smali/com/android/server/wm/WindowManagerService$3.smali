...
.method public run()V
    ...
    .line 959
    invoke-static {}, Lcom/android/server/HwServiceFactory;->getHuaweiWindowManagerService()Lcom/android/server/HwServiceFactory$IHwWindowManagerService;

    move-result-object v0

    .line 960
    .local v0, "iwms":Lcom/android/server/HwServiceFactory$IHwWindowManagerService;
    if-eqz v0, :cond_0

    .line 961
    iget-object v6, p0, Lcom/android/server/wm/WindowManagerService$3;->val$holder:[Lcom/android/server/wm/WindowManagerService;
    ...
    invoke-interface/range {v0 .. v5}, Lcom/android/server/HwServiceFactory$IHwWindowManagerService;->getInstance(Landroid/content/Context;Lcom/android/server/input/InputManagerService;ZZZ)Lcom/android/server/wm/WindowManagerService;
    ...
    iget-object v3, p0, Lcom/android/server/wm/WindowManagerService$3;->val$im:Lcom/android/server/input/InputManagerService;

    iget-boolean v4, p0, Lcom/android/server/wm/WindowManagerService$3;->val$haveInputMethods:Z

    iget-boolean v5, p0, Lcom/android/server/wm/WindowManagerService$3;->val$showBootMsgs:Z

    iget-boolean v6, p0, Lcom/android/server/wm/WindowManagerService$3;->val$onlyCore:Z

    invoke-direct/range {v1 .. v6}, Lcom/android/server/wm/WindowManagerService;-><init>(Landroid/content/Context;Lcom/android/server/input/InputManagerService;ZZZ)V
