...
.method public performDrag(Landroid/view/IWindow;Landroid/os/IBinder;FFFFLandroid/content/ClipData;)Z
    ...
    const-string v12, "No drag prepared"
    ...
    const-string v12, "performDrag() without prepareDrag()"
    ...
    iget-object v10, v10, Lcom/android/server/wm/DragState;->mToken:Landroid/os/IBinder;
    ...
    const-string v12, "Performing mismatched drag"
    ...
    const-string v12, "performDrag() does not match prepareDrag()"
    ...
    invoke-virtual {v10, v12, p1, v13}, Lcom/android/server/wm/WindowManagerService;->windowForClientLocked(Lcom/android/server/wm/Session;Landroid/view/IWindow;Z)Lcom/android/server/wm/WindowState;
    ...
    invoke-virtual {v10, v12, v13}, Lcom/android/server/wm/WindowManagerService$H;->removeMessages(ILjava/lang/Object;)V
    ...
    invoke-virtual {v10, v4}, Lcom/android/server/wm/DragState;->register(Landroid/view/Display;)V
    ...
    iget-object v12, v2, Lcom/android/server/wm/WindowState;->mInputChannel:Landroid/view/InputChannel;

    iget-object v13, p0, Lcom/android/server/wm/Session;->mService:Lcom/android/server/wm/WindowManagerService;

    iget-object v13, v13, Lcom/android/server/wm/WindowManagerService;->mDragState:Lcom/android/server/wm/DragState;

    iget-object v13, v13, Lcom/android/server/wm/DragState;->mServerChannel:Landroid/view/InputChannel;

    invoke-virtual {v10, v12, v13}, Lcom/android/server/input/InputManagerService;->transferTouchFocus(Landroid/view/InputChannel;Landroid/view/InputChannel;)Z
    ...
    const-string v12, "Unable to transfer touch focus"
    ...
    invoke-virtual {v10}, Lcom/android/server/wm/DragState;->unregister()V
    ...
    iput-object v12, v10, Lcom/android/server/wm/WindowManagerService;->mDragState:Lcom/android/server/wm/DragState;
    ...
    iput-object v0, v10, Lcom/android/server/wm/DragState;->mData:Landroid/content/ClipData;
    ...
    iput v0, v10, Lcom/android/server/wm/DragState;->mCurrentX:F
    ...
    iput v0, v10, Lcom/android/server/wm/DragState;->mCurrentY:F
    ...
    invoke-virtual {v10, v0, v1}, Lcom/android/server/wm/DragState;->broadcastDragStartedLw(FF)V
    ...
    iput v0, v10, Lcom/android/server/wm/DragState;->mThumbOffsetX:F
    ...
    iput v0, v10, Lcom/android/server/wm/DragState;->mThumbOffsetY:F
    ...
    iget-object v9, v10, Lcom/android/server/wm/DragState;->mSurfaceControl:Landroid/view/SurfaceControl;
    ...
    invoke-virtual {v10}, Lcom/android/server/wm/WindowManagerService;->getLazyMode()I
    ...
    .end local v3    # "dh":I
    .end local v6    # "dw":I
    .end local v8    # "lazyscale":F
    :cond_6
    sub-float v10, p3, p5

    sub-float v12, p4, p6

    invoke-virtual {v9, v10, v12}, Landroid/view/SurfaceControl;->setPosition(FF)V

    .line 360
    const v10, 0x3f350481    # 0.7071f

    invoke-virtual {v9, v10}, Landroid/view/SurfaceControl;->setAlpha(F)V
    ...
    invoke-virtual {v10}, Lcom/android/server/wm/DragState;->getDragLayerLw()I
    ...
    invoke-virtual {v9, v10}, Landroid/view/SurfaceControl;->setLayerStack(I)V
