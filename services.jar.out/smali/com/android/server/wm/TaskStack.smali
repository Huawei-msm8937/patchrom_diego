...
.super Lcom/android/server/wm/AbsTaskStack;
...
.method public constructor <init>(Lcom/android/server/wm/WindowManagerService;I)V
    ...
    .line 103
    invoke-direct {p0}, Lcom/android/server/wm/AbsTaskStack;-><init>()V
...
.method addTask(Lcom/android/server/wm/Task;ZZ)V
    ...
    .line 323
    .local v2, "shouldAdjustStack":Z
    invoke-virtual {v6}, Lcom/android/server/wm/WindowList;->size()I

    move-result v5

    .line 324
    .local v5, "winListSize":I
    const/4 v7, 0x2
    ...
    invoke-virtual {v6, v7}, Lcom/android/server/wm/WindowList;->get(I)Ljava/lang/Object;
    ...
    const-string v7, "com.huawei.hwstartupguide"
    ...
    invoke-virtual {v7, p0, p2}, Lcom/android/server/wm/DisplayContent;->moveStack(Lcom/android/server/wm/TaskStack;Z)V
    ...
    .line 301
    .end local v2    # "shouldAdjustStack":Z
    .end local v3    # "stackNdx":I
    .end local v5    # "winListSize":I
    ...
    .line 306
    .local v4, "tmpTask":Lcom/android/server/wm/Task;
    invoke-virtual {v4}, Lcom/android/server/wm/Task;->showForAllUsers()Z
    ...
    .line 312
    .end local v4    # "tmpTask":Lcom/android/server/wm/Task;
    :cond_5
    add-int/lit8 v3, v3, 0x1
    ...
    .line 336
    .restart local v2    # "shouldAdjustStack":Z
    .restart local v5    # "winListSize":I
