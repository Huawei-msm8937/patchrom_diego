...
.method static synthetic access$300(Lcom/android/server/LockSettingsService;)Landroid/service/gatekeeper/IGateKeeperService;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/LockSettingsService;
...
.method static synthetic access$302(Lcom/android/server/LockSettingsService;Landroid/service/gatekeeper/IGateKeeperService;)Landroid/service/gatekeeper/IGateKeeperService;
    .locals 0
    .param p0, "x0"    # Lcom/android/server/LockSettingsService;
...
.method private doVerifyPassword(Ljava/lang/String;ZJI)Lcom/android/internal/widget/VerifyCredentialResponse;
    ...
    .prologue
    .line 600
    invoke-virtual {p0, p5}, Lcom/android/server/LockSettingsService;->checkPasswordReadPermission(I)V
    ...
    iget-object v0, v3, Lcom/android/server/LockSettingsStorage$CredentialHash;->hash:[B
    ...
    const-string v1, "no Password saved VerifyPassword success"
...
.method private doVerifyPattern(Ljava/lang/String;ZJI)Lcom/android/internal/widget/VerifyCredentialResponse;
    ...
    iget-object v3, v5, Lcom/android/server/LockSettingsStorage$CredentialHash;->hash:[B
    ...
    const-string v4, "no Pattern saved VerifyPattern success"
...
.method private enrollCredential([BLjava/lang/String;Ljava/lang/String;I)[B
    ...
    const-string v6, "enrollCredential response null"
    ...
    .line 511
    invoke-virtual {p0, p3, p4}, Lcom/android/server/LockSettingsService;->setKeystorePassword(Ljava/lang/String;I)V

    .line 512
    const-string v4, "LockSettingsService"

    const-string v5, "enrollCredential response success"
...
.method private getCurrentHandle(I)[B
    ...
    const-string v5, "getCurrentHandle by user "
    ...
    const-string v5, ", currentHandleType "
...
.method private verifyCredential(ILcom/android/server/LockSettingsStorage$CredentialHash;Ljava/lang/String;ZJLcom/android/server/LockSettingsService$CredentialUtil;)Lcom/android/internal/widget/VerifyCredentialResponse;
    ...
    const-string v5, "no stored Password/Pattern, verifyCredential success"
    ...
    const-string v5, "no entered Password/Pattern, verifyCredential ERROR"
    ...
    const-string v5, "verifyCredential passed by GateKeeper"
...
.method protected setKeystorePassword(Ljava/lang/String;I)V
    .locals 7
    .param p1, "password"    # Ljava/lang/String;
    .param p2, "userHandle"    # I
...
.method public setLockPassword(Ljava/lang/String;Ljava/lang/String;I)V
    ...
    .line 470
    invoke-virtual {p0, v3, p3}, Lcom/android/server/LockSettingsService;->setKeystorePassword(Ljava/lang/String;I)V

    .line 471
    const-string v2, "LockSettingsService"

    const-string v3, "setLockPassword to null success"
    ...
    const-string v3, "set new LockPassword success"
...
.method public setLockPattern(Ljava/lang/String;Ljava/lang/String;I)V
    ...
    const-string v3, "setLockPattern to null success"
    ...
    const-string v3, "set new LockPattern success"
