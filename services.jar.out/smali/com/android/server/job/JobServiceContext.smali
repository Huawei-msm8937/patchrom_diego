...
.method executeRunnableJob(Lcom/android/server/job/controllers/JobStatus;)Z
    ...
    .line 149
    iget-object v6, p0, Lcom/android/server/job/JobServiceContext;->mLock:Ljava/lang/Object;

    monitor-enter v6

    .line 150
    :try_start_0
    iget-boolean v3, p0, Lcom/android/server/job/JobServiceContext;->mAvailable:Z
    ...
    :goto_1
    new-instance v3, Landroid/app/job/JobParameters;
    ...
    invoke-direct {v3, p0, v7, v8, v2}, Landroid/app/job/JobParameters;-><init>(Landroid/os/IBinder;ILandroid/os/PersistableBundle;Z)V
    ...
    iput-wide v8, p0, Lcom/android/server/job/JobServiceContext;->mExecutionStartTimeElapsed:J
    ...
    instance-of v3, v3, Lcom/android/server/job/JobSchedulerService;

    if-eqz v3, :cond_2

    iget-object v3, p0, Lcom/android/server/job/JobServiceContext;->mCompletedListener:Lcom/android/server/job/JobCompletedListener;

    check-cast v3, Lcom/android/server/job/JobSchedulerService;

    invoke-virtual {p1}, Lcom/android/server/job/controllers/JobStatus;->getUserId()I

    move-result v7

    invoke-virtual {v3, v1, v7}, Lcom/android/server/job/JobSchedulerService;->checkShouldFilterIntent(Landroid/content/Intent;I)Z
    ...
    invoke-virtual {v3, v1, p0, v7, v8}, Landroid/content/Context;->bindServiceAsUser(Landroid/content/Intent;Landroid/content/ServiceConnection;ILandroid/os/UserHandle;)Z
    :try_end_0
    ...
    invoke-interface {v3, v4, v7}, Lcom/android/internal/app/IBatteryStats;->noteJobStart(Ljava/lang/String;I)V
    :try_end_1
