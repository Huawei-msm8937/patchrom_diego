...
.super Lcom/android/server/usb/AbsUsbDeviceManager;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/server/usb/UsbDeviceManager$SuitestateObserver;,
        Lcom/android/server/usb/UsbDeviceManager$HdbSettingsObserver;,
...
.field private static final ACTION_USB_USER_UPDATE:Ljava/lang/String; = "android.hardware.usb.action.USB_UPDATE"
...
.field private static final SUITE_STATE_FILE:Ljava/lang/String; = "android_usb/f_mass_storage/suitestate"

.field private static final SUITE_STATE_PATH:Ljava/lang/String; = "/sys/class"

.field private static final TAG:Ljava/lang/String; = "UsbDeviceManager"

.field private static final UPDATE_DELAY:I = 0x5dc

.field private static final USBDATA_UNLOCKED:Ljava/lang/String; = "usbdata_unlocked"
...
.field private mChargingOnly_L:Z
...
.field private mHDBManager:Lcom/android/server/usb/HwUsbHDBManager;

.field private mHandler:Lcom/android/server/usb/UsbDeviceManager$UsbHandler;

.field private final mHasUsbAccessory:Z

.field private mHdbEnabled:Z

.field private final mHostReceiver:Landroid/content/BroadcastReceiver;

.field private mLastChargingState:Z
...
.field private mPowerCharging:Z
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/usb/UsbAlsaManager;)V
    ...
    .prologue
    .line 340
    invoke-direct {p0}, Lcom/android/server/usb/AbsUsbDeviceManager;-><init>()V
    ...
    iput-object v3, p0, Lcom/android/server/usb/UsbDeviceManager;->mPowerSupplyObserver:Landroid/os/UEventObserver;
    ...
    .line 351
    const-string v3, "persist.service.hdb.enable"
    ...
    iput-boolean v3, p0, Lcom/android/server/usb/UsbDeviceManager;->mHdbEnabled:Z
    ...
    iget-boolean v3, p0, Lcom/android/server/usb/UsbDeviceManager;->mHdbEnabled:Z

    if-eqz v3, :cond_3

    .line 370
    invoke-static {p1}, Lcom/android/server/HwServiceFactory;->getHwUsbHDBManager(Landroid/content/Context;)Lcom/android/server/usb/HwUsbHDBManager;

    move-result-object v3

    iput-object v3, p0, Lcom/android/server/usb/UsbDeviceManager;->mHDBManager:Lcom/android/server/usb/HwUsbHDBManager;
...
.method private HdbIsEnableFunction(Ljava/lang/String;)Z
    .locals 3
    ...
    .line 521
    invoke-virtual {p0}, Lcom/android/server/usb/UsbDeviceManager;->isCmccUsbLimit()Z
    ...
    const-string v2, "cmcc_usb_limit do not set hdb"
    ...
    const-string v1, "hisuite,mtp,mass_storage"
    ...
    const-string v1, "hisuite,mtp,mass_storage,adb"
    ...
    .line 534
    :cond_2
    iget-boolean v1, p0, Lcom/android/server/usb/UsbDeviceManager;->settingsHdbEnabled:Z
...
.method static synthetic access$1000(Lcom/android/server/usb/UsbDeviceManager;)Z
    ...
    .prologue
    .line 92
    iget-boolean v0, p0, Lcom/android/server/usb/UsbDeviceManager;->settingsHdbEnabled:Z
...
.method static synthetic access$1002(Lcom/android/server/usb/UsbDeviceManager;Z)Z
    ...
    .prologue
    .line 92
    iput-boolean p1, p0, Lcom/android/server/usb/UsbDeviceManager;->settingsHdbEnabled:Z
...
.method static synthetic access$1300(Lcom/android/server/usb/UsbDeviceManager;)Landroid/os/UEventObserver;
    ...
    .prologue
    .line 92
    iget-object v0, p0, Lcom/android/server/usb/UsbDeviceManager;->mPowerSupplyObserver:Landroid/os/UEventObserver;
...
.method static synthetic access$1600(Lcom/android/server/usb/UsbDeviceManager;)Lcom/android/server/usb/HwUsbHDBManager;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/usb/UsbDeviceManager;

    .prologue
    .line 92
    iget-object v0, p0, Lcom/android/server/usb/UsbDeviceManager;->mHDBManager:Lcom/android/server/usb/HwUsbHDBManager;
...
.method static synthetic access$1900(Lcom/android/server/usb/UsbDeviceManager;Ljava/lang/String;)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/server/usb/UsbDeviceManager;
    .param p1, "x1"    # Ljava/lang/String;
    ...
    .prologue
    .line 92
    invoke-direct {p0, p1}, Lcom/android/server/usb/UsbDeviceManager;->HdbIsEnableFunction(Ljava/lang/String;)Z
...
.method static synthetic access$2000(Lcom/android/server/usb/UsbDeviceManager;)Z
    ...
    .prologue
    .line 92
    iget-boolean v0, p0, Lcom/android/server/usb/UsbDeviceManager;->mHdbEnabled:Z

    return v0
.end method

.method static synthetic access$2100(Lcom/android/server/usb/UsbDeviceManager;)J
    .locals 2
    .param p0, "x0"    # Lcom/android/server/usb/UsbDeviceManager;
...
.method static synthetic access$2600(Lcom/android/server/usb/UsbDeviceManager;)Lcom/android/server/usb/UsbAlsaManager;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/usb/UsbDeviceManager;
...
.method static synthetic access$300(Lcom/android/server/usb/UsbDeviceManager;)Z
    ...
    .prologue
    .line 92
    iget-boolean v0, p0, Lcom/android/server/usb/UsbDeviceManager;->mUSBPlugType:Z

    return v0
.end method

.method static synthetic access$3000(Lcom/android/server/usb/UsbDeviceManager;Ljava/lang/String;)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/server/usb/UsbDeviceManager;
    .param p1, "x1"    # Ljava/lang/String;
    ...
    .prologue
    .line 92
    invoke-direct {p0, p1}, Lcom/android/server/usb/UsbDeviceManager;->isDefaultFunction(Ljava/lang/String;)Z
...
.method static synthetic access$302(Lcom/android/server/usb/UsbDeviceManager;Z)Z
    ...
    .prologue
    .line 92
    iput-boolean p1, p0, Lcom/android/server/usb/UsbDeviceManager;->mUSBPlugType:Z
...
.method static synthetic access$400(Lcom/android/server/usb/UsbDeviceManager;)Z
    ...
    .prologue
    .line 92
    iget-boolean v0, p0, Lcom/android/server/usb/UsbDeviceManager;->mPowerCharging:Z
...
.method static synthetic access$402(Lcom/android/server/usb/UsbDeviceManager;Z)Z
    ...
    .prologue
    .line 92
    iput-boolean p1, p0, Lcom/android/server/usb/UsbDeviceManager;->mPowerCharging:Z
...
.method static synthetic access$500(Lcom/android/server/usb/UsbDeviceManager;)Z
    ...
    .prologue
    .line 92
    iget-boolean v0, p0, Lcom/android/server/usb/UsbDeviceManager;->mLastChargingState:Z
...
.method static synthetic access$502(Lcom/android/server/usb/UsbDeviceManager;Z)Z
    ...
    .prologue
    .line 92
    iput-boolean p1, p0, Lcom/android/server/usb/UsbDeviceManager;->mLastChargingState:Z
...
.method static synthetic access$600(Lcom/android/server/usb/UsbDeviceManager;)Z
    ...
    .prologue
    .line 92
    iget-boolean v0, p0, Lcom/android/server/usb/UsbDeviceManager;->mSystemReady:Z
...
.method static synthetic access$602(Lcom/android/server/usb/UsbDeviceManager;Z)Z
    ...
    .prologue
    .line 92
    iput-boolean p1, p0, Lcom/android/server/usb/UsbDeviceManager;->mSystemReady:Z
...
.method static synthetic access$900(Lcom/android/server/usb/UsbDeviceManager;)Z
    ...
    .prologue
    .line 92
    iget-boolean v0, p0, Lcom/android/server/usb/UsbDeviceManager;->mChargingOnly_L:Z
...
.method static synthetic access$902(Lcom/android/server/usb/UsbDeviceManager;Z)Z
    ...
    .prologue
    .line 92
    iput-boolean p1, p0, Lcom/android/server/usb/UsbDeviceManager;->mChargingOnly_L:Z
...
.method private isDefaultFunction(Ljava/lang/String;)Z
    .locals 3
    .param p1, "functions"    # Ljava/lang/String;
    ...
    .line 550
    :cond_1
    const-string v2, "hisuite,mtp,mass_storage"
    ...
    .line 556
    :cond_3
    iget-boolean v2, p0, Lcom/android/server/usb/UsbDeviceManager;->mChargingOnly_L:Z
...
.method public allowUsbDebugging(ZLjava/lang/String;)V
    ...
    const-string v1, "UsbDeviceManager allowUsbDebugging..."
...
.method protected containsFunctionOuter(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    .prologue
    .line 1551
    invoke-static {p1, p2}, Landroid/hardware/usb/UsbManager;->containsFunction(Ljava/lang/String;Ljava/lang/String;)Z
...
.method public denyUsbDebugging()V
    ...
    const-string v1, "UsbDeviceManager denyUsbDebugging..."
...
.method public dump(Lcom/android/internal/util/IndentingPrintWriter;)V
    ...
    invoke-interface {v0, p1}, Lcom/android/server/usb/HwUsbHDBManager;->dump(Lcom/android/internal/util/IndentingPrintWriter;)V
...
.method protected getUsbHandlerConnected()Z
    ...
    invoke-static {v0}, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->access$3200(Lcom/android/server/usb/UsbDeviceManager$UsbHandler;)Z
...
.method protected removeAdbFunction(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    .prologue
    .line 1563
    invoke-static {p1, p2}, Landroid/hardware/usb/UsbManager;->removeFunction(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method protected sendHandlerEmptyMessage(I)Z
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->sendEmptyMessage(I)Z
...
.method public setCurrentFunctions(Ljava/lang/String;)V
    ...
    const-string v2, "UsbDeviceManager setCurrentFunctions("
...
.method protected setEnabledFunctionsEx(Ljava/lang/String;Z)V
    ...
    invoke-static {v0, p1, p2}, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->access$3300(Lcom/android/server/usb/UsbDeviceManager$UsbHandler;Ljava/lang/String;Z)V
...
.method protected setUsbConfigEx(Ljava/lang/String;)Z
    ...
    # invokes: Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->setUsbConfig(Ljava/lang/String;)Z
    invoke-static {v0, p1}, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->access$3400(Lcom/android/server/usb/UsbDeviceManager$UsbHandler;Ljava/lang/String;)Z
...
.method public setUsbDataUnlocked(Z)V
    ...
    const-string v2, "UsbDeviceManager setUsbDataUnlocked("
...
.method public systemReady()V
    ...
    const-string v8, "UsbDeviceManager make sure ADB_ENABLED setting value when systemReady, mAdbEnabled is "
    ...
    invoke-static {v4, v7}, Landroid/util/Flog;->i(ILjava/lang/String;)I
    ...
    .line 412
    :goto_3
    const-string v4, "persist.service.hdb.enable"
    ...
    .line 414
    const-string v4, "ro.default.userportmode"
    ...
    const-string v7, "UsbDeviceManager ro.default.userportmode:"

    invoke-virtual {v5, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    const-string v7, "ro.default.userportmode"
    ...
    const-string v5, "send message for ready to delay 1 second"
    ...
    invoke-virtual {v4, v5, v8, v9}, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->sendEmptyMessageDelayed(IJ)Z

    .line 446
    iget-boolean v4, p0, Lcom/android/server/usb/UsbDeviceManager;->mChargingOnly_L:Z
    ...
    const-string v4, "UsbDeviceManager ADB_ENABLED is restricted."

    invoke-static {v9, v4}, Landroid/util/Flog;->w(ILjava/lang/String;)I
    ...
    const-string v5, "UsbDeviceManager set KEY_CONTENT_HDB_ALLOWED failed: "
    ...
    invoke-static {v9, v4}, Landroid/util/Flog;->e(ILjava/lang/String;)I
    ...
    const-string v7, "UsbDeviceManager ro.product.locale.region:"
    ...
    :try_start_3
    const-string v5, "UsbDeviceManager System.KEY_CONTENT_HDB_ALLOWED : 0"
...
.method public writeSuitestate()V
    .locals 10
    ...
    const-string v7, "/sys/class"

    const-string v8, "android_usb/f_mass_storage/suitestate"
    ...
    const-string v8, "IOException in close fw"
    ...
    const-string v8, "IOException in writeCommand hisuite"
    ...
    const-string v9, "IOException in close fw"
