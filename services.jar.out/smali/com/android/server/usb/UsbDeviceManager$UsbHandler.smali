...
.method public constructor <init>(Lcom/android/server/usb/UsbDeviceManager;Landroid/os/Looper;)V
    ...
    invoke-direct {v2, p0}, Lcom/android/server/usb/UsbDeviceManager$UsbHandler$1;-><init>(Lcom/android/server/usb/UsbDeviceManager$UsbHandler;)V

    iput-object v2, p0, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->mBatteryChangedReceiver:Landroid/content/BroadcastReceiver;

    .line 635
    :try_start_0
    const-string v2, "ro.config.chargingonly_l"
    ...
    # setter for: Lcom/android/server/usb/UsbDeviceManager;->mChargingOnly_L:Z
    invoke-static {p1, v2}, Lcom/android/server/usb/UsbDeviceManager;->access$902(Lcom/android/server/usb/UsbDeviceManager;Z)Z
    ...
    .line 641
    # getter for: Lcom/android/server/usb/UsbDeviceManager;->mChargingOnly_L:Z
    ...
    .line 648
    iget-object v2, p1, Lcom/android/server/usb/UsbDeviceManager;->mContentResolver:Landroid/content/ContentResolver;

    const-string v3, "hdb_enabled"
    ...
    # setter for: Lcom/android/server/usb/UsbDeviceManager;->settingsHdbEnabled:Z
    invoke-static {p1, v2}, Lcom/android/server/usb/UsbDeviceManager;->access$1002(Lcom/android/server/usb/UsbDeviceManager;Z)Z
    ...
    invoke-static {p1, v2}, Lcom/android/server/usb/UsbDeviceManager;->access$1102(Lcom/android/server/usb/UsbDeviceManager;Z)Z
    ...
    .line 665
    const-string v2, "persist.service.hdb.enable"
    ...
    new-instance v5, Lcom/android/server/usb/UsbDeviceManager$HdbSettingsObserver;

    invoke-direct {v5, p1}, Lcom/android/server/usb/UsbDeviceManager$HdbSettingsObserver;-><init>(Lcom/android/server/usb/UsbDeviceManager;)V
    ...
    new-instance v5, Lcom/android/server/usb/UsbDeviceManager$SuitestateObserver;

    invoke-direct {v5, p1}, Lcom/android/server/usb/UsbDeviceManager$SuitestateObserver;-><init>(Lcom/android/server/usb/UsbDeviceManager;)V
    ...
    const-string v3, "now is using Version L only charging, register power state listener"

    invoke-static {v2, v3}, Landroid/util/Slog;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 682
    # getter for: Lcom/android/server/usb/UsbDeviceManager;->mPowerSupplyObserver:Landroid/os/UEventObserver;
    ...
    iget-object v3, p0, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->mBatteryChangedReceiver:Landroid/content/BroadcastReceiver;
...
.method static synthetic access$3200(Lcom/android/server/usb/UsbDeviceManager$UsbHandler;)Z
    .locals 1
...
.method static synthetic access$3400(Lcom/android/server/usb/UsbDeviceManager$UsbHandler;Ljava/lang/String;)Z
    .locals 1
    .param p0, "x0"    # Lcom/android/server/usb/UsbDeviceManager$UsbHandler;
    .param p1, "x1"    # Ljava/lang/String;
...
.method private applyAdbFunction(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v0, p1, v1}, Lcom/android/server/usb/UsbDeviceManager;->removeAdbFunction(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method private applyHdbFunction(Ljava/lang/String;)Ljava/lang/String;
    .locals 3
    .param p1, "functions"    # Ljava/lang/String;
    ...
    # invokes: Lcom/android/server/usb/UsbDeviceManager;->HdbIsEnableFunction(Ljava/lang/String;)Z
    invoke-static {v0, p1}, Lcom/android/server/usb/UsbDeviceManager;->access$1900(Lcom/android/server/usb/UsbDeviceManager;Ljava/lang/String;)Z
    ...
    # getter for: Lcom/android/server/usb/UsbDeviceManager;->mHdbEnabled:Z
...
.method private applyUserRestrictions(Ljava/lang/String;)Ljava/lang/String;
    .locals 3
    .param p1, "functions"    # Ljava/lang/String;
...
.method private getDefaultFunctions()Ljava/lang/String;
    ...
    const-string v3, "now is using Version L only charging, getDefaultFunctions maybe none"
    ...
    .line 1388
    .end local v0    # "func":Ljava/lang/String;
    .restart local v1    # "func":Ljava/lang/String;
    goto :goto_0
.end method
...
.method private setAdbEnabled(Z)V
    ...
    invoke-direct {p0, v0}, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->applyHdbFunction(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v4, "UsbDeviceManager setAdbEnabled -> USB_PERSISTENT_CONFIG_PROPERTY : "
...
.method private setDefaultFunctions(Ljava/lang/String;)V
    .locals 5
    .param p1, "functions"    # Ljava/lang/String;
    ...
    const-string v4, "setDefaultFunctions: "
    ...
    const-string v4, "UsbDeviceManager setDefaultFunctions -> USB_PERSISTENT_CONFIG_PROPERTY : "
    ...
    invoke-direct {p0, p1, v2}, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->setEnabledFunctions(Ljava/lang/String;Z)V
...
.method private setEnabledFunctions(Ljava/lang/String;Z)V
    ...
    invoke-virtual {v2, p1}, Lcom/android/server/usb/UsbDeviceManager;->interceptSetEnabledFunctions(Ljava/lang/String;)Z
...
.method private setHdbEnabled(Z)V
    .locals 5
    .param p1, "enable"    # Z
    ...
    # getter for: Lcom/android/server/usb/UsbDeviceManager;->settingsHdbEnabled:Z
    ...
    .line 839
    .local v1, "oldFunctions":Ljava/lang/String;
    invoke-direct {p0, v1}, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->applyHdbFunction(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v4, "UsbDeviceManager setHdbEnabled -> USB_PERSISTENT_CONFIG_PROPERTY : "
    ...
    # getter for: Lcom/android/server/usb/UsbDeviceManager;->mHDBManager:Lcom/android/server/usb/HwUsbHDBManager;
    invoke-static {v2}, Lcom/android/server/usb/UsbDeviceManager;->access$1600(Lcom/android/server/usb/UsbDeviceManager;)Lcom/android/server/usb/HwUsbHDBManager;
    ...
    invoke-interface {v2, v3}, Lcom/android/server/usb/HwUsbHDBManager;->setHdbEnabled(Z)V
...
.method private setUsbConfig(Ljava/lang/String;)Z
    ...
    const-string v3, "UsbDeviceManager setUsbConfig("
...
.method private setUsbDataUnlocked(Z)V
    ...
    const-string v1, "now is using Version L only charging"
    ...
    iget-object v0, v0, Lcom/android/server/usb/UsbDeviceManager;->mContentResolver:Landroid/content/ContentResolver;

    const-string v1, "usbdata_unlocked"
...
.method private trySetEnabledFunctions(Ljava/lang/String;Z)Z
    ...
    .line 911
    invoke-direct {p0, p1}, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->applyHdbFunction(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v3, p1}, Lcom/android/server/usb/UsbDeviceManager;->access$1700(Lcom/android/server/usb/UsbDeviceManager;Ljava/lang/String;)Ljava/lang/String;

    move-result-object p1

    .line 914
    invoke-direct {p0, p1}, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->applyUserRestrictions(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v3}, Lcom/android/server/usb/UsbDeviceManager;->access$1800(Lcom/android/server/usb/UsbDeviceManager;)Landroid/app/NotificationManager;
...
.method private updateAdbNotification()V
    ...
    const-string v1, "update adb notification"
    ...
    invoke-static {v1, v3, v4, v5}, Landroid/hwnotification/HwNotificationResource;->getNotificationThemeData(IIII)Landroid/os/Bundle;
    ...
    const-string v1, "cancel adb notification"
...
.method private updateAudioSourceFunction()V
    ...
    invoke-static {v6}, Lcom/android/server/usb/UsbDeviceManager;->access$2600(Lcom/android/server/usb/UsbDeviceManager;)Lcom/android/server/usb/UsbAlsaManager;
...
.method private updateCurrentAccessory()V
    ...
    invoke-static {v2}, Lcom/android/server/usb/UsbDeviceManager;->access$2100(Lcom/android/server/usb/UsbDeviceManager;)J
    ...
    # getter for: Lcom/android/server/usb/UsbDeviceManager;->mAccessoryModeRequestTime:J
    invoke-static {v4}, Lcom/android/server/usb/UsbDeviceManager;->access$2100(Lcom/android/server/usb/UsbDeviceManager;)J
    ...
    invoke-static {v1}, Lcom/android/server/usb/UsbDeviceManager;->access$2400(Lcom/android/server/usb/UsbDeviceManager;)Lcom/android/server/usb/UsbSettingsManager;
    ...
    invoke-static {v1, v8}, Lcom/android/server/usb/UsbDeviceManager;->access$2202(Lcom/android/server/usb/UsbDeviceManager;[Ljava/lang/String;)[Ljava/lang/String;
...
.method private updateMidiFunction()V
    ...
    invoke-static {v4, v5}, Lcom/android/server/usb/UsbDeviceManager;->access$2902(Lcom/android/server/usb/UsbDeviceManager;I)I
    :try_end_1
    .catch Ljava/io/FileNotFoundException; {:try_start_1 .. :try_end_1} :catch_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_1
    ...
    invoke-static {v4, v1}, Lcom/android/server/usb/UsbDeviceManager;->access$2702(Lcom/android/server/usb/UsbDeviceManager;Z)Z
    ...
    # getter for: Lcom/android/server/usb/UsbDeviceManager;->mUsbAlsaManager:Lcom/android/server/usb/UsbAlsaManager;
    invoke-static {v4}, Lcom/android/server/usb/UsbDeviceManager;->access$2600(Lcom/android/server/usb/UsbDeviceManager;)Lcom/android/server/usb/UsbAlsaManager;
    ...
    invoke-static {v6}, Lcom/android/server/usb/UsbDeviceManager;->access$2800(Lcom/android/server/usb/UsbDeviceManager;)I
    ...
    invoke-static {v7}, Lcom/android/server/usb/UsbDeviceManager;->access$2900(Lcom/android/server/usb/UsbDeviceManager;)I
...
.method private updateUsbNotification()V
    ...
    # getter for: Lcom/android/server/usb/UsbDeviceManager;->mNotificationManager:Landroid/app/NotificationManager;
    invoke-static {v6}, Lcom/android/server/usb/UsbDeviceManager;->access$1800(Lcom/android/server/usb/UsbDeviceManager;)Landroid/app/NotificationManager;
    ...
    invoke-static {v6}, Lcom/android/server/usb/UsbDeviceManager;->access$3100(Lcom/android/server/usb/UsbDeviceManager;)Z
    ...
    const-string v8, "update usb notification - mConnetced = "
    ...
    .line 1264
    :cond_3
    iget-boolean v6, p0, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->mUsbDataUnlocked:Z
    ...
    :cond_4
    :goto_1
    iget v6, p0, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->mUsbNotificationId:I
    ...
    invoke-virtual {v6, v12, v7, v8}, Landroid/app/NotificationManager;->cancelAsUser(Ljava/lang/String;ILandroid/os/UserHandle;)V
    ...
    invoke-virtual {v6, v12, v1, v3, v7}, Landroid/app/NotificationManager;->notifyAsUser(Ljava/lang/String;ILandroid/app/Notification;Landroid/os/UserHandle;)V
...
.method private updateUsbStateBroadcast()V
    ...
    .line 1049
    const-string v3, "only_charging"

    iget-object v6, p0, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->this$0:Lcom/android/server/usb/UsbDeviceManager;

    # getter for: Lcom/android/server/usb/UsbDeviceManager;->mPowerCharging:Z
    ...
    const-string v7, "UsbDeviceManager broadcasting "
    ...
    const-string v5, " mPowerCharging: "
...
.method private updateUserBroadcast()V
    .locals 4
    ...
    const-string v1, "android.hardware.usb.action.USB_UPDATE"
...
.method private waitForState(Ljava/lang/String;)Z
    ...
    const-string v4, "UsbDeviceManager waitForState("
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    const-string v3, "message update state "
    ...
    const-string v3, "now is using Version M only charging, set mUsbDataUnlocked false when disconnected"
    ...
    :goto_6
    invoke-direct {p0, v3}, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->setHdbEnabled(Z)V
    ...
    # invokes: Lcom/android/server/usb/UsbDeviceManager;->isDefaultFunction(Ljava/lang/String;)Z
    invoke-static {v2, v1}, Lcom/android/server/usb/UsbDeviceManager;->access$3000(Lcom/android/server/usb/UsbDeviceManager;Ljava/lang/String;)Z
    ...
    .line 1178
    invoke-direct {p0, v1}, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->setDefaultFunctions(Ljava/lang/String;)V
    ...
    # setter for: Lcom/android/server/usb/UsbDeviceManager;->mSystemReady:Z
    ...
    invoke-static {v2, v3}, Lcom/android/server/usb/UsbDeviceManager;->access$2302(Lcom/android/server/usb/UsbDeviceManager;Z)Z
    ...
    # invokes: Lcom/android/server/usb/UsbDeviceManager;->getCurrentSettings()Lcom/android/server/usb/UsbSettingsManager;
    invoke-static {v2}, Lcom/android/server/usb/UsbDeviceManager;->access$2400(Lcom/android/server/usb/UsbDeviceManager;)Lcom/android/server/usb/UsbSettingsManager;
    ...
    const-string v5, "usbdata_unlocked"
    ...
    .line 1238
    invoke-direct {p0}, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->updateUserBroadcast()V
    ...
    invoke-virtual {v2}, Lcom/android/server/usb/UsbDeviceManager;->dueSimStatusCompletedMsg()V
