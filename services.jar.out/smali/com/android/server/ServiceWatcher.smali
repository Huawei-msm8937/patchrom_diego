...
.field private static final MAX_REBIND_NUM:I = 0x3

.field private static final RETRY_TIME_INTERVAL:J = 0x1388L
...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;IIILjava/lang/Runnable;Landroid/os/Handler;)V
    ...
    iput-object v6, p0, Lcom/android/server/ServiceWatcher;->mRetryRunnable:Ljava/lang/Runnable;

    .line 325
    new-instance v6, Lcom/android/server/ServiceWatcher$3;

    invoke-direct {v6, p0}, Lcom/android/server/ServiceWatcher$3;-><init>(Lcom/android/server/ServiceWatcher;)V
...
.method static synthetic access$000(Lcom/android/server/ServiceWatcher;)Landroid/os/IBinder;
    .locals 1
...
.method static synthetic access$100(Lcom/android/server/ServiceWatcher;)I
    ...
    .prologue
    .line 49
    iget v0, p0, Lcom/android/server/ServiceWatcher;->mRetryCount:I

    return v0
.end method

.method static synthetic access$108(Lcom/android/server/ServiceWatcher;)I
    .locals 2
    .param p0, "x0"    # Lcom/android/server/ServiceWatcher;
    ...
    iput v1, p0, Lcom/android/server/ServiceWatcher;->mRetryCount:I
...
.method static synthetic access$300(Lcom/android/server/ServiceWatcher;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/ServiceWatcher;
...
.method static synthetic access$400(Lcom/android/server/ServiceWatcher;)Ljava/lang/String;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/ServiceWatcher;
...
.method static synthetic access$600(Lcom/android/server/ServiceWatcher;)Landroid/os/Handler;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/ServiceWatcher;
...
.method static synthetic access$700(Lcom/android/server/ServiceWatcher;)Ljava/lang/Object;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/ServiceWatcher;
...
.method static synthetic access$800(Lcom/android/server/ServiceWatcher;)Ljava/lang/String;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/ServiceWatcher;
...
.method private bindBestPackageLocked(Ljava/lang/String;)Z
    ...
    .line 229
    :cond_3
    invoke-static {}, Lcom/android/server/HwServiceFactory;->getHwNLPManager()Lcom/android/server/HwNLPManager;
    ...
    invoke-interface {v13, v14, v9}, Lcom/android/server/HwNLPManager;->skipForeignNlpPackage(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-interface {v13, v14, v9}, Lcom/android/server/HwNLPManager;->useCivilNlpPackage(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    const-string v15, " useCivilNlpPackage"
    ...
    .restart local v7    # "isMultiuser":Z
    .restart local v8    # "pInfo":Landroid/content/pm/PackageInfo;
...
.method private bindToPackageLocked(Ljava/lang/String;IZ)V
    ...
    const-string v3, "bind the same package:"
...
# virtual methods
.method public bindToPackageWithLock(Ljava/lang/String;IZ)V
    .locals 2
    .param p1, "packageName"    # Ljava/lang/String;
    .param p2, "version"    # I
    .param p3, "isMultiuser"    # Z
    ...
    .line 280
    :try_start_0
    invoke-direct {p0, p1, p2, p3}, Lcom/android/server/ServiceWatcher;->bindToPackageLocked(Ljava/lang/String;IZ)V
...
.method public onServiceDisconnected(Landroid/content/ComponentName;)V
    ...
    const-string v3, "delay rebind begin"
    ...
    iget-object v3, p0, Lcom/android/server/ServiceWatcher;->mRetryRunnable:Ljava/lang/Runnable;
