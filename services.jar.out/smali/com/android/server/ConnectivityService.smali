...
.super Lcom/android/server/AbstractConnectivityService;
...
.field private static final CODE_REMOVE_LEGACYROUTE_TO_HOST:I = 0x3f7
...
# instance fields
.field private mBestLegacyRoute:Landroid/net/RouteInfo;

.field private final mContext:Landroid/content/Context;

.field private mCurrentTcpBufferSizes:Ljava/lang/String;

.field private mCust:Lcom/android/server/HwCustConnectivityService;
...
.field private mLegacyRouteNetId:I

.field private mLegacyRouteUid:I
...
.field private mP2pNetworkInfo:Landroid/net/NetworkInfo;
...
.method public constructor <init>(Landroid/content/Context;Landroid/os/INetworkManagementService;Landroid/net/INetworkStatsService;Landroid/net/INetworkPolicyManager;)V
    ...
    .prologue
    .line 671
    invoke-direct/range {p0 .. p0}, Lcom/android/server/AbstractConnectivityService;-><init>()V
    ...
    invoke-direct {v2, v3, v4, v6, v7}, Landroid/net/NetworkInfo;-><init>(IILjava/lang/String;Ljava/lang/String;)V

    move-object/from16 v0, p0

    iput-object v2, v0, Lcom/android/server/ConnectivityService;->mP2pNetworkInfo:Landroid/net/NetworkInfo;
    ...
    .line 735
    const-class v2, Lcom/android/server/HwCustConnectivityService;

    const/4 v3, 0x0

    new-array v3, v3, [Ljava/lang/Object;

    invoke-static {v2, v3}, Lcom/huawei/cust/HwCustUtils;->createObj(Ljava/lang/Class;[Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Lcom/android/server/HwCustConnectivityService;

    move-object/from16 v0, p0

    iput-object v2, v0, Lcom/android/server/ConnectivityService;->mCust:Lcom/android/server/HwCustConnectivityService;

    .line 736
    move-object/from16 v0, p0

    iget-object v2, v0, Lcom/android/server/ConnectivityService;->mCust:Lcom/android/server/HwCustConnectivityService;
    ...
    invoke-virtual {v2, v3}, Lcom/android/server/HwCustConnectivityService;->initConnectivityService(Landroid/content/Context;)V
    ...
    invoke-virtual {v2, v11}, Lcom/android/server/HwCustConnectivityService;->custAddAction(Landroid/content/IntentFilter;)V
    ...
    .line 863
    const-string v2, "android.net.wifi.p2p.WIFI_P2P_NETWORK_CHANGED_ACTION"
...
.method static synthetic access$2600(Lcom/android/server/ConnectivityService;ZILcom/android/server/ConnectivityService$NotificationType;ILjava/lang/String;Landroid/app/PendingIntent;Z)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/ConnectivityService;
    .param p1, "x1"    # Z
    .param p2, "x2"    # I
...
.method static synthetic access$2700(Lcom/android/server/ConnectivityService;Lcom/android/server/connectivity/NetworkAgentInfo;Lcom/android/server/ConnectivityService$ReapUnvalidatedNetworks;)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/ConnectivityService;
    .param p1, "x1"    # Lcom/android/server/connectivity/NetworkAgentInfo;
    .param p2, "x2"    # Lcom/android/server/ConnectivityService$ReapUnvalidatedNetworks;

    .prologue
    .line 193
    invoke-direct {p0, p1, p2}, Lcom/android/server/ConnectivityService;->rematchNetworkAndRequests(Lcom/android/server/connectivity/NetworkAgentInfo;Lcom/android/server/ConnectivityService$ReapUnvalidatedNetworks;)V
...
.method static synthetic access$302(Lcom/android/server/ConnectivityService;Landroid/net/NetworkInfo;)Landroid/net/NetworkInfo;
    .locals 0
    .param p0, "x0"    # Lcom/android/server/ConnectivityService;
    ...
    .prologue
    .line 193
    iput-object p1, p0, Lcom/android/server/ConnectivityService;->mP2pNetworkInfo:Landroid/net/NetworkInfo;
...
.method static synthetic access$3800(Lcom/android/server/ConnectivityService;Landroid/app/PendingIntent;I)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/ConnectivityService;
...
.method static synthetic access$3900(Lcom/android/server/ConnectivityService;Landroid/net/NetworkRequest;I)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/ConnectivityService;
...
.method static synthetic access$400(Lcom/android/server/ConnectivityService;)Lcom/android/server/HwCustConnectivityService;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/ConnectivityService;

    .prologue
    .line 193
    iget-object v0, p0, Lcom/android/server/ConnectivityService;->mCust:Lcom/android/server/HwCustConnectivityService;

    return-object v0
.end method

.method static synthetic access$4000(Lcom/android/server/ConnectivityService;Landroid/net/Network;ZZ)V
    .locals 0
    .param p0, "x0"    # Lcom/android/server/ConnectivityService;
...
.method static synthetic access$4200(Lcom/android/server/ConnectivityService;Landroid/net/Network;)Lcom/android/server/connectivity/NetworkAgentInfo;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/ConnectivityService;
    .param p1, "x1"    # Landroid/net/Network;
...
.method static synthetic access$500(Lcom/android/server/ConnectivityService;)Lcom/android/server/connectivity/Tethering;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/ConnectivityService;
...
.method private addLegacyRouteToHost(Landroid/net/LinkProperties;Ljava/net/InetAddress;II)Z
    ...
    .line 1498
    :goto_0
    iget-object v3, p0, Lcom/android/server/ConnectivityService;->mBestLegacyRoute:Landroid/net/RouteInfo;
    ...
    .line 1500
    iget v3, p0, Lcom/android/server/ConnectivityService;->mLegacyRouteNetId:I

    iget-object v4, p0, Lcom/android/server/ConnectivityService;->mBestLegacyRoute:Landroid/net/RouteInfo;

    iget v5, p0, Lcom/android/server/ConnectivityService;->mLegacyRouteUid:I

    invoke-direct {p0, v3, v4, v5}, Lcom/android/server/ConnectivityService;->removeLegacyRouteToHost(ILandroid/net/RouteInfo;I)V
    ...
    const-string v4, " mLegacyRouteNetId "

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    iget v4, p0, Lcom/android/server/ConnectivityService;->mLegacyRouteNetId:I

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    move-result-object v3

    const-string v4, " mLegacyRouteUid "

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    iget v4, p0, Lcom/android/server/ConnectivityService;->mLegacyRouteUid:I
    ...
    .line 1515
    iput-object v0, p0, Lcom/android/server/ConnectivityService;->mBestLegacyRoute:Landroid/net/RouteInfo;

    .line 1516
    iput p3, p0, Lcom/android/server/ConnectivityService;->mLegacyRouteNetId:I

    .line 1517
    iput p4, p0, Lcom/android/server/ConnectivityService;->mLegacyRouteUid:I
    :try_end_0
...
.method private enforceNetworkRequestPermissions(Landroid/net/NetworkCapabilities;)V
    ...
    .line 3912
    :cond_0
    invoke-virtual {p0}, Lcom/android/server/ConnectivityService;->enforceChangePermission()V
...
.method private getFilteredNetworkState(II)Landroid/net/NetworkState;
    ...
    invoke-direct {v1, p1, v0, v6, v11}, Landroid/net/NetworkInfo;-><init>(IILjava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v0, v6, v11}, Landroid/net/NetworkInfo;->setDetailedState(Landroid/net/NetworkInfo$DetailedState;Ljava/lang/String;Ljava/lang/String;)V
...
.method private getIdenticalActiveNetworkAgentInfo(Lcom/android/server/connectivity/NetworkAgentInfo;)Lcom/android/server/connectivity/NetworkAgentInfo;
    .locals 8
    ...
    .line 4120
    .local v4, "network":Lcom/android/server/connectivity/NetworkAgentInfo;
    new-instance v6, Ljava/lang/StringBuilder;

    invoke-direct {v6}, Ljava/lang/StringBuilder;-><init>()V

    const-string v7, "checking existed "
    ...
    invoke-virtual {v6, v7}, Lcom/android/server/ConnectivityService$LegacyTypeTracker;->getNetworkForType(I)Lcom/android/server/connectivity/NetworkAgentInfo;
    ...
    .line 4122
    const-string v6, "not recorded, ignore"
    ...
    .line 4127
    .local v1, "curNetworkLp":Landroid/net/LinkProperties;
    iget-object v5, p1, Lcom/android/server/connectivity/NetworkAgentInfo;->linkProperties:Landroid/net/LinkProperties;

    .line 4128
    .local v5, "newNetworkLp":Landroid/net/LinkProperties;
    iget-object v6, v4, Lcom/android/server/connectivity/NetworkAgentInfo;->networkInfo:Landroid/net/NetworkInfo;
    ...
    .line 4131
    :cond_5
    const-string v6, "some key parameter is null, ignore"
    ...
    .line 4135
    :cond_6
    invoke-virtual {v1, v5}, Landroid/net/LinkProperties;->keyEquals(Ljava/lang/Object;)Z

    move-result v3

    .line 4136
    .local v3, "isLpIdentical":Z
    new-instance v6, Ljava/lang/StringBuilder;

    invoke-direct {v6}, Ljava/lang/StringBuilder;-><init>()V

    const-string v7, "LinkProperties Identical are "
    ...
    .line 4139
    const-string v6, "apparently satisfied"
...
.method private getUnfilteredActiveNetworkState(I)Landroid/net/NetworkState;
    ...
    instance-of v0, v12, Lcom/android/server/connectivity/NetworkAgentInfo;
...
.method private handleRegisterNetworkAgent(Lcom/android/server/connectivity/NetworkAgentInfo;)V
    ...
    .prologue
    .line 4169
    const-string v2, "Got NetworkAgent Messenger"

    invoke-static {v2}, Lcom/android/server/ConnectivityService;->log(Ljava/lang/String;)V

    .line 4172
    invoke-direct {p0, p1}, Lcom/android/server/ConnectivityService;->getIdenticalActiveNetworkAgentInfo(Lcom/android/server/connectivity/NetworkAgentInfo;)Lcom/android/server/connectivity/NetworkAgentInfo;

    move-result-object v0

    .line 4173
    .local v0, "identicalNai":Lcom/android/server/connectivity/NetworkAgentInfo;
    if-eqz v0, :cond_0
    ...
    invoke-virtual {v2, v3}, Landroid/net/NetworkCapabilities;->combineCapabilitiesWithNoSpecifiers(Landroid/net/NetworkCapabilities;)V
    ...
    .line 4177
    iget-object v2, p1, Lcom/android/server/connectivity/NetworkAgentInfo;->networkMonitor:Lcom/android/server/connectivity/NetworkMonitor;
    ...
    iget-object v4, p0, Lcom/android/server/ConnectivityService;->mTrackerHandler:Lcom/android/server/ConnectivityService$NetworkStateTrackerHandler;

    iget-object v5, p1, Lcom/android/server/connectivity/NetworkAgentInfo;->messenger:Landroid/os/Messenger;
    ...
    iput-object v2, p1, Lcom/android/server/connectivity/NetworkAgentInfo;->networkInfo:Landroid/net/NetworkInfo;

    .line 4190
    invoke-direct {p0, p1, v1}, Lcom/android/server/ConnectivityService;->updateNetworkInfo(Lcom/android/server/connectivity/NetworkAgentInfo;Landroid/net/NetworkInfo;)V

    .line 4192
    invoke-virtual {p0, v1}, Lcom/android/server/ConnectivityService;->handleLteMobileDataStateChange(Landroid/net/NetworkInfo;)V

    .line 4196
    invoke-virtual {p0, p1}, Lcom/android/server/ConnectivityService;->holdWifiNetworkMessenger(Lcom/android/server/connectivity/NetworkAgentInfo;)V
...
.method private rematchNetworkAndRequests(Lcom/android/server/connectivity/NetworkAgentInfo;Lcom/android/server/ConnectivityService$ReapUnvalidatedNetworks;)V
    ...
    invoke-virtual/range {v22 .. v22}, Landroid/telephony/HwTelephonyManager;->isVSimEnabled()Z
    ...
    .line 4593
    .local v11, "isDisabledMobileNetwork":Z
    :goto_0
    ...
    .line 4602
    const-string v22, "mobile net can\'t satisfy default network request when mobile data disabled"
    ...
    .line 4590
    .end local v4    # "addedRequests":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/server/ConnectivityService$NetworkRequestInfo;>;"
    .end local v5    # "affectedNetworks":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/server/connectivity/NetworkAgentInfo;>;"
    .end local v8    # "currentNetwork":Lcom/android/server/connectivity/NetworkAgentInfo;
    .end local v10    # "i$":Ljava/util/Iterator;
    .end local v11    # "isDisabledMobileNetwork":Z
    ...
    .line 4616
    .restart local v4    # "addedRequests":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/server/ConnectivityService$NetworkRequestInfo;>;"
    .restart local v5    # "affectedNetworks":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/server/connectivity/NetworkAgentInfo;>;"
    .restart local v8    # "currentNetwork":Lcom/android/server/connectivity/NetworkAgentInfo;
    .restart local v10    # "i$":Ljava/util/Iterator;
    .restart local v11    # "isDisabledMobileNetwork":Z
    ...
    invoke-virtual {v0, v1, v2}, Lcom/android/server/ConnectivityService;->checkNetworkSupportBip(Lcom/android/server/connectivity/NetworkAgentInfo;Landroid/net/NetworkRequest;)Z
    ...
    const-string v23, " stopped satisfying"
    ...
    const-string v24, "BUG: Removing request "
    ...
    const-string v24, " without updating mNetworkForRequestId or factories!"
    ...
    .line 4713
    const-string v22, "isDualCellDataEnable is true so keep is true"
    ...
    .line 4720
    invoke-virtual/range {p0 .. p1}, Lcom/android/server/ConnectivityService;->makeDefault(Lcom/android/server/connectivity/NetworkAgentInfo;)V
    ...
    .end local v19    # "stacked":Landroid/net/LinkProperties;
    .end local v20    # "stackedIface":Ljava/lang/String;
    ...
    .end local v9    # "i":I
    :cond_1d
    sget-object v22, Lcom/android/server/ConnectivityService$ReapUnvalidatedNetworks;->REAP:Lcom/android/server/ConnectivityService$ReapUnvalidatedNetworks;
...
.method private removeLegacyRouteToHost(ILandroid/net/RouteInfo;I)V
    .locals 7
    .param p1, "netId"    # I
    .param p2, "bestRoute"    # Landroid/net/RouteInfo;
    .param p3, "uid"    # I
    ...
    const-string v5, "removeLegacyRouteToHost"
    ...
    .line 1535
    :try_start_0
    const-string v5, "android.net.wifi.INetworkManager"
    ...
    invoke-virtual {p2, v0, v5}, Landroid/net/RouteInfo;->writeToParcel(Landroid/os/Parcel;I)V
    ...
    invoke-interface {v2, v5, v0, v1, v6}, Landroid/os/IBinder;->transact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    const-string v6, "Exception trying to remove a route: "
...
.method private sendGeneralBroadcast(Landroid/net/NetworkInfo;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/server/ConnectivityService;->sendStickyBroadcast(Landroid/content/Intent;)V
...
.method private sendLegacyNetworkBroadcast(Lcom/android/server/connectivity/NetworkAgentInfo;Landroid/net/NetworkInfo$DetailedState;I)V
    ...
    .line 5054
    invoke-virtual {p0, v1}, Lcom/android/server/ConnectivityService;->sendStickyBroadcast(Landroid/content/Intent;)V
...
.method private sendUpdatedScoreToFactoriesWhenWifiDisconnected(Landroid/net/NetworkRequest;I)V
    .locals 5
    .param p1, "networkRequest"    # Landroid/net/NetworkRequest;
    .param p2, "score"    # I
...
.method private setProvNotificationVisibleIntent(ZILcom/android/server/ConnectivityService$NotificationType;ILjava/lang/String;Landroid/app/PendingIntent;Z)V
    ...
    invoke-static {v10, v11, v12, v13}, Landroid/hwnotification/HwNotificationResource;->getNotificationThemeData(IIII)Landroid/os/Bundle;

    move-result-object v10

    iput-object v10, v5, Landroid/app/Notification;->extras:Landroid/os/Bundle;
    ...
    invoke-virtual {p0, v5, v0}, Lcom/android/server/ConnectivityService;->startBrowserForWifiPortal(Landroid/app/Notification;Ljava/lang/String;)Z
...
.method private unneeded(Lcom/android/server/connectivity/NetworkAgentInfo;)Z
    ...
    iget-boolean v7, p1, Lcom/android/server/connectivity/NetworkAgentInfo;->lingering:Z
    ...
    .line 2491
    :cond_1
    invoke-virtual {p0, p1}, Lcom/android/server/ConnectivityService;->ignoreRemovedByWifiPro(Lcom/android/server/connectivity/NetworkAgentInfo;)Z
    ...
    invoke-virtual {v7}, Landroid/telephony/HwTelephonyManager;->isVSimEnabled()Z
    ...
    .line 2497
    .local v2, "isDisabledMobileNetwork":Z
    :goto_1
    ...
    .line 2500
    .local v0, "existing":Lcom/android/server/connectivity/NetworkAgentInfo;
    if-nez v0, :cond_3
    ...
    const-string v8, "can not find existing request info on mNetworkForRequestId, request is "
    ...
    invoke-virtual {p1, v7}, Lcom/android/server/connectivity/NetworkAgentInfo;->satisfies(Landroid/net/NetworkRequest;)Z
    ...
    invoke-virtual {p0, p1, v7}, Lcom/android/server/ConnectivityService;->checkNetworkSupportBip(Lcom/android/server/connectivity/NetworkAgentInfo;Landroid/net/NetworkRequest;)Z
    ...
    .line 2509
    const-string v7, "mobile net can\'t satisfy default network request when mobile data disabled"
    ...
    .line 2514
    :cond_5
    iget-boolean v7, v3, Lcom/android/server/ConnectivityService$NetworkRequestInfo;->isRequest:Z

    if-eqz v7, :cond_2

    if-eqz v4, :cond_2

    iget-object v7, p1, Lcom/android/server/connectivity/NetworkAgentInfo;->networkRequests:Landroid/util/SparseArray;
    ...
    .end local v0    # "existing":Lcom/android/server/connectivity/NetworkAgentInfo;
    .end local v1    # "i$":Ljava/util/Iterator;
    .end local v2    # "isDisabledMobileNetwork":Z
    .end local v3    # "nri":Lcom/android/server/ConnectivityService$NetworkRequestInfo;
    ...
    .restart local v0    # "existing":Lcom/android/server/connectivity/NetworkAgentInfo;
    .restart local v1    # "i$":Ljava/util/Iterator;
    .restart local v2    # "isDisabledMobileNetwork":Z
    .restart local v3    # "nri":Lcom/android/server/ConnectivityService$NetworkRequestInfo;
    :cond_7
    move v4, v6
...
.method private updateNetworkInfo(Lcom/android/server/connectivity/NetworkAgentInfo;Landroid/net/NetworkInfo;)V
    ...
    invoke-virtual {p0, v3, v4}, Lcom/android/server/ConnectivityService;->enableDefaultTypeApnWhenWifiConnectionStateChanged(Landroid/net/NetworkInfo$State;I)V

    .line 4901
    invoke-virtual {p0, p1, p2}, Lcom/android/server/ConnectivityService;->enableDefaultTypeApnWhenBlueToothTetheringStateChanged(Lcom/android/server/connectivity/NetworkAgentInfo;Landroid/net/NetworkInfo;)V
    ...
    .line 4933
    invoke-virtual {p0, v7}, Lcom/android/server/ConnectivityService;->setVpnSettingValue(Z)V
    ...
    invoke-virtual {p0, v3, v4}, Lcom/android/server/ConnectivityService;->hintUserSwitchToMobileWhileWifiDisconnected(Landroid/net/NetworkInfo$State;I)V
    ...
    .line 4955
    invoke-virtual {p0, v6}, Lcom/android/server/ConnectivityService;->setVpnSettingValue(Z)V
...
.method protected enforceAccessPermission()V
    .locals 3
...
.method protected enforceChangePermission()V
    .locals 1
...
.method public getActiveLinkProperties()Landroid/net/LinkProperties;
    ...
    .prologue
    .line 1294
    invoke-virtual {p0}, Lcom/android/server/ConnectivityService;->enforceAccessPermission()V
...
.method public getNetworkInfo(I)Landroid/net/NetworkInfo;
    ...
    const-string v3, "getNetworkInfo mP2pNetworkInfo:"

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    iget-object v3, p0, Lcom/android/server/ConnectivityService;->mP2pNetworkInfo:Landroid/net/NetworkInfo;
...
.method protected makeDefault(Lcom/android/server/connectivity/NetworkAgentInfo;)V
    .locals 3
    .param p1, "newNetwork"    # Lcom/android/server/connectivity/NetworkAgentInfo;
...
.method public setUsbTethering(Z)I
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/HwCustConnectivityService;->isUsbTetheringEnable(Z)Z
