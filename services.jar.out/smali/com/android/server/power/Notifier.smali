...
.field private mCustNotifier:Lcom/android/server/power/HwCustNotifier;
...
.method public constructor <init>(Landroid/os/Looper;Landroid/content/Context;Lcom/android/internal/app/IBatteryStats;Lcom/android/internal/app/IAppOpsService;Lcom/android/server/power/SuspendBlocker;Landroid/view/WindowManagerPolicy;)V
    ...
    .line 143
    const-class v0, Lcom/android/server/power/HwCustNotifier;
    ...
    check-cast v0, Lcom/android/server/power/HwCustNotifier;

    iput-object v0, p0, Lcom/android/server/power/Notifier;->mCustNotifier:Lcom/android/server/power/HwCustNotifier;
...
.method private sendBrightnessBoostChangedBroadcast()V
    ...
    const-string v1, "PowerManagerNotifier Sending brightness boost changed broadcast."
...
.method private sendGoToSleepBroadcast()V
    ...
    const-string v1, "PowerManagerNotifier Sending go to sleep broadcast."
    ...
    .line 678
    iget-object v0, p0, Lcom/android/server/power/Notifier;->mCustNotifier:Lcom/android/server/power/HwCustNotifier;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lcom/android/server/power/Notifier;->mCustNotifier:Lcom/android/server/power/HwCustNotifier;

    invoke-virtual {v0}, Lcom/android/server/power/HwCustNotifier;->isAllowRamCompress()Z
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/power/HwCustNotifier;->setEvent(Ljava/lang/String;)V
...
.method private sendWakeUpBroadcast()V
    ...
    const-string v1, "PowerManagerNotifier Sending wake up broadcast."
...
.method public onUserActivity(II)V
    ...
    const-string v3, "PowerManagerNotifier onUserActivity: event="
...
.method public onWakeLockAcquired(ILjava/lang/String;Ljava/lang/String;IILandroid/os/WorkSource;Ljava/lang/String;)V
    ...
    invoke-static/range {v0 .. v5}, Lcom/huawei/pgmng/common/Utils;->noteWakelock(ILjava/lang/String;IILandroid/os/WorkSource;I)V
...
.method public onWakeLockChanging(ILjava/lang/String;Ljava/lang/String;IILandroid/os/WorkSource;Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;IILandroid/os/WorkSource;Ljava/lang/String;)V
    ...
    invoke-direct {p0, v0}, Lcom/android/server/power/Notifier;->getBatteryStatsWakeLockMonitorType(I)I
    ...
    .line 231
    invoke-static/range {v1 .. v6}, Lcom/huawei/pgmng/common/Utils;->noteWakelock(ILjava/lang/String;IILandroid/os/WorkSource;Landroid/os/WorkSource;)V
...
.method public onWakeUp(Ljava/lang/String;ILjava/lang/String;I)V
    ...
    const-string v2, "PowerManagerNotifier onWakeUp: event="
...
.method public onWakefulnessChangeFinished()V
    ...
    const-string v2, "PowerManagerNotifier onWakefulnessChangeFinished mInteractiveChanging="
    ...
    const-string v1, "JL_PMS_WAKEUP_FINISHED"
...
.method public onWakefulnessChangeStarted(II)V
    ...
    const-string v3, "PowerManagerNotifier onWakefulnessChangeStarted: wakefulness="
    ...
    const-string v3, ", mInteractiveChanging="
