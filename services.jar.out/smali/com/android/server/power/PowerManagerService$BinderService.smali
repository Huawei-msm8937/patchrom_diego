...
.method private printScreenBrightnessSource(Ljava/lang/String;)V
    .locals 5
...
.method public acquireWakeLock(Landroid/os/IBinder;ILjava/lang/String;Ljava/lang/String;Landroid/os/WorkSource;Ljava/lang/String;)V
    ...
    const-string v5, "lock must not be null"
    ...
    const-string v5, "packageName must not be null"
    ...
    invoke-virtual {v4, v0, v1, v2}, Lcom/android/server/power/PowerManagerService;->isAppWakeLockFilterTag(ILjava/lang/String;Landroid/os/WorkSource;)Z
    ...
    invoke-virtual/range {v4 .. v12}, Lcom/android/server/power/PowerManagerService;->acquireProxyWakeLock(Landroid/os/IBinder;ILjava/lang/String;Ljava/lang/String;Landroid/os/WorkSource;Ljava/lang/String;II)Z
    :try_end_0
    ...
    invoke-static/range {v4 .. v12}, Lcom/android/server/power/PowerManagerService;->access$2900(Lcom/android/server/power/PowerManagerService;Landroid/os/IBinder;ILjava/lang/String;Ljava/lang/String;Landroid/os/WorkSource;Ljava/lang/String;II)V
    :try_end_1
...
.method public crash(Ljava/lang/String;)V
    ...
    invoke-static {v2, p1}, Lcom/android/server/power/PowerManagerService;->access$4300(Lcom/android/server/power/PowerManagerService;Ljava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    invoke-virtual {v2, p2}, Lcom/android/server/power/PowerManagerService;->dumpInternal(Ljava/io/PrintWriter;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public isHighPrecision()Z
    ...
    iget-object v1, v1, Lcom/android/server/power/PowerManagerService;->mLightsManager:Lcom/android/server/lights/LightsManager;
    ...
    .line 4102
    .local v0, "lcdLight":Lcom/android/server/lights/Light;
    invoke-virtual {v0}, Lcom/android/server/lights/Light;->isHighPrecision()Z
...
.method public isPowerSaveMode()Z
    ...
    invoke-static {v2}, Lcom/android/server/power/PowerManagerService;->access$3900(Lcom/android/server/power/PowerManagerService;)Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public isUsingSkipWakeLock(ILjava/lang/String;)Z
    ...
    invoke-virtual {v0, p1, p2}, Lcom/android/server/power/PowerManagerService;->isSkipWakeLockUsing(ILjava/lang/String;)Z
...
.method public isWakeLockLevelSupported(I)Z
    ...
    invoke-static {v2, p1}, Lcom/android/server/power/PowerManagerService;->access$3200(Lcom/android/server/power/PowerManagerService;I)Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public powerHint(II)V
    ...
    invoke-static {v0, p1, p2}, Lcom/android/server/power/PowerManagerService;->access$2800(Lcom/android/server/power/PowerManagerService;II)V
...
.method public reboot(ZLjava/lang/String;Z)V
    ...
    const-string v6, "PowerManagerService reboot_reason:"
    ...
    invoke-static {v4, v5}, Landroid/util/Flog;->e(ILjava/lang/String;)I
    ...
    invoke-static {v4, v5, p1, p2, p3}, Lcom/android/server/power/PowerManagerService;->access$4200(Lcom/android/server/power/PowerManagerService;ZZLjava/lang/String;Z)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public releaseWakeLock(Landroid/os/IBinder;I)V
    ...
    invoke-virtual {v2, p1}, Lcom/android/server/power/PowerManagerService;->releaseProxyWakeLock(Landroid/os/IBinder;)Z

    .line 3598
    iget-object v2, p0, Lcom/android/server/power/PowerManagerService$BinderService;->this$0:Lcom/android/server/power/PowerManagerService;

    # invokes: Lcom/android/server/power/PowerManagerService;->releaseWakeLockInternal(Landroid/os/IBinder;I)V
    invoke-static {v2, p1, p2}, Lcom/android/server/power/PowerManagerService;->access$3000(Lcom/android/server/power/PowerManagerService;Landroid/os/IBinder;I)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public setAttentionLight(ZI)V
    ...
    invoke-static {v2, p1, p2}, Lcom/android/server/power/PowerManagerService;->access$4700(Lcom/android/server/power/PowerManagerService;ZI)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public setColorTemperature(I)I
    ...
    const-string v2, "setColorTemperature"
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/power/PowerManagerService;->setColorTemperatureInternal(I)I
...
.method public setPowerSaveMode(Z)Z
    ...
    invoke-static {v2, p1}, Lcom/android/server/power/PowerManagerService;->access$4000(Lcom/android/server/power/PowerManagerService;Z)Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public setStartDreamFromOtherFlag(Z)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/power/HwCustPowerManagerService;->setStartDreamFromUser(Z)V
...
.method public setTemporaryScreenAutoBrightnessAdjustmentSettingOverride(F)V
    ...
    .line 3962
    .local v0, "ident":J
    const-string v2, "setTemporaryScreenAutoBrightnessAdjustmentSettingOverride"

    invoke-direct {p0, v2}, Lcom/android/server/power/PowerManagerService$BinderService;->printScreenBrightnessSource(Ljava/lang/String;)V
    ...
    invoke-static {v2, p1}, Lcom/android/server/power/PowerManagerService;->access$4500(Lcom/android/server/power/PowerManagerService;F)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public setTemporaryScreenAutoBrightnessSettingOverride(I)V
    .locals 5
    ...
    .line 3977
    .local v0, "ident":J
    const-string v2, "setTemporaryScreenAutoBrightnessSettingOverride"
    ...
    # invokes: Lcom/android/server/power/PowerManagerService;->setTemporaryScreenAutoBrightnessSettingOverrideInternal(I)V
...
.method public setTemporaryScreenBrightnessSettingOverride(I)V
    ...
    invoke-static {v2, p1}, Lcom/android/server/power/PowerManagerService;->access$4400(Lcom/android/server/power/PowerManagerService;I)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public shutdown(ZZ)V
    ...
    const-string v6, "PowerManagerService shutdown  uid="
    ...
    # invokes: Lcom/android/server/power/PowerManagerService;->shutdownOrRebootInternal(ZZLjava/lang/String;Z)V
    invoke-static {v4, v5, p1, v6, p2}, Lcom/android/server/power/PowerManagerService;->access$4200(Lcom/android/server/power/PowerManagerService;ZZLjava/lang/String;Z)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public startDream()Z
    ...
    # getter for: Lcom/android/server/power/PowerManagerService;->mCust:Lcom/android/server/power/HwCustPowerManagerService;
    invoke-static {v1}, Lcom/android/server/power/PowerManagerService;->access$1500(Lcom/android/server/power/PowerManagerService;)Lcom/android/server/power/HwCustPowerManagerService;
    ...
    :cond_0
    invoke-virtual {v1, v0}, Lcom/android/server/power/HwCustPowerManagerService;->startDream(Z)Z
...
.method public startWakeUpReady(JLjava/lang/String;)V
    ...
    invoke-virtual {v3, p1, p2, v2, p3}, Lcom/android/server/power/PowerManagerService;->startWakeUpReadyInternal(JILjava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public stopDream()Z
    ...
    invoke-virtual {v0}, Lcom/android/server/power/HwCustPowerManagerService;->stopDream()Z
...
.method public stopWakeUpReady(JZLjava/lang/String;)V
    ...
    invoke-virtual/range {v1 .. v6}, Lcom/android/server/power/PowerManagerService;->stopWakeUpReadyInternal(JIZLjava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public updateRgbGamma(FFF)I
    .locals 3
    .param p1, "red"    # F
    .param p2, "green"    # F
    .param p3, "blue"    # F
    ...
    invoke-virtual {v0, p1, p2, p3}, Lcom/android/server/power/PowerManagerService;->updateRgbGammaInternal(FFF)I
...
.method public updateWakeLockWorkSource(Landroid/os/IBinder;Landroid/os/WorkSource;Ljava/lang/String;)V
    ...
    invoke-virtual {v5, p1, p2, p3, v0}, Lcom/android/server/power/PowerManagerService;->updateProxyWakeLockWorkSource(Landroid/os/IBinder;Landroid/os/WorkSource;Ljava/lang/String;I)Z
    :try_end_0
    ...
    invoke-static {v4, p1, p2, p3, v0}, Lcom/android/server/power/PowerManagerService;->access$3100(Lcom/android/server/power/PowerManagerService;Landroid/os/IBinder;Landroid/os/WorkSource;Ljava/lang/String;I)V
    :try_end_1
    ...
    const-string v6, "Exception when search wack lock :"
...
.method public userActivity(JII)V
    ...
    invoke-static {v0}, Lcom/android/server/power/PowerManagerService;->access$3300(Lcom/android/server/power/PowerManagerService;)J
    ...
    invoke-static {v0, v10, v11}, Lcom/android/server/power/PowerManagerService;->access$3302(Lcom/android/server/power/PowerManagerService;J)J
    ...
    invoke-static/range {v1 .. v6}, Lcom/android/server/power/PowerManagerService;->access$3400(Lcom/android/server/power/PowerManagerService;JIII)V
    :try_end_1
...
.method public wakeUp(JLjava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static/range {v1 .. v7}, Lcom/android/server/power/PowerManagerService;->access$3500(Lcom/android/server/power/PowerManagerService;JLjava/lang/String;ILjava/lang/String;I)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
