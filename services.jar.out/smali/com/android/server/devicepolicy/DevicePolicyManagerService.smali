...
.super Lcom/android/server/devicepolicy/AbsDevicePolicyManagerService;
...
.field private static final MONITORING_CERT_NOTIFICATION_ID:I = 0x10400e5
...
.field private static mHwCustDevicePolicyManagerService:Lcom/android/server/devicepolicy/HwCustDevicePolicyManagerService;
...
.field private mNotAllowSimplePwd:Z
...
.method static constructor <clinit>()V
    ...
    .line 300
    const-class v0, Lcom/android/server/devicepolicy/HwCustDevicePolicyManagerService;
    ...
    check-cast v0, Lcom/android/server/devicepolicy/HwCustDevicePolicyManagerService;

    sput-object v0, Lcom/android/server/devicepolicy/DevicePolicyManagerService;->mHwCustDevicePolicyManagerService:Lcom/android/server/devicepolicy/HwCustDevicePolicyManagerService;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 1093
    invoke-direct {p0}, Lcom/android/server/devicepolicy/AbsDevicePolicyManagerService;-><init>()V
    ...
    iput-boolean v0, p0, Lcom/android/server/devicepolicy/DevicePolicyManagerService;->mNotAllowSimplePwd:Z
    ...
    .line 1104
    sget-object v0, Lcom/android/server/devicepolicy/DevicePolicyManagerService;->mHwCustDevicePolicyManagerService:Lcom/android/server/devicepolicy/HwCustDevicePolicyManagerService;

    if-eqz v0, :cond_0

    sget-object v0, Lcom/android/server/devicepolicy/DevicePolicyManagerService;->mHwCustDevicePolicyManagerService:Lcom/android/server/devicepolicy/HwCustDevicePolicyManagerService;

    invoke-virtual {v0}, Lcom/android/server/devicepolicy/HwCustDevicePolicyManagerService;->isNotAllowSimplePwd()Z
    ...
    .line 1105
    iput-boolean v2, p0, Lcom/android/server/devicepolicy/DevicePolicyManagerService;->mNotAllowSimplePwd:Z
...
.method static synthetic access$400()Lcom/android/server/devicepolicy/HwCustDevicePolicyManagerService;
    .locals 1
...
.method private loadSettingsLocked(Lcom/android/server/devicepolicy/DevicePolicyManagerService$DevicePolicyData;I)V
    ...
    iget-boolean v0, v0, Lcom/android/server/devicepolicy/DevicePolicyManagerService;->mNotAllowSimplePwd:Z
    ...
    iput-boolean v0, v1, Lcom/android/server/devicepolicy/DevicePolicyManagerService$DevicePolicyData;->mIsCurrentPwdSimple:Z
    :try_end_3
    .catchall {:try_start_3 .. :try_end_3} :catchall_0
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/devicepolicy/DevicePolicyManagerService;->syncHwDeviceSettingsLocked(I)V
    ...
    const-string v23, "is-currentpwd-simple"
...
.method private setActiveAdmin(Landroid/content/ComponentName;ZILandroid/os/Bundle;)V
    ...
    const-string v13, "setActiveAdmin("
...
.method private wipeDataLocked(ZLjava/lang/String;)V
    ...
    .line 3423
    const-class v3, Lcom/android/server/devicepolicy/HwCustDevicePolicyManagerService;

    const/4 v4, 0x0

    new-array v4, v4, [Ljava/lang/Object;

    invoke-static {v3, v4}, Lhuawei/cust/HwCustUtils;->createObj(Ljava/lang/Class;[Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v1

    check-cast v1, Lcom/android/server/devicepolicy/HwCustDevicePolicyManagerService;

    .line 3424
    .local v1, "mHwCustRecoverySystem":Lcom/android/server/devicepolicy/HwCustDevicePolicyManagerService;
    if-eqz v1, :cond_0

    iget-object v3, p0, Lcom/android/server/devicepolicy/DevicePolicyManagerService;->mContext:Landroid/content/Context;

    invoke-virtual {v1, v3}, Lcom/android/server/devicepolicy/HwCustDevicePolicyManagerService;->wipeDataAndReset(Landroid/content/Context;)Z
    ...
    const-string v4, "Successed wipe storage data."

    invoke-static {v3, v4}, Landroid/util/Slog;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 3435
    .end local v1    # "mHwCustRecoverySystem":Lcom/android/server/devicepolicy/HwCustDevicePolicyManagerService;
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    .line 4917
    iget-boolean v7, p0, Lcom/android/server/devicepolicy/DevicePolicyManagerService;->mNotAllowSimplePwd:Z

    if-eqz v7, :cond_5

    .line 4918
    const-string v7, "  mIsCurrentPwdSimple="

    invoke-virtual {p2, v7}, Ljava/io/PrintWriter;->print(Ljava/lang/String;)V

    .line 4919
    iget-boolean v7, v4, Lcom/android/server/devicepolicy/DevicePolicyManagerService$DevicePolicyData;->mIsCurrentPwdSimple:Z
...
.method public isActivePasswordSufficient(I)Z
    ...
    .restart local v2    # "policy":Lcom/android/server/devicepolicy/DevicePolicyManagerService$DevicePolicyData;
    :cond_3
    iget-boolean v5, p0, Lcom/android/server/devicepolicy/DevicePolicyManagerService;->mNotAllowSimplePwd:Z

    if-eqz v5, :cond_4

    const/4 v5, 0x0

    invoke-virtual {p0, v5, p1}, Lcom/android/server/devicepolicy/DevicePolicyManagerService;->getAllowSimplePassword(Landroid/content/ComponentName;I)Z

    move-result v5

    if-nez v5, :cond_4

    iget-boolean v5, v2, Lcom/android/server/devicepolicy/DevicePolicyManagerService$DevicePolicyData;->mIsCurrentPwdSimple:Z
...
.method public isAdminActive(Landroid/content/ComponentName;I)Z
    ...
    const-string v2, ", return false, cause no feature"
    ...
    invoke-static {v3, v1}, Landroid/util/Flog;->i(ILjava/lang/String;)I
...
.method removeActiveAdminLocked(Landroid/content/ComponentName;I)V
    ...
    const-string v3, "removeActiveAdminLocked("
...
.method public resetPassword(Ljava/lang/String;I)Z
    ...
    const-string v36, "reset the password"
    ...
    .line 2942
    const-string v36, "DevicePolicyManagerService"

    new-instance v37, Ljava/lang/StringBuilder;

    invoke-direct/range {v37 .. v37}, Ljava/lang/StringBuilder;-><init>()V

    const-string v38, "resetPassword: password quality 0x"
    ...
    const-string v38, " does not meet required quality 0x"
    ...
    .restart local v30    # "realQuality":I
    :cond_2
    :try_start_1
    move/from16 v0, v30
    ...
    const-string v38, "resetPassword: password length "
    ...
    const-string v38, " does not meet required length "
    ...
    sget-object v36, Lcom/android/server/devicepolicy/DevicePolicyManagerService;->mHwCustDevicePolicyManagerService:Lcom/android/server/devicepolicy/HwCustDevicePolicyManagerService;
    ...
    invoke-virtual {v0, v1, v2}, Lcom/android/server/devicepolicy/HwCustDevicePolicyManagerService;->isNewPwdSimpleCheck(Ljava/lang/String;Landroid/content/Context;)Z

    move-result v14

    .line 2959
    .local v14, "isNewPwdSimple":Z
    const/16 v36, 0x0
    ...
    invoke-virtual {v0, v1, v2}, Lcom/android/server/devicepolicy/DevicePolicyManagerService;->getAllowSimplePassword(Landroid/content/ComponentName;I)Z

    move-result v6

    .line 2960
    .local v6, "allowSimplePwd":Z
    if-nez v6, :cond_5
    ...
    .line 2965
    .end local v6    # "allowSimplePwd":Z
    .end local v14    # "isNewPwdSimple":Z
    :cond_5
    const/high16 v36, 0x60000
    ...
    const-string v38, "resetPassword: number of letters "
    ...
    const-string v38, " does not meet required number of letters "
    ...
    const-string v38, "resetPassword: number of numerical digits "
    ...
    const-string v38, " does not meet required number of numerical digits "
    ...
    const-string v38, "resetPassword: number of lowercase letters "
    ...
    const-string v38, " does not meet required number of lowercase letters "
    ...
    const-string v38, "resetPassword: number of uppercase letters "
    ...
    const-string v38, " does not meet required number of uppercase letters "
    ...
    const-string v38, "resetPassword: number of special symbols "
    ...
    const-string v38, " does not meet required number of special symbols "
    ...
    const-string v38, "resetPassword: number of non-letter characters "
    ...
    const-string v38, " does not meet required number of non-letter characters "
    ...
    .line 3033
    .local v28, "policy":Lcom/android/server/devicepolicy/DevicePolicyManagerService$DevicePolicyData;
    ...
    const-string v37, "resetPassword: already set by another uid and not entered by user"
    ...
    invoke-direct {v0, v9}, Lcom/android/server/devicepolicy/DevicePolicyManagerService;->isCallerDeviceOwnerOrInitializer(I)Z
    ...
    .local v12, "ident":J
    :try_start_2
    new-instance v35, Lcom/android/internal/widget/LockPatternUtils;
    ...
    invoke-direct/range {v35 .. v36}, Lcom/android/internal/widget/LockPatternUtils;-><init>(Landroid/content/Context;)V

    .line 3050
    .local v35, "utils":Lcom/android/internal/widget/LockPatternUtils;
    ...
    invoke-virtual/range {v35 .. v36}, Lcom/android/internal/widget/LockPatternUtils;->requireCredentialEntry(I)V
    ...
    .end local v35    # "utils":Lcom/android/internal/widget/LockPatternUtils;
    :cond_14
    const/4 v10, 0x0
    ...
    .restart local v35    # "utils":Lcom/android/internal/widget/LockPatternUtils;
    :cond_15
    :try_start_4
    move-object/from16 v0, v35
...
.method saveSettingsLocked(I)V
    ...
    iget-boolean v10, p0, Lcom/android/server/devicepolicy/DevicePolicyManagerService;->mNotAllowSimplePwd:Z

    if-eqz v10, :cond_a

    iget-boolean v10, v7, Lcom/android/server/devicepolicy/DevicePolicyManagerService$DevicePolicyData;->mIsCurrentPwdSimple:Z
    ...
    const-string v11, "is-currentpwd-simple"

    iget-boolean v12, v7, Lcom/android/server/devicepolicy/DevicePolicyManagerService$DevicePolicyData;->mIsCurrentPwdSimple:Z
...
.method public setDeviceOwner(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-static {p1, v7}, Lcom/android/server/devicepolicy/DeviceOwner;->isInstalled(Ljava/lang/String;Landroid/content/pm/PackageManager;)Z
    ...
    const-string v9, "Invalid package name "
    ...
    const-string v9, " for device owner"
    ...
    .line 4229
    .local v6, "mPms":Lcom/android/server/pm/PackageManagerService;
    invoke-virtual {p0}, Lcom/android/server/devicepolicy/DevicePolicyManagerService;->getDeviceOwner()Ljava/lang/String;

    move-result-object v0

    .line 4230
    .local v0, "devOwner":Ljava/lang/String;
    const-string v7, "DevicePolicyManagerService"
    ...
    const-string v9, "NeedClearDeviceForCTS:"

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v8

    invoke-virtual {v6}, Lcom/android/server/pm/PackageManagerService;->getNeedClearDeviceForCTS()Z
    ...
    const-string v9, "clear CurrentDeviceOwner:"
    ...
    invoke-direct {p0, v7}, Lcom/android/server/devicepolicy/DevicePolicyManagerService;->clearUserPoliciesLocked(Landroid/os/UserHandle;)V
    ...
    invoke-virtual {v7}, Lcom/android/server/devicepolicy/DeviceOwner;->clearDeviceOwner()V

    .line 4237
    iget-object v7, p0, Lcom/android/server/devicepolicy/DevicePolicyManagerService;->mDeviceOwner:Lcom/android/server/devicepolicy/DeviceOwner;

    invoke-virtual {v7}, Lcom/android/server/devicepolicy/DeviceOwner;->writeOwnerFile()V
    ...
    invoke-virtual {v6, v7, v0}, Lcom/android/server/pm/PackageManagerService;->setNeedClearDeviceForCTS(ZLjava/lang/String;)V
    ...
    invoke-interface {v2, v7, v8}, Landroid/app/backup/IBackupManager;->setBackupServiceActive(IZ)V
    :try_end_1
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_0
    .catchall {:try_start_1 .. :try_end_1} :catchall_1
    ...
    iput-object v7, p0, Lcom/android/server/devicepolicy/DevicePolicyManagerService;->mDeviceOwner:Lcom/android/server/devicepolicy/DeviceOwner;
    ...
    .line 4275
    .end local v0    # "devOwner":Ljava/lang/String;
    .end local v2    # "ibm":Landroid/app/backup/IBackupManager;
    .end local v3    # "intent":Landroid/content/Intent;
    .end local v4    # "ident":J
    .end local v6    # "mPms":Lcom/android/server/pm/PackageManagerService;
    :catchall_0
    move-exception v7
    ...
    .line 4251
    .restart local v0    # "devOwner":Ljava/lang/String;
    .restart local v4    # "ident":J
    .restart local v6    # "mPms":Lcom/android/server/pm/PackageManagerService;
    :catch_0
    move-exception v1
    ...
    const-string v8, "Failed deactivating backup service."
    ...
    invoke-virtual {v7, p1, p2}, Lcom/android/server/devicepolicy/DeviceOwner;->setDeviceOwner(Ljava/lang/String;Ljava/lang/String;)V
