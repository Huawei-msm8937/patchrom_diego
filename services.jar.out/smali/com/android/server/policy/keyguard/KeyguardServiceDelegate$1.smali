...
.method public onServiceConnected(Landroid/content/ComponentName;Landroid/os/IBinder;)V
    ...
    const-string v2, "*** Keyguard connected (yay!), systemIsReady "
    ...
    invoke-static {v2}, Lcom/android/server/policy/keyguard/KeyguardServiceDelegate;->access$000(Lcom/android/server/policy/keyguard/KeyguardServiceDelegate;)Lcom/android/server/policy/keyguard/KeyguardServiceDelegate$KeyguardState;

    move-result-object v2

    iget-boolean v2, v2, Lcom/android/server/policy/keyguard/KeyguardServiceDelegate$KeyguardState;->systemIsReady:Z
    ...
    # setter for: Lcom/android/server/policy/keyguard/KeyguardServiceDelegate;->mShowListener:Lcom/android/server/policy/keyguard/KeyguardServiceDelegate$DrawnListener;
    invoke-static {v0, v4}, Lcom/android/server/policy/keyguard/KeyguardServiceDelegate;->access$102(Lcom/android/server/policy/keyguard/KeyguardServiceDelegate;Lcom/android/server/policy/keyguard/KeyguardServiceDelegate$DrawnListener;)Lcom/android/server/policy/keyguard/KeyguardServiceDelegate$DrawnListener;
    ...
    invoke-static {v0, v4}, Lcom/android/server/policy/keyguard/KeyguardServiceDelegate;->access$302(Lcom/android/server/policy/keyguard/KeyguardServiceDelegate;Lcom/android/server/policy/keyguard/KeyguardServiceDelegate$DrawnListener;)Lcom/android/server/policy/keyguard/KeyguardServiceDelegate$DrawnListener;
    ...
    iput-boolean v1, v0, Lcom/android/server/policy/keyguard/KeyguardServiceDelegate$KeyguardState;->deviceHasKeyguard:Z
...
.method public onServiceDisconnected(Landroid/content/ComponentName;)V
    ...
    iput-object v3, v0, Lcom/android/server/policy/keyguard/KeyguardServiceDelegate;->mKeyguardService:Lcom/android/server/policy/keyguard/KeyguardServiceWrapper;
    ...
    # getter for: Lcom/android/server/policy/keyguard/KeyguardServiceDelegate;->mShowListener:Lcom/android/server/policy/keyguard/KeyguardServiceDelegate$DrawnListener;
    invoke-static {v0}, Lcom/android/server/policy/keyguard/KeyguardServiceDelegate;->access$100(Lcom/android/server/policy/keyguard/KeyguardServiceDelegate;)Lcom/android/server/policy/keyguard/KeyguardServiceDelegate$DrawnListener;
    ...
    .line 186
    const-string v0, "*** Keyguard disconnected when screen on"
    ...
    # setter for: Lcom/android/server/policy/keyguard/KeyguardServiceDelegate;->mShowListener:Lcom/android/server/policy/keyguard/KeyguardServiceDelegate$DrawnListener;
    invoke-static {v0, v3}, Lcom/android/server/policy/keyguard/KeyguardServiceDelegate;->access$102(Lcom/android/server/policy/keyguard/KeyguardServiceDelegate;Lcom/android/server/policy/keyguard/KeyguardServiceDelegate$DrawnListener;)Lcom/android/server/policy/keyguard/KeyguardServiceDelegate$DrawnListener;
