...
.field private mShowListener:Lcom/android/server/policy/keyguard/KeyguardServiceDelegate$DrawnListener;
...
.method static constructor <clinit>()V
    ...
    :goto_0
    sput-boolean v0, Lcom/android/server/policy/keyguard/KeyguardServiceDelegate;->DEBUG:Z
...
.method static synthetic access$100(Lcom/android/server/policy/keyguard/KeyguardServiceDelegate;)Lcom/android/server/policy/keyguard/KeyguardServiceDelegate$DrawnListener;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/policy/keyguard/KeyguardServiceDelegate;

    .prologue
    .line 34
    iget-object v0, p0, Lcom/android/server/policy/keyguard/KeyguardServiceDelegate;->mShowListener:Lcom/android/server/policy/keyguard/KeyguardServiceDelegate$DrawnListener;

    return-object v0
.end method

.method static synthetic access$102(Lcom/android/server/policy/keyguard/KeyguardServiceDelegate;Lcom/android/server/policy/keyguard/KeyguardServiceDelegate$DrawnListener;)Lcom/android/server/policy/keyguard/KeyguardServiceDelegate$DrawnListener;
    .locals 0
    .param p0, "x0"    # Lcom/android/server/policy/keyguard/KeyguardServiceDelegate;
    ...
    .prologue
    .line 34
    iput-object p1, p0, Lcom/android/server/policy/keyguard/KeyguardServiceDelegate;->mShowListener:Lcom/android/server/policy/keyguard/KeyguardServiceDelegate$DrawnListener;
...
.method public bindService(Landroid/content/Context;)V
    ...
    const-string v4, "*** Keyguard: can\'t bind to "
    ...
    invoke-static {v7, v3}, Landroid/util/Flog;->i(ILjava/lang/String;)I
...
.method public doKeyguardTimeout(Landroid/os/Bundle;)V
    ...
    const-string v2, "doKeyguardTimeout(), options "
...
.method public isOccluded()Z
    ...
    invoke-virtual {v1}, Lcom/android/server/policy/keyguard/KeyguardServiceWrapper;->isOccluded()Z
...
.method public onScreenTurnedOff()V
    ...
    .line 277
    sget-boolean v0, Lcom/android/server/policy/keyguard/KeyguardServiceDelegate;->DEBUG:Z
...
.method public onScreenTurningOn(Lcom/android/server/policy/keyguard/KeyguardServiceDelegate$DrawnListener;)V
    ...
    const-string v1, "KeyguardServiceDelegate  onScreenTurnedOn(showListener = "
    ...
    .line 290
    :cond_0
    const-string v0, "KeyguardServiceDelegate  onScreenTurningOn(): no keyguard service!"
...
.method public showScrim()V
    ...
    const-string v3, "showScrim(), deviceHasKeyguard "
    ...
    iget-boolean v3, v3, Lcom/android/server/policy/keyguard/KeyguardServiceDelegate$KeyguardState;->deviceHasKeyguard:Z
...
.method public startKeyguardExitAnimation(JJ)V
    ...
    const-string v2, "startKeyguardExitAnimation, startTime "
