...
.super Lcom/android/server/AbsBatteryService;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/server/BatteryService$CheckForShutdown;,
...
.field private static final IS_UDP:Z

.field private static final SHUTDOWN_DELAY_TIMEOUT:I = 0x4e20
...
.field private mPendingCheckForShutdown:Lcom/android/server/BatteryService$CheckForShutdown;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/server/BatteryService;->boardname:Ljava/lang/String;

    .line 116
    sget-object v0, Lcom/android/server/BatteryService;->boardname:Ljava/lang/String;
    ...
    sput-boolean v0, Lcom/android/server/BatteryService;->IS_EMU:Z
    ...
    sput-boolean v0, Lcom/android/server/BatteryService;->IS_FPGA:Z
    ...
    sput-boolean v0, Lcom/android/server/BatteryService;->IS_UDP:Z
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .prologue
    .line 159
    invoke-direct {p0, p1}, Lcom/android/server/AbsBatteryService;-><init>(Landroid/content/Context;)V
...
.method private dumpInternal(Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    const-string v11, "dumpInternal args[0]: "
    ...
    const-string v11, " mUpdatesStopped: "

    invoke-virtual {v10, v11}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v10

    iget-boolean v11, p0, Lcom/android/server/BatteryService;->mUpdatesStopped:Z
...
.method private processValuesLocked(Z)V
    ...
    .line 478
    invoke-virtual {p0}, Lcom/android/server/BatteryService;->playRing()V
    ...
    :cond_8
    :goto_7
    invoke-virtual {p0}, Lcom/android/server/BatteryService;->updateLight()V
    ...
    .line 490
    invoke-virtual {p0}, Lcom/android/server/BatteryService;->stopRing()V
...
.method private shutdownIfNoPowerLocked()V
    ...
    sget-boolean v0, Lcom/android/server/BatteryService;->IS_EMU:Z

    if-nez v0, :cond_1

    sget-boolean v0, Lcom/android/server/BatteryService;->IS_FPGA:Z

    if-nez v0, :cond_1

    sget-boolean v0, Lcom/android/server/BatteryService;->IS_UDP:Z
    ...
    .line 299
    iget-object v0, p0, Lcom/android/server/BatteryService;->mPendingCheckForShutdown:Lcom/android/server/BatteryService$CheckForShutdown;

    if-nez v0, :cond_0

    .line 300
    new-instance v0, Lcom/android/server/BatteryService$CheckForShutdown;

    invoke-direct {v0, p0, v2}, Lcom/android/server/BatteryService$CheckForShutdown;-><init>(Lcom/android/server/BatteryService;Lcom/android/server/BatteryService$1;)V

    iput-object v0, p0, Lcom/android/server/BatteryService;->mPendingCheckForShutdown:Lcom/android/server/BatteryService$CheckForShutdown;

    .line 301
    iget-object v0, p0, Lcom/android/server/BatteryService;->mHandler:Landroid/os/Handler;

    iget-object v1, p0, Lcom/android/server/BatteryService;->mPendingCheckForShutdown:Lcom/android/server/BatteryService$CheckForShutdown;
    ...
    .line 308
    iput-object v2, p0, Lcom/android/server/BatteryService;->mPendingCheckForShutdown:Lcom/android/server/BatteryService$CheckForShutdown;
...
.method private update(Landroid/os/BatteryProperties;)V
    ...
    invoke-virtual {p0, v0, p1, v1, v2}, Lcom/android/server/BatteryService;->printBatteryLog(Landroid/os/BatteryProperties;Landroid/os/BatteryProperties;IZ)V
...
# virtual methods
.method protected getBatteryProps()Landroid/os/BatteryProperties;
    .locals 1
...
.method protected getLowBatteryWarningLevel()I
    .locals 1
...
.method public onStart()V
    ...
    invoke-direct {v2, p0}, Lcom/android/server/BatteryService$BatteryListener;-><init>(Lcom/android/server/BatteryService;)V
