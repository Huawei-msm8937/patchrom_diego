...
.method constructor <init>(Lcom/android/server/pm/PackageManagerService;Ljava/lang/String;[Ljava/lang/String;Z)V
    ...
    .line 12266
    .local v12, "sdDir":Ljava/lang/String;
    if-eqz v12, :cond_0
    ...
    .line 12260
    .end local v12    # "sdDir":Ljava/lang/String;
    :cond_1
    const/4 v0, 0x0
...
.method copyApk(Lcom/android/internal/app/IMediaContainerService;Z)I
    ...
    const-string v1, "DCS:cPTC;f("

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v0

    iget-object v1, p0, Lcom/android/server/pm/PackageManagerService$AsecInstallArgs;->origin:Lcom/android/server/pm/PackageManagerService$OriginInfo;
    ...
    const-string v2, "AIA::cA"

    invoke-static {v0, v1, v2, v8}, Lcom/android/server/radar/FrameworkRadar;->msg(IILjava/lang/String;Ljava/lang/String;)V
...
.method doPostCopy(I)I
    ...
    invoke-static {v1, v2, v3}, Lcom/android/internal/content/PackageHelper;->fixSdPermissions(Ljava/lang/String;ILjava/lang/String;)Z
    ...
    const-string v3, "AIA::dPstC"

    invoke-static {v1, v2, v3, v0}, Lcom/android/server/radar/FrameworkRadar;->msg(IILjava/lang/String;Ljava/lang/String;)V
...
.method doPostInstall(II)I
    ...
    invoke-virtual {v4}, Lcom/android/server/pm/PackageManagerService;->hwCertCleanUp()V
    ...
    invoke-static {v4, v0, v2}, Lcom/android/internal/content/PackageHelper;->fixSdPermissions(Ljava/lang/String;ILjava/lang/String;)Z
    ...
    const-string v6, "Failed to finalize "
    ...
    const-string v6, "AIA::dPstI"

    invoke-static {v4, v5, v6, v3}, Lcom/android/server/radar/FrameworkRadar;->msg(IILjava/lang/String;Ljava/lang/String;)V
...
.method doPreInstall(I)I
    ...
    const-string v5, "AIA::dPrI"

    invoke-static {v3, v4, v5, v2}, Lcom/android/server/radar/FrameworkRadar;->msg(IILjava/lang/String;Ljava/lang/String;)V
