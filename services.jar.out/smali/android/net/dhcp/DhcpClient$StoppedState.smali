...
.method public processMessage(Landroid/os/Message;)Z
    ...
    # setter for: Landroid/net/dhcp/DhcpClient;->mDhcpAction:I
    invoke-static {v0, v1}, Landroid/net/dhcp/DhcpClient;->access$502(Landroid/net/dhcp/DhcpClient;I)I

    .line 575
    iget-object v0, p0, Landroid/net/dhcp/DhcpClient$StoppedState;->this$0:Landroid/net/dhcp/DhcpClient;

    # invokes: Landroid/net/dhcp/DhcpClient;->scheduleOneshotTimeout()V
    invoke-static {v0}, Landroid/net/dhcp/DhcpClient;->access$600(Landroid/net/dhcp/DhcpClient;)V
    ...
    invoke-static {v0, v1}, Landroid/net/dhcp/DhcpClient;->access$900(Landroid/net/dhcp/DhcpClient;Lcom/android/internal/util/IState;)V
    ...
    # invokes: Landroid/net/dhcp/DhcpClient;->transitionTo(Lcom/android/internal/util/IState;)V
    invoke-static {v0, v1}, Landroid/net/dhcp/DhcpClient;->access$1100(Landroid/net/dhcp/DhcpClient;Lcom/android/internal/util/IState;)V
