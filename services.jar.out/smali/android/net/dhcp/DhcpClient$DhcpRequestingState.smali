...
.method protected receivePacket(Landroid/net/dhcp/DhcpPacket;)V
    ...
    invoke-static {v1, v0}, Landroid/net/dhcp/DhcpClient;->access$3202(Landroid/net/dhcp/DhcpClient;Landroid/net/DhcpResults;)Landroid/net/DhcpResults;

    .line 804
    iget-object v1, p0, Landroid/net/dhcp/DhcpClient$DhcpRequestingState;->this$0:Landroid/net/dhcp/DhcpClient;

    # setter for: Landroid/net/dhcp/DhcpClient;->mOffer:Landroid/net/DhcpResults;
    invoke-static {v1, v3}, Landroid/net/dhcp/DhcpClient;->access$2802(Landroid/net/dhcp/DhcpClient;Landroid/net/DhcpResults;)Landroid/net/DhcpResults;
    ...
    invoke-static {v3}, Landroid/net/dhcp/DhcpClient;->access$3200(Landroid/net/dhcp/DhcpClient;)Landroid/net/DhcpResults;
    ...
    invoke-static {v1, v2}, Landroid/net/dhcp/DhcpClient;->access$3400(Landroid/net/dhcp/DhcpClient;Lcom/android/internal/util/IState;)V
    ...
    invoke-static {v2}, Landroid/net/dhcp/DhcpClient;->access$1000(Landroid/net/dhcp/DhcpClient;)Lcom/android/internal/util/State;

    move-result-object v2

    # invokes: Landroid/net/dhcp/DhcpClient;->transitionTo(Lcom/android/internal/util/IState;)V
    invoke-static {v1, v2}, Landroid/net/dhcp/DhcpClient;->access$3500(Landroid/net/dhcp/DhcpClient;Lcom/android/internal/util/IState;)V
...
.method protected sendPacket()Z
    ...
    invoke-static {v0}, Landroid/net/dhcp/DhcpClient;->access$2800(Landroid/net/dhcp/DhcpClient;)Landroid/net/DhcpResults;
    ...
    # getter for: Landroid/net/dhcp/DhcpClient;->mOffer:Landroid/net/DhcpResults;
    invoke-static {v1}, Landroid/net/dhcp/DhcpClient;->access$2800(Landroid/net/dhcp/DhcpClient;)Landroid/net/DhcpResults;
    ...
    invoke-static {v2, v3, v0, v1, v4}, Landroid/net/dhcp/DhcpClient;->access$3100(Landroid/net/dhcp/DhcpClient;Ljava/net/Inet4Address;Ljava/net/Inet4Address;Ljava/net/Inet4Address;Ljava/net/Inet4Address;)Z
