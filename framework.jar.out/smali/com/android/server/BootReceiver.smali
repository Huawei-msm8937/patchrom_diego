...
.field private static final PSTORE_DIR:Ljava/io/File;

.field private static final TAG:Ljava/lang/String; = "BootReceiver"

.field private static final TOMBSTONE_DIR:Ljava/io/File;

.field private static sPstoreObserver:Landroid/os/FileObserver;
...
.method static constructor <clinit>()V
    ...
    const-string v1, "/mnt/pstore"

    invoke-direct {v0, v1}, Ljava/io/File;-><init>(Ljava/lang/String;)V

    sput-object v0, Lcom/android/server/BootReceiver;->PSTORE_DIR:Ljava/io/File;

    .line 62
    sput-object v2, Lcom/android/server/BootReceiver;->sTombstoneObserver:Landroid/os/FileObserver;

    .line 63
    sput-object v2, Lcom/android/server/BootReceiver;->sPstoreObserver:Landroid/os/FileObserver;
...
.method static synthetic access$500()Ljava/io/File;
    ...
    .prologue
    .line 42
    sget-object v0, Lcom/android/server/BootReceiver;->PSTORE_DIR:Ljava/io/File;
...
.method private logBootEvents(Landroid/content/Context;)V
    ...
    const-string v7, "Can\'t create a empty TOMBSTONE_DIR"
    ...
    .line 201
    sget-object v6, Lcom/android/server/BootReceiver;->PSTORE_DIR:Ljava/io/File;
    ...
    .line 202
    .local v16, "pstoreFiles":[Ljava/io/File;
    const/4 v14, 0x0
    ...
    const-string v11, "SYSTEM_PSTORE"
    ...
    .line 209
    :cond_9
    new-instance v6, Lcom/android/server/BootReceiver$3;

    sget-object v7, Lcom/android/server/BootReceiver;->PSTORE_DIR:Ljava/io/File;
    ...
    invoke-direct/range {v6 .. v12}, Lcom/android/server/BootReceiver$3;-><init>(Lcom/android/server/BootReceiver;Ljava/lang/String;ILandroid/os/DropBoxManager;Landroid/content/SharedPreferences;Ljava/lang/String;)V

    sput-object v6, Lcom/android/server/BootReceiver;->sPstoreObserver:Landroid/os/FileObserver;

    .line 225
    sget-object v6, Lcom/android/server/BootReceiver;->sPstoreObserver:Landroid/os/FileObserver;
