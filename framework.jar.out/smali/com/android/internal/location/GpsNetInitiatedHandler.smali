...
.method private declared-synchronized setNiNotification(Lcom/android/internal/location/GpsNetInitiatedHandler$GpsNiNotification;)V
    ...
    invoke-static {p1, v7}, Lcom/android/internal/location/GpsNetInitiatedHandler;->getNotifTitle(Lcom/android/internal/location/GpsNetInitiatedHandler$GpsNiNotification;Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {p1, v7}, Lcom/android/internal/location/GpsNetInitiatedHandler;->getNotifMessage(Lcom/android/internal/location/GpsNetInitiatedHandler$GpsNiNotification;Landroid/content/Context;)Ljava/lang/String;

    move-result-object v2

    .line 373
    .local v2, "message":Ljava/lang/String;
    const-string v7, "GpsNetInitiatedHandler"

    new-instance v8, Ljava/lang/StringBuilder;

    invoke-direct {v8}, Ljava/lang/StringBuilder;-><init>()V

    const-string v9, "setNiNotification, notifyId: "

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v8

    iget v9, p1, Lcom/android/internal/location/GpsNetInitiatedHandler$GpsNiNotification;->notificationId:I
    ...
    iget-object v8, p0, Lcom/android/internal/location/GpsNetInitiatedHandler;->mContext:Landroid/content/Context;
    ...
    iput-object v7, p0, Lcom/android/internal/location/GpsNetInitiatedHandler;->mNiNotificationBuilder:Landroid/app/Notification$Builder;

    .line 392
    .end local v0    # "bmp":Landroid/graphics/Bitmap;
    :cond_1
    iget-boolean v7, p0, Lcom/android/internal/location/GpsNetInitiatedHandler;->mPlaySounds:Z
    ...
    .line 399
    :goto_1
    iget-boolean v7, p0, Lcom/android/internal/location/GpsNetInitiatedHandler;->mPopupImmediately:Z
    ...
    invoke-static {p1, v8}, Lcom/android/internal/location/GpsNetInitiatedHandler;->getNotifTicker(Lcom/android/internal/location/GpsNetInitiatedHandler$GpsNiNotification;Landroid/content/Context;)Ljava/lang/String;
    ...
    iput-object v7, v3, Landroid/app/Notification;->extras:Landroid/os/Bundle;
