...
.field private static mCustLockPatternUtils:Lcom/android/internal/widget/HwCustLockPatternUtils;
...
.method static constructor <clinit>()V
    ...
    .prologue
    .line 146
    const-class v0, Lcom/android/internal/widget/HwCustLockPatternUtils;
    ...
    check-cast v0, Lcom/android/internal/widget/HwCustLockPatternUtils;

    sput-object v0, Lcom/android/internal/widget/LockPatternUtils;->mCustLockPatternUtils:Lcom/android/internal/widget/HwCustLockPatternUtils;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 190
    sget-object v0, Lcom/android/internal/widget/LockPatternUtils;->mCustLockPatternUtils:Lcom/android/internal/widget/HwCustLockPatternUtils;

    if-eqz v0, :cond_0

    sget-object v0, Lcom/android/internal/widget/LockPatternUtils;->mCustLockPatternUtils:Lcom/android/internal/widget/HwCustLockPatternUtils;

    invoke-virtual {v0}, Lcom/android/internal/widget/HwCustLockPatternUtils;->isNotAllowSimplePwd()Z
    ...
    invoke-virtual {v0, v1, v2}, Lcom/android/internal/widget/HwCustLockPatternUtils;->initHwCustLockPatternUtils(Landroid/app/admin/DevicePolicyManager;Landroid/content/Context;)V
...
.method public static isDeviceEncrypted()Z
    ...
    invoke-interface {v0}, Landroid/os/storage/IMountService;->isSecure()Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method private writeSettingsData()V
    .locals 8
    ...
    .line 830
    .local v2, "subjectDate":Ljava/lang/String;
    ...
    const-string v4, "lock_settings_time"
    ...
    .line 832
    .local v1, "locksettingstime":Ljava/lang/String;
    ...
    const-string v4, "first_lock_time"
    ...
    .line 840
    .end local v1    # "locksettingstime":Ljava/lang/String;
    .end local v2    # "subjectDate":Ljava/lang/String;
    :goto_0
    return-void
...
.method public checkPassword(Ljava/lang/String;I)Z
    ...
    const-string v5, "checkPassword error  "
...
.method public checkPasswordHistory(Ljava/lang/String;I)Z
    ...
    invoke-virtual {p0, p2}, Lcom/android/internal/widget/LockPatternUtils;->getRequestedPasswordHistoryLength(I)I
...
.method public clearLock(I)V
    ...
    const-string v3, "clearLock success by uid = "
    ...
    invoke-virtual {p0, v0, v4}, Lcom/android/internal/widget/LockPatternUtils;->updateEncryptionPassword(ILjava/lang/String;)V
    ...
    .line 486
    invoke-virtual {p0, p1}, Lcom/android/internal/widget/LockPatternUtils;->onAfterChangingPassword(I)V
...
.method public getRequestedPasswordHistoryLength(I)I
    .locals 2
    .param p1, "userId"    # I
...
.method protected onAfterChangingPassword(I)V
    .locals 1
    .param p1, "userHandle"    # I
...
.method public saveLockPassword(Ljava/lang/String;Ljava/lang/String;II)V
    ...
    const-string v13, "saveLockPattern success by uid = "
    ...
    .line 735
    invoke-direct/range {p0 .. p0}, Lcom/android/internal/widget/LockPatternUtils;->writeSettingsData()V
    ...
    invoke-virtual {v0, v5}, Lcom/android/internal/widget/LockPatternUtils;->shouldEncryptWithCredentials(Z)Z
    ...
    .end local v23    # "c":C
    :cond_b
    sget-object v5, Lcom/android/internal/widget/LockPatternUtils;->mCustLockPatternUtils:Lcom/android/internal/widget/HwCustLockPatternUtils;

    if-eqz v5, :cond_c

    sget-object v5, Lcom/android/internal/widget/LockPatternUtils;->mCustLockPatternUtils:Lcom/android/internal/widget/HwCustLockPatternUtils;

    invoke-virtual {v5}, Lcom/android/internal/widget/HwCustLockPatternUtils;->isNotAllowSimplePwd()Z
    ...
    sget-object v6, Lcom/android/internal/widget/LockPatternUtils;->mCustLockPatternUtils:Lcom/android/internal/widget/HwCustLockPatternUtils;

    move-object/from16 v0, p1

    invoke-virtual {v6, v0}, Lcom/android/internal/widget/HwCustLockPatternUtils;->currentpwdSimpleCheck(Ljava/lang/String;)Z

    move-result v6

    invoke-virtual {v5, v6}, Lcom/android/internal/widget/HwCustLockPatternUtils;->saveCurrentPwdStatus(Z)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/internal/widget/LockPatternUtils;->getRequestedPasswordHistoryLength(I)I
    ...
    invoke-virtual {v0, v1}, Lcom/android/internal/widget/LockPatternUtils;->onAfterChangingPassword(I)V
...
.method public saveLockPattern(Ljava/util/List;Ljava/lang/String;I)V
    ...
    const-string v3, "saveLockPattern success by uid = "
    ...
    invoke-virtual {p0, v1}, Lcom/android/internal/widget/LockPatternUtils;->shouldEncryptWithCredentials(Z)Z
    ...
    .line 551
    invoke-virtual {p0, p3}, Lcom/android/internal/widget/LockPatternUtils;->onAfterChangingPassword(I)V
    ...
    invoke-virtual {p0, v1, v11}, Lcom/android/internal/widget/LockPatternUtils;->updateEncryptionPassword(ILjava/lang/String;)V
    :try_end_1
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_0
...
.method protected shouldEncryptWithCredentials(Z)Z
    .locals 1
    .param p1, "defaultValue"    # Z
...
.method protected updateEncryptionPassword(ILjava/lang/String;)V
    ...
    invoke-virtual {v1, v2, v3}, Lcom/android/internal/widget/LockPatternUtils$1;->executeOnExecutor(Ljava/util/concurrent/Executor;[Ljava/lang/Object;)Landroid/os/AsyncTask;
