...
.field private static final PRELOAD_GC_THRESHOLD:I = 0x4000000
...
.method public static clearHwThemeZipsAndSomeIcons()V
    .locals 2
    ...
    invoke-static {v0}, Landroid/content/res/Resources;->getSystem(Z)Landroid/content/res/Resources;
    ...
    const-string v1, "clearHwThemeZipsAndSomeIcons"
    ...
    invoke-virtual {v0}, Landroid/content/res/Resources;->clearHwThemeZipsAndSomeIcons()V
...
.method public static main([Ljava/lang/String;)V
    ...
    const-string v9, "JL_BOOT_PROGRESS_PRELOAD_START:"
    ...
    invoke-static {v7, v8}, Landroid/util/Jlog;->d(ILjava/lang/String;)I
    ...
    const-string v8, "JL_BOOT_PROGRESS_PRELOAD_END"
...
.method static preload()V
    ...
    new-instance v4, Lcom/android/internal/os/ZygoteInit$1;

    invoke-direct {v4}, Lcom/android/internal/os/ZygoteInit$1;-><init>()V

    invoke-direct {v3, v4}, Ljava/lang/Thread;-><init>(Ljava/lang/Runnable;)V

    .line 196
    .local v3, "resourceThread":Ljava/lang/Thread;
    invoke-virtual {v3}, Ljava/lang/Thread;->start()V

    .line 199
    new-instance v0, Ljava/lang/Thread;

    new-instance v4, Lcom/android/internal/os/ZygoteInit$2;

    invoke-direct {v4}, Lcom/android/internal/os/ZygoteInit$2;-><init>()V

    invoke-direct {v0, v4}, Ljava/lang/Thread;-><init>(Ljava/lang/Runnable;)V

    .line 210
    .local v0, "classThread":Ljava/lang/Thread;
    ...
    invoke-static {v4}, Lcom/android/internal/os/ZygoteInit;->preloadHwThemeZipsAndSomeIcons(I)V
    ...
    const-string v5, "wairint for preloading class/resource"
    ...
    const-string v5, "wait preload class/resource error"
...
.method public static preloadHwThemeZipsAndSomeIcons(I)V
    .locals 2
    ...
    const-string v1, "preloadHwThemeZipsAndSomeIcons"
    ...
    invoke-virtual {v0, p0}, Landroid/content/res/Resources;->preloadHwThemeZipsAndSomeIcons(I)V
...
.method private static preloadResources()V
    ...
    :try_start_0
    invoke-static {v6}, Landroid/content/res/Resources;->getSystem(Z)Landroid/content/res/Resources;
    ...
    const-string v8, " hwextdrawable resources in "
...
.method private static startSystemServer(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    const-string v2, "--setgroups=1001,1002,1003,1004,1005,1006,1007,1008,1009,1010,1018,1021,1023,1032,3001,3002,3003,3006,3007"
