...
.field private static final DEBUG_CONTROL:Z
...
.field private static final MAX_WAKERLOCKS_WEIXIN:I = 0x3c
...
.field private static sNumSpeedStepsBackup:I
...
.method static constructor <clinit>()V
    ...
    :goto_0
    sput-boolean v0, Lcom/android/internal/os/BatteryStatsImpl;->DEBUG_CONTROL:Z

    .line 133
    sput v1, Lcom/android/internal/os/BatteryStatsImpl;->sNumSpeedStepsBackup:I
...
.method private computeTimePerLevel([JI)J
    ...
    const-string v7, "numSteps > steps.length, numSteps = "
...
.method private readHistoryTag(ILandroid/os/BatteryStats$HistoryTag;)V
    ...
    const-string v1, "readHistoryTag, index >= mReadHistoryStrings.length"
    ...
    const-string v1, "readHistoryTag, index >= mReadHistoryUids.length"
...
.method private resetAllStatsLocked()V
    ...
    .line 7704
    sget-boolean v3, Lcom/android/internal/os/BatteryStatsImpl;->DEBUG_CONTROL:Z
    ...
    const-string v5, "resetAllStatsLocked sNumSpeedSteps = "
    ...
    const-string v5, ",sNumSpeedStepsBackup = "

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    sget v5, Lcom/android/internal/os/BatteryStatsImpl;->sNumSpeedStepsBackup:I
...
.method public noteWifiScanStartedLocked(I)V
    ...
    invoke-static {v4, v5}, Lcom/huawei/pgmng/log/LogPower;->push(ILjava/lang/String;)I
...
.method public readLocked()V
    ...
    const-string v7, "after resetAllStatsLocked when exception. sNumSpeedSteps = "

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v6

    sget v7, Lcom/android/internal/os/BatteryStatsImpl;->sNumSpeedSteps:I

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    move-result-object v6

    const-string v7, ", sNumSpeedStepsBackup = "

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v6

    sget v7, Lcom/android/internal/os/BatteryStatsImpl;->sNumSpeedStepsBackup:I
    ...
    .line 9203
    sget v1, Lcom/android/internal/os/BatteryStatsImpl;->sNumSpeedStepsBackup:I

    sput v1, Lcom/android/internal/os/BatteryStatsImpl;->sNumSpeedSteps:I
...
.method public setNumSpeedSteps(I)V
    ...
    .prologue
    .line 7079
    sget-boolean v0, Lcom/android/internal/os/BatteryStatsImpl;->DEBUG_CONTROL:Z
    ...
    const-string v2, "sNumSpeedSteps = "
    ...
    .line 7084
    sput p1, Lcom/android/internal/os/BatteryStatsImpl;->sNumSpeedStepsBackup:I
...
.method public updateCpuTimeLocked()V
    ...
    invoke-direct {v0, v1, v10, v5, v4}, Lcom/android/internal/os/BatteryStatsImpl$2;-><init>(Lcom/android/internal/os/BatteryStatsImpl;I[JI)V
