...
.field private static final OBJECT_ALL_INFO_PROJECTION:[Ljava/lang/String;
...
.method private beginSendObject(Ljava/lang/String;IIIJJ)I
    ...
    .line 355
    invoke-static {}, Landroid/common/HwFrameworkFactory;->getHwMtpDatabaseManager()Landroid/mtp/HwMtpDatabaseManager;

    move-result-object v0

    invoke-interface {v0, p1, v8}, Landroid/mtp/HwMtpDatabaseManager;->hwBeginSendObject(Ljava/lang/String;Landroid/database/Cursor;)I
    :try_end_0
...
.method private createObjectQuery(III)Landroid/database/Cursor;
    ...
    sget-object v3, Landroid/mtp/MtpDatabase;->OBJECT_ALL_INFO_PROJECTION:[Ljava/lang/String;
...
.method private getObjectInfo(I[I[C[J)Z
    ...
    invoke-interface {v4, v0, v1, v2, v3}, Landroid/mtp/HwMtpDatabaseManager;->hwGetObjectInfo(I[I[C[J)Z
    ...
    sget-object v7, Landroid/mtp/MtpDatabase;->OBJECT_INFO_PROJECTION:[Ljava/lang/String;
    ...
    invoke-virtual {v0, v1, v14, v2, v4}, Ljava/lang/String;->getChars(II[CI)V
...
.method private getObjectList(III)[I
    ...
    invoke-interface {v6, v1, v0}, Landroid/mtp/HwMtpDatabaseManager;->hwStoreObjects(ILandroid/database/Cursor;)V
    :try_end_1
...
.method private getObjectPropertyList(JIJII)Landroid/mtp/MtpPropertyList;
    ...
    invoke-direct {v6, v4, v1}, Landroid/mtp/MtpPropertyList;-><init>(II)V
    ...
    invoke-interface {v1, p4, p5, p1, p2}, Landroid/mtp/HwMtpDatabaseManager;->getObjectPropertyList(JJ)Landroid/mtp/MtpPropertyList;

    move-result-object v6

    .line 766
    .local v6, "result":Landroid/mtp/MtpPropertyList;
    if-nez v6, :cond_0
...
.method private getObjectReferences(I)[I
    ...
    invoke-interface {v0, p1}, Landroid/mtp/HwMtpDatabaseManager;->hwGetObjectReferences(I)Z
...
.method private renameFile(ILjava/lang/String;)I
    ...
    invoke-virtual {v1, v13, v2, v0, v3}, Landroid/media/MediaScanner;->scanMtpFile(Ljava/lang/String;Ljava/lang/String;II)V
