...
.method public static cdmaCheckAndProcessPlusCode(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 2499
    invoke-static {}, Landroid/telephony/PhoneNumberUtils;->getCdmaSubId()I
    ...
    invoke-virtual {v3, v2}, Landroid/telephony/TelephonyManager;->getNetworkCountryIsoForSubscription(I)Ljava/lang/String;
    ...
    invoke-virtual {v3, v2}, Landroid/telephony/TelephonyManager;->getSimCountryIsoForSubscription(I)Ljava/lang/String;
...
.method public static formatNumber(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-interface {v3}, Landroid/telephony/HwInnerTelephonyManager;->isCustomProcess()Z
    ...
    invoke-interface {v3, v1}, Landroid/telephony/HwInnerTelephonyManager;->stripBrackets(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-interface {v3}, Landroid/telephony/HwInnerTelephonyManager;->isCustRemoveSep()Z
    ...
    invoke-interface {v3, v1}, Landroid/telephony/HwInnerTelephonyManager;->removeAllSeparate(Ljava/lang/String;)Ljava/lang/String;
...
.method public static formatNumber(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-interface {v6}, Landroid/telephony/HwInnerTelephonyManager;->isCustomProcess()Z
    ...
    invoke-interface {v6, v4}, Landroid/telephony/HwInnerTelephonyManager;->stripBrackets(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-interface {v6}, Landroid/telephony/HwInnerTelephonyManager;->isCustRemoveSep()Z
    ...
    invoke-interface {v6, v4}, Landroid/telephony/HwInnerTelephonyManager;->removeAllSeparate(Ljava/lang/String;)Ljava/lang/String;
...
.method private static getCdmaSubId()I
    ...
    const-string v4, "getCdmaSubId find cdma phone subId = "
    ...
    const-string v4, "getCdmaSubId find none cdma phone return default 0 "
...
.method private static initMccMatchTable()Ljava/util/ArrayList;
    ...
    const-string v5, "13,15,18,17,14,10649"
...
.method private static isEmergencyNumberInternal(ILjava/lang/String;Ljava/lang/String;Z)Z
    ...
    invoke-interface {v9, v10, v11, v3}, Landroid/telephony/HwInnerTelephonyManager;->custExtraEmergencyNumbers(JLjava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo v10, "ro.product.locale.region"
    ...
    invoke-interface {v9}, Landroid/telephony/HwInnerTelephonyManager;->skipHardcodeEmergencyNumbers()Z
...
.method private static isLocalEmergencyNumberInternal(ILjava/lang/String;Landroid/content/Context;Z)Z
    ...
    invoke-interface {v2, p2, p1}, Landroid/telephony/HwInnerTelephonyManager;->isHwCustNotEmergencyNumber(Landroid/content/Context;Ljava/lang/String;)Z
...
.method public static isMobileNumber(Ljava/lang/String;I)Z
    ...
    invoke-static {v3, v4}, Landroid/telephony/PhoneNumberUtils;->beginWith(Ljava/lang/String;[Ljava/lang/String;)Z
    ...
    const-string/jumbo v5, "plus: isMobileNumber = "
    ...
    .line 235
    :cond_4
    invoke-virtual {v1}, Landroid/telephony/PhoneNumberUtils$MccNumberMatch;->getIdd()Ljava/lang/String;
...
.method public static isVoiceMailNumber(Landroid/content/Context;ILjava/lang/String;)Z
    ...
    invoke-interface {v5, p1, p2}, Landroid/telephony/HwInnerTelephonyManager;->isLongVoiceMailNumber(ILjava/lang/String;)Z
...
.method public static isVoiceMailNumber(Ljava/lang/String;)Z
    ...
    invoke-interface {v0}, Landroid/telephony/HwInnerTelephonyManager;->useVoiceMailNumberFeature()Z
    ...
    invoke-interface {v0, p0}, Landroid/telephony/HwInnerTelephonyManager;->isVoiceMailNumber(Ljava/lang/String;)Z
