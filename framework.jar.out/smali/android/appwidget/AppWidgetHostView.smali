...
.method protected getDefaultView()Landroid/view/View;
    ...
    .line 544
    .local v5, "defaultView":Landroid/view/View;
    const/4 v7, 0x0
    ...
    iget-object v0, v0, Landroid/appwidget/AppWidgetHostView;->mInfo:Landroid/appwidget/AppWidgetProviderInfo;
    ...
    .line 548
    invoke-direct/range {p0 .. p0}, Landroid/appwidget/AppWidgetHostView;->getRemoteContext()Landroid/content/Context;

    move-result-object v20

    .line 549
    .local v20, "theirContext":Landroid/content/Context;
    move-object/from16 v0, v20

    move-object/from16 v1, p0

    iput-object v0, v1, Landroid/appwidget/AppWidgetHostView;->mRemoteContext:Landroid/content/Context;

    .line 552
    const/16 v18, 0x0

    .line 553
    .local v18, "remoteConf":Landroid/content/res/Configuration;
    const/16 v17, 0x0

    .line 554
    .local v17, "remoteCI":Landroid/content/res/CompatibilityInfo;
    const/16 v19, 0x0

    .line 556
    .local v19, "remoteDM":Landroid/util/DisplayMetrics;
    new-instance v11, Landroid/util/DisplayMetrics;

    invoke-direct {v11}, Landroid/util/DisplayMetrics;-><init>()V

    .line 557
    .local v11, "hostDM":Landroid/util/DisplayMetrics;
    move-object/from16 v0, p0
    ...
    invoke-virtual {v11, v0}, Landroid/util/DisplayMetrics;->setTo(Landroid/util/DisplayMetrics;)V

    .line 559
    new-instance v19, Landroid/util/DisplayMetrics;

    .end local v19    # "remoteDM":Landroid/util/DisplayMetrics;
    invoke-direct/range {v19 .. v19}, Landroid/util/DisplayMetrics;-><init>()V

    .line 560
    .restart local v19    # "remoteDM":Landroid/util/DisplayMetrics;
    ...
    .line 564
    .local v10, "hostConf":Landroid/content/res/Configuration;
    move-object/from16 v0, p0
    ...
    .line 567
    .local v9, "hostCI":Landroid/content/res/CompatibilityInfo;
    new-instance v18, Landroid/content/res/Configuration;

    .end local v18    # "remoteConf":Landroid/content/res/Configuration;
    invoke-direct/range {v18 .. v18}, Landroid/content/res/Configuration;-><init>()V

    .line 568
    .restart local v18    # "remoteConf":Landroid/content/res/Configuration;
    invoke-virtual/range {v20 .. v20}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;
    ...
    invoke-virtual {v0, v10, v11, v9}, Landroid/content/res/Resources;->updateConfiguration(Landroid/content/res/Configuration;Landroid/util/DisplayMetrics;Landroid/content/res/CompatibilityInfo;)V

    .line 575
    .end local v9    # "hostCI":Landroid/content/res/CompatibilityInfo;
    .end local v10    # "hostConf":Landroid/content/res/Configuration;
    :cond_0
    ...
    invoke-virtual {v12, v0}, Landroid/view/LayoutInflater;->cloneInContext(Landroid/content/Context;)Landroid/view/LayoutInflater;

    move-result-object v12

    .line 578
    sget-object v21, Landroid/appwidget/AppWidgetHostView;->sInflaterFilter:Landroid/view/LayoutInflater$Filter;

    move-object/from16 v0, v21

    invoke-virtual {v12, v0}, Landroid/view/LayoutInflater;->setFilter(Landroid/view/LayoutInflater$Filter;)V
    ...
    iget v0, v0, Landroid/appwidget/AppWidgetHostView;->mAppWidgetId:I

    move/from16 v21, v0

    move/from16 v0, v21

    invoke-virtual {v15, v0}, Landroid/appwidget/AppWidgetManager;->getAppWidgetOptions(I)Landroid/os/Bundle;
    ...
    iget v14, v0, Landroid/appwidget/AppWidgetProviderInfo;->initialLayout:I
    ...
    iget v13, v0, Landroid/appwidget/AppWidgetProviderInfo;->initialKeyguardLayout:I

    .line 589
    .local v13, "kgLayoutId":I
    if-nez v13, :cond_6

    .line 597
    .end local v4    # "category":I
    .end local v13    # "kgLayoutId":I
    :cond_1
    :goto_0
    move-object/from16 v0, p0

    iget-object v0, v0, Landroid/appwidget/AppWidgetHostView;->mRemoteContext:Landroid/content/Context;
    ...
    invoke-interface/range {v21 .. v23}, Landroid/widget/HwWidgetManager;->createWidgetFactoryHuaWei(Landroid/content/Context;Ljava/lang/String;)Landroid/view/LayoutInflater$Factory;

    move-result-object v21

    move-object/from16 v0, v21

    invoke-virtual {v12, v0}, Landroid/view/LayoutInflater;->setFactory(Landroid/view/LayoutInflater$Factory;)V
    ...
    invoke-virtual {v12, v14, v0, v1}, Landroid/view/LayoutInflater;->inflate(ILandroid/view/ViewGroup;Z)Landroid/view/View;
    ...
    iput v14, v0, Landroid/appwidget/AppWidgetHostView;->mLayoutId:I
    :try_end_0
    ...
    .end local v11    # "hostDM":Landroid/util/DisplayMetrics;
    ...
    .end local v17    # "remoteCI":Landroid/content/res/CompatibilityInfo;
    .end local v18    # "remoteConf":Landroid/content/res/Configuration;
    .end local v19    # "remoteDM":Landroid/util/DisplayMetrics;
    .end local v20    # "theirContext":Landroid/content/Context;
    :goto_2
    if-eqz v7, :cond_4

    .line 628
    const-string v21, "AppWidgetHostView"

    new-instance v22, Ljava/lang/StringBuilder;

    invoke-direct/range {v22 .. v22}, Ljava/lang/StringBuilder;-><init>()V

    const-string v23, "Error inflating AppWidget "
    ...
    .restart local v11    # "hostDM":Landroid/util/DisplayMetrics;
    .restart local v12    # "inflater":Landroid/view/LayoutInflater;
    .restart local v13    # "kgLayoutId":I
    .restart local v14    # "layoutId":I
    .restart local v15    # "manager":Landroid/appwidget/AppWidgetManager;
    .restart local v16    # "options":Landroid/os/Bundle;
    .restart local v17    # "remoteCI":Landroid/content/res/CompatibilityInfo;
    .restart local v18    # "remoteConf":Landroid/content/res/Configuration;
    .restart local v19    # "remoteDM":Landroid/util/DisplayMetrics;
    .restart local v20    # "theirContext":Landroid/content/Context;
    :cond_6
    move v14, v13
    ...
    const-string v22, "can\'t inflate defaultView because mInfo is missing"
