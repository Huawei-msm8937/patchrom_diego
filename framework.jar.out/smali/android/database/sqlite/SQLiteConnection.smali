...
.field private final mIsExclusiveConnection:Z
...
.method private constructor <init>(Landroid/database/sqlite/SQLiteConnectionPool;Landroid/database/sqlite/SQLiteDatabaseConfiguration;IZ)V
    ...
    invoke-direct/range {v0 .. v5}, Landroid/database/sqlite/SQLiteConnection;-><init>(Landroid/database/sqlite/SQLiteConnectionPool;Landroid/database/sqlite/SQLiteDatabaseConfiguration;IZZ)V

    .line 163
    return-void
.end method

.method private constructor <init>(Landroid/database/sqlite/SQLiteConnectionPool;Landroid/database/sqlite/SQLiteDatabaseConfiguration;IZZ)V
    .locals 2
    .param p1, "pool"    # Landroid/database/sqlite/SQLiteConnectionPool;
    .param p2, "configuration"    # Landroid/database/sqlite/SQLiteDatabaseConfiguration;
    .param p3, "connectionId"    # I
    .param p4, "primaryConnection"    # Z
    .param p5, "exclusiveConnection"    # Z
    ...
    .line 175
    iput-boolean p5, p0, Landroid/database/sqlite/SQLiteConnection;->mIsExclusiveConnection:Z
...
.method static openExclusive(Landroid/database/sqlite/SQLiteConnectionPool;Landroid/database/sqlite/SQLiteDatabaseConfiguration;I)Landroid/database/sqlite/SQLiteConnection;
    .locals 7
    .param p0, "pool"    # Landroid/database/sqlite/SQLiteConnectionPool;
    .param p1, "configuration"    # Landroid/database/sqlite/SQLiteDatabaseConfiguration;
    .param p2, "connectionId"    # I
    ...
    invoke-direct {v0, v4}, Landroid/database/sqlite/SQLiteConnection;->dispose(Z)V
...
.method public isExclusiveConnection()Z
    .locals 1

    .prologue
    .line 1532
    iget-boolean v0, p0, Landroid/database/sqlite/SQLiteConnection;->mIsExclusiveConnection:Z
