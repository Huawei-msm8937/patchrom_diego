...
.field private static final MAX_EACH_THRESHOLDE:I = 0x1e

.field private static final MAX_THRESHOLDE:I = 0x64

.field private static final STATS_TAG:Ljava/lang/String; = "CursorWindowStats"

.field private static sCursorMonitor:Landroid/database/CursorResourceWrapper;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/database/CursorWindow;->sCursorMonitor:Landroid/database/CursorResourceWrapper;
...
.method private getStatsByPidLocked(I)I
    .locals 6
...
.method private recordNewWindow(IJ)V
    ...
    .prologue
    .line 723
    sget-object v2, Landroid/database/CursorWindow;->sWindowToPidMap:Landroid/util/LongSparseArray;

    monitor-enter v2

    .line 725
    :try_start_0
    sget-object v1, Landroid/database/CursorWindow;->sCursorMonitor:Landroid/database/CursorResourceWrapper;
    ...
    .line 727
    invoke-direct {p0, p1}, Landroid/database/CursorWindow;->getStatsByPidLocked(I)I
    ...
    invoke-virtual {v1, p1, v3, v0}, Landroid/database/CursorResourceWrapper;->acquireLocked(III)Z
    ...
    const-string v4, "Created too many Cursor windows."
    ...
    invoke-direct {v1, v3}, Landroid/database/CursorWindowAllocationException;-><init>(Ljava/lang/String;)V

    throw v1

    .line 740
    .end local v0    # "usage":I
    :catchall_0
    move-exception v1
    ...
    invoke-virtual {v1, p2, p3, v3}, Landroid/util/LongSparseArray;->put(JLjava/lang/Object;)V
    ...
    const-string v4, "Created a new Cursor. "
...
.method public static setCursorResource(Landroid/database/CursorResourceWrapper;)V
    .locals 2
    .param p0, "crw"    # Landroid/database/CursorResourceWrapper;
    ...
    .line 817
    :try_start_0
    sput-object p0, Landroid/database/CursorWindow;->sCursorMonitor:Landroid/database/CursorResourceWrapper;
