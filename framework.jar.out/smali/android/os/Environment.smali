...
.field public static final EXTRA_VOLUME_NEW_STATE:Ljava/lang/String; = "android.os.storage.extra.VOLUME_NEW_STATE"

.field public static final EXTRA_VOLUME_OLD_STATE:Ljava/lang/String; = "android.os.storage.extra.VOLUME_OLD_STATE"
...
.method public static getEnvExternalStorage()Ljava/lang/String;
    .locals 1
...
.method public static getExternalDirsForApp()[Ljava/io/File;
    .locals 1
...
.method public static getExternalStorageDirectory()Ljava/io/File;
    ...
    invoke-interface {v0}, Landroid/common/HwSettingsManager;->checkPrimaryVolumeIsSD()Z
    ...
    invoke-interface {v1}, Landroid/common/HwSettingsManager;->getExternalStorageDirectory()Ljava/io/File;

    move-result-object v1

    invoke-interface {v0, v1}, Landroid/common/HwSettingsManager;->handleExternalStorageDirectoryForClone(Ljava/io/File;)Ljava/io/File;
...
.method public static getExternalStoragePublicDirectory(Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-interface {v0, p0}, Landroid/common/HwSettingsManager;->getExternalStoragePublicDirectory(Ljava/lang/String;)Ljava/io/File;
...
.method public static getExternalStorageState()Ljava/lang/String;
    ...
    invoke-interface {v1}, Landroid/common/HwSettingsManager;->checkPrimaryVolumeIsSD()Z
    ...
    invoke-interface {v1}, Landroid/common/HwSettingsManager;->getExternalStorageState()Ljava/io/File;
...
.method public static initForCurrentUser()V
    ...
    invoke-interface {v1, v0}, Landroid/common/HwSettingsManager;->initUserEnvironmentSD(I)V
