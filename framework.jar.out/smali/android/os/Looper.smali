...
.method public static loop()V
    ...
    .line 178
    .end local v2    # "logging":Landroid/util/Printer;
    .end local v6    # "newIdent":J
    :cond_5
    iget-object v2, v3, Landroid/os/Looper;->mLogging:Landroid/util/Printer;

    .line 179
    .restart local v2    # "logging":Landroid/util/Printer;
    if-eqz v2, :cond_6
    ...
    .line 189
    invoke-static {v8, v9, v4}, Landroid/os/BlockMonitor;->checkMessageTime(JLandroid/os/Message;)V

    .line 190
    invoke-static {v5}, Landroid/os/BlockMonitor;->checkMessageCount(Landroid/os/MessageQueue;)V
