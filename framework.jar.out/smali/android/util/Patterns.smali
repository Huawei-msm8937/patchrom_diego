...
.field public static final DOMAIN_NAME_EMUI:Ljava/util/regex/Pattern;
...
.field private static final GOOD_GTLD_CHAR_EMUI:Ljava/lang/String; = "a-zA-Z"

.field public static final GOOD_IRI_CHAR:Ljava/lang/String; = "a-zA-Z0-9\u00a0-\ud7ff\uf900-\ufdcf\ufdf0-\uffef"

.field public static final GOOD_IRI_CHAR_EMUI:Ljava/lang/String; = "a-zA-Z0-9"

.field private static final GTLD:Ljava/lang/String; = "[a-zA-Z\u00a0-\ud7ff\uf900-\ufdcf\ufdf0-\uffef]{2,63}"

.field private static final GTLD_EMUI:Ljava/lang/String; = "[a-zA-Z]{2,63}"
...
.field private static final HOST_NAME_EMUI:Ljava/lang/String; = "([a-zA-Z0-9]([a-zA-Z0-9\\-]{0,61}[a-zA-Z0-9]){0,1}\\.)+[a-zA-Z]{2,63}"
...
.field private static final IRI_EMUI:Ljava/lang/String; = "[a-zA-Z0-9]([a-zA-Z0-9\\-]{0,61}[a-zA-Z0-9]){0,1}"
...
.field public static final WEB_URL_ORIGINAL:Ljava/util/regex/Pattern;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/util/Patterns;->DOMAIN_NAME_EMUI:Ljava/util/regex/Pattern;
    ...
    sget-object v1, Landroid/util/Patterns;->DOMAIN_NAME_EMUI:Ljava/util/regex/Pattern;
    ...
    const-string v1, "\\-\\.\\+\\!\\*\\\'\\(\\)\\,\\_])|(?:\\%[a-fA-F0-9]{2}))+[\\;\\.\\=\\?\\/\\+\\)][a-zA-Z0-9\\%\\#\\&\\-\\_\\.\\~]*)"
    ...
    sput-object v0, Landroid/util/Patterns;->WEB_URL_ORIGINAL:Ljava/util/regex/Pattern;
...
.method public static getWebUrl()Ljava/util/regex/Pattern;
    ...
    :cond_0
    sget-object v0, Landroid/util/Patterns;->WEB_URL_ORIGINAL:Ljava/util/regex/Pattern;

    goto :goto_0
.end method

.method public static setUserOriginalUrlPattern(Z)V
    .locals 0
    .param p0, "isUseOriginal"    # Z
