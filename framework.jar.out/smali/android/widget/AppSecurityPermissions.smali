...
.method private static getPermissionItemView(Landroid/content/Context;Landroid/view/LayoutInflater;Landroid/widget/AppSecurityPermissions$MyPermissionGroupInfo;Landroid/widget/AppSecurityPermissions$MyPermissionInfo;ZLjava/lang/CharSequence;Ljava/lang/String;Z)Landroid/widget/AppSecurityPermissions$PermissionItemView;
    ...
    :goto_1
    invoke-static {v1, p1}, Landroid/hwcontrol/HwWidgetFactory$PermissionInformation;->getHwPermItemView(ZLandroid/view/LayoutInflater;)Landroid/widget/AppSecurityPermissions$PermissionItemView;
    ...
    .line 518
    .restart local v0    # "permView":Landroid/widget/AppSecurityPermissions$PermissionItemView;
    :cond_1
    const/4 v1, 0x0
...
.method private static getPermissionItemViewOld(Landroid/content/Context;Landroid/view/LayoutInflater;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ZLandroid/graphics/drawable/Drawable;)Landroid/view/View;
    ...
    invoke-static {p1}, Landroid/hwcontrol/HwWidgetFactory$PermissionInformation;->getPermissionItemViewOld(Landroid/view/LayoutInflater;)Landroid/view/View;
    ...
    invoke-static {v3}, Landroid/hwcontrol/HwWidgetFactory$PermissionInformation;->getPermissionItemViewOldPermGrpView(Landroid/view/View;)Landroid/widget/TextView;

    move-result-object v2

    .line 536
    invoke-static {v3}, Landroid/hwcontrol/HwWidgetFactory$PermissionInformation;->getPermissionItemViewOldPermDescView(Landroid/view/View;)Landroid/widget/TextView;

    move-result-object v1

    .line 537
    invoke-static {v3}, Landroid/hwcontrol/HwWidgetFactory$PermissionInformation;->getPermissionItemViewOldImgView(Landroid/view/View;)Landroid/widget/ImageView;
