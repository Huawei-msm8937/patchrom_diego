...
.method public onClick(Landroid/view/View;)V
    ...
    invoke-static {v2, v6}, Landroid/hwcontrol/HwWidgetFactory$PermissionInformation;->setPositiveButton(Landroid/app/AlertDialog$Builder;Landroid/app/AlertDialog;)V
...
.method public setPermission(Landroid/widget/AppSecurityPermissions$MyPermissionGroupInfo;Landroid/widget/AppSecurityPermissions$MyPermissionInfo;ZLjava/lang/CharSequence;Ljava/lang/String;Z)V
    ...
    invoke-static {p0}, Landroid/hwcontrol/HwWidgetFactory$PermissionInformation;->getPermissionImageView(Landroid/widget/AppSecurityPermissions$PermissionItemView;)Landroid/view/View;

    move-result-object v5

    .end local v5    # "permGrpIcon":Landroid/widget/ImageView;
    check-cast v5, Landroid/widget/ImageView;

    .line 157
    .restart local v5    # "permGrpIcon":Landroid/widget/ImageView;
    invoke-static {p0}, Landroid/hwcontrol/HwWidgetFactory$PermissionInformation;->getPermissionTextView(Landroid/widget/AppSecurityPermissions$PermissionItemView;)Landroid/view/View;

    move-result-object v6

    .end local v6    # "permNameView":Landroid/widget/TextView;
    check-cast v6, Landroid/widget/TextView;

    .line 159
    .restart local v6    # "permNameView":Landroid/widget/TextView;
    const/4 v1, 0x0
    ...
    invoke-static {p4, v4, v7}, Landroid/text/TextUtils;->writeToParcel(Ljava/lang/CharSequence;Landroid/os/Parcel;I)V
