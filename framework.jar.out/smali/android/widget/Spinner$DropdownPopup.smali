...
.field private mHwListPopupWindow:Landroid/hwcontrol/HwWidgetFactory$HwListPopupWindow;
...
.method public constructor <init>(Landroid/widget/Spinner;Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    .line 1148
    iput-object v1, p0, Landroid/widget/Spinner$DropdownPopup;->mHwListPopupWindow:Landroid/hwcontrol/HwWidgetFactory$HwListPopupWindow;

    .line 1149
    iput-object v1, p0, Landroid/widget/Spinner$DropdownPopup;->mPopupWindow:Landroid/widget/PopupWindow;

    .line 1154
    invoke-static {p2, p3, p4, p5}, Landroid/hwcontrol/HwWidgetFactory;->getHwListPopupWindow(Landroid/content/Context;Landroid/util/AttributeSet;II)Landroid/widget/ListPopupWindow;

    move-result-object v0

    .line 1155
    .local v0, "listPopupWindow":Landroid/widget/ListPopupWindow;
    instance-of v1, v0, Landroid/hwcontrol/HwWidgetFactory$HwListPopupWindow;

    if-eqz v1, :cond_0

    .line 1156
    check-cast v0, Landroid/hwcontrol/HwWidgetFactory$HwListPopupWindow;

    .end local v0    # "listPopupWindow":Landroid/widget/ListPopupWindow;
    iput-object v0, p0, Landroid/widget/Spinner$DropdownPopup;->mHwListPopupWindow:Landroid/hwcontrol/HwWidgetFactory$HwListPopupWindow;

    .line 1157
    iget-object v1, p0, Landroid/widget/Spinner$DropdownPopup;->mHwListPopupWindow:Landroid/hwcontrol/HwWidgetFactory$HwListPopupWindow;

    invoke-interface {v1}, Landroid/hwcontrol/HwWidgetFactory$HwListPopupWindow;->getPopup()Landroid/widget/PopupWindow;
    ...
    .line 1158
    iget-object v1, p0, Landroid/widget/Spinner$DropdownPopup;->mPopupWindow:Landroid/widget/PopupWindow;

    invoke-virtual {p0, v1}, Landroid/widget/Spinner$DropdownPopup;->setPopup(Landroid/widget/PopupWindow;)V
...
.method protected popupShow(Landroid/view/View;)V
    .locals 1
    .param p1, "anchorView"    # Landroid/view/View;

    .prologue
    .line 1185
    iget-object v0, p0, Landroid/widget/Spinner$DropdownPopup;->mHwListPopupWindow:Landroid/hwcontrol/HwWidgetFactory$HwListPopupWindow;
    ...
    invoke-interface {v0}, Landroid/hwcontrol/HwWidgetFactory$HwListPopupWindow;->setHwFullDim()V

    .line 1187
    iget-object v0, p0, Landroid/widget/Spinner$DropdownPopup;->mHwListPopupWindow:Landroid/hwcontrol/HwWidgetFactory$HwListPopupWindow;

    invoke-interface {v0, p1}, Landroid/hwcontrol/HwWidgetFactory$HwListPopupWindow;->popupShow(Landroid/view/View;)V
    ...
    .line 1189
    :cond_0
    invoke-super {p0, p1}, Landroid/widget/ListPopupWindow;->popupShow(Landroid/view/View;)V

    goto :goto_0
.end method

.method protected popupUpdate(Landroid/view/View;II)V
    .locals 1
    .param p1, "anchorView"    # Landroid/view/View;
    ...
    invoke-interface {v0, p1, p2, p3}, Landroid/hwcontrol/HwWidgetFactory$HwListPopupWindow;->popupUpdate(Landroid/view/View;II)V
    ...
    .line 1180
    :cond_0
    invoke-super {p0, p1, p2, p3}, Landroid/widget/ListPopupWindow;->popupUpdate(Landroid/view/View;II)V
