...
.field protected mDropDownGravity:I

.field private mDropDownHeight:I

.field protected mDropDownHorizontalOffset:I

.field private mDropDownList:Landroid/widget/ListPopupWindow$DropDownListView;

.field private mDropDownListHighlight:Landroid/graphics/drawable/Drawable;

.field protected mDropDownVerticalOffset:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    .line 241
    invoke-virtual {p0, p1, p2}, Landroid/widget/ListPopupWindow;->setEmuiBackground(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method private buildDropDown()I
    ...
    .line 1230
    :cond_c
    invoke-virtual/range {p0 .. p0}, Landroid/widget/ListPopupWindow;->setHuaweiScrollIndicators()V
...
.method protected getPopup()Landroid/widget/PopupWindow;
    .locals 1
...
.method protected setEmuiBackground(Landroid/content/Context;Landroid/util/AttributeSet;)V
    .locals 2
    .param p1, "context"    # Landroid/content/Context;
    .param p2, "attrs"    # Landroid/util/AttributeSet;
...
.method protected setHuaweiScrollIndicators()V
    .locals 0
...
.method protected setPopup(Landroid/widget/PopupWindow;)V
    .locals 0
    .param p1, "popup"    # Landroid/widget/PopupWindow;

    .prologue
    .line 1894
    iput-object p1, p0, Landroid/widget/ListPopupWindow;->mPopup:Landroid/widget/PopupWindow;
...
.method public show()V
    ...
    :goto_0
    invoke-virtual {v8, v4}, Landroid/widget/PopupWindow;->setAllowScrollingAnchorParent(Z)V

    .line 602
    iget-object v4, p0, Landroid/widget/ListPopupWindow;->mPopup:Landroid/widget/PopupWindow;

    iget v8, p0, Landroid/widget/ListPopupWindow;->mDropDownWindowLayoutType:I
    ...
    :goto_3
    invoke-virtual {v8, v4}, Landroid/widget/PopupWindow;->setWidth(I)V
    ...
    :goto_7
    invoke-virtual {p0, v5, v4, v7}, Landroid/widget/ListPopupWindow;->popupUpdate(Landroid/view/View;II)V
    ...
    invoke-virtual {v4, v5}, Landroid/widget/PopupWindow;->setClipToScreenEnabled(Z)V
    ...
    invoke-virtual {p0, v4}, Landroid/widget/ListPopupWindow;->popupShow(Landroid/view/View;)V

    .line 675
    iget-object v4, p0, Landroid/widget/ListPopupWindow;->mDropDownList:Landroid/widget/ListPopupWindow$DropDownListView;

    invoke-virtual {v4, v7}, Landroid/widget/ListPopupWindow$DropDownListView;->setSelection(I)V
    ...
    invoke-virtual {v4}, Landroid/widget/ListPopupWindow$DropDownListView;->isInTouchMode()Z
