...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    iput-object v9, p0, Landroid/widget/Switch;->mThumbTintList:Landroid/content/res/ColorStateList;

    .line 95
    const/4 v9, 0x0

    iput-object v9, p0, Landroid/widget/Switch;->mThumbTintMode:Landroid/graphics/PorterDuff$Mode;
    ...
    iput-object v9, p0, Landroid/widget/Switch;->mTrackTintList:Landroid/content/res/ColorStateList;

    .line 101
    const/4 v9, 0x0

    iput-object v9, p0, Landroid/widget/Switch;->mTrackTintMode:Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-static {v8, p1, v9}, Landroid/hwcontrol/HwWidgetFactory;->getTrackDrawable(Landroid/util/TypedValue;Landroid/content/Context;Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    iput-boolean v9, p0, Landroid/widget/Switch;->mShowText:Z
    ...
    iput-boolean v9, p0, Landroid/widget/Switch;->mSplitTrack:Z
    ...
    iget-object v9, p0, Landroid/widget/Switch;->mThumbTintMode:Landroid/graphics/PorterDuff$Mode;
    ...
    .line 263
    :cond_3
    iget-boolean v9, p0, Landroid/widget/Switch;->mHasThumbTint:Z

    if-nez v9, :cond_4

    iget-boolean v9, p0, Landroid/widget/Switch;->mHasThumbTintMode:Z
    ...
    iget-object v9, p0, Landroid/widget/Switch;->mTrackTintMode:Landroid/graphics/PorterDuff$Mode;
    ...
    .line 279
    :cond_7
    iget-boolean v9, p0, Landroid/widget/Switch;->mHasTrackTint:Z

    if-nez v9, :cond_8

    iget-boolean v9, p0, Landroid/widget/Switch;->mHasTrackTintMode:Z
...
.method private getThumbOffset()I
    ...
    .prologue
    .line 1318
    invoke-virtual {p0}, Landroid/widget/Switch;->isRtlLocale()Z
