...
.super Landroid/content/res/AbsResources;
...
.field private static final ROUNDING_NUMBER:F = 0.5f
...
.field private static final mNavigationBarHeight:I
...
.field private final mHwStateListAnimatorCache:Landroid/content/res/ConfigurationBoundResourceCache;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroid/content/res/ConfigurationBoundResourceCache",
            "<",
...
.method static constructor <clinit>()V
    ...
    .line 116
    const-string/jumbo v0, "ro.config.navigation_bar_height"

    invoke-static {v0, v2}, Landroid/os/SystemProperties;->getInt(Ljava/lang/String;I)I

    move-result v0

    sput v0, Landroid/content/res/Resources;->mNavigationBarHeight:I
...
.method public constructor <init>()V
    ...
    .line 2961
    invoke-direct {p0}, Landroid/content/res/AbsResources;-><init>()V
    ...
    iput-object v0, p0, Landroid/content/res/Resources;->mHwStateListAnimatorCache:Landroid/content/res/ConfigurationBoundResourceCache;
...
.method public constructor <init>(Landroid/content/res/AssetManager;Landroid/util/DisplayMetrics;Landroid/content/res/Configuration;)V
    ...
    iget v1, p2, Landroid/util/DisplayMetrics;->noncompatDensity:F
...
.method public constructor <init>(Landroid/content/res/AssetManager;Landroid/util/DisplayMetrics;Landroid/content/res/Configuration;Landroid/content/res/CompatibilityInfo;)V
    ...
    .line 301
    :cond_0
    invoke-virtual {p0, p3}, Landroid/content/res/Resources;->setHwTheme(Landroid/content/res/Configuration;)V
...
.method private calcConfigChanges(Landroid/content/res/Configuration;)I
    ...
    invoke-virtual {v2, v3, v1, v4}, Landroid/content/res/CompatibilityInfo;->applyToConfigurationExt(Landroid/util/DisplayMetrics;ILandroid/content/res/Configuration;)V
...
.method public static getSystem()Landroid/content/res/Resources;
    ...
    .line 318
    invoke-static {}, Landroid/hwtheme/HwThemeManager;->getResources()Landroid/content/res/Resources;
...
.method public static getSystem(Z)Landroid/content/res/Resources;
    .locals 3
    ...
    .line 332
    invoke-static {p0}, Landroid/hwtheme/HwThemeManager;->getResources(Z)Landroid/content/res/Resources;
...
.method protected getColorStateListCache()Landroid/content/res/ConfigurationBoundResourceCache;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public getDimension(I)F
    ...
    sget v1, Landroid/content/res/Resources;->mNavigationBarHeight:I
...
.method public getHwStateListAnimatorCache()Landroid/content/res/ConfigurationBoundResourceCache;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .prologue
    .line 3003
    iget-object v0, p0, Landroid/content/res/Resources;->mHwStateListAnimatorCache:Landroid/content/res/ConfigurationBoundResourceCache;
...
.method protected loadDrawable(Landroid/util/TypedValue;ILandroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;
    .locals 18
    .param p1, "value"    # Landroid/util/TypedValue;
    .param p2, "id"    # I
    .param p3, "theme"    # Landroid/content/res/Resources$Theme;
    ...
    invoke-virtual {v0, v1, v12}, Landroid/content/res/Resources;->handleAddIconBackground(ILandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
...
.method public updateConfiguration(Landroid/content/res/Configuration;Landroid/util/DisplayMetrics;Landroid/content/res/CompatibilityInfo;)V
    ...
    invoke-virtual/range {v2 .. v20}, Landroid/content/res/AssetManager;->setConfiguration(IILjava/lang/String;IIIIIIIIIIIIIIZ)V
    ...
    iget-object v2, v0, Landroid/content/res/Resources;->mHwStateListAnimatorCache:Landroid/content/res/ConfigurationBoundResourceCache;
    ...
    .end local v15    # "screenWidthDp":I
    .end local v16    # "screenHeightDp":I
    .end local v22    # "realDpi":I
    .end local v23    # "rogwidth":I
    .end local v24    # "srcDpi":I
    :cond_9
    :try_start_2
    move-object/from16 v0, p0
    ...
    .restart local v15    # "screenWidthDp":I
    .restart local v16    # "screenHeightDp":I
    .restart local v21    # "configChanges":I
    .restart local v22    # "realDpi":I
    .restart local v23    # "rogwidth":I
    .restart local v24    # "srcDpi":I
    :catchall_1
    move-exception v2
