...
.method public cancelLearning()V
    ...
    const-string v2, "failed to cancelLearning; no consumer ir service."
    ...
    const-string v2, "cancelLearning I"
    ...
    invoke-interface {v1}, Landroid/hardware/IConsumerIrService;->cancelLearn()V
    :try_end_0
    ...
    const-string v2, "failed to cancle learn ir."
...
.method public learnIR(I)[I
    ...
    const-string v3, "failed to learnIR; no consumer ir service."
    ...
    invoke-interface {v2, p1}, Landroid/hardware/IConsumerIrService;->learnIR(I)[I
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v3, "failed to learn IR."
