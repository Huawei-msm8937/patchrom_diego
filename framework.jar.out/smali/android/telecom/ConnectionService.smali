...
.method static synthetic access$2700(Landroid/telecom/ConnectionService;)I
    .locals 1
    .param p0, "x0"    # Landroid/telecom/ConnectionService;
...
.method static synthetic access$2702(Landroid/telecom/ConnectionService;I)I
    .locals 0
    .param p0, "x0"    # Landroid/telecom/ConnectionService;
    .param p1, "x1"    # I
...
.method private createConnection(Landroid/telecom/PhoneAccountHandle;Ljava/lang/String;Landroid/telecom/ConnectionRequest;ZZ)V
    ...
    .line 686
    .local v22, "connection":Landroid/telecom/Connection;
    :goto_0
    ...
    .line 692
    :cond_0
    invoke-virtual/range {v22 .. v22}, Landroid/telecom/Connection;->getState()I
    ...
    invoke-virtual/range {v22 .. v22}, Landroid/telecom/Connection;->getConnectionCapabilities()I
    ...
    invoke-virtual/range {v22 .. v22}, Landroid/telecom/Connection;->getAddress()Landroid/net/Uri;

    move-result-object v8

    invoke-virtual/range {v22 .. v22}, Landroid/telecom/Connection;->getAddressPresentation()I

    move-result v9

    invoke-virtual/range {v22 .. v22}, Landroid/telecom/Connection;->getCallerDisplayName()Ljava/lang/String;

    move-result-object v10

    invoke-virtual/range {v22 .. v22}, Landroid/telecom/Connection;->getCallerDisplayNamePresentation()I

    move-result v11

    invoke-virtual/range {v22 .. v22}, Landroid/telecom/Connection;->getVideoProvider()Landroid/telecom/Connection$VideoProvider;
    ...
    :goto_1
    invoke-virtual/range {v22 .. v22}, Landroid/telecom/Connection;->getVideoState()I

    move-result v13

    invoke-virtual/range {v22 .. v22}, Landroid/telecom/Connection;->isRingbackRequested()Z

    move-result v14

    invoke-virtual/range {v22 .. v22}, Landroid/telecom/Connection;->getAudioModeIsVoip()Z

    move-result v15

    invoke-virtual/range {v22 .. v22}, Landroid/telecom/Connection;->getConnectTimeMillis()J

    move-result-wide v16

    invoke-virtual/range {v22 .. v22}, Landroid/telecom/Connection;->getStatusHints()Landroid/telecom/StatusHints;

    move-result-object v18

    invoke-virtual/range {v22 .. v22}, Landroid/telecom/Connection;->getDisconnectCause()Landroid/telecom/DisconnectCause;

    move-result-object v19

    invoke-virtual/range {v22 .. v22}, Landroid/telecom/Connection;->getConferenceables()Ljava/util/List;
    ...
    invoke-virtual/range {v22 .. v22}, Landroid/telecom/Connection;->getExtras()Landroid/os/Bundle;
    ...
    .line 683
    .end local v22    # "connection":Landroid/telecom/Connection;
    :cond_2
    if-eqz p4, :cond_3
    ...
    .line 707
    .restart local v22    # "connection":Landroid/telecom/Connection;
    :cond_4
    invoke-virtual/range {v22 .. v22}, Landroid/telecom/Connection;->getVideoProvider()Landroid/telecom/Connection$VideoProvider;
