...
.field public static final HISI_AP_START_BEGIN:Ljava/lang/String; = "hisi_ap_start_begin"
...
.field public static final PPPOE_BASE:I = 0x90000
...
.field public static final PPPOE_START:I = 0x90001
...
.field public static final PPPOE_STOP:I = 0x90002
...
.method static constructor <clinit>()V
    ...
    :goto_0
    sput-boolean v0, Landroid/net/wifi/WifiManager;->HWFLOW:Z
...
.method private init()V
    ...
    const-string v5, "Enter init, sThreadRefCount:"

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    sget v5, Landroid/net/wifi/WifiManager;->sThreadRefCount:I
    ...
    const-string v5, "WifiServiceMessenger == null"
    ...
    const-string v5, "Create WifiManager handlerthread"
...
.method public cancelWps(Landroid/net/wifi/WifiManager$WpsCallback;)V
    ...
    .prologue
    .line 2330
    sget-boolean v0, Landroid/net/wifi/WifiManager;->HWFLOW:Z
...
.method public connect(Landroid/net/wifi/WifiConfiguration;Landroid/net/wifi/WifiManager$ActionListener;)V
    ...
    iput v0, p1, Landroid/net/wifi/WifiConfiguration;->callingPid:I
...
.method public getPPPOEInfo()Landroid/net/wifi/PPPOEInfo;
    ...
    invoke-interface {v1}, Landroid/net/wifi/HwInnerWifiManager;->getPPPOEInfo()Landroid/net/wifi/PPPOEInfo;
...
.method public setWifiApStateByManual(Z)V
    ...
    invoke-interface {v1, p1}, Landroid/net/wifi/IWifiManager;->setWifiApStateByManual(Z)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string/jumbo v2, "setWifiApStateByManual exception:"
...
.method public setWifiEnableForP2p(Z)V
    ...
    invoke-interface {v1, p1}, Landroid/net/wifi/IWifiManager;->setWifiEnableForP2p(Z)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string/jumbo v2, "setWifiEnableForP2p exception:"
...
.method public setWifiStateByManual(Z)V
    ...
    invoke-interface {v1, p1}, Landroid/net/wifi/IWifiManager;->setWifiStateByManual(Z)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string/jumbo v2, "setWifiStateByManual exception:"
...
.method public startPPPOE(Landroid/net/wifi/PPPOEConfig;)V
    ...
    invoke-interface {v0, p1}, Landroid/net/wifi/HwInnerWifiManager;->startPPPOE(Landroid/net/wifi/PPPOEConfig;)V
...
.method public stopPPPOE()V
    ...
    invoke-interface {v0}, Landroid/net/wifi/HwInnerWifiManager;->stopPPPOE()V
