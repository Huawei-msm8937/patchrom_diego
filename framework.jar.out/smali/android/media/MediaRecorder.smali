...
.field public static final RECORDSTATE_STARTED:I = 0x3
...
.field private mPerm:Landroid/hsm/HwMediaPermWrapper;
...
.method public constructor <init>()V
    ...
    .line 110
    new-instance v2, Landroid/hsm/HwMediaPermWrapper;

    invoke-direct {v2}, Landroid/hsm/HwMediaPermWrapper;-><init>()V

    iput-object v2, p0, Landroid/media/MediaRecorder;->mPerm:Landroid/hsm/HwMediaPermWrapper;
...
# virtual methods
.method public native _setOutputFile(Ljava/io/FileDescriptor;JJ)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/IllegalStateException;,
            Ljava/io/IOException;
...
.method public prepare()V
    ...
    .line 820
    iget-object v1, p0, Landroid/media/MediaRecorder;->mPerm:Landroid/hsm/HwMediaPermWrapper;
    ...
    invoke-virtual/range {v1 .. v7}, Landroid/hsm/HwMediaPermWrapper;->setOutputFile(Landroid/media/MediaRecorder;Ljava/lang/String;JJ)V
    ...
    invoke-virtual/range {v1 .. v7}, Landroid/hsm/HwMediaPermWrapper;->setOutputFile(Landroid/media/MediaRecorder;Ljava/io/FileDescriptor;JJ)V
...
.method public setPreviewDisplay(Landroid/view/Surface;)V
    ...
    .prologue
    .line 200
    iget-object v0, p0, Landroid/media/MediaRecorder;->mPerm:Landroid/hsm/HwMediaPermWrapper;

    invoke-virtual {v0, p1}, Landroid/hsm/HwMediaPermWrapper;->setPreviewDisplay(Landroid/view/Surface;)Landroid/view/Surface;

    move-result-object v0

    iput-object v0, p0, Landroid/media/MediaRecorder;->mSurface:Landroid/view/Surface;
...
.method public setUse64bitOffset(I)V
    .locals 3
    .param p1, "bUse64BitOffset"    # I
    ...
    const-string/jumbo v2, "setUse64bitOffset param-use-64bit-offset="
...
.method public setVideoSource(I)V
    ...
    invoke-virtual {v0}, Landroid/hsm/HwMediaPermWrapper;->confirmCameraPermission()V
...
.method public start()V
    ...
    .line 1155
    invoke-static {}, Landroid/common/HwFrameworkFactory;->getHwMediaRecorder()Landroid/media/IHwMediaRecorder;

    move-result-object v0

    invoke-interface {v0}, Landroid/media/IHwMediaRecorder;->checkRecordActive()V
    ...
    invoke-interface {v0, v1}, Landroid/media/IHwMediaRecorder;->sendStateChangedIntent(I)V
