...
.method private deleteFile(Ljava/io/File;)V
    ...
    const-string v3, "Delete the .nomedia file in the root directory."
    ...
    invoke-direct {p0, v2}, Landroid/media/MediaScanner;->deleteFile(Ljava/io/File;)V
...
.method private initialize(Ljava/lang/String;)V
    ...
    invoke-interface {v0, v1}, Landroid/common/HwMediaScannerManager;->getExtSdcardVolumePath(Landroid/content/Context;)Ljava/lang/String;

    move-result-object v0

    iput-object v0, p0, Landroid/media/MediaScanner;->mExtStroagePath:Ljava/lang/String;
    ...
    iget-object v2, p0, Landroid/media/MediaScanner;->mExtStroagePath:Ljava/lang/String;

    iget-object v3, p0, Landroid/media/MediaScanner;->mPackageName:Ljava/lang/String;

    iget-object v4, p0, Landroid/media/MediaScanner;->mFilesUriNoNotify:Landroid/net/Uri;

    invoke-interface {v0, v1, v2, v3, v4}, Landroid/common/HwMediaScannerManager;->isSkipExtSdcard(Landroid/content/IContentProvider;Ljava/lang/String;Ljava/lang/String;Landroid/net/Uri;)Z
...
.method private prescan(Ljava/lang/String;Z)V
    ...
    .line 1202
    new-instance v26, Landroid/media/MediaScanner$MediaBulkDeleter;
    ...
    .line 1207
    .local v26, "deleter":Landroid/media/MediaScanner$MediaBulkDeleter;
    if-eqz p2, :cond_2
    ...
    const-string v15, "_data is null and media_type != 4"

    const/16 v16, 0x0

    move-object/from16 v0, v16

    invoke-interface {v2, v3, v5, v15, v0}, Landroid/content/IContentProvider;->delete(Ljava/lang/String;Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    .line 1287
    :cond_3
    invoke-virtual/range {v26 .. v26}, Landroid/media/MediaScanner$MediaBulkDeleter;->flush()V
    ...
    .end local v26    # "deleter":Landroid/media/MediaScanner$MediaBulkDeleter;
    :cond_6
    move-object/from16 v0, p0
    ...
    .restart local v26    # "deleter":Landroid/media/MediaScanner$MediaBulkDeleter;
    ...
    .line 1259
    .local v32, "mediaFileType":Landroid/media/MediaFile$MediaFileType;
    if-nez v32, :cond_c
    ...
    .end local v32    # "mediaFileType":Landroid/media/MediaFile$MediaFileType;
    .end local v33    # "num":I
    ...
    .restart local v32    # "mediaFileType":Landroid/media/MediaFile$MediaFileType;
...
.method private setDefaultRingtoneFileNames()V
    ...
    invoke-interface {v0}, Landroid/common/HwMediaScannerManager;->setHwDefaultRingtoneFileNames()V
...
# virtual methods
.method public native addSkipCustomDirectory(Ljava/lang/String;I)V
.end method

.method public native clearSkipCustomDirectory()V
.end method
...
.method public postscan([Ljava/lang/String;)V
    .locals 3
    ...
    invoke-interface {v0}, Landroid/common/HwMediaScannerManager;->pruneDeadThumbnailsFolder()V
...
.method public scanCustomDirectories([Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;[Ljava/lang/String;)V
    ...
    .param p4, "blackList"    # [Ljava/lang/String;
    ...
    invoke-direct {v0, v1, v2, v3}, Landroid/media/MediaInserter;-><init>(Landroid/content/IContentProvider;Ljava/lang/String;I)V
    ...
    invoke-interface {v0, v1}, Landroid/common/HwMediaScannerManager;->setMediaInserter(Landroid/media/MediaInserter;)V

    .line 1538
    const-string v0, "MediaScanner"

    const-string v1, "delete nomedia File when scanCustomDirectories"
    ...
    .line 1540
    .local v8, "rootNomedia":Ljava/lang/String;
    new-instance v7, Ljava/io/File;

    invoke-direct {v7, v8}, Ljava/io/File;-><init>(Ljava/lang/String;)V

    .line 1541
    .local v7, "rootMediaFile":Ljava/io/File;
    invoke-direct {p0, v7}, Landroid/media/MediaScanner;->deleteFile(Ljava/io/File;)V
    ...
    invoke-interface/range {v0 .. v6}, Landroid/common/HwMediaScannerManager;->scanCustomDirectories(Landroid/media/MediaScanner;Landroid/media/MediaScanner$MyMediaScannerClient;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;[Ljava/lang/String;)V

    .line 1546
    invoke-virtual {p0}, Landroid/media/MediaScanner;->clearSkipCustomDirectory()V
    ...
    invoke-interface {v0, v9}, Landroid/common/HwMediaScannerManager;->setMediaInserter(Landroid/media/MediaInserter;)V
...
.method public scanDirectories([Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v13, "delete nomedia File when scanDirectories"
    ...
    .line 1484
    .local v7, "rootNomedia":Ljava/lang/String;
    new-instance v6, Ljava/io/File;

    invoke-direct {v6, v7}, Ljava/io/File;-><init>(Ljava/lang/String;)V

    .line 1485
    .local v6, "rootMediaFile":Ljava/io/File;
    move-object/from16 v0, p0

    invoke-direct {v0, v6}, Landroid/media/MediaScanner;->deleteFile(Ljava/io/File;)V
    ...
    iget-object v12, v0, Landroid/media/MediaScanner;->mFileCache:Ljava/util/HashMap;
    ...
    iput-object v12, v0, Landroid/media/MediaScanner;->mFileCache:Ljava/util/HashMap;
    ...
    iput-boolean v12, v0, Landroid/media/MediaScanner;->mSkipExternelQuery:Z

    .line 1527
    .end local v3    # "i":I
    .end local v4    # "prescan":J
    .end local v6    # "rootMediaFile":Ljava/io/File;
    .end local v7    # "rootNomedia":Ljava/lang/String;
    .end local v8    # "scan":J
    ...
    iput-boolean v13, v0, Landroid/media/MediaScanner;->mSkipExternelQuery:Z
...
.method public scanMtpFile(Ljava/lang/String;Ljava/lang/String;II)V
    ...
    check-cast v22, Landroid/media/MediaScanner$FileEntry;
...
.method public scanSingleFile(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/net/Uri;
    ...
    const-string v4, "delete nomedia File when scanSingleFile"
    ...
    .line 1570
    .local v15, "rootNomedia":Ljava/lang/String;
    new-instance v14, Ljava/io/File;

    invoke-direct {v14, v15}, Ljava/io/File;-><init>(Ljava/lang/String;)V

    .line 1571
    .local v14, "rootMediaFile":Ljava/io/File;
    move-object/from16 v0, p0

    invoke-direct {v0, v14}, Landroid/media/MediaScanner;->deleteFile(Ljava/io/File;)V
    ...
    .end local v13    # "file":Ljava/io/File;
    .end local v14    # "rootMediaFile":Ljava/io/File;
    .end local v15    # "rootNomedia":Ljava/lang/String;
    :catch_0
    move-exception v2
