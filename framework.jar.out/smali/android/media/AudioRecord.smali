...
.field private mPermission:Landroid/hsm/HwAudioPermWrapper;
...
.method public constructor <init>(Landroid/media/AudioAttributes;Landroid/media/AudioFormat;II)V
    ...
    .line 248
    new-instance v2, Landroid/hsm/HwAudioPermWrapper;

    invoke-direct {v2}, Landroid/hsm/HwAudioPermWrapper;-><init>()V

    move-object/from16 v0, p0

    iput-object v2, v0, Landroid/media/AudioRecord;->mPermission:Landroid/hsm/HwAudioPermWrapper;
...
.method public read([BIII)I
    ...
    iget-object v1, p0, Landroid/media/AudioRecord;->mPermission:Landroid/hsm/HwAudioPermWrapper;

    invoke-virtual {v1}, Landroid/hsm/HwAudioPermWrapper;->isBlocked()Z
    ...
    invoke-virtual {v1, p1, p2, v0}, Landroid/hsm/HwAudioPermWrapper;->mockRead([BII)I
...
.method public read([SIII)I
    ...
    invoke-virtual {v1, p1, p2, v0}, Landroid/hsm/HwAudioPermWrapper;->mockRead([SII)I
...
.method public startRecording()V
    ...
    .line 900
    :cond_0
    iget-object v0, p0, Landroid/media/AudioRecord;->mPermission:Landroid/hsm/HwAudioPermWrapper;

    invoke-virtual {v0}, Landroid/hsm/HwAudioPermWrapper;->confirmPermission()V

    .line 902
    invoke-static {}, Landroid/common/HwFrameworkFactory;->getHwHwAudioRecord()Landroid/media/IHwAudioRecord;

    move-result-object v0

    invoke-interface {v0}, Landroid/media/IHwAudioRecord;->checkRecordActive()V
    ...
    invoke-interface {v0, v1}, Landroid/media/IHwAudioRecord;->sendStateChangedIntent(I)V
