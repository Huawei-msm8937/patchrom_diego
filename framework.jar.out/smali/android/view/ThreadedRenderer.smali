...
.field private mJankDrawData:[J

.field private mJankTrackDraw:Z
...
.method constructor <init>(Landroid/content/Context;Z)V
    ...
    .line 113
    iput-boolean v5, p0, Landroid/view/ThreadedRenderer;->mJankTrackDraw:Z

    .line 114
    new-array v1, v9, [J

    iput-object v1, p0, Landroid/view/ThreadedRenderer;->mJankDrawData:[J
    ...
    .line 120
    invoke-virtual {v0, v9, v6}, Landroid/content/res/TypedArray;->getDimension(IF)F
...
.method draw(Landroid/view/View;Landroid/view/View$AttachInfo;Landroid/view/HardwareRenderer$HardwareDrawCallbacks;)V
    ...
    .line 334
    .local v10, "startdraw":J
    const-wide/16 v12, 0x0

    .line 335
    .local v12, "step1time":J
    const-wide/16 v14, 0x0

    .line 336
    .local v14, "step2time":J
    const-wide/16 v16, 0x0

    .line 337
    .local v16, "step3time":J
    move-object/from16 v0, p0

    iget-boolean v4, v0, Landroid/view/ThreadedRenderer;->mJankTrackDraw:Z

    .line 338
    .local v4, "bJankEnable":Z
    if-eqz v4, :cond_0
    ...
    iget-object v5, v0, Landroid/view/ViewRootImpl;->mChoreographer:Landroid/view/Choreographer;

    .line 343
    .local v5, "choreographer":Landroid/view/Choreographer;
    iget-object v0, v5, Landroid/view/Choreographer;->mFrameInfo:Landroid/view/FrameInfo;

    move-object/from16 v18, v0

    invoke-virtual/range {v18 .. v18}, Landroid/view/FrameInfo;->markDrawStart()V
    ...
    check-cast v18, Landroid/view/RenderNode;

    move-object/from16 v0, p0

    move-object/from16 v1, v18

    invoke-virtual {v0, v1}, Landroid/view/ThreadedRenderer;->registerAnimatingRenderNode(Landroid/view/RenderNode;)V
    ...
    iput-object v0, v1, Landroid/view/View$AttachInfo;->mPendingAnimatingRenderNodes:Ljava/util/List;
    ...
    iget-object v7, v0, Landroid/view/FrameInfo;->mFrameInfo:[J

    .line 368
    .local v7, "frameInfo":[J
    move-object/from16 v0, p0

    iget-wide v0, v0, Landroid/view/ThreadedRenderer;->mNativeProxy:J
    ...
    invoke-static {v0, v1, v7, v2}, Landroid/view/ThreadedRenderer;->nSyncAndDrawFrame(J[JI)I
    ...
    invoke-virtual {v0, v1}, Landroid/view/ThreadedRenderer;->setEnabled(Z)V
    ...
    invoke-virtual/range {v18 .. v18}, Landroid/view/Surface;->release()V
    ...
    invoke-virtual/range {v18 .. v18}, Landroid/view/ViewRootImpl;->invalidate()V
    ...
    iget-object v0, v0, Landroid/view/ThreadedRenderer;->mJankDrawData:[J
...
.method getJankDrawData(I)J
    ...
    iget-object v0, p0, Landroid/view/ThreadedRenderer;->mJankDrawData:[J
...
.method loadSystemProperties()Z
    ...
    iput-boolean v1, p0, Landroid/view/ThreadedRenderer;->mJankTrackDraw:Z
