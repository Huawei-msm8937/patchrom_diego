...
.field mLastSrvView:Landroid/view/View;
...
.field mSecImmHelper:Landroid/view/inputmethod/IHwSecImmHelper;
...
.method constructor <init>(Lcom/android/internal/view/IInputMethodManager;Landroid/os/Looper;)V
    ...
    .line 367
    iput-object v4, p0, Landroid/view/inputmethod/InputMethodManager;->mCursorAnchorInfo:Landroid/view/inputmethod/CursorAnchorInfo;
    ...
    .line 1336
    iput-object v4, p0, Landroid/view/inputmethod/InputMethodManager;->mLastSrvView:Landroid/view/View;

    .line 1337
    iput-boolean v1, p0, Landroid/view/inputmethod/InputMethodManager;->mInTransition:Z
    ...
    .line 627
    invoke-static {p1}, Landroid/common/HwFrameworkFactory;->getSecImmHelper(Lcom/android/internal/view/IInputMethodManager;)Landroid/view/inputmethod/IHwSecImmHelper;

    move-result-object v0

    iput-object v0, p0, Landroid/view/inputmethod/InputMethodManager;->mSecImmHelper:Landroid/view/inputmethod/IHwSecImmHelper;
...
.method focusInLocked(Landroid/view/View;)V
    ...
    :goto_1
    iput-boolean v0, p0, Landroid/view/inputmethod/InputMethodManager;->mInTransition:Z

    .line 1351
    iget-object v0, p0, Landroid/view/inputmethod/InputMethodManager;->mServedView:Landroid/view/View;

    iput-object v0, p0, Landroid/view/inputmethod/InputMethodManager;->mLastSrvView:Landroid/view/View;
...
.method public hideSoftInputFromWindow(Landroid/content/Context;I)V
    .locals 5
    ...
    .line 2414
    const-string v3, "huawei.android.permission.MULTIWINDOW_SERVICE"

    const-string v4, "Requires MULTIWINDOW SERVICE permission"
    ...
    invoke-interface {v3}, Lcom/android/internal/view/IInputMethodManager;->asBinder()Landroid/os/IBinder;

    move-result-object v1

    .line 2418
    .local v1, "inputMethodBinder":Landroid/os/IBinder;
    ...
    .line 2422
    :try_start_0
    const-string v3, "android.input.IInputMethodManager"
    ...
    .end local v1    # "inputMethodBinder":Landroid/os/IBinder;
    ...
    .restart local v1    # "inputMethodBinder":Landroid/os/IBinder;
...
.method public hideSoftInputFromWindow(Landroid/os/IBinder;ILandroid/os/ResultReceiver;)Z
    ...
    .line 1072
    :cond_1
    invoke-virtual {p0}, Landroid/view/inputmethod/InputMethodManager;->isSecImmEnabled()Z
    ...
    .line 1073
    iget-object v0, p0, Landroid/view/inputmethod/InputMethodManager;->mSecImmHelper:Landroid/view/inputmethod/IHwSecImmHelper;
    ...
    invoke-interface/range {v0 .. v5}, Landroid/view/inputmethod/IHwSecImmHelper;->hideSoftInputFromWindow(Landroid/os/IBinder;ILandroid/os/ResultReceiver;Landroid/view/View;Lcom/android/internal/view/IInputMethodClient$Stub;)Z
...
.method public isSecImmEnabled()Z
    .locals 2

    .prologue
    .line 1611
    iget-object v1, p0, Landroid/view/inputmethod/InputMethodManager;->mSecImmHelper:Landroid/view/inputmethod/IHwSecImmHelper;
    ...
    invoke-interface {v1}, Landroid/view/inputmethod/IHwSecImmHelper;->isUseSecureIME()Z
...
.method public isViewInTransition(Landroid/view/View;)Z
    .locals 6
    .param p1, "view"    # Landroid/view/View;
    ...
    .line 1626
    iget-boolean v4, p0, Landroid/view/inputmethod/InputMethodManager;->mInTransition:Z
    ...
    iget-object v4, p0, Landroid/view/inputmethod/InputMethodManager;->mLastSrvView:Landroid/view/View;
    ...
    .line 1654
    iget-object v4, p0, Landroid/view/inputmethod/InputMethodManager;->mSecImmHelper:Landroid/view/inputmethod/IHwSecImmHelper;

    iget-object v5, p0, Landroid/view/inputmethod/InputMethodManager;->mServedView:Landroid/view/View;

    invoke-interface {v4, v5}, Landroid/view/inputmethod/IHwSecImmHelper;->isPasswordInputType(Landroid/view/View;)Z

    move-result v0

    .line 1655
    .local v0, "isPwdType":Z
    if-eqz v1, :cond_6
    ...
    iget-object v5, p0, Landroid/view/inputmethod/InputMethodManager;->mLastSrvView:Landroid/view/View;
    ...
    const-string v3, "isViewInTransition is true !"
...
.method public resetInTransitionState()V
    .locals 1
...
.method public showSoftInput(Landroid/view/View;ILandroid/os/ResultReceiver;)Z
    ...
    invoke-interface {v0, p1, p2, p3, v2}, Landroid/view/inputmethod/IHwSecImmHelper;->showSoftInput(Landroid/view/View;ILandroid/os/ResultReceiver;Lcom/android/internal/view/IInputMethodClient$Stub;)Z
...
.method startInputInner(Landroid/os/IBinder;III)Z
    ...
    iput-object v1, v0, Landroid/view/inputmethod/InputMethodManager;->mCursorAnchorInfo:Landroid/view/inputmethod/CursorAnchorInfo;
    ...
    .line 1270
    iget v1, v12, Lcom/android/internal/view/InputBindResult;->userActionNotificationSequenceNumber:I

    move-object/from16 v0, p0

    iput v1, v0, Landroid/view/inputmethod/InputMethodManager;->mNextUserActionNotificationSequenceNumber:I
    ...
    const-string v2, "Current bind isn\'t success!"
    ...
    const-string v2, "Can not start input method, need check in Settings, a default language is needed!"
    ...
    const-string v3, "startInputInner() has exception -> "
