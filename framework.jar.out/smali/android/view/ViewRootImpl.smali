...
# static fields
.field static CONTINUOUS_REF:I = 0x0
...
.field private static final REDUNDANT:J = 0x7a120L

.field private static final SF_VSYNC_OFFSET:J = 0x4c4b40L

.field private static final TAG:Ljava/lang/String; = "ViewRootImpl"

.field private static final VSYNC_OFFSET:J = 0x7270e0L

.field private static final VSYNC_SPAN:J = 0xfe502bL
...
# instance fields
.field private lastFrameDefer:I
...
.field private mDebugRefreshDirty:Z

.field private mDeliverInputTime:J
...
.method static constructor <clinit>()V
    ...
    .line 134
    const-string v0, "ro.config.hw_jank_ontimeref"
    ...
    sput v0, Landroid/view/ViewRootImpl;->ONTIME_REF:I

    .line 135
    const-string v0, "ro.config.hw_jank_continuousref"
    ...
    sput v0, Landroid/view/ViewRootImpl;->CONTINUOUS_REF:I
    ...
    sput-boolean v0, Landroid/view/ViewRootImpl;->FRONT_FINGERPRINT_NAVIGATION:Z
...
.method public constructor <init>(Landroid/content/Context;Landroid/view/Display;)V
    ...
    .line 376
    iput-boolean v2, p0, Landroid/view/ViewRootImpl;->mDebugRefreshDirty:Z
    ...
    .line 3632
    iput v2, p0, Landroid/view/ViewRootImpl;->lastFrameDefer:I
    ...
    iput-object v0, p0, Landroid/view/ViewRootImpl;->mPkgName:Ljava/lang/String;

    .line 436
    invoke-direct {p0}, Landroid/view/ViewRootImpl;->debugRefreshDirty()Z

    move-result v0

    iput-boolean v0, p0, Landroid/view/ViewRootImpl;->mDebugRefreshDirty:Z
...
.method static synthetic access$2002(Landroid/view/ViewRootImpl;J)J
    .locals 1
    .param p0, "x0"    # Landroid/view/ViewRootImpl;
    .param p1, "x1"    # J
    ...
    .prologue
    .line 106
    iput-wide p1, p0, Landroid/view/ViewRootImpl;->mDeliverInputTime:J
...
.method static synthetic access$900()Z
    ...
    .prologue
    .line 106
    sget-boolean v0, Landroid/view/ViewRootImpl;->FRONT_FINGERPRINT_NAVIGATION:Z
...
.method private debugRefreshDirty()Z
    .locals 2
    ...
    .line 2740
    const-string v1, "debug.refresh.dirty"
...
.method private doRelayoutAsyncly(Z)V
    .locals 2
    .param p1, "shouldDo"    # Z
    ...
    invoke-virtual {v0, v1}, Landroid/view/ViewRootImpl$RunQueue;->post(Ljava/lang/Runnable;)V
...
.method private draw(Z)V
    ...
    .line 2669
    :cond_10
    invoke-direct/range {p0 .. p0}, Landroid/view/ViewRootImpl;->enableRefreshDirty()Z
    ...
    invoke-direct {v0, v14}, Landroid/view/ViewRootImpl;->setRefreshDirty(Landroid/graphics/Rect;)V
...
.method private enableRefreshDirty()Z
    .locals 2
    ...
    .line 2736
    const-string v1, "sys.refresh.dirty"
...
.method private performDraw()V
    ...
    iput-wide v10, p0, Landroid/view/ViewRootImpl;->mSoftDrawTime:J
    ...
    .end local v5    # "i":I
    :cond_4
    iget-object v10, p0, Landroid/view/ViewRootImpl;->mDirty:Landroid/graphics/Rect;
    ...
    iput-wide v12, p0, Landroid/view/ViewRootImpl;->mSoftDrawTime:J
...
.method private performLayout(Landroid/view/WindowManager$LayoutParams;II)Z
    .locals 13
    ...
    .line 2226
    .local v12, "windowSizeMayChange":Z
    iget-object v1, p0, Landroid/view/ViewRootImpl;->mView:Landroid/view/View;
    ...
    invoke-direct {v2, p0, v6}, Landroid/view/ViewRootImpl$3;-><init>(Landroid/view/ViewRootImpl;Ljava/util/ArrayList;)V
...
.method private performTraversals()V
    ...
    iget-boolean v4, v4, Landroid/view/View$AttachInfo;->mKeepScreenOn:Z
    ...
    iget-boolean v4, v4, Landroid/view/View$AttachInfo;->mHasSystemUiListeners:Z
    ...
    invoke-direct {v0, v6, v8, v9}, Landroid/view/ViewRootImpl;->performLayout(Landroid/view/WindowManager$LayoutParams;II)Z

    move-result v70

    .line 1992
    .local v70, "wsmayChange":Z
    move-object/from16 v0, p0

    move/from16 v1, v70

    invoke-direct {v0, v1}, Landroid/view/ViewRootImpl;->doRelayoutAsyncly(Z)V
    ...
    iget-object v4, v0, Landroid/view/ViewRootImpl;->mPkgName:Ljava/lang/String;
    ...
    .end local v15    # "touchableRegion":Landroid/graphics/Region;
    .end local v44    # "insets":Landroid/view/ViewTreeObserver$InternalInsetsInfo;
    .restart local v70    # "wsmayChange":Z
    :catch_4
    move-exception v4
...
.method public static setEnablePartialUpdate(Z)V
    .locals 3
    .param p0, "isEnable"    # Z
    ...
    invoke-direct {v2, v0}, Landroid/view/ViewRootImpl$1;-><init>(Z)V
...
.method private setRefreshDirty(Landroid/graphics/Rect;)V
    .locals 4
    .param p1, "dirty"    # Landroid/graphics/Rect;
    ...
    const-string v2, "setRefreshDirty-dirty is null"
    ...
    .line 2749
    :cond_0
    iget-boolean v1, p0, Landroid/view/ViewRootImpl;->mDebugRefreshDirty:Z
    ...
    const-string v3, "@@@setRefreshDirty-dirty=["
    ...
    invoke-virtual {v1, p1}, Landroid/view/Surface;->setRefreshDirty(Landroid/graphics/Rect;)V
    :try_end_0
    ...
    const-string v2, "setRefreshDirty-fail, Run Time exception"
    ...
    const-string v2, "setRefreshDirty-fail"
...
.method doDie()V
    ...
    invoke-virtual {v4}, Landroid/view/View;->isTouchableInOtherThread()Z
    ...
    const-string v6, ",CREATE IN "

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    iget-object v6, p0, Landroid/view/ViewRootImpl;->mThread:Ljava/lang/Thread;
    ...
    .end local v0    # "ignoreCheckThread":Z
    :cond_0
    move v0, v3
    ...
    .line 5844
    .restart local v0    # "ignoreCheckThread":Z
    :cond_1
    invoke-virtual {p0}, Landroid/view/ViewRootImpl;->checkThread()V
...
.method public getWinFrame()Landroid/graphics/Rect;
    .locals 1
...
.method jank_processAfterTraversal(Z)V
    .locals 30
    .param p1, "scroll"    # Z
    ...
    invoke-virtual/range {v24 .. v24}, Landroid/view/Choreographer;->getDoFrameDelayTime()J
    ...
    invoke-virtual/range {v24 .. v24}, Landroid/view/Choreographer;->getLastFrameDoneTime()J

    move-result-wide v14

    .line 3637
    .local v14, "lastFrameDoneTime":J
    move-object/from16 v0, p0
    ...
    invoke-virtual/range {v24 .. v24}, Landroid/view/Choreographer;->getRealFrameTime()J

    move-result-wide v12

    .line 3638
    .local v12, "frameTime":J
    ...
    .line 3641
    .local v22, "skip":I
    sget v24, Landroid/view/ViewRootImpl;->ONTIME_REF:I
    ...
    .line 3644
    .local v6, "bContinuousUpdate":Z
    if-eqz v7, :cond_3

    .line 3645
    sub-long v24, v12, v14

    const-wide/32 v26, 0xfe502b
    ...
    iput v0, v1, Landroid/view/ViewRootImpl;->lastFrameDefer:I
    ...
    .line 3641
    .end local v6    # "bContinuousUpdate":Z
    .end local v7    # "bOntime":Z
    :cond_1
    const/4 v7, 0x0
    ...
    .line 3645
    .restart local v6    # "bContinuousUpdate":Z
    .restart local v7    # "bOntime":Z
    :cond_2
    const/4 v6, 0x0
    ...
    sget v26, Landroid/view/ViewRootImpl;->CONTINUOUS_REF:I
    ...
    iget v0, v0, Landroid/view/ViewRootImpl;->lastFrameDefer:I
    ...
    const-string v25, "jank_event_sync: start_ts="
    ...
    .line 3698
    .local v23, "traceMark":Ljava/lang/String;
    ...
    iget-wide v0, v0, Landroid/view/ViewRootImpl;->mDeliverInputTime:J
    ...
    invoke-virtual/range {v25 .. v26}, Landroid/view/HardwareRenderer;->getJankDrawData(I)J
    ...
    invoke-static {v0, v9}, Landroid/util/Jlog;->d(ILjava/lang/String;)I
    ...
    iget-wide v0, v0, Landroid/view/ViewRootImpl;->mSoftDrawTime:J
...
.method public setSDRRatio(F)V
    ...
    invoke-virtual {v0, p1}, Landroid/view/Surface;->setSDRRatio(F)V
...
.method updateConfiguration(Landroid/content/res/Configuration;Z)V
    ...
    invoke-virtual {v0, v5, v6, v1}, Landroid/content/res/CompatibilityInfo;->applyToConfigurationExt(Landroid/util/DisplayMetrics;ILandroid/content/res/Configuration;)V
