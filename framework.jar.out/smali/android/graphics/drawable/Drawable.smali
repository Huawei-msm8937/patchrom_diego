...
.method public static createFromXmlInner(Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;
    ...
    :sswitch_3
    const-string/jumbo v3, "hwcolorful"
    ...
    invoke-direct {v0}, Landroid/graphics/drawable/HwColorfulDrawable;-><init>()V

    .restart local v0    # "drawable":Landroid/graphics/drawable/Drawable;
    move-object v2, v0

    .line 1170
    check-cast v2, Landroid/graphics/drawable/HwColorfulDrawable;

    invoke-static {p0}, Landroid/hwcontrol/HwWidgetFactory;->getControlColor(Landroid/content/res/Resources;)I

    move-result v3

    invoke-virtual {v2, v3}, Landroid/graphics/drawable/HwColorfulDrawable;->setColor(I)V
    ...
    .sparse-switch
        ...
        -0x63a70093 -> :sswitch_12
        -0x5905b6b9 -> :sswitch_f
        -0x52c70ed1 -> :sswitch_11
        -0x377b49d0 -> :sswitch_6
        -0x372522a5 -> :sswitch_d
        -0x30e61ebd -> :sswitch_9
        -0x1e6b8b37 -> :sswitch_1
        -0x59d5866 -> :sswitch_4
        0x2ea350 -> :sswitch_c
        0x42a8d49 -> :sswitch_3
        0x5a72f63 -> :sswitch_7
        0x5fb611d -> :sswitch_10
        0x683094a -> :sswitch_b
        0x6854fa1 -> :sswitch_8
        0x993c947 -> :sswitch_2
        0x4705f3df -> :sswitch_0
        0x780890c5 -> :sswitch_e
        0x7e4794ad -> :sswitch_a
    .end sparse-switch
