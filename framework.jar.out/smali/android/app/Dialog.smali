...
.field private mHwDialogStub:Landroid/hwcontrol/HwWidgetFactory$HwDialogStub;
...
.method constructor <init>(Landroid/content/Context;IZ)V
    ...
    invoke-static {v2}, Lcom/android/internal/policy/HwPolicyFactory;->getHwPhoneWindow(Landroid/content/Context;)Landroid/view/Window;
    ...
    invoke-static {p1, v2, p0, v4}, Landroid/hwcontrol/HwWidgetFactory;->getHwDialogStub(Landroid/content/Context;Landroid/view/Window;Landroid/app/Dialog;Landroid/util/AttributeSet;)Landroid/hwcontrol/HwWidgetFactory$HwDialogStub;

    move-result-object v2

    iput-object v2, p0, Landroid/app/Dialog;->mHwDialogStub:Landroid/hwcontrol/HwWidgetFactory$HwDialogStub;
...
.method private hasAnimatorMask()Z
    .locals 1

    .prologue
    .line 1382
    iget-object v0, p0, Landroid/app/Dialog;->mHwDialogStub:Landroid/hwcontrol/HwWidgetFactory$HwDialogStub;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/app/Dialog;->mHwDialogStub:Landroid/hwcontrol/HwWidgetFactory$HwDialogStub;

    invoke-interface {v0}, Landroid/hwcontrol/HwWidgetFactory$HwDialogStub;->getMask()I
...
.method private hasButtons()Z
    ...
    .prologue
    .line 1390
    invoke-direct {p0}, Landroid/app/Dialog;->hasDismissMask()Z
    ...
    invoke-interface {v0}, Landroid/hwcontrol/HwWidgetFactory$HwDialogStub;->hasButtons()Z
...
.method private hasDismissMask()Z
    .locals 1
...
.method public onAttachedToWindow()V
    ...
    .prologue
    .line 766
    invoke-direct {p0}, Landroid/app/Dialog;->hasAnimatorMask()Z
    ...
    invoke-interface {v0}, Landroid/hwcontrol/HwWidgetFactory$HwDialogStub;->showDialogFactory()V
...
.method public onDetachedFromWindow()V
    ...
    invoke-interface {v0}, Landroid/hwcontrol/HwWidgetFactory$HwDialogStub;->dismissDialogFactory()V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 694
    invoke-direct {p0}, Landroid/app/Dialog;->hasButtons()Z
...
.method public show()V
    ...
    .line 321
    invoke-static {p0}, Landroid/hwcontrol/HwWidgetFactory;->getHuaweiActionBarImpl(Landroid/app/Dialog;)Lcom/android/internal/app/WindowDecorActionBar;
    ...
    const-string/jumbo v4, "show mWindowManager.addView RuntimeException"
