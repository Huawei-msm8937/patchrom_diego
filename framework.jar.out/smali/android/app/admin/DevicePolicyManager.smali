...
.method private uploadRadarData(Ljava/lang/String;Ljava/lang/String;)V
    .locals 5
    ...
    .line 1833
    .local v0, "logException":Landroid/util/LogException;
    if-nez v0, :cond_0

    .line 1834
    sget-object v2, Landroid/app/admin/DevicePolicyManager;->TAG:Ljava/lang/String;

    const-string/jumbo v3, "log exception error"
    ...
    const-string v3, "Scene def: "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    const-string v3, "2805\n"
    ...
    .line 1846
    .local v1, "radarHeader":Ljava/lang/String;
    ...
    invoke-interface {v0, v2, v3, v1, v4}, Landroid/util/LogException;->msg(Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;)I

    goto :goto_0
.end method

.method private uploadResetPasswordRadarData()V
    .locals 6
    ...
    const-string v5, "get packagemanager error"
    ...
    const-string v5, "get packagename error"
    ...
    invoke-direct {p0, v2, v4}, Landroid/app/admin/DevicePolicyManager;->uploadRadarData(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string/jumbo v5, "package name not found"
    ...
    invoke-direct {p0, v4, v5}, Landroid/app/admin/DevicePolicyManager;->uploadRadarData(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_1
...
.method public resetPassword(Ljava/lang/String;I)Z
    ...
    .line 1789
    :try_start_0
    invoke-direct {p0}, Landroid/app/admin/DevicePolicyManager;->uploadResetPasswordRadarData()V
