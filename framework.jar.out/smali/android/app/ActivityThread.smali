...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Landroid/app/ActivityThread$GraphicBufferCreate;,
        ...
        Landroid/app/ActivityThread$AcquiringProviderRecord;,
...
# instance fields
.field final mAcquiringProviderMap:Landroid/util/ArrayMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method static constructor <clinit>()V
    ...
    .line 235
    const-string v0, "build.hisi_perf_opt"
    ...
    sput-boolean v0, Landroid/app/ActivityThread;->HISI_PERF_OPT:Z
...
.method constructor <init>()V
    ...
    iput-object v0, p0, Landroid/app/ActivityThread;->mAcquiringProviderMap:Landroid/util/ArrayMap;
...
.method private acquireExistingProvider(Landroid/content/Context;Landroid/app/ActivityThread$ProviderKey;Z)Landroid/content/IContentProvider;
    .locals 9
...
.method private attach(Z)V
    ...
    const-string v4, "ActivityThread,attachApplication"
    ...
    .line 5503
    invoke-static {}, Landroid/hwtheme/HwThemeManager;->setThemeFont()V
    ...
    invoke-virtual {v3, v4}, Landroid/app/ActivityThread$ApplicationThread;->scheduleTrimMemory(I)V
    :try_end_1
...
.method private getContextForClassLoader(Landroid/content/pm/ApplicationInfo;Landroid/content/Context;Landroid/content/Context;)Landroid/content/Context;
    .locals 7
    .param p1, "ai"    # Landroid/content/pm/ApplicationInfo;
    .param p2, "context"    # Landroid/content/Context;
    .param p3, "defContext"    # Landroid/content/Context;
    ...
    invoke-interface {v4, v1, v5, v6}, Landroid/content/pm/IPackageManager;->getApplicationInfo(Ljava/lang/String;II)Landroid/content/pm/ApplicationInfo;
    ...
    const-string v6, " is uninstalled, can\'t install provider"
    ...
    .end local p3    # "defContext":Landroid/content/Context;
    :cond_0
    :goto_0
    return-object p3
    ...
    .restart local v2    # "publicSourceDir":Ljava/lang/String;
    .restart local v3    # "sourceDir":Ljava/lang/String;
    .restart local p3    # "defContext":Landroid/content/Context;
    :cond_1
    ...
    const-string v6, " is replaced, sourceDir is changed from "
    ...
    const-string v6, ", publicSourceDir is changed from "
...
.method private handleBindApplication(Landroid/app/ActivityThread$AppBindData;)V
    ...
    .line 4553
    sget-boolean v2, Landroid/app/ActivityThread;->HISI_PERF_OPT:Z

    if-eqz v2, :cond_0

    .line 4554
    new-instance v20, Landroid/app/ActivityThread$GraphicBufferCreate;

    const/4 v2, 0x0

    move-object/from16 v0, v20

    invoke-direct {v0, v2}, Landroid/app/ActivityThread$GraphicBufferCreate;-><init>(Landroid/app/ActivityThread$1;)V

    .line 4555
    .local v20, "graphicBuffer":Landroid/app/ActivityThread$GraphicBufferCreate;
    ...
    .line 4556
    .local v30, "t1":Ljava/lang/Thread;
    invoke-virtual/range {v30 .. v30}, Ljava/lang/Thread;->start()V

    .line 4560
    .end local v20    # "graphicBuffer":Landroid/app/ActivityThread$GraphicBufferCreate;
    .end local v30    # "t1":Ljava/lang/Thread;
    :cond_0
    move-object/from16 v0, p1
    ...
    invoke-virtual {v12}, Landroid/app/ContextImpl;->preloadSharedPrefs()V
    ...
    iget-object v2, v0, Landroid/app/ActivityThread;->mConfiguration:Landroid/content/res/Configuration;

    invoke-static {v2}, Landroid/hwtheme/HwThemeManager;->initForThemeFont(Landroid/content/res/Configuration;)V
    ...
    invoke-virtual {v2, v4}, Landroid/app/ActivityThread$ApplicationThread;->scheduleTrimMemory(I)V
    :try_end_7
...
.method private handleBindService(Landroid/app/ActivityThread$BindServiceData;)V
    ...
    const-string/jumbo v6, "publishService failed when binding service "
    ...
    invoke-static {v4, v5}, Landroid/util/Flog;->w(ILjava/lang/String;)I
    :try_end_2
    ...
    const-string/jumbo v5, "service can\'t be binded"

    invoke-static {v4, v5}, Landroid/util/Flog;->v(ILjava/lang/String;)I
...
.method private handleCreateService(Landroid/app/ActivityThread$CreateServiceData;)V
    ...
    const-string/jumbo v5, "serviceDone failed when creating service "
    ...
    invoke-static {v3, v4}, Landroid/util/Flog;->w(ILjava/lang/String;)I
    :try_end_3
    .catch Ljava/lang/Exception; {:try_start_3 .. :try_end_3} :catch_2
...
.method private handleRelaunchActivity(Landroid/app/ActivityThread$ActivityClientRecord;)V
    ...
    .line 4125
    iget-boolean v7, v5, Landroid/app/ActivityThread$ActivityClientRecord;->onlyLocalRequest:Z
    ...
    iput-boolean v7, p1, Landroid/app/ActivityThread$ActivityClientRecord;->startsNotResumed:Z
...
.method private handleServiceArgs(Landroid/app/ActivityThread$ServiceArgsData;)V
    ...
    const-string v5, "Unable to finish starting service "
...
.method private handleStopActivity(Landroid/os/IBinder;ZI)V
    ...
    const-string v4, "Stop activity error, ActivityClientRecord is removed, token= "
...
.method private handleUnbindService(Landroid/app/ActivityThread$BindServiceData;)V
    ...
    const-string v6, "Unable to finish unbind to service "
...
.method private installProvider(Landroid/content/Context;Landroid/app/IActivityManager$ContentProviderHolder;Landroid/content/pm/ProviderInfo;ZZZ)Landroid/app/IActivityManager$ContentProviderHolder;
    ...
    invoke-direct {v0, v2, v1, v3}, Landroid/app/ActivityThread;->getContextForClassLoader(Landroid/content/pm/ApplicationInfo;Landroid/content/Context;Landroid/content/Context;)Landroid/content/Context;
    ...
    iget-object v15, v0, Landroid/content/pm/ProviderInfo;->applicationInfo:Landroid/content/pm/ApplicationInfo;
    ...
    .line 5383
    const-string v15, "acquire_provider"
    ...
    invoke-static/range {v15 .. v17}, Lcom/huawei/pgmng/common/Utils;->handleTimeOut(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method private performDestroyActivity(Landroid/os/IBinder;ZIZ)Landroid/app/ActivityThread$ActivityClientRecord;
    ...
    const-string v5, "Remove activity client record, r= "
...
.method private performLaunchActivity(Landroid/app/ActivityThread$ActivityClientRecord;Landroid/content/Intent;)Landroid/app/Activity;
    ...
    const-string v5, "ActivityThread,callActivityOnCreate"
    ...
    const-string v6, "add activity client record, r= "
...
.method public final acquireExistingProvider(Landroid/content/Context;Ljava/lang/String;IZ)Landroid/content/IContentProvider;
    ...
    invoke-direct {p0, p1, v0, p4}, Landroid/app/ActivityThread;->acquireExistingProvider(Landroid/content/Context;Landroid/app/ActivityThread$ProviderKey;Z)Landroid/content/IContentProvider;
...
.method public final acquireProvider(Landroid/content/Context;Ljava/lang/String;IZ)Landroid/content/IContentProvider;
    ...
    invoke-direct {p0, p1, v8, p4}, Landroid/app/ActivityThread;->acquireExistingProvider(Landroid/content/Context;Landroid/app/ActivityThread$ProviderKey;Z)Landroid/content/IContentProvider;
    ...
    .line 4912
    .local v7, "first":Z
    iget-object v1, p0, Landroid/app/ActivityThread;->mAcquiringProviderMap:Landroid/util/ArrayMap;

    monitor-enter v1

    .line 4913
    :try_start_0
    iget-object v0, p0, Landroid/app/ActivityThread;->mAcquiringProviderMap:Landroid/util/ArrayMap;

    invoke-virtual {v0, v8}, Landroid/util/ArrayMap;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v10

    check-cast v10, Landroid/app/ActivityThread$AcquiringProviderRecord;

    .line 4914
    .local v10, "r":Landroid/app/ActivityThread$AcquiringProviderRecord;
    if-nez v10, :cond_3

    .line 4915
    new-instance v10, Landroid/app/ActivityThread$AcquiringProviderRecord;

    .end local v10    # "r":Landroid/app/ActivityThread$AcquiringProviderRecord;
    invoke-direct {v10}, Landroid/app/ActivityThread$AcquiringProviderRecord;-><init>()V

    .line 4916
    .restart local v10    # "r":Landroid/app/ActivityThread$AcquiringProviderRecord;
    iget-object v0, p0, Landroid/app/ActivityThread;->mAcquiringProviderMap:Landroid/util/ArrayMap;
    ...
    :try_start_2
    iput-boolean v0, v10, Landroid/app/ActivityThread$AcquiringProviderRecord;->acquiring:Z
    ...
    .line 4946
    :try_start_3
    iget v0, v10, Landroid/app/ActivityThread$AcquiringProviderRecord;->requests:I

    add-int/lit8 v0, v0, -0x1

    iput v0, v10, Landroid/app/ActivityThread$AcquiringProviderRecord;->requests:I
    ...
    iget v4, v10, Landroid/app/ActivityThread$AcquiringProviderRecord;->requests:I

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    move-result-object v3

    const-string v4, " threads acquire provider "
    ...
    const-string v4, " at the same time!"
    ...
    :try_start_a
    iput-boolean v1, v10, Landroid/app/ActivityThread$AcquiringProviderRecord;->acquiring:Z
    ...
    .line 4946
    :try_start_b
    iget v3, v10, Landroid/app/ActivityThread$AcquiringProviderRecord;->requests:I

    add-int/lit8 v3, v3, -0x1

    iput v3, v10, Landroid/app/ActivityThread$AcquiringProviderRecord;->requests:I

    if-nez v3, :cond_5

    .line 4947
    iget-object v3, p0, Landroid/app/ActivityThread;->mAcquiringProviderMap:Landroid/util/ArrayMap;
    ...
    :goto_3
    :try_start_e
    iget-boolean v0, v10, Landroid/app/ActivityThread$AcquiringProviderRecord;->acquiring:Z
    :try_end_e
...
.method applyConfigCompatMainThread(ILandroid/content/res/Configuration;Landroid/content/res/CompatibilityInfo;)Landroid/content/res/Configuration;
    ...
    .line 1722
    iget-object v1, p0, Landroid/app/ActivityThread;->mMainThreadConfig:Landroid/content/res/Configuration;
    ...
    .line 1727
    invoke-virtual {p3, v0, p1, p2}, Landroid/content/res/CompatibilityInfo;->applyToConfigurationExt(Landroid/util/DisplayMetrics;ILandroid/content/res/Configuration;)V
...
.method getTopLevelResources(Ljava/lang/String;[Ljava/lang/String;[Ljava/lang/String;[Ljava/lang/String;ILandroid/content/res/Configuration;Landroid/app/LoadedApk;)Landroid/content/res/Resources;
    ...
    .line 1743
    .local v7, "info":Landroid/content/res/CompatibilityInfo;
    ...
    .line 1747
    .local v8, "manager":Landroid/app/IActivityManager;
    if-eqz v8, :cond_0
    ...
    invoke-interface {v8, v0}, Landroid/app/IActivityManager;->getPackageScreenCompatMode(Ljava/lang/String;)I
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 1754
    .end local v8    # "manager":Landroid/app/IActivityManager;
    :cond_0
    :goto_0
    const/4 v0, 0x1
    ...
    invoke-static {v0}, Landroid/content/res/CompatibilityInfo;->makeCompatibilityInfo(I)Landroid/content/res/CompatibilityInfo;
    ...
    const-string v1, "APS: SDR: ActivityThread.getPackageScreenCompatMode, RemoteException is thrown!"
...
.method final handleConfigurationChanged(Landroid/content/res/Configuration;Landroid/content/res/CompatibilityInfo;)V
    ...
    .line 4337
    invoke-static {p1}, Landroid/hwtheme/HwThemeManager;->setThemeFontOnConfigChg(Landroid/content/res/Configuration;)Z

    move-result v3

    .line 4338
    .local v3, "fontNeedChange":Z
    if-eqz v3, :cond_6
    ...
    invoke-virtual {v5, v6}, Landroid/app/ActivityThread$ApplicationThread;->scheduleTrimMemory(I)V
...
.method final handleResumeActivity(Landroid/os/IBinder;ZZZ)V
    ...
    const-string v9, ",forwardBitChanged="
    ...
    const-string v9, " onlyLocalRequest="
    ...
    invoke-static {v8, v7}, Landroid/util/Flog;->i(ILjava/lang/String;)I
