...
.field protected static final mCallbacks:Ljava/util/ArrayList;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/app/WallpaperManager;->mCallbacks:Ljava/util/ArrayList;
...
.method private getWallpaperHeight()I
    .locals 1
    ...
    invoke-virtual {v0}, Landroid/app/WallpaperManager$Globals;->getWallpaperHeight()I
...
.method private getWallpaperWidth()I
    .locals 1
    ...
    invoke-virtual {v0}, Landroid/app/WallpaperManager$Globals;->getWallpaperWidth()I
...
.method protected createDefaultWallpaperBitmap(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    ...
    .prologue
    .line 1520
    invoke-virtual {p0}, Landroid/app/WallpaperManager;->getContext()Landroid/content/Context;
    ...
    invoke-static {v5, p1, v2, v1}, Landroid/hwtheme/HwThemeManager;->generateBitmap(Landroid/content/Context;Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
...
.method public forgetLoadedBlurWallpaper()V
    ...
    invoke-virtual {v0}, Landroid/app/WallpaperManager$Globals;->forgetLoadedBlurWallpaper()V
...
.method public getUserWallpaperBounds()Landroid/os/Bundle;
    .locals 1
    ...
    invoke-virtual {v0}, Landroid/app/WallpaperManager$Globals;->peekCurrentWallpaperBounds()Landroid/os/Bundle;
...
.method public peekBlurWallpaperBitmap(Landroid/graphics/Rect;)Landroid/graphics/Bitmap;
    ...
    invoke-virtual {v0, p1}, Landroid/app/WallpaperManager$Globals;->peekBlurWallpaperBitmap(Landroid/graphics/Rect;)Landroid/graphics/Bitmap;
...
.method public setWallpaperOffsets(Landroid/os/IBinder;FF)V
    ...
    .local v8, "height":I
    :goto_1
    invoke-direct {p0}, Landroid/app/WallpaperManager;->getWallpaperWidth()I

    move-result v11

    .line 1330
    .local v11, "wallpaperWidth":I
    invoke-direct {p0}, Landroid/app/WallpaperManager;->getWallpaperHeight()I

    move-result v10

    .line 1331
    .local v10, "wallpaperHeight":I
    if-nez v11, :cond_0
    ...
    .line 1333
    .local v6, "currentWallpaper":Landroid/graphics/Bitmap;
    if-eqz v6, :cond_0
    ...
    .line 1339
    .end local v6    # "currentWallpaper":Landroid/graphics/Bitmap;
    :cond_0
    ...
    .end local v10    # "wallpaperHeight":I
    .end local v11    # "wallpaperWidth":I
    ...
    .restart local v10    # "wallpaperHeight":I
    .restart local v11    # "wallpaperWidth":I
    :cond_5
    invoke-static {}, Landroid/view/WindowManagerGlobal;->getWindowSession()Landroid/view/IWindowSession;
