...
.field private static mHwCustApplicationPackageManager:Landroid/app/HwCustApplicationPackageManager; = null
...
.method static constructor <clinit>()V
    ...
    .prologue
    .line 115
    const-class v0, Landroid/app/HwCustApplicationPackageManager;
    ...
    check-cast v0, Landroid/app/HwCustApplicationPackageManager;

    sput-object v0, Landroid/app/ApplicationPackageManager;->mHwCustApplicationPackageManager:Landroid/app/HwCustApplicationPackageManager;
...
.method private static isPackageCandidateVolume(Landroid/content/pm/ApplicationInfo;Landroid/os/storage/VolumeInfo;)Z
    ...
    sget-object v2, Landroid/app/ApplicationPackageManager;->mHwCustApplicationPackageManager:Landroid/app/HwCustApplicationPackageManager;

    if-eqz v2, :cond_3

    sget-object v2, Landroid/app/ApplicationPackageManager;->mHwCustApplicationPackageManager:Landroid/app/HwCustApplicationPackageManager;

    invoke-virtual {v2, p0}, Landroid/app/HwCustApplicationPackageManager;->isSdMoveabled(Landroid/content/pm/ApplicationInfo;)Z
    ...
    invoke-virtual {v2, p1}, Landroid/app/HwCustApplicationPackageManager;->isSdVol(Landroid/os/storage/VolumeInfo;)Z
...
.method public getCachedString(Landroid/app/ApplicationPackageManager$ResourceName;)Ljava/lang/CharSequence;
    .locals 4
    .param p1, "name"    # Landroid/app/ApplicationPackageManager$ResourceName;
...
.method public getInstalledApplications(I)Ljava/util/List;
    ...
    :try_start_0
    invoke-static {v3}, Landroid/hsm/HwSystemManager;->allowOp(I)Z
    ...
    const-string v4, "getInstalledApplications blocked"
    ...
    invoke-static {v3}, Landroid/hsm/HwSystemManager;->getFakeApplications(Ljava/util/List;)Ljava/util/List;
    ...
    .line 643
    .restart local v1    # "slice":Landroid/content/pm/ParceledListSlice;, "Landroid/content/pm/ParceledListSlice<Landroid/content/pm/ApplicationInfo;>;"
    invoke-virtual {v1}, Landroid/content/pm/ParceledListSlice;->getList()Ljava/util/List;
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public getInstalledPackages(II)Ljava/util/List;
    ...
    :try_start_0
    invoke-static {v2}, Landroid/hsm/HwSystemManager;->allowOp(I)Z
    ...
    const-string v4, "getInstalledPackages blocked, userId "
    ...
    invoke-static {v2}, Landroid/hsm/HwSystemManager;->getFakePackages(Ljava/util/List;)Ljava/util/List;
    ...
    .line 612
    .restart local v1    # "slice":Landroid/content/pm/ParceledListSlice;, "Landroid/content/pm/ParceledListSlice<Landroid/content/pm/PackageInfo;>;"
    invoke-virtual {v1}, Landroid/content/pm/ParceledListSlice;->getList()Ljava/util/List;
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public getPackageCurrentVolume(Landroid/content/pm/ApplicationInfo;)Landroid/os/storage/VolumeInfo;
    ...
    .line 1677
    sget-object v1, Landroid/app/ApplicationPackageManager;->mHwCustApplicationPackageManager:Landroid/app/HwCustApplicationPackageManager;

    if-eqz v1, :cond_1

    sget-object v1, Landroid/app/ApplicationPackageManager;->mHwCustApplicationPackageManager:Landroid/app/HwCustApplicationPackageManager;

    invoke-virtual {v1}, Landroid/app/HwCustApplicationPackageManager;->isSdInstallEnabled()Z
    ...
    invoke-virtual {v1, v0}, Landroid/app/HwCustApplicationPackageManager;->getSDVolume(Landroid/os/storage/StorageManager;)Landroid/os/storage/VolumeInfo;
...
.method public getResourcesForApplication(Landroid/content/pm/ApplicationInfo;)Landroid/content/res/Resources;
    ...
    invoke-virtual {v8, v0}, Landroid/content/res/Resources;->setPackageName(Ljava/lang/String;)V
...
.method public getText(Ljava/lang/String;ILandroid/content/pm/ApplicationInfo;)Ljava/lang/CharSequence;
    ...
    invoke-virtual {p0, v1}, Landroid/app/ApplicationPackageManager;->getCachedString(Landroid/app/ApplicationPackageManager$ResourceName;)Ljava/lang/CharSequence;
    ...
    .line 1371
    invoke-virtual {p0, v1, v3}, Landroid/app/ApplicationPackageManager;->putCachedString(Landroid/app/ApplicationPackageManager$ResourceName;Ljava/lang/CharSequence;)V
    :try_end_1
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_1 .. :try_end_1} :catch_1
...
.method public getUserBadgedIcon(Landroid/graphics/drawable/Drawable;Landroid/os/UserHandle;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v2, p1}, Landroid/hwtheme/HwThemeManager;->getClonedDrawable(Landroid/content/Context;Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, v2, v1, v4}, Landroid/app/ApplicationPackageManager;->getDrawable(Ljava/lang/String;ILandroid/content/pm/ApplicationInfo;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, p1, v0, v4, v2}, Landroid/app/ApplicationPackageManager;->getBadgedDrawable(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/Rect;Z)Landroid/graphics/drawable/Drawable;
...
.method public loadUnbadgedItemIcon(Landroid/content/pm/PackageItemInfo;Landroid/content/pm/ApplicationInfo;)Landroid/graphics/drawable/Drawable;
    ...
    .line 2162
    instance-of v2, p1, Landroid/content/pm/PermissionGroupInfo;
    ...
    :goto_0
    invoke-static {p1, v4, v5, v6, v2}, Landroid/hwtheme/HwThemeManager;->updateIconCache(Landroid/content/pm/PackageItemInfo;Ljava/lang/String;Ljava/lang/String;II)V
    ...
    invoke-virtual {v2, v4}, Landroid/os/UserManager;->getUserIcon(I)Landroid/graphics/Bitmap;
    ...
    .line 2163
    :cond_2
    iget v2, p2, Landroid/content/pm/ApplicationInfo;->icon:I
...
.method public putCachedString(Landroid/app/ApplicationPackageManager$ResourceName;Ljava/lang/CharSequence;)V
    .locals 3
    .param p1, "name"    # Landroid/app/ApplicationPackageManager$ResourceName;
...
.method public queryBroadcastReceivers(Landroid/content/Intent;II)Ljava/util/List;
    ...
    invoke-interface {v2, p1, v3, p2, p3}, Landroid/content/pm/IPackageManager;->queryIntentReceivers(Landroid/content/Intent;Ljava/lang/String;II)Ljava/util/List;
    ...
    const-string/jumbo v4, "queryBroadcastReceivers blocked, "
    ...
    .line 759
    invoke-static {v1}, Landroid/hsm/HwSystemManager;->getFakeResolveInfoList(Ljava/util/List;)Ljava/util/List;
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public queryIntentActivitiesAsUser(Landroid/content/Intent;II)Ljava/util/List;
    ...
    invoke-virtual {v2, v1, p1, v3}, Landroid/app/HwCustApplicationPackageManager;->removeMmsResolveInfo(Ljava/util/List;Landroid/content/Intent;Landroid/content/Context;)V
    ...
    const-string/jumbo v4, "queryIntentActivitiesAsUser blocked, "
...
.method public queryIntentActivityOptions(Landroid/content/ComponentName;[Landroid/content/Intent;Landroid/content/Intent;I)Ljava/util/List;
    ...
    const-string/jumbo v3, "queryIntentActivityOptions blocked, "
    ...
    .line 738
    invoke-static {v12}, Landroid/hsm/HwSystemManager;->getFakeResolveInfoList(Ljava/util/List;)Ljava/util/List;
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public removeCacheIcon(Ljava/lang/String;I)V
    .locals 2
    .param p1, "packageName"    # Ljava/lang/String;
    .param p2, "resid"    # I
