...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Landroid/inputmethodservice/InputMethodService;->DEBUG_FLOW:Z
...
.method public hideWindow()V
    ...
    .line 1603
    invoke-static {p0}, Landroid/common/HwFrameworkFactory;->getHwInputMethodService(Landroid/content/Context;)Landroid/inputmethodservice/IHwInputMethodService;

    move-result-object v0

    invoke-interface {v0, v1}, Landroid/inputmethodservice/IHwInputMethodService;->updateImeDockVisibility(Z)Z
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-virtual {v7, v8, v5, v9}, Landroid/view/inputmethod/InputMethodManager;->setImeWindowStatus(Landroid/os/IBinder;II)V

    .line 858
    sget-boolean v5, Lhuawei/android/mw/HwMultiWindowUtils;->HW_FLOAT_KEYBOARD_FLAG:Z
    ...
    invoke-interface {v5, v6}, Landroid/inputmethodservice/IHwInputMethodService;->updateImeDockConfiguration(Z)Z
...
.method public onCreate()V
    ...
    invoke-virtual {v1, v2, v11, v11}, Landroid/content/res/Resources;->getIdentifier(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)I
    ...
    :goto_0
    iput-boolean v1, p0, Landroid/inputmethodservice/InputMethodService;->mShouldClearInsetOfPreviousIme:Z
    ...
    .line 712
    sget-boolean v1, Lhuawei/android/mw/HwMultiWindowUtils;->HW_FLOAT_KEYBOARD_FLAG:Z
    ...
    invoke-interface {v1, v10}, Landroid/inputmethodservice/IHwInputMethodService;->updateImeDockVisibility(Z)Z
...
.method public onDestroy()V
    ...
    invoke-interface {v1}, Landroid/inputmethodservice/IHwInputMethodService;->handleImeDockDestroy()Z
    ...
    const-string v2, "IME win has removed:"
...
.method public onEvaluateFullscreenMode()Z
    ...
    invoke-static {}, Lhuawei/android/mw/HwMultiWindowUtils;->isSplitWindowActive()Z
...
.method public showWindow(Z)V
    ...
    .line 1483
    sget-boolean v0, Landroid/inputmethodservice/InputMethodService;->DEBUG_FLOW:Z
...
.method showWindowInner(Z)V
    ...
    invoke-virtual {v4, v7, v1, v8}, Landroid/view/inputmethod/InputMethodManager;->setImeWindowStatus(Landroid/os/IBinder;II)V
    ...
    .line 1558
    sget-boolean v4, Landroid/inputmethodservice/InputMethodService;->DEBUG_FLOW:Z

    if-eqz v4, :cond_6

    const-string v4, "InputMethodService"

    const-string/jumbo v7, "showWindow: showing!"
    ...
    invoke-static {v4}, Lcom/huawei/pgmng/log/LogPower;->push(I)I
    ...
    .line 1569
    sget-boolean v4, Lhuawei/android/mw/HwMultiWindowUtils;->HW_FLOAT_KEYBOARD_FLAG:Z
    ...
    invoke-interface {v4, v5}, Landroid/inputmethodservice/IHwInputMethodService;->updateImeDockVisibility(Z)Z
